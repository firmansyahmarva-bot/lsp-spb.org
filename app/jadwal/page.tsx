...
export const metadata: Metadata = {
  title: 'Jadwal Pelatihan Ahli K3 Umum & Program K3 | PT Kreasi Ultimate Berjaya',
  description: 'Informasi dan konfirmasi jadwal batch pelatihan Ahli K3 Umum Kemnaker RI, skema BNSP, dan jadwal In-House Training K3 terdekat bersama PT Kreasi Ultimate Berjaya.',
  alternates: { canonical: '/jadwal' },
  openGraph: {
    title: 'Jadwal Pelatihan Ahli K3 Umum & Program K3 | PT Kreasi Ultimate Berjaya',
    description: 'Konfirmasi jadwal batch pelatihan Ahli K3 Umum Kemnaker RI, skema BNSP, dan jadwal In-House Training K3 terdekat.',
    url: `${site.url}/jadwal`,
    siteName: site.name,
    locale: 'id_ID',
    type: 'website',
  ...
  return (
    <main className="content-main">
      ...
      <header className="hub-hero">
        ...
        <h1>Jadwal Pelatihan Ahli K3 Umum & K3 Indonesia</h1>
        <p>
          Kami menyelenggarakan batch kelas publik secara berkala setiap bulan (metode Blended Online / Offline) serta melayani penjadwalan fleksibel untuk In-House Training khusus perusahaan di seluruh Indonesia.
        </p>
      </header>
      ...
      <section className="schedule-inquiry-card" style={{ textAlign: 'left', padding: '36px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1.4fr) minmax(280px, 0.9fr)', gap: '32px', alignItems: 'center' }}>
          <div>
            <span className="schedule-badge">BATCH TERDEKAT DIBUKA</span>
            <h2 style={{ fontFamily: 'var(--font-serif)', fontSize: '28px', margin: '10px 0 12px' }}>
              Konfirmasi Jadwal & Sisa Kuota Batch Ahli K3 Umum
            </h2>
            <p style={{ color: 'var(--muted)', fontSize: '15px', lineHeight: 1.7, margin: 0 }}>
              Untuk menjaga kualitas pembelajaran dan rasio interaksi dengan Pengawas Kemnaker RI, setiap batch dibatasi kuotanya. Hubungi tim admisi kami untuk memeriksa tanggal pembukaan batch terdekat yang masih tersedia.
            </p>
          </div>
          <div style={{ background: 'var(--surface-alt)', padding: '24px', borderRadius: '10px', textAlign: 'center' }}>
            <span style={{ fontSize: '12px', fontWeight: 800, color: 'var(--green)', letterSpacing: '0.08em' }}>RESPON CEPAT</span>
            <h3 style={{ fontSize: '18px', margin: '8px 0 14px' }}>Cek Jadwal Terdekat</h3>
            <a
      ...
      <section style={{ margin: '48px 0' }}>
        ...
        <div className="program-grid-3">
          <div className="program-card-prominent">
            ...
            <p>
              Dilaksanakan setiap bulan dengan durasi 12 hari kerja efektif (Senin – Sabtu). Pembelajaran teori via Zoom tatap muka interaktif + PKL observasi industri terpandu + ujian Kemnaker RI.
            </p>
          ...
          <div className="program-card-prominent">
            ...
            <p>
              Penetapan tanggal pelaksanaan disesuaikan sepenuhnya dengan kalender operasional dan shift kerja perusahaan Anda. Dapat diselenggarakan di kantor perusahaan atau venue hotel pilihan.
            </p>
            <ul className="program-meta-list">
              <li>Jadwal: Fleksibel sesuai kesepakatan</li>
              <li>Lokasi: Di perusahaan / hotel rekanan</li>
      ...
      <section className="section-container-alt" style={{ padding: '40px', borderRadius: '12px', margin: '40px 0' }}>
        <h2 style={{ fontFamily: 'var(--font-serif)', fontSize: '26px', margin: '0 0 12px' }}>
          Prosedur Booking Seat & Pendaftaran Batch
        </h2>
        <p style={{ color: 'var(--muted)', fontSize: '15px', marginBottom: '24px' }}>
          Ikuti langkah mudah berikut untuk mengamankan kuota kursi Anda pada batch yang diinginkan:
        </p>
        <div className="process-grid">
          <div className="process-step-card">
            <div className="step-number">1</div>
            <h3>Pilih Jadwal</h3>
            <p>Hubungi admisi untuk konfirmasi tanggal batch yang sesuai dengan waktu luang Anda.</p>
          </div>
          <div className="process-step-card">
            <div className="step-number">2</div>
            <h3>Kirim Berkas</h3>
            <p>Kirimkan scan KTP, Ijazah minimal D3/S1, dan pas foto untuk verifikasi syarat awal.</p>
          </div>
          <div className="process-step-card">
            <div className="step-number">3</div>
            <h3>Konfirmasi Seat</h3>
            <p>Lakukan registrasi resmi untuk mengunci kuota sebelum kuota kelas ditutup.</p>
          </div>
          <div className="process-step-card">
            <div className="step-number">4</div>
            <h3>Terima Undangan</h3>
            <p>Dapatkan surat panggilan pelatihan (invitation letter), modul materi, dan jadwal harian.</p>
          </div>
        </div>
      </section>
      ...
      <ConsultationBanner
        title="Butuh Jadwal Batch Mendesak untuk Syarat Tender Perusahaan?"
        text="Sampaikan deadline kebutuhan sertifikat perusahaan Anda. Tim kami akan membantu mencarikan opsi batch terdekat yang paling optimal."
        ctaText="Konsultasi Jadwal Mendesak via WA"
        intent="jadwal"
