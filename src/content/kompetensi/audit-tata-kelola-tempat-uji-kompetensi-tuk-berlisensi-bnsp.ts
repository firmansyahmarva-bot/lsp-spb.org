...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "audit-tata-kelola-tempat-uji-kompetensi-tuk-berlisensi-bnsp",
  "title": "Skema Sertifikasi Kompetensi BNSP: Audit Tata Kelola Tempat Uji Kompetensi (TUK) Berlisensi BNSP",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Audit Tata Kelola Tempat Uji Kompetensi (TUK) Berlisensi BNSP | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Audit Tata Kelola Tempat Uji Kompetensi (TUK) Berlisensi BNSP: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Audit Tata Kelola Tempat Uji Kompetensi (TUK) Berlisensi BNSP adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Audit Tata Kelola Tempat Uji Kompetensi (TUK) Berlisensi BNSP sesuai SKKNI Audit Sistem Manajemen & Asesmen Kompetensi.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Audit Tata Kelola Tempat Uji Kompetensi (TUK) Berlisensi BNSP",
  ...
  "indexable": true,
  "intent": "kompetensi audit-tata-kelola-tempat-uji-kompetensi-tuk-berlisensi-bnsp syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp audit tata kelola tempat uji kompetensi tuk berlisensi bnsp",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Audit Tata Kelola Tempat Uji Kompetensi (TUK) Berlisensi BNSP",
