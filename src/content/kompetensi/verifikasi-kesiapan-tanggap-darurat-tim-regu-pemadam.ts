...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "verifikasi-kesiapan-tanggap-darurat-tim-regu-pemadam",
  "title": "Skema Sertifikasi Kompetensi BNSP: Verifikasi Kesiapan Tanggap Darurat & Tim Regu Pemadam",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Verifikasi Kesiapan Tanggap Darurat & Tim Regu Pemadam | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Verifikasi Kesiapan Tanggap Darurat & Tim Regu Pemadam: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Verifikasi Kesiapan Tanggap Darurat & Tim Regu Pemadam adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Verifikasi Kesiapan Tanggap Darurat & Tim Regu Pemadam sesuai SKKNI Pengawasan Operasional & Risiko K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Verifikasi Kesiapan Tanggap Darurat & Tim Regu Pemadam",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Verifikasi Kesiapan Tanggap Darurat & Tim Regu Pemadam",
      "paragraphs": [
        "Skema sertifikasi Verifikasi Kesiapan Tanggap Darurat & Tim Regu Pemadam mengacu pada ketetapan SKKNI Pengawasan Operasional & Risiko K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi verifikasi-kesiapan-tanggap-darurat-tim-regu-pemadam syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp verifikasi kesiapan tanggap darurat tim regu pemadam",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Verifikasi Kesiapan Tanggap Darurat & Tim Regu Pemadam",
