...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pemanduan-safety-toolbox-meeting-tool-box-talk-harian",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pemanduan Safety Toolbox Meeting & Tool Box Talk Harian",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pemanduan Safety Toolbox Meeting & Tool Box Talk Harian | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pemanduan Safety Toolbox Meeting & Tool Box Talk Harian: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pemanduan Safety Toolbox Meeting & Tool Box Talk Harian adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pemanduan Safety Toolbox Meeting & Tool Box Talk Harian sesuai SKKNI Pengawasan Operasional & Risiko K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pemanduan Safety Toolbox Meeting & Tool Box Talk Harian",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Pemanduan Safety Toolbox Meeting & Tool Box Talk Harian",
      "paragraphs": [
        "Skema sertifikasi Pemanduan Safety Toolbox Meeting & Tool Box Talk Harian mengacu pada ketetapan SKKNI Pengawasan Operasional & Risiko K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi pemanduan-safety-toolbox-meeting-tool-box-talk-harian syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pemanduan safety toolbox meeting tool box talk harian",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pemanduan Safety Toolbox Meeting & Tool Box Talk Harian",
