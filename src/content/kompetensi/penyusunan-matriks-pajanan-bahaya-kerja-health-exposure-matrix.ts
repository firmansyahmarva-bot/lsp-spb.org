...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "penyusunan-matriks-pajanan-bahaya-kerja-health-exposure-matrix",
  "title": "Skema Sertifikasi Kompetensi BNSP: Penyusunan Matriks Pajanan Bahaya Kerja (Health Exposure Matrix)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Penyusunan Matriks Pajanan Bahaya Kerja (Health Exposure Matrix) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Penyusunan Matriks Pajanan Bahaya Kerja (Health Exposure Matrix): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Penyusunan Matriks Pajanan Bahaya Kerja (Health Exposure Matrix) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Penyusunan Matriks Pajanan Bahaya Kerja (Health Exposure Matrix) sesuai SKKNI Higiene Industri & Pemantauan Lingkungan Kerja.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Penyusunan Matriks Pajanan Bahaya Kerja (Health Exposure Matrix)",
  ...
  "indexable": true,
  "intent": "kompetensi penyusunan-matriks-pajanan-bahaya-kerja-health-exposure-matrix syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp penyusunan matriks pajanan bahaya kerja health exposure matrix",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Penyusunan Matriks Pajanan Bahaya Kerja (Health Exposure Matrix)",
