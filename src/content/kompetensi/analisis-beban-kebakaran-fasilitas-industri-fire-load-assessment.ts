...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "analisis-beban-kebakaran-fasilitas-industri-fire-load-assessment",
  "title": "Skema Sertifikasi Kompetensi BNSP: Analisis Beban Kebakaran Fasilitas Industri (Fire Load Assessment)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Analisis Beban Kebakaran Fasilitas Industri (Fire Load Assessment) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Analisis Beban Kebakaran Fasilitas Industri (Fire Load Assessment): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Analisis Beban Kebakaran Fasilitas Industri (Fire Load Assessment) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Analisis Beban Kebakaran Fasilitas Industri (Fire Load Assessment) sesuai SKKNI Analisis Rekayasa & Manajemen K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Analisis Beban Kebakaran Fasilitas Industri (Fire Load Assessment)",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Analisis Beban Kebakaran Fasilitas Industri (Fire Load Assessment)",
      "paragraphs": [
        "Skema sertifikasi Analisis Beban Kebakaran Fasilitas Industri (Fire Load Assessment) mengacu pada ketetapan SKKNI Analisis Rekayasa & Manajemen K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi analisis-beban-kebakaran-fasilitas-industri-fire-load-assessment syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp analisis beban kebakaran fasilitas industri fire load assessment",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Analisis Beban Kebakaran Fasilitas Industri (Fire Load Assessment)",
