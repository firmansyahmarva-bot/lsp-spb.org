...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pemeriksaan-sistem-keselamatan-lift-penumpang",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Sistem Keselamatan Lift Penumpang",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Sistem Keselamatan Lift Penumpang | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pemeriksaan Sistem Keselamatan Lift Penumpang: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Sistem Keselamatan Lift Penumpang adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pemeriksaan Sistem Keselamatan Lift Penumpang sesuai SKKNI Pemeliharaan & Pengujian Teknis K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pemeriksaan Sistem Keselamatan Lift Penumpang",
  ...
  "indexable": true,
  "intent": "kompetensi pemeriksaan-sistem-keselamatan-lift-penumpang syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pemeriksaan sistem keselamatan lift penumpang",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Sistem Keselamatan Lift Penumpang",
