...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "penanganan-korban-paparan-bahan-kimia-beracun-dekontaminasi-massal",
  "title": "Skema Sertifikasi Kompetensi BNSP: Penanganan Korban Paparan Bahan Kimia Beracun & Dekontaminasi Massal",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Penanganan Korban Paparan Bahan Kimia Beracun & Dekontaminasi Massal | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Penanganan Korban Paparan Bahan Kimia Beracun & Dekontaminasi Massal: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Penanganan Korban Paparan Bahan Kimia Beracun & Dekontaminasi Massal adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Penanganan Korban Paparan Bahan Kimia Beracun & Dekontaminasi Massal sesuai SKKNI Tanggap Darurat & Penyelamatan Industri.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Penanganan Korban Paparan Bahan Kimia Beracun & Dekontaminasi Massal",
  ...
  "indexable": true,
  "intent": "kompetensi penanganan-korban-paparan-bahan-kimia-beracun-dekontaminasi-massal syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp penanganan korban paparan bahan kimia beracun dekontaminasi massal",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Penanganan Korban Paparan Bahan Kimia Beracun & Dekontaminasi Massal",
