...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengambilan-sampel-debu-respirabel-menggunakan-cyclone-sampler",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengambilan Sampel Debu Respirabel Menggunakan Cyclone Sampler",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengambilan Sampel Debu Respirabel Menggunakan Cyclone Sampler | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengambilan Sampel Debu Respirabel Menggunakan Cyclone Sampler: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengambilan Sampel Debu Respirabel Menggunakan Cyclone Sampler adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengambilan Sampel Debu Respirabel Menggunakan Cyclone Sampler sesuai SKKNI Higiene Industri & Pemantauan Lingkungan Kerja.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengambilan Sampel Debu Respirabel Menggunakan Cyclone Sampler",
  ...
  "indexable": true,
  "intent": "kompetensi pengambilan-sampel-debu-respirabel-menggunakan-cyclone-sampler syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengambilan sampel debu respirabel menggunakan cyclone sampler",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengambilan Sampel Debu Respirabel Menggunakan Cyclone Sampler",
