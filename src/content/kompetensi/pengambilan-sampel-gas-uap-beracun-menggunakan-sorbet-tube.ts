...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengambilan-sampel-gas-uap-beracun-menggunakan-sorbet-tube",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengambilan Sampel Gas & Uap Beracun Menggunakan Sorbet Tube",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengambilan Sampel Gas & Uap Beracun Menggunakan Sorbet Tube | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengambilan Sampel Gas & Uap Beracun Menggunakan Sorbet Tube: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengambilan Sampel Gas & Uap Beracun Menggunakan Sorbet Tube adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengambilan Sampel Gas & Uap Beracun Menggunakan Sorbet Tube sesuai SKKNI Higiene Industri & Pemantauan Lingkungan Kerja.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengambilan Sampel Gas & Uap Beracun Menggunakan Sorbet Tube",
  ...
  "indexable": true,
  "intent": "kompetensi pengambilan-sampel-gas-uap-beracun-menggunakan-sorbet-tube syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengambilan sampel gas uap beracun menggunakan sorbet tube",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengambilan Sampel Gas & Uap Beracun Menggunakan Sorbet Tube",
