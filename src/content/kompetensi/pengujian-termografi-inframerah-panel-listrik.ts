...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengujian-termografi-inframerah-panel-listrik",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengujian Termografi Inframerah Panel Listrik",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengujian Termografi Inframerah Panel Listrik | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengujian Termografi Inframerah Panel Listrik: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengujian Termografi Inframerah Panel Listrik adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengujian Termografi Inframerah Panel Listrik sesuai SKKNI Pemeliharaan & Pengujian Teknis K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengujian Termografi Inframerah Panel Listrik",
  ...
  "indexable": true,
  "intent": "kompetensi pengujian-termografi-inframerah-panel-listrik syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengujian termografi inframerah panel listrik",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengujian Termografi Inframerah Panel Listrik",
