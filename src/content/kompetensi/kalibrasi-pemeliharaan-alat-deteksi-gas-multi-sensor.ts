...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "kalibrasi-pemeliharaan-alat-deteksi-gas-multi-sensor",
  "title": "Skema Sertifikasi Kompetensi BNSP: Kalibrasi & Pemeliharaan Alat Deteksi Gas Multi-Sensor",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Kalibrasi & Pemeliharaan Alat Deteksi Gas Multi-Sensor | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Kalibrasi & Pemeliharaan Alat Deteksi Gas Multi-Sensor: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Kalibrasi & Pemeliharaan Alat Deteksi Gas Multi-Sensor adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Kalibrasi & Pemeliharaan Alat Deteksi Gas Multi-Sensor sesuai SKKNI Pemeliharaan & Pengujian Teknis K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Kalibrasi & Pemeliharaan Alat Deteksi Gas Multi-Sensor",
  ...
  "indexable": true,
  "intent": "kompetensi kalibrasi-pemeliharaan-alat-deteksi-gas-multi-sensor syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp kalibrasi pemeliharaan alat deteksi gas multi sensor",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Kalibrasi & Pemeliharaan Alat Deteksi Gas Multi-Sensor",
