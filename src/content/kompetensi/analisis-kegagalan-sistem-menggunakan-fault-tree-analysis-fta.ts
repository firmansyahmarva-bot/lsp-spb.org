...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "analisis-kegagalan-sistem-menggunakan-fault-tree-analysis-fta",
  "title": "Skema Sertifikasi Kompetensi BNSP: Analisis Kegagalan Sistem Menggunakan Fault Tree Analysis (FTA)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Analisis Kegagalan Sistem Menggunakan Fault Tree Analysis (FTA) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Analisis Kegagalan Sistem Menggunakan Fault Tree Analysis (FTA): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Analisis Kegagalan Sistem Menggunakan Fault Tree Analysis (FTA) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Analisis Kegagalan Sistem Menggunakan Fault Tree Analysis (FTA) sesuai SKKNI Analisis Rekayasa & Manajemen K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Analisis Kegagalan Sistem Menggunakan Fault Tree Analysis (FTA)",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Analisis Kegagalan Sistem Menggunakan Fault Tree Analysis (FTA)",
      "paragraphs": [
        "Skema sertifikasi Analisis Kegagalan Sistem Menggunakan Fault Tree Analysis (FTA) mengacu pada ketetapan SKKNI Analisis Rekayasa & Manajemen K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi analisis-kegagalan-sistem-menggunakan-fault-tree-analysis-fta syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp analisis kegagalan sistem menggunakan fault tree analysis fta",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Analisis Kegagalan Sistem Menggunakan Fault Tree Analysis (FTA)",
