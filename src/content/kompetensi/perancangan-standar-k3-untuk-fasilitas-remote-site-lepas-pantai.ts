...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "perancangan-standar-k3-untuk-fasilitas-remote-site-lepas-pantai",
  "title": "Skema Sertifikasi Kompetensi BNSP: Perancangan Standar K3 untuk Fasilitas Remote Site & Lepas Pantai",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Perancangan Standar K3 untuk Fasilitas Remote Site & Lepas Pantai | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Perancangan Standar K3 untuk Fasilitas Remote Site & Lepas Pantai: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Perancangan Standar K3 untuk Fasilitas Remote Site & Lepas Pantai adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Perancangan Standar K3 untuk Fasilitas Remote Site & Lepas Pantai sesuai SKKNI Manajemen Strategis Keselamatan & CSMS.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Perancangan Standar K3 untuk Fasilitas Remote Site & Lepas Pantai",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Perancangan Standar K3 untuk Fasilitas Remote Site & Lepas Pantai",
      "paragraphs": [
        "Skema sertifikasi Perancangan Standar K3 untuk Fasilitas Remote Site & Lepas Pantai mengacu pada ketetapan SKKNI Manajemen Strategis Keselamatan & CSMS dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi perancangan-standar-k3-untuk-fasilitas-remote-site-lepas-pantai syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp perancangan standar k3 untuk fasilitas remote site lepas pantai",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Perancangan Standar K3 untuk Fasilitas Remote Site & Lepas Pantai",
