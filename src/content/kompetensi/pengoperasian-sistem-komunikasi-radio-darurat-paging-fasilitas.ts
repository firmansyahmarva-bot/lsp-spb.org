...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengoperasian-sistem-komunikasi-radio-darurat-paging-fasilitas",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengoperasian Sistem Komunikasi Radio Darurat & Paging Fasilitas",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengoperasian Sistem Komunikasi Radio Darurat & Paging Fasilitas | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengoperasian Sistem Komunikasi Radio Darurat & Paging Fasilitas: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengoperasian Sistem Komunikasi Radio Darurat & Paging Fasilitas adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengoperasian Sistem Komunikasi Radio Darurat & Paging Fasilitas sesuai SKKNI Tanggap Darurat & Penyelamatan Industri.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengoperasian Sistem Komunikasi Radio Darurat & Paging Fasilitas",
  ...
  "indexable": true,
  "intent": "kompetensi pengoperasian-sistem-komunikasi-radio-darurat-paging-fasilitas syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengoperasian sistem komunikasi radio darurat paging fasilitas",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengoperasian Sistem Komunikasi Radio Darurat & Paging Fasilitas",
