...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "penyusunan-event-tree-analysis-eta-skenario-kecelakaan-parah",
  "title": "Skema Sertifikasi Kompetensi BNSP: Penyusunan Event Tree Analysis (ETA) Skenario Kecelakaan Parah",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Penyusunan Event Tree Analysis (ETA) Skenario Kecelakaan Parah | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Penyusunan Event Tree Analysis (ETA) Skenario Kecelakaan Parah: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Penyusunan Event Tree Analysis (ETA) Skenario Kecelakaan Parah adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Penyusunan Event Tree Analysis (ETA) Skenario Kecelakaan Parah sesuai SKKNI Analisis Rekayasa & Manajemen K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Penyusunan Event Tree Analysis (ETA) Skenario Kecelakaan Parah",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Penyusunan Event Tree Analysis (ETA) Skenario Kecelakaan Parah",
      "paragraphs": [
        "Skema sertifikasi Penyusunan Event Tree Analysis (ETA) Skenario Kecelakaan Parah mengacu pada ketetapan SKKNI Analisis Rekayasa & Manajemen K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi penyusunan-event-tree-analysis-eta-skenario-kecelakaan-parah syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp penyusunan event tree analysis eta skenario kecelakaan parah",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Penyusunan Event Tree Analysis (ETA) Skenario Kecelakaan Parah",
