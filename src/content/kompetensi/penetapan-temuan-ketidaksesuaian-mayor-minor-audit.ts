...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "penetapan-temuan-ketidaksesuaian-mayor-minor-audit",
  "title": "Skema Sertifikasi Kompetensi BNSP: Penetapan Temuan Ketidaksesuaian Mayor & Minor Audit",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Penetapan Temuan Ketidaksesuaian Mayor & Minor Audit | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Penetapan Temuan Ketidaksesuaian Mayor & Minor Audit: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Penetapan Temuan Ketidaksesuaian Mayor & Minor Audit adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Penetapan Temuan Ketidaksesuaian Mayor & Minor Audit sesuai SKKNI Audit Sistem Manajemen & Asesmen Kompetensi.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Penetapan Temuan Ketidaksesuaian Mayor & Minor Audit",
  ...
  "indexable": true,
  "intent": "kompetensi penetapan-temuan-ketidaksesuaian-mayor-minor-audit syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp penetapan temuan ketidaksesuaian mayor minor audit",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Penetapan Temuan Ketidaksesuaian Mayor & Minor Audit",
