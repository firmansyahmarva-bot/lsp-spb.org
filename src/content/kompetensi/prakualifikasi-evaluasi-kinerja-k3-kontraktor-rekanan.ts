...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "prakualifikasi-evaluasi-kinerja-k3-kontraktor-rekanan",
  "title": "Skema Sertifikasi Kompetensi BNSP: Prakualifikasi & Evaluasi Kinerja K3 Kontraktor Rekanan",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Prakualifikasi & Evaluasi Kinerja K3 Kontraktor Rekanan | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Prakualifikasi & Evaluasi Kinerja K3 Kontraktor Rekanan: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Prakualifikasi & Evaluasi Kinerja K3 Kontraktor Rekanan adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Prakualifikasi & Evaluasi Kinerja K3 Kontraktor Rekanan sesuai SKKNI Manajemen Strategis Keselamatan & CSMS.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Prakualifikasi & Evaluasi Kinerja K3 Kontraktor Rekanan",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Prakualifikasi & Evaluasi Kinerja K3 Kontraktor Rekanan",
      "paragraphs": [
        "Skema sertifikasi Prakualifikasi & Evaluasi Kinerja K3 Kontraktor Rekanan mengacu pada ketetapan SKKNI Manajemen Strategis Keselamatan & CSMS dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi prakualifikasi-evaluasi-kinerja-k3-kontraktor-rekanan syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp prakualifikasi evaluasi kinerja k3 kontraktor rekanan",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Prakualifikasi & Evaluasi Kinerja K3 Kontraktor Rekanan",
