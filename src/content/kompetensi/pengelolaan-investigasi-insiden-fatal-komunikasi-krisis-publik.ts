...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengelolaan-investigasi-insiden-fatal-komunikasi-krisis-publik",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengelolaan Investigasi Insiden Fatal & Komunikasi Krisis Publik",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengelolaan Investigasi Insiden Fatal & Komunikasi Krisis Publik | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengelolaan Investigasi Insiden Fatal & Komunikasi Krisis Publik: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengelolaan Investigasi Insiden Fatal & Komunikasi Krisis Publik adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengelolaan Investigasi Insiden Fatal & Komunikasi Krisis Publik sesuai SKKNI Manajemen Strategis Keselamatan & CSMS.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengelolaan Investigasi Insiden Fatal & Komunikasi Krisis Publik",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Pengelolaan Investigasi Insiden Fatal & Komunikasi Krisis Publik",
      "paragraphs": [
        "Skema sertifikasi Pengelolaan Investigasi Insiden Fatal & Komunikasi Krisis Publik mengacu pada ketetapan SKKNI Manajemen Strategis Keselamatan & CSMS dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi pengelolaan-investigasi-insiden-fatal-komunikasi-krisis-publik syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengelolaan investigasi insiden fatal komunikasi krisis publik",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengelolaan Investigasi Insiden Fatal & Komunikasi Krisis Publik",
