...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengikatan-beban-rigging-muatan-berat",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengikatan Beban & Rigging Muatan Berat",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengikatan Beban & Rigging Muatan Berat | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengikatan Beban & Rigging Muatan Berat: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengikatan Beban & Rigging Muatan Berat adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengikatan Beban & Rigging Muatan Berat sesuai SKKNI Pengoperasian Peralatan & Sarana K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengikatan Beban & Rigging Muatan Berat",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Pengikatan Beban & Rigging Muatan Berat",
      "paragraphs": [
        "Skema sertifikasi Pengikatan Beban & Rigging Muatan Berat mengacu pada ketetapan SKKNI Pengoperasian Peralatan & Sarana K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi pengikatan-beban-rigging-muatan-berat syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengikatan beban rigging muatan berat",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengikatan Beban & Rigging Muatan Berat",
