...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengelolaan-hubungan-dengan-instansi-pengawas-ketenagakerjaan-disnaker",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengelolaan Hubungan dengan Instansi Pengawas Ketenagakerjaan & Disnaker",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengelolaan Hubungan dengan Instansi Pengawas Ketenagakerjaan & Disnaker | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengelolaan Hubungan dengan Instansi Pengawas Ketenagakerjaan & Disnaker: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengelolaan Hubungan dengan Instansi Pengawas Ketenagakerjaan & Disnaker adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengelolaan Hubungan dengan Instansi Pengawas Ketenagakerjaan & Disnaker sesuai SKKNI Manajemen Strategis Keselamatan & CSMS.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengelolaan Hubungan dengan Instansi Pengawas Ketenagakerjaan & Disnaker",
  ...
  "indexable": true,
  "intent": "kompetensi pengelolaan-hubungan-dengan-instansi-pengawas-ketenagakerjaan-disnaker syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengelolaan hubungan dengan instansi pengawas ketenagakerjaan disnaker",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengelolaan Hubungan dengan Instansi Pengawas Ketenagakerjaan & Disnaker",
