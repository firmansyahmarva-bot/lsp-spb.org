...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengawasan-izin-masuk-ruang-terbatas-confined-space-permit",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengawasan Izin Masuk Ruang Terbatas (Confined Space Permit)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengawasan Izin Masuk Ruang Terbatas (Confined Space Permit) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengawasan Izin Masuk Ruang Terbatas (Confined Space Permit): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengawasan Izin Masuk Ruang Terbatas (Confined Space Permit) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengawasan Izin Masuk Ruang Terbatas (Confined Space Permit) sesuai SKKNI Pengawasan Operasional & Risiko K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengawasan Izin Masuk Ruang Terbatas (Confined Space Permit)",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Pengawasan Izin Masuk Ruang Terbatas (Confined Space Permit)",
      "paragraphs": [
        "Skema sertifikasi Pengawasan Izin Masuk Ruang Terbatas (Confined Space Permit) mengacu pada ketetapan SKKNI Pengawasan Operasional & Risiko K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi pengawasan-izin-masuk-ruang-terbatas-confined-space-permit syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengawasan izin masuk ruang terbatas confined space permit",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengawasan Izin Masuk Ruang Terbatas (Confined Space Permit)",
