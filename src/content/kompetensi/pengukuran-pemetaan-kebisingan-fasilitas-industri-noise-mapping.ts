...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengukuran-pemetaan-kebisingan-fasilitas-industri-noise-mapping",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengukuran & Pemetaan Kebisingan Fasilitas Industri (Noise Mapping)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengukuran & Pemetaan Kebisingan Fasilitas Industri (Noise Mapping) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengukuran & Pemetaan Kebisingan Fasilitas Industri (Noise Mapping): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengukuran & Pemetaan Kebisingan Fasilitas Industri (Noise Mapping) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengukuran & Pemetaan Kebisingan Fasilitas Industri (Noise Mapping) sesuai SKKNI Higiene Industri & Pemantauan Lingkungan Kerja.",
  "highlights": [
    "Sertifikat Resmi Berlogo Garuda Emas BNSP",
    "Standar Rujukan: SKKNI Higiene Industri & Pemantauan Lingkungan Kerja",
    "Tingkatan: Tingkat Higiene Industri & Kesehatan Kerja (Industrial Hygienist)",
    "Metode Asesmen: Verifikasi Portofolio, Wawancara & Observasi TUK"
  ],
  "courseDetails": {
    "level": "Skema Sertifikasi Kompetensi Tingkat Higiene Industri & Kesehatan Kerja",
    ...
    "targetAudience": [
      "Industrial Hygienist dan Praktisi K3 Sektoral Terkait",
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengukuran & Pemetaan Kebisingan Fasilitas Industri (Noise Mapping)",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Pengukuran & Pemetaan Kebisingan Fasilitas Industri (Noise Mapping)",
      "paragraphs": [
        "Skema sertifikasi Pengukuran & Pemetaan Kebisingan Fasilitas Industri (Noise Mapping) mengacu pada ketetapan SKKNI Higiene Industri & Pemantauan Lingkungan Kerja dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi pengukuran-pemetaan-kebisingan-fasilitas-industri-noise-mapping syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengukuran pemetaan kebisingan fasilitas industri noise mapping",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengukuran & Pemetaan Kebisingan Fasilitas Industri (Noise Mapping)",
  "intentType": "commercial",
  "parentTopic": "Sertifikasi Kompetensi BNSP Tingkat Higiene Industri & Kesehatan Kerja",
  "cannibalizationGroup": "kompetensi-industrial-hygienist",
