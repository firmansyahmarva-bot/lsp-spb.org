...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengelolaan-manajemen-risiko-perubahan-organisasi-akuisisi-aset",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengelolaan Manajemen Risiko Perubahan Organisasi & Akuisisi Aset",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengelolaan Manajemen Risiko Perubahan Organisasi & Akuisisi Aset | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengelolaan Manajemen Risiko Perubahan Organisasi & Akuisisi Aset: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengelolaan Manajemen Risiko Perubahan Organisasi & Akuisisi Aset adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengelolaan Manajemen Risiko Perubahan Organisasi & Akuisisi Aset sesuai SKKNI Manajemen Strategis Keselamatan & CSMS.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengelolaan Manajemen Risiko Perubahan Organisasi & Akuisisi Aset",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Pengelolaan Manajemen Risiko Perubahan Organisasi & Akuisisi Aset",
      "paragraphs": [
        "Skema sertifikasi Pengelolaan Manajemen Risiko Perubahan Organisasi & Akuisisi Aset mengacu pada ketetapan SKKNI Manajemen Strategis Keselamatan & CSMS dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi pengelolaan-manajemen-risiko-perubahan-organisasi-akuisisi-aset syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengelolaan manajemen risiko perubahan organisasi akuisisi aset",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengelolaan Manajemen Risiko Perubahan Organisasi & Akuisisi Aset",
