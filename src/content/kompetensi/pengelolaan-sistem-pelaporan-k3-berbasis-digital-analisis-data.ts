...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengelolaan-sistem-pelaporan-k3-berbasis-digital-analisis-data",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengelolaan Sistem Pelaporan K3 Berbasis Digital & Analisis Data",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengelolaan Sistem Pelaporan K3 Berbasis Digital & Analisis Data | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengelolaan Sistem Pelaporan K3 Berbasis Digital & Analisis Data: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengelolaan Sistem Pelaporan K3 Berbasis Digital & Analisis Data adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengelolaan Sistem Pelaporan K3 Berbasis Digital & Analisis Data sesuai SKKNI Manajemen Strategis Keselamatan & CSMS.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengelolaan Sistem Pelaporan K3 Berbasis Digital & Analisis Data",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Pengelolaan Sistem Pelaporan K3 Berbasis Digital & Analisis Data",
      "paragraphs": [
        "Skema sertifikasi Pengelolaan Sistem Pelaporan K3 Berbasis Digital & Analisis Data mengacu pada ketetapan SKKNI Manajemen Strategis Keselamatan & CSMS dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi pengelolaan-sistem-pelaporan-k3-berbasis-digital-analisis-data syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengelolaan sistem pelaporan k3 berbasis digital analisis data",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengelolaan Sistem Pelaporan K3 Berbasis Digital & Analisis Data",
