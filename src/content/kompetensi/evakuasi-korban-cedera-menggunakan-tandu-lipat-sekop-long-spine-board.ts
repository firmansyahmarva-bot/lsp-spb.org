...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "evakuasi-korban-cedera-menggunakan-tandu-lipat-sekop-long-spine-board",
  "title": "Skema Sertifikasi Kompetensi BNSP: Evakuasi Korban Cedera Menggunakan Tandu Lipat, Sekop & Long Spine Board",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Evakuasi Korban Cedera Menggunakan Tandu Lipat, Sekop & Long Spine Board | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Evakuasi Korban Cedera Menggunakan Tandu Lipat, Sekop & Long Spine Board: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Evakuasi Korban Cedera Menggunakan Tandu Lipat, Sekop & Long Spine Board adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Evakuasi Korban Cedera Menggunakan Tandu Lipat, Sekop & Long Spine Board sesuai SKKNI Tanggap Darurat & Penyelamatan Industri.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Evakuasi Korban Cedera Menggunakan Tandu Lipat, Sekop & Long Spine Board",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Evakuasi Korban Cedera Menggunakan Tandu Lipat, Sekop & Long Spine Board",
      "paragraphs": [
        "Skema sertifikasi Evakuasi Korban Cedera Menggunakan Tandu Lipat, Sekop & Long Spine Board mengacu pada ketetapan SKKNI Tanggap Darurat & Penyelamatan Industri dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi evakuasi-korban-cedera-menggunakan-tandu-lipat-sekop-long-spine-board syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp evakuasi korban cedera menggunakan tandu lipat sekop long spine board",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Evakuasi Korban Cedera Menggunakan Tandu Lipat, Sekop & Long Spine Board",
