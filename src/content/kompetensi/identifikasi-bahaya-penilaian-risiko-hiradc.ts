...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "identifikasi-bahaya-penilaian-risiko-hiradc",
  "title": "Skema Sertifikasi Kompetensi BNSP: Identifikasi Bahaya & Penilaian Risiko (HIRADC)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Identifikasi Bahaya & Penilaian Risiko (HIRADC) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Identifikasi Bahaya & Penilaian Risiko (HIRADC): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Identifikasi Bahaya & Penilaian Risiko (HIRADC) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Identifikasi Bahaya & Penilaian Risiko (HIRADC) sesuai SKKNI Pengawasan Operasional & Risiko K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Identifikasi Bahaya & Penilaian Risiko (HIRADC)",
  ...
  "indexable": true,
  "intent": "kompetensi identifikasi-bahaya-penilaian-risiko-hiradc syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp identifikasi bahaya penilaian risiko hiradc",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Identifikasi Bahaya & Penilaian Risiko (HIRADC)",
