...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pemeriksaan-instalasi-penyalur-petir-grounding",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Instalasi Penyalur Petir & Grounding",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Instalasi Penyalur Petir & Grounding | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pemeriksaan Instalasi Penyalur Petir & Grounding: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Instalasi Penyalur Petir & Grounding adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pemeriksaan Instalasi Penyalur Petir & Grounding sesuai SKKNI Pemeliharaan & Pengujian Teknis K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pemeriksaan Instalasi Penyalur Petir & Grounding",
  ...
  "indexable": true,
  "intent": "kompetensi pemeriksaan-instalasi-penyalur-petir-grounding syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pemeriksaan instalasi penyalur petir grounding",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Instalasi Penyalur Petir & Grounding",
