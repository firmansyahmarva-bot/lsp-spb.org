...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "identifikasi-pengendalian-bahaya-biologis-biohazard-control",
  "title": "Skema Sertifikasi Kompetensi BNSP: Identifikasi & Pengendalian Bahaya Biologis (Biohazard Control)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Identifikasi & Pengendalian Bahaya Biologis (Biohazard Control) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Identifikasi & Pengendalian Bahaya Biologis (Biohazard Control): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Identifikasi & Pengendalian Bahaya Biologis (Biohazard Control) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Identifikasi & Pengendalian Bahaya Biologis (Biohazard Control) sesuai SKKNI Higiene Industri & Pemantauan Lingkungan Kerja.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Identifikasi & Pengendalian Bahaya Biologis (Biohazard Control)",
  ...
  "indexable": true,
  "intent": "kompetensi identifikasi-pengendalian-bahaya-biologis-biohazard-control syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp identifikasi pengendalian bahaya biologis biohazard control",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Identifikasi & Pengendalian Bahaya Biologis (Biohazard Control)",
