...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "penyelamatan-darurat-dasar-evakuasi-lapangan",
  "title": "Skema Sertifikasi Kompetensi BNSP: Penyelamatan Darurat Dasar & Evakuasi Lapangan",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Penyelamatan Darurat Dasar & Evakuasi Lapangan | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Penyelamatan Darurat Dasar & Evakuasi Lapangan: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Penyelamatan Darurat Dasar & Evakuasi Lapangan adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Penyelamatan Darurat Dasar & Evakuasi Lapangan sesuai SKKNI Pengoperasian Peralatan & Sarana K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Penyelamatan Darurat Dasar & Evakuasi Lapangan",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Penyelamatan Darurat Dasar & Evakuasi Lapangan",
      "paragraphs": [
        "Skema sertifikasi Penyelamatan Darurat Dasar & Evakuasi Lapangan mengacu pada ketetapan SKKNI Pengoperasian Peralatan & Sarana K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi penyelamatan-darurat-dasar-evakuasi-lapangan syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp penyelamatan darurat dasar evakuasi lapangan",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Penyelamatan Darurat Dasar & Evakuasi Lapangan",
