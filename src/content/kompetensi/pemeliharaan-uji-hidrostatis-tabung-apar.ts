...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pemeliharaan-uji-hidrostatis-tabung-apar",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pemeliharaan & Uji Hidrostatis Tabung APAR",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pemeliharaan & Uji Hidrostatis Tabung APAR | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pemeliharaan & Uji Hidrostatis Tabung APAR: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pemeliharaan & Uji Hidrostatis Tabung APAR adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pemeliharaan & Uji Hidrostatis Tabung APAR sesuai SKKNI Pemeliharaan & Pengujian Teknis K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pemeliharaan & Uji Hidrostatis Tabung APAR",
  ...
  "indexable": true,
  "intent": "kompetensi pemeliharaan-uji-hidrostatis-tabung-apar syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pemeliharaan uji hidrostatis tabung apar",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pemeliharaan & Uji Hidrostatis Tabung APAR",
