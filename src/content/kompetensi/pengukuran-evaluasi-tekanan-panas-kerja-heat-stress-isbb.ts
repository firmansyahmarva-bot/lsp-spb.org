...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengukuran-evaluasi-tekanan-panas-kerja-heat-stress-isbb",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengukuran & Evaluasi Tekanan Panas Kerja (Heat Stress ISBB)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengukuran & Evaluasi Tekanan Panas Kerja (Heat Stress ISBB) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengukuran & Evaluasi Tekanan Panas Kerja (Heat Stress ISBB): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengukuran & Evaluasi Tekanan Panas Kerja (Heat Stress ISBB) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengukuran & Evaluasi Tekanan Panas Kerja (Heat Stress ISBB) sesuai SKKNI Higiene Industri & Pemantauan Lingkungan Kerja.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengukuran & Evaluasi Tekanan Panas Kerja (Heat Stress ISBB)",
  ...
  "indexable": true,
  "intent": "kompetensi pengukuran-evaluasi-tekanan-panas-kerja-heat-stress-isbb syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengukuran evaluasi tekanan panas kerja heat stress isbb",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengukuran & Evaluasi Tekanan Panas Kerja (Heat Stress ISBB)",
