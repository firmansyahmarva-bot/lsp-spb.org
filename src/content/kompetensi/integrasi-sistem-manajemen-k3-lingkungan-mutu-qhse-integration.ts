...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "integrasi-sistem-manajemen-k3-lingkungan-mutu-qhse-integration",
  "title": "Skema Sertifikasi Kompetensi BNSP: Integrasi Sistem Manajemen K3, Lingkungan & Mutu (QHSE Integration)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Integrasi Sistem Manajemen K3, Lingkungan & Mutu (QHSE Integration) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Integrasi Sistem Manajemen K3, Lingkungan & Mutu (QHSE Integration): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Integrasi Sistem Manajemen K3, Lingkungan & Mutu (QHSE Integration) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Integrasi Sistem Manajemen K3, Lingkungan & Mutu (QHSE Integration) sesuai SKKNI Manajemen Strategis Keselamatan & CSMS.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Integrasi Sistem Manajemen K3, Lingkungan & Mutu (QHSE Integration)",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Integrasi Sistem Manajemen K3, Lingkungan & Mutu (QHSE Integration)",
      "paragraphs": [
        "Skema sertifikasi Integrasi Sistem Manajemen K3, Lingkungan & Mutu (QHSE Integration) mengacu pada ketetapan SKKNI Manajemen Strategis Keselamatan & CSMS dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi integrasi-sistem-manajemen-k3-lingkungan-mutu-qhse-integration syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp integrasi sistem manajemen k3 lingkungan mutu qhse integration",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Integrasi Sistem Manajemen K3, Lingkungan & Mutu (QHSE Integration)",
