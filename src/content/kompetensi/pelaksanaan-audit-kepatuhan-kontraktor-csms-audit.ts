...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pelaksanaan-audit-kepatuhan-kontraktor-csms-audit",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pelaksanaan Audit Kepatuhan Kontraktor (CSMS Audit)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pelaksanaan Audit Kepatuhan Kontraktor (CSMS Audit) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pelaksanaan Audit Kepatuhan Kontraktor (CSMS Audit): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pelaksanaan Audit Kepatuhan Kontraktor (CSMS Audit) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pelaksanaan Audit Kepatuhan Kontraktor (CSMS Audit) sesuai SKKNI Audit Sistem Manajemen & Asesmen Kompetensi.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pelaksanaan Audit Kepatuhan Kontraktor (CSMS Audit)",
  ...
  "indexable": true,
  "intent": "kompetensi pelaksanaan-audit-kepatuhan-kontraktor-csms-audit syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pelaksanaan audit kepatuhan kontraktor csms audit",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pelaksanaan Audit Kepatuhan Kontraktor (CSMS Audit)",
