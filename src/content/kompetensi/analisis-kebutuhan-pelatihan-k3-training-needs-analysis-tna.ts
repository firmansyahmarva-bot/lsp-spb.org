...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "analisis-kebutuhan-pelatihan-k3-training-needs-analysis-tna",
  "title": "Skema Sertifikasi Kompetensi BNSP: Analisis Kebutuhan Pelatihan K3 (Training Needs Analysis / TNA)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Analisis Kebutuhan Pelatihan K3 (Training Needs Analysis / TNA) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Analisis Kebutuhan Pelatihan K3 (Training Needs Analysis / TNA): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Analisis Kebutuhan Pelatihan K3 (Training Needs Analysis / TNA) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Analisis Kebutuhan Pelatihan K3 (Training Needs Analysis / TNA) sesuai SKKNI Analisis Rekayasa & Manajemen K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Analisis Kebutuhan Pelatihan K3 (Training Needs Analysis / TNA)",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Analisis Kebutuhan Pelatihan K3 (Training Needs Analysis / TNA)",
      "paragraphs": [
        "Skema sertifikasi Analisis Kebutuhan Pelatihan K3 (Training Needs Analysis / TNA) mengacu pada ketetapan SKKNI Analisis Rekayasa & Manajemen K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi analisis-kebutuhan-pelatihan-k3-training-needs-analysis-tna syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp analisis kebutuhan pelatihan k3 training needs analysis tna",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Analisis Kebutuhan Pelatihan K3 (Training Needs Analysis / TNA)",
