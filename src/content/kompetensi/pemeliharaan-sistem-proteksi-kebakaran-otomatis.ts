...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pemeliharaan-sistem-proteksi-kebakaran-otomatis",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pemeliharaan Sistem Proteksi Kebakaran Otomatis",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pemeliharaan Sistem Proteksi Kebakaran Otomatis | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pemeliharaan Sistem Proteksi Kebakaran Otomatis: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pemeliharaan Sistem Proteksi Kebakaran Otomatis adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pemeliharaan Sistem Proteksi Kebakaran Otomatis sesuai SKKNI Pemeliharaan & Pengujian Teknis K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pemeliharaan Sistem Proteksi Kebakaran Otomatis",
  ...
  "indexable": true,
  "intent": "kompetensi pemeliharaan-sistem-proteksi-kebakaran-otomatis syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pemeliharaan sistem proteksi kebakaran otomatis",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pemeliharaan Sistem Proteksi Kebakaran Otomatis",
