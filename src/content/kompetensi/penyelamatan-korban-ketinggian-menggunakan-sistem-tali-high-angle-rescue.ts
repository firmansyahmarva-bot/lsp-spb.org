...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "penyelamatan-korban-ketinggian-menggunakan-sistem-tali-high-angle-rescue",
  "title": "Skema Sertifikasi Kompetensi BNSP: Penyelamatan Korban Ketinggian Menggunakan Sistem Tali (High Angle Rescue)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Penyelamatan Korban Ketinggian Menggunakan Sistem Tali (High Angle Rescue) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Penyelamatan Korban Ketinggian Menggunakan Sistem Tali (High Angle Rescue): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Penyelamatan Korban Ketinggian Menggunakan Sistem Tali (High Angle Rescue) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Penyelamatan Korban Ketinggian Menggunakan Sistem Tali (High Angle Rescue) sesuai SKKNI Tanggap Darurat & Penyelamatan Industri.",
  "highlights": [
    "Sertifikat Resmi Berlogo Garuda Emas BNSP",
    "Standar Rujukan: SKKNI Tanggap Darurat & Penyelamatan Industri",
    "Tingkatan: Tingkat Tanggap Darurat & Fire Rescue (Emergency Responder)",
    "Metode Asesmen: Verifikasi Portofolio, Wawancara & Observasi TUK"
  ],
  "courseDetails": {
    "level": "Skema Sertifikasi Kompetensi Tingkat Tanggap Darurat & Fire Rescue",
    ...
    "targetAudience": [
      "Emergency Responder dan Praktisi K3 Sektoral Terkait",
    ...
    "syllabusModules": [
      {
        "module": "Unit Kompetensi Inti 1",
        "topics": [
          "Penerapan Norma & Prosedur Kerja Penyelamatan Korban Ketinggian Menggunakan Sistem Tali (High Angle Rescue)",
          "Identifikasi Bahaya & Pengendalian Risiko Operasional"
        ]
      },
      {
        "module": "Unit Kompetensi Inti 2",
        "topics": [
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Penyelamatan Korban Ketinggian Menggunakan Sistem Tali (High Angle Rescue)",
      "paragraphs": [
        "Skema sertifikasi Penyelamatan Korban Ketinggian Menggunakan Sistem Tali (High Angle Rescue) mengacu pada ketetapan SKKNI Tanggap Darurat & Penyelamatan Industri dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "faqs": [
    {
      "question": "Apa perbedaan utama antara sertifikasi kompetensi BNSP dengan pelatihan sertifikat biasa?",
      "answer": "Pelatihan biasa hanya menyatakan keikutsertaan kursus, sedangkan sertifikasi BNSP melalui proses uji asesmen ketat oleh asesor bersertifikat untuk memvalidasi bukti kerja riil sesuai Standar Kompetensi Kerja Nasional Indonesia (SKKNI)."
    },
    {
      "question": "Berapa lama masa berlaku Sertifikat Kompetensi BNSP?",
      "answer": "Sertifikat Kompetensi BNSP berlaku selama 3 (tiga) tahun dan dapat diperpanjang melalui mekanisme resertifikasi portofolio sebelum masa berlaku habis."
    },
    {
      "question": "Bagaimana jika seorang asesi dinyatakan Belum Kompeten (BK)?",
      "answer": "Peserta yang belum memenuhi bukti pada unit tertentu akan diberikan kesempatan perbaikan (re-asesmen) pada unit yang belum kompeten dalam batas waktu yang ditentukan oleh LSP."
    }
  ],
  "related": [
  ...
  "indexable": true,
  "intent": "kompetensi penyelamatan-korban-ketinggian-menggunakan-sistem-tali-high-angle-rescue syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp penyelamatan korban ketinggian menggunakan sistem tali high angle rescue",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Penyelamatan Korban Ketinggian Menggunakan Sistem Tali (High Angle Rescue)",
  "intentType": "commercial",
  "parentTopic": "Sertifikasi Kompetensi BNSP Tingkat Tanggap Darurat & Fire Rescue",
  "cannibalizationGroup": "kompetensi-emergency-responder",
