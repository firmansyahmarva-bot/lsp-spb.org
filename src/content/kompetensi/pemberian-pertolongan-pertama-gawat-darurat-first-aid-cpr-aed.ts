...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pemberian-pertolongan-pertama-gawat-darurat-first-aid-cpr-aed",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pemberian Pertolongan Pertama Gawat Darurat (First Aid CPR & AED)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pemberian Pertolongan Pertama Gawat Darurat (First Aid CPR & AED) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pemberian Pertolongan Pertama Gawat Darurat (First Aid CPR & AED): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pemberian Pertolongan Pertama Gawat Darurat (First Aid CPR & AED) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pemberian Pertolongan Pertama Gawat Darurat (First Aid CPR & AED) sesuai SKKNI Tanggap Darurat & Penyelamatan Industri.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pemberian Pertolongan Pertama Gawat Darurat (First Aid CPR & AED)",
  ...
  "indexable": true,
  "intent": "kompetensi pemberian-pertolongan-pertama-gawat-darurat-first-aid-cpr-aed syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pemberian pertolongan pertama gawat darurat first aid cpr aed",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pemberian Pertolongan Pertama Gawat Darurat (First Aid CPR & AED)",
