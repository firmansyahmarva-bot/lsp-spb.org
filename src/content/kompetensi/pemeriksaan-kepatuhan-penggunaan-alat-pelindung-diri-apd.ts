...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pemeriksaan-kepatuhan-penggunaan-alat-pelindung-diri-apd",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Kepatuhan Penggunaan Alat Pelindung Diri (APD)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Kepatuhan Penggunaan Alat Pelindung Diri (APD) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pemeriksaan Kepatuhan Penggunaan Alat Pelindung Diri (APD): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Kepatuhan Penggunaan Alat Pelindung Diri (APD) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pemeriksaan Kepatuhan Penggunaan Alat Pelindung Diri (APD) sesuai SKKNI Pengawasan Operasional & Risiko K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pemeriksaan Kepatuhan Penggunaan Alat Pelindung Diri (APD)",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Pemeriksaan Kepatuhan Penggunaan Alat Pelindung Diri (APD)",
      "paragraphs": [
        "Skema sertifikasi Pemeriksaan Kepatuhan Penggunaan Alat Pelindung Diri (APD) mengacu pada ketetapan SKKNI Pengawasan Operasional & Risiko K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi pemeriksaan-kepatuhan-penggunaan-alat-pelindung-diri-apd syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pemeriksaan kepatuhan penggunaan alat pelindung diri apd",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Kepatuhan Penggunaan Alat Pelindung Diri (APD)",
