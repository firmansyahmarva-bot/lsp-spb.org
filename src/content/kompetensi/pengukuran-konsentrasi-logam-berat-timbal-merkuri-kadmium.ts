...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengukuran-konsentrasi-logam-berat-timbal-merkuri-kadmium",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengukuran Konsentrasi Logam Berat (Timbal, Merkuri, Kadmium)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengukuran Konsentrasi Logam Berat (Timbal, Merkuri, Kadmium) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengukuran Konsentrasi Logam Berat (Timbal, Merkuri, Kadmium): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengukuran Konsentrasi Logam Berat (Timbal, Merkuri, Kadmium) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengukuran Konsentrasi Logam Berat (Timbal, Merkuri, Kadmium) sesuai SKKNI Higiene Industri & Pemantauan Lingkungan Kerja.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengukuran Konsentrasi Logam Berat (Timbal, Merkuri, Kadmium)",
  ...
  "indexable": true,
  "intent": "kompetensi pengukuran-konsentrasi-logam-berat-timbal-merkuri-kadmium syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengukuran konsentrasi logam berat timbal merkuri kadmium",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengukuran Konsentrasi Logam Berat (Timbal, Merkuri, Kadmium)",
