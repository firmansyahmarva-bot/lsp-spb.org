...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengukuran-faktor-fisika-lingkungan-kerja-kebisingan-getaran",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengukuran Faktor Fisika Lingkungan Kerja (Kebisingan & Getaran)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengukuran Faktor Fisika Lingkungan Kerja (Kebisingan & Getaran) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengukuran Faktor Fisika Lingkungan Kerja (Kebisingan & Getaran): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengukuran Faktor Fisika Lingkungan Kerja (Kebisingan & Getaran) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengukuran Faktor Fisika Lingkungan Kerja (Kebisingan & Getaran) sesuai SKKNI Pemeliharaan & Pengujian Teknis K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengukuran Faktor Fisika Lingkungan Kerja (Kebisingan & Getaran)",
  ...
  "indexable": true,
  "intent": "kompetensi pengukuran-faktor-fisika-lingkungan-kerja-kebisingan-getaran syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengukuran faktor fisika lingkungan kerja kebisingan getaran",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengukuran Faktor Fisika Lingkungan Kerja (Kebisingan & Getaran)",
