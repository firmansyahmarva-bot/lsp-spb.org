...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengujian-integritas-tali-kawat-baja-wire-rope-ndt",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengujian Integritas Tali Kawat Baja (Wire Rope NDT)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengujian Integritas Tali Kawat Baja (Wire Rope NDT) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengujian Integritas Tali Kawat Baja (Wire Rope NDT): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengujian Integritas Tali Kawat Baja (Wire Rope NDT) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengujian Integritas Tali Kawat Baja (Wire Rope NDT) sesuai SKKNI Pemeliharaan & Pengujian Teknis K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengujian Integritas Tali Kawat Baja (Wire Rope NDT)",
  ...
  "indexable": true,
  "intent": "kompetensi pengujian-integritas-tali-kawat-baja-wire-rope-ndt syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengujian integritas tali kawat baja wire rope ndt",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengujian Integritas Tali Kawat Baja (Wire Rope NDT)",
