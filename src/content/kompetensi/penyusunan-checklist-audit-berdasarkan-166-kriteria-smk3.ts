...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "penyusunan-checklist-audit-berdasarkan-166-kriteria-smk3",
  "title": "Skema Sertifikasi Kompetensi BNSP: Penyusunan Checklist Audit Berdasarkan 166 Kriteria SMK3",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Penyusunan Checklist Audit Berdasarkan 166 Kriteria SMK3 | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Penyusunan Checklist Audit Berdasarkan 166 Kriteria SMK3: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Penyusunan Checklist Audit Berdasarkan 166 Kriteria SMK3 adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Penyusunan Checklist Audit Berdasarkan 166 Kriteria SMK3 sesuai SKKNI Audit Sistem Manajemen & Asesmen Kompetensi.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Penyusunan Checklist Audit Berdasarkan 166 Kriteria SMK3",
  ...
  "indexable": true,
  "intent": "kompetensi penyusunan-checklist-audit-berdasarkan-166-kriteria-smk3 syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp penyusunan checklist audit berdasarkan 166 kriteria smk3",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Penyusunan Checklist Audit Berdasarkan 166 Kriteria SMK3",
