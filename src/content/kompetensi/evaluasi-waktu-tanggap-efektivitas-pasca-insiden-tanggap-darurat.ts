...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "evaluasi-waktu-tanggap-efektivitas-pasca-insiden-tanggap-darurat",
  "title": "Skema Sertifikasi Kompetensi BNSP: Evaluasi Waktu Tanggap & Efektivitas Pasca-Insiden Tanggap Darurat",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Evaluasi Waktu Tanggap & Efektivitas Pasca-Insiden Tanggap Darurat | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Evaluasi Waktu Tanggap & Efektivitas Pasca-Insiden Tanggap Darurat: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Evaluasi Waktu Tanggap & Efektivitas Pasca-Insiden Tanggap Darurat adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Evaluasi Waktu Tanggap & Efektivitas Pasca-Insiden Tanggap Darurat sesuai SKKNI Tanggap Darurat & Penyelamatan Industri.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Evaluasi Waktu Tanggap & Efektivitas Pasca-Insiden Tanggap Darurat",
  ...
  "indexable": true,
  "intent": "kompetensi evaluasi-waktu-tanggap-efektivitas-pasca-insiden-tanggap-darurat syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp evaluasi waktu tanggap efektivitas pasca insiden tanggap darurat",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Evaluasi Waktu Tanggap & Efektivitas Pasca-Insiden Tanggap Darurat",
