...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "penyusunan-kajian-keselamatan-proses-process-safety-hazard-analysis",
  "title": "Skema Sertifikasi Kompetensi BNSP: Penyusunan Kajian Keselamatan Proses (Process Safety Hazard Analysis)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Penyusunan Kajian Keselamatan Proses (Process Safety Hazard Analysis) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Penyusunan Kajian Keselamatan Proses (Process Safety Hazard Analysis): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Penyusunan Kajian Keselamatan Proses (Process Safety Hazard Analysis) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Penyusunan Kajian Keselamatan Proses (Process Safety Hazard Analysis) sesuai SKKNI Analisis Rekayasa & Manajemen K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Penyusunan Kajian Keselamatan Proses (Process Safety Hazard Analysis)",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Penyusunan Kajian Keselamatan Proses (Process Safety Hazard Analysis)",
      "paragraphs": [
        "Skema sertifikasi Penyusunan Kajian Keselamatan Proses (Process Safety Hazard Analysis) mengacu pada ketetapan SKKNI Analisis Rekayasa & Manajemen K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi penyusunan-kajian-keselamatan-proses-process-safety-hazard-analysis syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp penyusunan kajian keselamatan proses process safety hazard analysis",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Penyusunan Kajian Keselamatan Proses (Process Safety Hazard Analysis)",
