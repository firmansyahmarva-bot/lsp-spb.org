...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "audit-due-diligence-k3-untuk-transaksi-akuisisi-fasilitas-industri",
  "title": "Skema Sertifikasi Kompetensi BNSP: Audit Due Diligence K3 untuk Transaksi & Akuisisi Fasilitas Industri",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Audit Due Diligence K3 untuk Transaksi & Akuisisi Fasilitas Industri | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Audit Due Diligence K3 untuk Transaksi & Akuisisi Fasilitas Industri: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Audit Due Diligence K3 untuk Transaksi & Akuisisi Fasilitas Industri adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Audit Due Diligence K3 untuk Transaksi & Akuisisi Fasilitas Industri sesuai SKKNI Audit Sistem Manajemen & Asesmen Kompetensi.",
  "highlights": [
    "Sertifikat Resmi Berlogo Garuda Emas BNSP",
    "Standar Rujukan: SKKNI Audit Sistem Manajemen & Asesmen Kompetensi",
    "Tingkatan: Tingkat Auditor & Asesor K3 (Auditor K3)",
    "Metode Asesmen: Verifikasi Portofolio, Wawancara & Observasi TUK"
  ],
  "courseDetails": {
    "level": "Skema Sertifikasi Kompetensi Tingkat Auditor & Asesor K3",
    ...
    "targetAudience": [
      "Auditor K3 dan Praktisi K3 Sektoral Terkait",
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Audit Due Diligence K3 untuk Transaksi & Akuisisi Fasilitas Industri",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Audit Due Diligence K3 untuk Transaksi & Akuisisi Fasilitas Industri",
      "paragraphs": [
        "Skema sertifikasi Audit Due Diligence K3 untuk Transaksi & Akuisisi Fasilitas Industri mengacu pada ketetapan SKKNI Audit Sistem Manajemen & Asesmen Kompetensi dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi audit-due-diligence-k3-untuk-transaksi-akuisisi-fasilitas-industri syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp audit due diligence k3 untuk transaksi akuisisi fasilitas industri",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Audit Due Diligence K3 untuk Transaksi & Akuisisi Fasilitas Industri",
  "intentType": "commercial",
  "parentTopic": "Sertifikasi Kompetensi BNSP Tingkat Auditor & Asesor K3",
  "cannibalizationGroup": "kompetensi-auditor-k3",
