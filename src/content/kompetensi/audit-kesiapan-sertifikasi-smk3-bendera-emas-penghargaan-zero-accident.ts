...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "audit-kesiapan-sertifikasi-smk3-bendera-emas-penghargaan-zero-accident",
  "title": "Skema Sertifikasi Kompetensi BNSP: Audit Kesiapan Sertifikasi SMK3 Bendera Emas & Penghargaan Zero Accident",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Audit Kesiapan Sertifikasi SMK3 Bendera Emas & Penghargaan Zero Accident | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Audit Kesiapan Sertifikasi SMK3 Bendera Emas & Penghargaan Zero Accident: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Audit Kesiapan Sertifikasi SMK3 Bendera Emas & Penghargaan Zero Accident adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Audit Kesiapan Sertifikasi SMK3 Bendera Emas & Penghargaan Zero Accident sesuai SKKNI Manajemen Strategis Keselamatan & CSMS.",
  "highlights": [
    "Sertifikat Resmi Berlogo Garuda Emas BNSP",
    "Standar Rujukan: SKKNI Manajemen Strategis Keselamatan & CSMS",
    "Tingkatan: Tingkat Manajemen Korporat & CSMS (HSE Corporate Lead)",
    "Metode Asesmen: Verifikasi Portofolio, Wawancara & Observasi TUK"
  ],
  "courseDetails": {
    "level": "Skema Sertifikasi Kompetensi Tingkat Manajemen Korporat & CSMS",
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Audit Kesiapan Sertifikasi SMK3 Bendera Emas & Penghargaan Zero Accident",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Audit Kesiapan Sertifikasi SMK3 Bendera Emas & Penghargaan Zero Accident",
      "paragraphs": [
        "Skema sertifikasi Audit Kesiapan Sertifikasi SMK3 Bendera Emas & Penghargaan Zero Accident mengacu pada ketetapan SKKNI Manajemen Strategis Keselamatan & CSMS dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi audit-kesiapan-sertifikasi-smk3-bendera-emas-penghargaan-zero-accident syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp audit kesiapan sertifikasi smk3 bendera emas penghargaan zero accident",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Audit Kesiapan Sertifikasi SMK3 Bendera Emas & Penghargaan Zero Accident",
  "intentType": "commercial",
  "parentTopic": "Sertifikasi Kompetensi BNSP Tingkat Manajemen Korporat & CSMS",
  "cannibalizationGroup": "kompetensi-hse-corporate-lead",
