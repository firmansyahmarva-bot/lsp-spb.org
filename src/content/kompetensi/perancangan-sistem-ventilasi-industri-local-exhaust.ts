...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "perancangan-sistem-ventilasi-industri-local-exhaust",
  "title": "Skema Sertifikasi Kompetensi BNSP: Perancangan Sistem Ventilasi Industri & Local Exhaust",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Perancangan Sistem Ventilasi Industri & Local Exhaust | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Perancangan Sistem Ventilasi Industri & Local Exhaust: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Perancangan Sistem Ventilasi Industri & Local Exhaust adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Perancangan Sistem Ventilasi Industri & Local Exhaust sesuai SKKNI Analisis Rekayasa & Manajemen K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Perancangan Sistem Ventilasi Industri & Local Exhaust",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Perancangan Sistem Ventilasi Industri & Local Exhaust",
      "paragraphs": [
        "Skema sertifikasi Perancangan Sistem Ventilasi Industri & Local Exhaust mengacu pada ketetapan SKKNI Analisis Rekayasa & Manajemen K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi perancangan-sistem-ventilasi-industri-local-exhaust syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp perancangan sistem ventilasi industri local exhaust",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Perancangan Sistem Ventilasi Industri & Local Exhaust",
