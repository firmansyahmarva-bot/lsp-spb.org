...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "perancangan-sistem-proteksi-jatuh-total-fall-protection-plan",
  "title": "Skema Sertifikasi Kompetensi BNSP: Perancangan Sistem Proteksi Jatuh Total (Fall Protection Plan)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Perancangan Sistem Proteksi Jatuh Total (Fall Protection Plan) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Perancangan Sistem Proteksi Jatuh Total (Fall Protection Plan): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Perancangan Sistem Proteksi Jatuh Total (Fall Protection Plan) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Perancangan Sistem Proteksi Jatuh Total (Fall Protection Plan) sesuai SKKNI Analisis Rekayasa & Manajemen K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Perancangan Sistem Proteksi Jatuh Total (Fall Protection Plan)",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Perancangan Sistem Proteksi Jatuh Total (Fall Protection Plan)",
      "paragraphs": [
        "Skema sertifikasi Perancangan Sistem Proteksi Jatuh Total (Fall Protection Plan) mengacu pada ketetapan SKKNI Analisis Rekayasa & Manajemen K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi perancangan-sistem-proteksi-jatuh-total-fall-protection-plan syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp perancangan sistem proteksi jatuh total fall protection plan",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Perancangan Sistem Proteksi Jatuh Total (Fall Protection Plan)",
