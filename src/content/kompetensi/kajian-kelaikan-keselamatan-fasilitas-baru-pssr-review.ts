...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "kajian-kelaikan-keselamatan-fasilitas-baru-pssr-review",
  "title": "Skema Sertifikasi Kompetensi BNSP: Kajian Kelaikan Keselamatan Fasilitas Baru (PSSR Review)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Kajian Kelaikan Keselamatan Fasilitas Baru (PSSR Review) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Kajian Kelaikan Keselamatan Fasilitas Baru (PSSR Review): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Kajian Kelaikan Keselamatan Fasilitas Baru (PSSR Review) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Kajian Kelaikan Keselamatan Fasilitas Baru (PSSR Review) sesuai SKKNI Analisis Rekayasa & Manajemen K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Kajian Kelaikan Keselamatan Fasilitas Baru (PSSR Review)",
  ...
  "indexable": true,
  "intent": "kompetensi kajian-kelaikan-keselamatan-fasilitas-baru-pssr-review syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp kajian kelaikan keselamatan fasilitas baru pssr review",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Kajian Kelaikan Keselamatan Fasilitas Baru (PSSR Review)",
