...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "analisis-kuantitatif-paparan-senyawa-organik-volatil-vocs",
  "title": "Skema Sertifikasi Kompetensi BNSP: Analisis Kuantitatif Paparan Senyawa Organik Volatil (VOCs)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Analisis Kuantitatif Paparan Senyawa Organik Volatil (VOCs) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Analisis Kuantitatif Paparan Senyawa Organik Volatil (VOCs): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Analisis Kuantitatif Paparan Senyawa Organik Volatil (VOCs) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Analisis Kuantitatif Paparan Senyawa Organik Volatil (VOCs) sesuai SKKNI Higiene Industri & Pemantauan Lingkungan Kerja.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Analisis Kuantitatif Paparan Senyawa Organik Volatil (VOCs)",
  ...
  "indexable": true,
  "intent": "kompetensi analisis-kuantitatif-paparan-senyawa-organik-volatil-vocs syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp analisis kuantitatif paparan senyawa organik volatil vocs",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Analisis Kuantitatif Paparan Senyawa Organik Volatil (VOCs)",
