...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengembangan-budaya-keselamatan-kerja-proaktif-safety-culture-maturity",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengembangan Budaya Keselamatan Kerja Proaktif (Safety Culture Maturity)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengembangan Budaya Keselamatan Kerja Proaktif (Safety Culture Maturity) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengembangan Budaya Keselamatan Kerja Proaktif (Safety Culture Maturity): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengembangan Budaya Keselamatan Kerja Proaktif (Safety Culture Maturity) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengembangan Budaya Keselamatan Kerja Proaktif (Safety Culture Maturity) sesuai SKKNI Manajemen Strategis Keselamatan & CSMS.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Pengembangan Budaya Keselamatan Kerja Proaktif (Safety Culture Maturity)",
      "paragraphs": [
  ...
  "indexable": true,
  "intent": "kompetensi pengembangan-budaya-keselamatan-kerja-proaktif-safety-culture-maturity syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengembangan budaya keselamatan kerja proaktif safety culture maturity",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengembangan Budaya Keselamatan Kerja Proaktif (Safety Culture Maturity)",
