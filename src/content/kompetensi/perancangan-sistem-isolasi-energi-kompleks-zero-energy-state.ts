...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "perancangan-sistem-isolasi-energi-kompleks-zero-energy-state",
  "title": "Skema Sertifikasi Kompetensi BNSP: Perancangan Sistem Isolasi Energi Kompleks & Zero Energy State",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Perancangan Sistem Isolasi Energi Kompleks & Zero Energy State | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Perancangan Sistem Isolasi Energi Kompleks & Zero Energy State: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Perancangan Sistem Isolasi Energi Kompleks & Zero Energy State adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Perancangan Sistem Isolasi Energi Kompleks & Zero Energy State sesuai SKKNI Analisis Rekayasa & Manajemen K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Perancangan Sistem Isolasi Energi Kompleks & Zero Energy State",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Perancangan Sistem Isolasi Energi Kompleks & Zero Energy State",
      "paragraphs": [
        "Skema sertifikasi Perancangan Sistem Isolasi Energi Kompleks & Zero Energy State mengacu pada ketetapan SKKNI Analisis Rekayasa & Manajemen K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi perancangan-sistem-isolasi-energi-kompleks-zero-energy-state syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp perancangan sistem isolasi energi kompleks zero energy state",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Perancangan Sistem Isolasi Energi Kompleks & Zero Energy State",
