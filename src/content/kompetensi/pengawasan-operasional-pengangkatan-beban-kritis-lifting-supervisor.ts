...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengawasan-operasional-pengangkatan-beban-kritis-lifting-supervisor",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengawasan Operasional Pengangkatan Beban Kritis (Lifting Supervisor)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengawasan Operasional Pengangkatan Beban Kritis (Lifting Supervisor) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengawasan Operasional Pengangkatan Beban Kritis (Lifting Supervisor): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengawasan Operasional Pengangkatan Beban Kritis (Lifting Supervisor) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengawasan Operasional Pengangkatan Beban Kritis (Lifting Supervisor) sesuai SKKNI Pengawasan Operasional & Risiko K3.",
  "highlights": [
    "Sertifikat Resmi Berlogo Garuda Emas BNSP",
    "Standar Rujukan: SKKNI Pengawasan Operasional & Risiko K3",
    "Tingkatan: Tingkat Officer & Pengawas K3 (Safety Officer)",
    "Metode Asesmen: Verifikasi Portofolio, Wawancara & Observasi TUK"
  ],
  "courseDetails": {
    "level": "Skema Sertifikasi Kompetensi Tingkat Officer & Pengawas K3",
    ...
    "targetAudience": [
      "Safety Officer dan Praktisi K3 Sektoral Terkait",
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengawasan Operasional Pengangkatan Beban Kritis (Lifting Supervisor)",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Pengawasan Operasional Pengangkatan Beban Kritis (Lifting Supervisor)",
      "paragraphs": [
        "Skema sertifikasi Pengawasan Operasional Pengangkatan Beban Kritis (Lifting Supervisor) mengacu pada ketetapan SKKNI Pengawasan Operasional & Risiko K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi pengawasan-operasional-pengangkatan-beban-kritis-lifting-supervisor syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengawasan operasional pengangkatan beban kritis lifting supervisor",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengawasan Operasional Pengangkatan Beban Kritis (Lifting Supervisor)",
  "intentType": "commercial",
  "parentTopic": "Sertifikasi Kompetensi BNSP Tingkat Officer & Pengawas K3",
  "cannibalizationGroup": "kompetensi-safety-officer",
