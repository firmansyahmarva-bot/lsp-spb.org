...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "penerapan-taktik-pemadaman-api-menggunakan-formasi-regu-hydrant",
  "title": "Skema Sertifikasi Kompetensi BNSP: Penerapan Taktik Pemadaman Api Menggunakan Formasi Regu Hydrant",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Penerapan Taktik Pemadaman Api Menggunakan Formasi Regu Hydrant | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Penerapan Taktik Pemadaman Api Menggunakan Formasi Regu Hydrant: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Penerapan Taktik Pemadaman Api Menggunakan Formasi Regu Hydrant adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Penerapan Taktik Pemadaman Api Menggunakan Formasi Regu Hydrant sesuai SKKNI Tanggap Darurat & Penyelamatan Industri.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Penerapan Taktik Pemadaman Api Menggunakan Formasi Regu Hydrant",
  ...
  "indexable": true,
  "intent": "kompetensi penerapan-taktik-pemadaman-api-menggunakan-formasi-regu-hydrant syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp penerapan taktik pemadaman api menggunakan formasi regu hydrant",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Penerapan Taktik Pemadaman Api Menggunakan Formasi Regu Hydrant",
