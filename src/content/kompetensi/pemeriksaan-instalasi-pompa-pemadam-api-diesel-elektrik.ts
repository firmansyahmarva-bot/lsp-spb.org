...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pemeriksaan-instalasi-pompa-pemadam-api-diesel-elektrik",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Instalasi Pompa Pemadam Api Diesel & Elektrik",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Instalasi Pompa Pemadam Api Diesel & Elektrik | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pemeriksaan Instalasi Pompa Pemadam Api Diesel & Elektrik: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Instalasi Pompa Pemadam Api Diesel & Elektrik adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pemeriksaan Instalasi Pompa Pemadam Api Diesel & Elektrik sesuai SKKNI Pemeliharaan & Pengujian Teknis K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pemeriksaan Instalasi Pompa Pemadam Api Diesel & Elektrik",
  ...
  "indexable": true,
  "intent": "kompetensi pemeriksaan-instalasi-pompa-pemadam-api-diesel-elektrik syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pemeriksaan instalasi pompa pemadam api diesel elektrik",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Instalasi Pompa Pemadam Api Diesel & Elektrik",
