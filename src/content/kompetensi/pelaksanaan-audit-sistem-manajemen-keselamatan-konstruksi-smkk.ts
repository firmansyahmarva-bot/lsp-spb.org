...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pelaksanaan-audit-sistem-manajemen-keselamatan-konstruksi-smkk",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pelaksanaan Audit Sistem Manajemen Keselamatan Konstruksi (SMKK)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pelaksanaan Audit Sistem Manajemen Keselamatan Konstruksi (SMKK) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pelaksanaan Audit Sistem Manajemen Keselamatan Konstruksi (SMKK): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pelaksanaan Audit Sistem Manajemen Keselamatan Konstruksi (SMKK) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pelaksanaan Audit Sistem Manajemen Keselamatan Konstruksi (SMKK) sesuai SKKNI Audit Sistem Manajemen & Asesmen Kompetensi.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pelaksanaan Audit Sistem Manajemen Keselamatan Konstruksi (SMKK)",
  ...
  "indexable": true,
  "intent": "kompetensi pelaksanaan-audit-sistem-manajemen-keselamatan-konstruksi-smkk syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pelaksanaan audit sistem manajemen keselamatan konstruksi smkk",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pelaksanaan Audit Sistem Manajemen Keselamatan Konstruksi (SMKK)",
