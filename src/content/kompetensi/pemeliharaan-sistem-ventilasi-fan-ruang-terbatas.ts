...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pemeliharaan-sistem-ventilasi-fan-ruang-terbatas",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pemeliharaan Sistem Ventilasi & Fan Ruang Terbatas",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pemeliharaan Sistem Ventilasi & Fan Ruang Terbatas | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pemeliharaan Sistem Ventilasi & Fan Ruang Terbatas: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pemeliharaan Sistem Ventilasi & Fan Ruang Terbatas adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pemeliharaan Sistem Ventilasi & Fan Ruang Terbatas sesuai SKKNI Pemeliharaan & Pengujian Teknis K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pemeliharaan Sistem Ventilasi & Fan Ruang Terbatas",
  ...
  "indexable": true,
  "intent": "kompetensi pemeliharaan-sistem-ventilasi-fan-ruang-terbatas syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pemeliharaan sistem ventilasi fan ruang terbatas",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pemeliharaan Sistem Ventilasi & Fan Ruang Terbatas",
