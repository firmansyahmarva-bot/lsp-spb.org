...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pemeriksaan-keselamatan-operasi-genset-daya-sementara",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Keselamatan Operasi Genset & Daya Sementara",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Keselamatan Operasi Genset & Daya Sementara | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pemeriksaan Keselamatan Operasi Genset & Daya Sementara: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Keselamatan Operasi Genset & Daya Sementara adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pemeriksaan Keselamatan Operasi Genset & Daya Sementara sesuai SKKNI Pengawasan Operasional & Risiko K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pemeriksaan Keselamatan Operasi Genset & Daya Sementara",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Pemeriksaan Keselamatan Operasi Genset & Daya Sementara",
      "paragraphs": [
        "Skema sertifikasi Pemeriksaan Keselamatan Operasi Genset & Daya Sementara mengacu pada ketetapan SKKNI Pengawasan Operasional & Risiko K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi pemeriksaan-keselamatan-operasi-genset-daya-sementara syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pemeriksaan keselamatan operasi genset daya sementara",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Keselamatan Operasi Genset & Daya Sementara",
