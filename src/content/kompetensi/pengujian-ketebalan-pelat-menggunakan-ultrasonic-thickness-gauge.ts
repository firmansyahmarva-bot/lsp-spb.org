...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengujian-ketebalan-pelat-menggunakan-ultrasonic-thickness-gauge",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengujian Ketebalan Pelat Menggunakan Ultrasonic Thickness Gauge",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengujian Ketebalan Pelat Menggunakan Ultrasonic Thickness Gauge | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengujian Ketebalan Pelat Menggunakan Ultrasonic Thickness Gauge: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengujian Ketebalan Pelat Menggunakan Ultrasonic Thickness Gauge adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengujian Ketebalan Pelat Menggunakan Ultrasonic Thickness Gauge sesuai SKKNI Pemeliharaan & Pengujian Teknis K3.",
  "highlights": [
    "Sertifikat Resmi Berlogo Garuda Emas BNSP",
    "Standar Rujukan: SKKNI Pemeliharaan & Pengujian Teknis K3",
    "Tingkatan: Tingkat Teknisi K3 (Teknisi K3)",
    "Metode Asesmen: Verifikasi Portofolio, Wawancara & Observasi TUK"
  ],
  "courseDetails": {
    "level": "Skema Sertifikasi Kompetensi Tingkat Teknisi K3",
    ...
    "targetAudience": [
      "Teknisi K3 dan Praktisi K3 Sektoral Terkait",
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengujian Ketebalan Pelat Menggunakan Ultrasonic Thickness Gauge",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Pengujian Ketebalan Pelat Menggunakan Ultrasonic Thickness Gauge",
      "paragraphs": [
        "Skema sertifikasi Pengujian Ketebalan Pelat Menggunakan Ultrasonic Thickness Gauge mengacu pada ketetapan SKKNI Pemeliharaan & Pengujian Teknis K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi pengujian-ketebalan-pelat-menggunakan-ultrasonic-thickness-gauge syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengujian ketebalan pelat menggunakan ultrasonic thickness gauge",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengujian Ketebalan Pelat Menggunakan Ultrasonic Thickness Gauge",
  "intentType": "commercial",
  "parentTopic": "Sertifikasi Kompetensi BNSP Tingkat Teknisi K3",
  "cannibalizationGroup": "kompetensi-teknisi-k3",
