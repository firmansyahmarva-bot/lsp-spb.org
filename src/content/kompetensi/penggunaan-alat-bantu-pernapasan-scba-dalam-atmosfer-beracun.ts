...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "penggunaan-alat-bantu-pernapasan-scba-dalam-atmosfer-beracun",
  "title": "Skema Sertifikasi Kompetensi BNSP: Penggunaan Alat Bantu Pernapasan SCBA dalam Atmosfer Beracun",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Penggunaan Alat Bantu Pernapasan SCBA dalam Atmosfer Beracun | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Penggunaan Alat Bantu Pernapasan SCBA dalam Atmosfer Beracun: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Penggunaan Alat Bantu Pernapasan SCBA dalam Atmosfer Beracun adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Penggunaan Alat Bantu Pernapasan SCBA dalam Atmosfer Beracun sesuai SKKNI Tanggap Darurat & Penyelamatan Industri.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Penggunaan Alat Bantu Pernapasan SCBA dalam Atmosfer Beracun",
  ...
  "indexable": true,
  "intent": "kompetensi penggunaan-alat-bantu-pernapasan-scba-dalam-atmosfer-beracun syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp penggunaan alat bantu pernapasan scba dalam atmosfer beracun",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Penggunaan Alat Bantu Pernapasan SCBA dalam Atmosfer Beracun",
