...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pemeriksaan-sensor-interlock-guarding-mesin",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Sensor Interlock & Guarding Mesin",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Sensor Interlock & Guarding Mesin | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pemeriksaan Sensor Interlock & Guarding Mesin: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Sensor Interlock & Guarding Mesin adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pemeriksaan Sensor Interlock & Guarding Mesin sesuai SKKNI Pemeliharaan & Pengujian Teknis K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pemeriksaan Sensor Interlock & Guarding Mesin",
  ...
  "indexable": true,
  "intent": "kompetensi pemeriksaan-sensor-interlock-guarding-mesin syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pemeriksaan sensor interlock guarding mesin",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Sensor Interlock & Guarding Mesin",
