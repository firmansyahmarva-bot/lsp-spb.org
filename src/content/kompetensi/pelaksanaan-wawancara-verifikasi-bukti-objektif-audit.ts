...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pelaksanaan-wawancara-verifikasi-bukti-objektif-audit",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pelaksanaan Wawancara & Verifikasi Bukti Objektif Audit",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pelaksanaan Wawancara & Verifikasi Bukti Objektif Audit | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pelaksanaan Wawancara & Verifikasi Bukti Objektif Audit: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pelaksanaan Wawancara & Verifikasi Bukti Objektif Audit adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pelaksanaan Wawancara & Verifikasi Bukti Objektif Audit sesuai SKKNI Audit Sistem Manajemen & Asesmen Kompetensi.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pelaksanaan Wawancara & Verifikasi Bukti Objektif Audit",
  ...
  "indexable": true,
  "intent": "kompetensi pelaksanaan-wawancara-verifikasi-bukti-objektif-audit syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pelaksanaan wawancara verifikasi bukti objektif audit",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pelaksanaan Wawancara & Verifikasi Bukti Objektif Audit",
