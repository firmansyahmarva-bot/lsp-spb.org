...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "perancangan-protokol-tanggap-darurat-medis-lapangan-medevac-protocol",
  "title": "Skema Sertifikasi Kompetensi BNSP: Perancangan Protokol Tanggap Darurat Medis Lapangan (Medevac Protocol)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Perancangan Protokol Tanggap Darurat Medis Lapangan (Medevac Protocol) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Perancangan Protokol Tanggap Darurat Medis Lapangan (Medevac Protocol): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Perancangan Protokol Tanggap Darurat Medis Lapangan (Medevac Protocol) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Perancangan Protokol Tanggap Darurat Medis Lapangan (Medevac Protocol) sesuai SKKNI Analisis Rekayasa & Manajemen K3.",
  "highlights": [
    "Sertifikat Resmi Berlogo Garuda Emas BNSP",
    "Standar Rujukan: SKKNI Analisis Rekayasa & Manajemen K3",
    "Tingkatan: Tingkat Ahli & Spesialis K3 (Ahli K3 Spesialis)",
    "Metode Asesmen: Verifikasi Portofolio, Wawancara & Observasi TUK"
  ],
  "courseDetails": {
    "level": "Skema Sertifikasi Kompetensi Tingkat Ahli & Spesialis K3",
    ...
    "targetAudience": [
      "Ahli K3 Spesialis dan Praktisi K3 Sektoral Terkait",
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Perancangan Protokol Tanggap Darurat Medis Lapangan (Medevac Protocol)",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Perancangan Protokol Tanggap Darurat Medis Lapangan (Medevac Protocol)",
      "paragraphs": [
        "Skema sertifikasi Perancangan Protokol Tanggap Darurat Medis Lapangan (Medevac Protocol) mengacu pada ketetapan SKKNI Analisis Rekayasa & Manajemen K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi perancangan-protokol-tanggap-darurat-medis-lapangan-medevac-protocol syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp perancangan protokol tanggap darurat medis lapangan medevac protocol",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Perancangan Protokol Tanggap Darurat Medis Lapangan (Medevac Protocol)",
  "intentType": "commercial",
  "parentTopic": "Sertifikasi Kompetensi BNSP Tingkat Ahli & Spesialis K3",
  "cannibalizationGroup": "kompetensi-ahli-k3-spesialis",
