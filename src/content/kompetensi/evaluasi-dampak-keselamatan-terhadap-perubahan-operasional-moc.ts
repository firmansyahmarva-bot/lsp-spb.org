...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "evaluasi-dampak-keselamatan-terhadap-perubahan-operasional-moc",
  "title": "Skema Sertifikasi Kompetensi BNSP: Evaluasi Dampak Keselamatan Terhadap Perubahan Operasional (MOC)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Evaluasi Dampak Keselamatan Terhadap Perubahan Operasional (MOC) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Evaluasi Dampak Keselamatan Terhadap Perubahan Operasional (MOC): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Evaluasi Dampak Keselamatan Terhadap Perubahan Operasional (MOC) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Evaluasi Dampak Keselamatan Terhadap Perubahan Operasional (MOC) sesuai SKKNI Analisis Rekayasa & Manajemen K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Evaluasi Dampak Keselamatan Terhadap Perubahan Operasional (MOC)",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Evaluasi Dampak Keselamatan Terhadap Perubahan Operasional (MOC)",
      "paragraphs": [
        "Skema sertifikasi Evaluasi Dampak Keselamatan Terhadap Perubahan Operasional (MOC) mengacu pada ketetapan SKKNI Analisis Rekayasa & Manajemen K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi evaluasi-dampak-keselamatan-terhadap-perubahan-operasional-moc syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp evaluasi dampak keselamatan terhadap perubahan operasional moc",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Evaluasi Dampak Keselamatan Terhadap Perubahan Operasional (MOC)",
