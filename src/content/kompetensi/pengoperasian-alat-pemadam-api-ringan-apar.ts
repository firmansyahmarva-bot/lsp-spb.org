...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengoperasian-alat-pemadam-api-ringan-apar",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengoperasian Alat Pemadam Api Ringan (APAR)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengoperasian Alat Pemadam Api Ringan (APAR) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengoperasian Alat Pemadam Api Ringan (APAR): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengoperasian Alat Pemadam Api Ringan (APAR) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengoperasian Alat Pemadam Api Ringan (APAR) sesuai SKKNI Pengoperasian Peralatan & Sarana K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengoperasian Alat Pemadam Api Ringan (APAR)",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Pengoperasian Alat Pemadam Api Ringan (APAR)",
      "paragraphs": [
        "Skema sertifikasi Pengoperasian Alat Pemadam Api Ringan (APAR) mengacu pada ketetapan SKKNI Pengoperasian Peralatan & Sarana K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi pengoperasian-alat-pemadam-api-ringan-apar syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengoperasian alat pemadam api ringan apar",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengoperasian Alat Pemadam Api Ringan (APAR)",
