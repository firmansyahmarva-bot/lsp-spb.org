...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengendalian-bahaya-radiasi-gelombang-elektromagnetik-uv",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengendalian Bahaya Radiasi Gelombang Elektromagnetik & UV",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengendalian Bahaya Radiasi Gelombang Elektromagnetik & UV | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengendalian Bahaya Radiasi Gelombang Elektromagnetik & UV: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengendalian Bahaya Radiasi Gelombang Elektromagnetik & UV adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengendalian Bahaya Radiasi Gelombang Elektromagnetik & UV sesuai SKKNI Higiene Industri & Pemantauan Lingkungan Kerja.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengendalian Bahaya Radiasi Gelombang Elektromagnetik & UV",
  ...
  "indexable": true,
  "intent": "kompetensi pengendalian-bahaya-radiasi-gelombang-elektromagnetik-uv syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengendalian bahaya radiasi gelombang elektromagnetik uv",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengendalian Bahaya Radiasi Gelombang Elektromagnetik & UV",
