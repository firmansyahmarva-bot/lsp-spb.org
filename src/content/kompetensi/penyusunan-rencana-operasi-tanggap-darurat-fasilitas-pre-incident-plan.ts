...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "penyusunan-rencana-operasi-tanggap-darurat-fasilitas-pre-incident-plan",
  "title": "Skema Sertifikasi Kompetensi BNSP: Penyusunan Rencana Operasi Tanggap Darurat Fasilitas (Pre-Incident Plan)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Penyusunan Rencana Operasi Tanggap Darurat Fasilitas (Pre-Incident Plan) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Penyusunan Rencana Operasi Tanggap Darurat Fasilitas (Pre-Incident Plan): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Penyusunan Rencana Operasi Tanggap Darurat Fasilitas (Pre-Incident Plan) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Penyusunan Rencana Operasi Tanggap Darurat Fasilitas (Pre-Incident Plan) sesuai SKKNI Tanggap Darurat & Penyelamatan Industri.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Penyusunan Rencana Operasi Tanggap Darurat Fasilitas (Pre-Incident Plan)",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Penyusunan Rencana Operasi Tanggap Darurat Fasilitas (Pre-Incident Plan)",
      "paragraphs": [
        "Skema sertifikasi Penyusunan Rencana Operasi Tanggap Darurat Fasilitas (Pre-Incident Plan) mengacu pada ketetapan SKKNI Tanggap Darurat & Penyelamatan Industri dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi penyusunan-rencana-operasi-tanggap-darurat-fasilitas-pre-incident-plan syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp penyusunan rencana operasi tanggap darurat fasilitas pre incident plan",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Penyusunan Rencana Operasi Tanggap Darurat Fasilitas (Pre-Incident Plan)",
