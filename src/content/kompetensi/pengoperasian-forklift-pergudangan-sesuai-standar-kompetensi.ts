...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengoperasian-forklift-pergudangan-sesuai-standar-kompetensi",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengoperasian Forklift Pergudangan Sesuai Standar Kompetensi",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengoperasian Forklift Pergudangan Sesuai Standar Kompetensi | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengoperasian Forklift Pergudangan Sesuai Standar Kompetensi: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengoperasian Forklift Pergudangan Sesuai Standar Kompetensi adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengoperasian Forklift Pergudangan Sesuai Standar Kompetensi sesuai SKKNI Pengoperasian Peralatan & Sarana K3.",
  "highlights": [
    "Sertifikat Resmi Berlogo Garuda Emas BNSP",
    "Standar Rujukan: SKKNI Pengoperasian Peralatan & Sarana K3",
    "Tingkatan: Tingkat Operator K3 (Operator K3)",
    "Metode Asesmen: Verifikasi Portofolio, Wawancara & Observasi TUK"
  ],
  "courseDetails": {
    "level": "Skema Sertifikasi Kompetensi Tingkat Operator K3",
    ...
    "targetAudience": [
      "Operator K3 dan Praktisi K3 Sektoral Terkait",
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengoperasian Forklift Pergudangan Sesuai Standar Kompetensi",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Pengoperasian Forklift Pergudangan Sesuai Standar Kompetensi",
      "paragraphs": [
        "Skema sertifikasi Pengoperasian Forklift Pergudangan Sesuai Standar Kompetensi mengacu pada ketetapan SKKNI Pengoperasian Peralatan & Sarana K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi pengoperasian-forklift-pergudangan-sesuai-standar-kompetensi syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengoperasian forklift pergudangan sesuai standar kompetensi",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengoperasian Forklift Pergudangan Sesuai Standar Kompetensi",
  "intentType": "commercial",
  "parentTopic": "Sertifikasi Kompetensi BNSP Tingkat Operator K3",
  "cannibalizationGroup": "kompetensi-operator-k3",
