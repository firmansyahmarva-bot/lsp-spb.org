...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pelaksanaan-asesmen-uji-lisan-wawancara-pemahaman-standar",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pelaksanaan Asesmen Uji Lisan & Wawancara Pemahaman Standar",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pelaksanaan Asesmen Uji Lisan & Wawancara Pemahaman Standar | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pelaksanaan Asesmen Uji Lisan & Wawancara Pemahaman Standar: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pelaksanaan Asesmen Uji Lisan & Wawancara Pemahaman Standar adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pelaksanaan Asesmen Uji Lisan & Wawancara Pemahaman Standar sesuai SKKNI Audit Sistem Manajemen & Asesmen Kompetensi.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pelaksanaan Asesmen Uji Lisan & Wawancara Pemahaman Standar",
  ...
  "indexable": true,
  "intent": "kompetensi pelaksanaan-asesmen-uji-lisan-wawancara-pemahaman-standar syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pelaksanaan asesmen uji lisan wawancara pemahaman standar",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pelaksanaan Asesmen Uji Lisan & Wawancara Pemahaman Standar",
