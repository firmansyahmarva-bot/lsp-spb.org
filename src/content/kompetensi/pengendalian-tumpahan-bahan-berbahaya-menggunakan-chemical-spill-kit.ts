...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengendalian-tumpahan-bahan-berbahaya-menggunakan-chemical-spill-kit",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengendalian Tumpahan Bahan Berbahaya Menggunakan Chemical Spill Kit",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengendalian Tumpahan Bahan Berbahaya Menggunakan Chemical Spill Kit | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengendalian Tumpahan Bahan Berbahaya Menggunakan Chemical Spill Kit: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengendalian Tumpahan Bahan Berbahaya Menggunakan Chemical Spill Kit adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengendalian Tumpahan Bahan Berbahaya Menggunakan Chemical Spill Kit sesuai SKKNI Tanggap Darurat & Penyelamatan Industri.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengendalian Tumpahan Bahan Berbahaya Menggunakan Chemical Spill Kit",
  ...
  "indexable": true,
  "intent": "kompetensi pengendalian-tumpahan-bahan-berbahaya-menggunakan-chemical-spill-kit syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengendalian tumpahan bahan berbahaya menggunakan chemical spill kit",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengendalian Tumpahan Bahan Berbahaya Menggunakan Chemical Spill Kit",
