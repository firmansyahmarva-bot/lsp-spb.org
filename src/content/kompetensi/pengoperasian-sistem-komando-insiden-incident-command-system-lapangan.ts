...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengoperasian-sistem-komando-insiden-incident-command-system-lapangan",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengoperasian Sistem Komando Insiden (Incident Command System Lapangan)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengoperasian Sistem Komando Insiden (Incident Command System Lapangan) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengoperasian Sistem Komando Insiden (Incident Command System Lapangan): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengoperasian Sistem Komando Insiden (Incident Command System Lapangan) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengoperasian Sistem Komando Insiden (Incident Command System Lapangan) sesuai SKKNI Tanggap Darurat & Penyelamatan Industri.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengoperasian Sistem Komando Insiden (Incident Command System Lapangan)",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Pengoperasian Sistem Komando Insiden (Incident Command System Lapangan)",
      "paragraphs": [
        "Skema sertifikasi Pengoperasian Sistem Komando Insiden (Incident Command System Lapangan) mengacu pada ketetapan SKKNI Tanggap Darurat & Penyelamatan Industri dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi pengoperasian-sistem-komando-insiden-incident-command-system-lapangan syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengoperasian sistem komando insiden incident command system lapangan",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengoperasian Sistem Komando Insiden (Incident Command System Lapangan)",
