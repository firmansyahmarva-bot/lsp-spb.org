...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengambilan-keputusan-kompeten-k-atau-belum-kompeten-bk",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengambilan Keputusan Kompeten (K) atau Belum Kompeten (BK)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengambilan Keputusan Kompeten (K) atau Belum Kompeten (BK) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengambilan Keputusan Kompeten (K) atau Belum Kompeten (BK): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengambilan Keputusan Kompeten (K) atau Belum Kompeten (BK) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengambilan Keputusan Kompeten (K) atau Belum Kompeten (BK) sesuai SKKNI Audit Sistem Manajemen & Asesmen Kompetensi.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengambilan Keputusan Kompeten (K) atau Belum Kompeten (BK)",
  ...
  "indexable": true,
  "intent": "kompetensi pengambilan-keputusan-kompeten-k-atau-belum-kompeten-bk syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengambilan keputusan kompeten k atau belum kompeten bk",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengambilan Keputusan Kompeten (K) atau Belum Kompeten (BK)",
