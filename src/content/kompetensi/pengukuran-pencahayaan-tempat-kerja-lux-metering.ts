...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengukuran-pencahayaan-tempat-kerja-lux-metering",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengukuran Pencahayaan Tempat Kerja (Lux Metering)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengukuran Pencahayaan Tempat Kerja (Lux Metering) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengukuran Pencahayaan Tempat Kerja (Lux Metering): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengukuran Pencahayaan Tempat Kerja (Lux Metering) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengukuran Pencahayaan Tempat Kerja (Lux Metering) sesuai SKKNI Pemeliharaan & Pengujian Teknis K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengukuran Pencahayaan Tempat Kerja (Lux Metering)",
  ...
  "indexable": true,
  "intent": "kompetensi pengukuran-pencahayaan-tempat-kerja-lux-metering syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengukuran pencahayaan tempat kerja lux metering",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengukuran Pencahayaan Tempat Kerja (Lux Metering)",
