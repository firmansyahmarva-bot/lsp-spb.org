...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pemeriksaan-kelaikan-struktur-perancah-scaffolding",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Kelaikan Struktur Perancah Scaffolding",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Kelaikan Struktur Perancah Scaffolding | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pemeriksaan Kelaikan Struktur Perancah Scaffolding: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Kelaikan Struktur Perancah Scaffolding adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pemeriksaan Kelaikan Struktur Perancah Scaffolding sesuai SKKNI Pemeliharaan & Pengujian Teknis K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pemeriksaan Kelaikan Struktur Perancah Scaffolding",
  ...
  "indexable": true,
  "intent": "kompetensi pemeriksaan-kelaikan-struktur-perancah-scaffolding syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pemeriksaan kelaikan struktur perancah scaffolding",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pemeriksaan Kelaikan Struktur Perancah Scaffolding",
