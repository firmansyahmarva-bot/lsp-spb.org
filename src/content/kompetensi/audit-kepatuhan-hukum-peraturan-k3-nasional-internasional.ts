...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "audit-kepatuhan-hukum-peraturan-k3-nasional-internasional",
  "title": "Skema Sertifikasi Kompetensi BNSP: Audit Kepatuhan Hukum Peraturan K3 Nasional & Internasional",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Audit Kepatuhan Hukum Peraturan K3 Nasional & Internasional | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Audit Kepatuhan Hukum Peraturan K3 Nasional & Internasional: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Audit Kepatuhan Hukum Peraturan K3 Nasional & Internasional adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Audit Kepatuhan Hukum Peraturan K3 Nasional & Internasional sesuai SKKNI Analisis Rekayasa & Manajemen K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Audit Kepatuhan Hukum Peraturan K3 Nasional & Internasional",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Audit Kepatuhan Hukum Peraturan K3 Nasional & Internasional",
      "paragraphs": [
        "Skema sertifikasi Audit Kepatuhan Hukum Peraturan K3 Nasional & Internasional mengacu pada ketetapan SKKNI Analisis Rekayasa & Manajemen K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi audit-kepatuhan-hukum-peraturan-k3-nasional-internasional syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp audit kepatuhan hukum peraturan k3 nasional internasional",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Audit Kepatuhan Hukum Peraturan K3 Nasional & Internasional",
