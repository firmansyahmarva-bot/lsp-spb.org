...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "penerapan-isolasi-energi-prosedur-loto",
  "title": "Skema Sertifikasi Kompetensi BNSP: Penerapan Isolasi Energi & Prosedur LOTO",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Penerapan Isolasi Energi & Prosedur LOTO | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Penerapan Isolasi Energi & Prosedur LOTO: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Penerapan Isolasi Energi & Prosedur LOTO adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Penerapan Isolasi Energi & Prosedur LOTO sesuai SKKNI Pengoperasian Peralatan & Sarana K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Penerapan Isolasi Energi & Prosedur LOTO",
  ...
  "indexable": true,
  "intent": "kompetensi penerapan-isolasi-energi-prosedur-loto syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp penerapan isolasi energi prosedur loto",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Penerapan Isolasi Energi & Prosedur LOTO",
