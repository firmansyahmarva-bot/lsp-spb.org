...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "perancangan-program-konservasi-pendengaran-korporasi",
  "title": "Skema Sertifikasi Kompetensi BNSP: Perancangan Program Konservasi Pendengaran Korporasi",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Perancangan Program Konservasi Pendengaran Korporasi | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Perancangan Program Konservasi Pendengaran Korporasi: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Perancangan Program Konservasi Pendengaran Korporasi adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Perancangan Program Konservasi Pendengaran Korporasi sesuai SKKNI Analisis Rekayasa & Manajemen K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Perancangan Program Konservasi Pendengaran Korporasi",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Perancangan Program Konservasi Pendengaran Korporasi",
      "paragraphs": [
        "Skema sertifikasi Perancangan Program Konservasi Pendengaran Korporasi mengacu pada ketetapan SKKNI Analisis Rekayasa & Manajemen K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi perancangan-program-konservasi-pendengaran-korporasi syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp perancangan program konservasi pendengaran korporasi",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Perancangan Program Konservasi Pendengaran Korporasi",
