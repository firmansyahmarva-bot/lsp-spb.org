...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "perancangan-sistem-manajemen-keselamatan-kontraktor-csms",
  "title": "Skema Sertifikasi Kompetensi BNSP: Perancangan Sistem Manajemen Keselamatan Kontraktor (CSMS)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Perancangan Sistem Manajemen Keselamatan Kontraktor (CSMS) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Perancangan Sistem Manajemen Keselamatan Kontraktor (CSMS): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Perancangan Sistem Manajemen Keselamatan Kontraktor (CSMS) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Perancangan Sistem Manajemen Keselamatan Kontraktor (CSMS) sesuai SKKNI Analisis Rekayasa & Manajemen K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Perancangan Sistem Manajemen Keselamatan Kontraktor (CSMS)",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Perancangan Sistem Manajemen Keselamatan Kontraktor (CSMS)",
      "paragraphs": [
        "Skema sertifikasi Perancangan Sistem Manajemen Keselamatan Kontraktor (CSMS) mengacu pada ketetapan SKKNI Analisis Rekayasa & Manajemen K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi perancangan-sistem-manajemen-keselamatan-kontraktor-csms syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp perancangan sistem manajemen keselamatan kontraktor csms",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Perancangan Sistem Manajemen Keselamatan Kontraktor (CSMS)",
