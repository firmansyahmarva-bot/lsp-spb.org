...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "analisis-akar-masalah-kecelakaan-kerja-root-cause-analysis",
  "title": "Skema Sertifikasi Kompetensi BNSP: Analisis Akar Masalah Kecelakaan Kerja (Root Cause Analysis)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Analisis Akar Masalah Kecelakaan Kerja (Root Cause Analysis) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Analisis Akar Masalah Kecelakaan Kerja (Root Cause Analysis): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Analisis Akar Masalah Kecelakaan Kerja (Root Cause Analysis) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Analisis Akar Masalah Kecelakaan Kerja (Root Cause Analysis) sesuai SKKNI Analisis Rekayasa & Manajemen K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Analisis Akar Masalah Kecelakaan Kerja (Root Cause Analysis)",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Analisis Akar Masalah Kecelakaan Kerja (Root Cause Analysis)",
      "paragraphs": [
        "Skema sertifikasi Analisis Akar Masalah Kecelakaan Kerja (Root Cause Analysis) mengacu pada ketetapan SKKNI Analisis Rekayasa & Manajemen K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi analisis-akar-masalah-kecelakaan-kerja-root-cause-analysis syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp analisis akar masalah kecelakaan kerja root cause analysis",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Analisis Akar Masalah Kecelakaan Kerja (Root Cause Analysis)",
