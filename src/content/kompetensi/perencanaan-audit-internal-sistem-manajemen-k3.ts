...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "perencanaan-audit-internal-sistem-manajemen-k3",
  "title": "Skema Sertifikasi Kompetensi BNSP: Perencanaan Audit Internal Sistem Manajemen K3",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Perencanaan Audit Internal Sistem Manajemen K3 | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Perencanaan Audit Internal Sistem Manajemen K3: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Perencanaan Audit Internal Sistem Manajemen K3 adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Perencanaan Audit Internal Sistem Manajemen K3 sesuai SKKNI Audit Sistem Manajemen & Asesmen Kompetensi.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Perencanaan Audit Internal Sistem Manajemen K3",
  ...
  "indexable": true,
  "intent": "kompetensi perencanaan-audit-internal-sistem-manajemen-k3 syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp perencanaan audit internal sistem manajemen k3",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Perencanaan Audit Internal Sistem Manajemen K3",
