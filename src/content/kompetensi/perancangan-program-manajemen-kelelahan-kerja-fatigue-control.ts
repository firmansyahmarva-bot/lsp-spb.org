...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "perancangan-program-manajemen-kelelahan-kerja-fatigue-control",
  "title": "Skema Sertifikasi Kompetensi BNSP: Perancangan Program Manajemen Kelelahan Kerja (Fatigue Control)",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Perancangan Program Manajemen Kelelahan Kerja (Fatigue Control) | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Perancangan Program Manajemen Kelelahan Kerja (Fatigue Control): unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Perancangan Program Manajemen Kelelahan Kerja (Fatigue Control) adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Perancangan Program Manajemen Kelelahan Kerja (Fatigue Control) sesuai SKKNI Higiene Industri & Pemantauan Lingkungan Kerja.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Perancangan Program Manajemen Kelelahan Kerja (Fatigue Control)",
  ...
  "indexable": true,
  "intent": "kompetensi perancangan-program-manajemen-kelelahan-kerja-fatigue-control syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp perancangan program manajemen kelelahan kerja fatigue control",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Perancangan Program Manajemen Kelelahan Kerja (Fatigue Control)",
