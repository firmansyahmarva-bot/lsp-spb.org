...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "pengoperasian-mobile-crane-industri",
  "title": "Skema Sertifikasi Kompetensi BNSP: Pengoperasian Mobile Crane Industri",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Pengoperasian Mobile Crane Industri | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Pengoperasian Mobile Crane Industri: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Pengoperasian Mobile Crane Industri adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Pengoperasian Mobile Crane Industri sesuai SKKNI Pengoperasian Peralatan & Sarana K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Pengoperasian Mobile Crane Industri",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Pengoperasian Mobile Crane Industri",
      "paragraphs": [
        "Skema sertifikasi Pengoperasian Mobile Crane Industri mengacu pada ketetapan SKKNI Pengoperasian Peralatan & Sarana K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi pengoperasian-mobile-crane-industri syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp pengoperasian mobile crane industri",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Pengoperasian Mobile Crane Industri",
