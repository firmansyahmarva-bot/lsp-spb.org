...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "penggunaan-peralatan-proteksi-jatuh-akses-tali",
  "title": "Skema Sertifikasi Kompetensi BNSP: Penggunaan Peralatan Proteksi Jatuh & Akses Tali",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Penggunaan Peralatan Proteksi Jatuh & Akses Tali | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Penggunaan Peralatan Proteksi Jatuh & Akses Tali: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Penggunaan Peralatan Proteksi Jatuh & Akses Tali adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Penggunaan Peralatan Proteksi Jatuh & Akses Tali sesuai SKKNI Pengoperasian Peralatan & Sarana K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Penggunaan Peralatan Proteksi Jatuh & Akses Tali",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Penggunaan Peralatan Proteksi Jatuh & Akses Tali",
      "paragraphs": [
        "Skema sertifikasi Penggunaan Peralatan Proteksi Jatuh & Akses Tali mengacu pada ketetapan SKKNI Pengoperasian Peralatan & Sarana K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi penggunaan-peralatan-proteksi-jatuh-akses-tali syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp penggunaan peralatan proteksi jatuh akses tali",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Penggunaan Peralatan Proteksi Jatuh & Akses Tali",
