...
export const record: ContentRecord = {
  "section": "kompetensi",
  "slug": "perancangan-program-tanggap-darurat-kontinjensi-bencana-korporat",
  "title": "Skema Sertifikasi Kompetensi BNSP: Perancangan Program Tanggap Darurat & Kontinjensi Bencana Korporat",
  "metaTitle": "Skema Sertifikasi Kompetensi BNSP: Perancangan Program Tanggap Darurat & Kontinjensi Bencana Korporat | Uji Kompetensi BNSP",
  "description": "Panduan resmi skema sertifikasi kompetensi BNSP Perancangan Program Tanggap Darurat & Kontinjensi Bencana Korporat: unit kompetensi SKKNI, persyaratan portofolio bukti kerja, metode asesmen LSP, dan sertifikat berlogo Garuda.",
  "answer": "Skema Sertifikasi Kompetensi BNSP: Perancangan Program Tanggap Darurat & Kontinjensi Bencana Korporat adalah skema sertifikasi profesi berstandar nasional yang diselenggarakan melalui Lembaga Sertifikasi Profesi (LSP) berlisensi BNSP untuk memvalidasi keterampilan, pengetahuan kerja, dan sikap profesional tenaga kerja dalam Perancangan Program Tanggap Darurat & Kontinjensi Bencana Korporat sesuai SKKNI Analisis Rekayasa & Manajemen K3.",
  "highlights": [
    ...
    "syllabusModules": [
      {
        ...
        "topics": [
          "Penerapan Norma & Prosedur Kerja Perancangan Program Tanggap Darurat & Kontinjensi Bencana Korporat",
  ...
  "blocks": [
    {
      "heading": "Mengenal Skema Kompetensi Perancangan Program Tanggap Darurat & Kontinjensi Bencana Korporat",
      "paragraphs": [
        "Skema sertifikasi Perancangan Program Tanggap Darurat & Kontinjensi Bencana Korporat mengacu pada ketetapan SKKNI Analisis Rekayasa & Manajemen K3 dan regulasi ketenagakerjaan nasional. Skema ini dirancang khusus untuk memastikan bahwa tenaga kerja memiliki keterampilan praktis, pengetahuan regulasi, dan sikap kerja aman yang teruji secara objektif oleh Asesor Kompetensi berlisensi BNSP.",
  ...
  "indexable": true,
  "intent": "kompetensi perancangan-program-tanggap-darurat-kontinjensi-bencana-korporat syarat portofolio skkni bnsp",
  "primaryKeyword": "sertifikasi bnsp perancangan program tanggap darurat kontinjensi bencana korporat",
  "searchIntent": "syarat uji kompetensi, unit skkni, portofolio, dan pendaftaran Skema Sertifikasi Kompetensi BNSP: Perancangan Program Tanggap Darurat & Kontinjensi Bencana Korporat",
