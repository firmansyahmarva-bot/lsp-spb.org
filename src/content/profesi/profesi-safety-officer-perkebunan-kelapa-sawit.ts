...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-safety-officer-perkebunan-kelapa-sawit",
  "title": "Profesi Safety Officer Perkebunan Kelapa Sawit",
  "metaTitle": "Profesi Safety Officer Perkebunan Kelapa Sawit: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Safety Officer Perkebunan Kelapa Sawit: lingkup tugas operasional di Pengawasan Lapangan & Implementasi K3, wewenang hukum, estimasi gaji industri Rp 6.000.000 - Rp 15.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "blocks": [
    {
      "heading": "Peran & Tanggung Jawab Profesi Safety Officer Perkebunan Kelapa Sawit",
      "paragraphs": [
        "Posisi Profesi Safety Officer Perkebunan Kelapa Sawit memegang peranan krusial dalam menjamin operasional berjalan aman tanpa insiden (Zero Accident) di sektor Pengawasan Lapangan & Implementasi K3. Personel pada posisi ini bertanggung jawab mengidentifikasi bahaya spesifik, memantau penerapan SOP, dan mengawal kepatuhan tim lapangan.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Safety Officer Perkebunan Kelapa Sawit?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Safety Officer Perkebunan Kelapa Sawit?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Safety Officer Perkebunan Kelapa Sawit di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-safety-officer-perkebunan-kelapa-sawit tugas wewenang gaji syarat",
  "primaryKeyword": "profesi safety officer perkebunan kelapa sawit",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Safety Officer Perkebunan Kelapa Sawit",
