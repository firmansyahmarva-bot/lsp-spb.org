...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-auditor-sistem-manajemen-k3-migas",
  "title": "Profesi Auditor Sistem Manajemen K3 Migas",
  "metaTitle": "Profesi Auditor Sistem Manajemen K3 Migas: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Auditor Sistem Manajemen K3 Migas: lingkup tugas operasional di undefined, wewenang hukum, estimasi gaji industri Rp 10.000.000 - Rp 25.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Auditor Sistem Manajemen K3 Migas?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Auditor Sistem Manajemen K3 Migas?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Auditor Sistem Manajemen K3 Migas di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-auditor-sistem-manajemen-k3-migas tugas wewenang gaji syarat",
  "primaryKeyword": "profesi auditor sistem manajemen k3 migas",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Auditor Sistem Manajemen K3 Migas",
