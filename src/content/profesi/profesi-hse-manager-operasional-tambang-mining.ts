...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-hse-manager-operasional-tambang-mining",
  "title": "Profesi HSE Manager Operasional Tambang Mining",
  "metaTitle": "Profesi HSE Manager Operasional Tambang Mining: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi HSE Manager Operasional Tambang Mining: lingkup tugas operasional di Manajemen Strategis & Leadership K3, wewenang hukum, estimasi gaji industri Rp 16.000.000 - Rp 45.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "blocks": [
    {
      "heading": "Peran & Tanggung Jawab Profesi HSE Manager Operasional Tambang Mining",
      "paragraphs": [
        "Posisi Profesi HSE Manager Operasional Tambang Mining memegang peranan krusial dalam menjamin operasional berjalan aman tanpa insiden (Zero Accident) di sektor Manajemen Strategis & Leadership K3. Personel pada posisi ini bertanggung jawab mengidentifikasi bahaya spesifik, memantau penerapan SOP, dan mengawal kepatuhan tim lapangan.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi HSE Manager Operasional Tambang Mining?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi HSE Manager Operasional Tambang Mining?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi HSE Manager Operasional Tambang Mining di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-hse-manager-operasional-tambang-mining tugas wewenang gaji syarat",
  "primaryKeyword": "profesi hse manager operasional tambang mining",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi HSE Manager Operasional Tambang Mining",
