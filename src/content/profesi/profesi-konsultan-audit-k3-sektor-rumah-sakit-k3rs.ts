...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-konsultan-audit-k3-sektor-rumah-sakit-k3rs",
  "title": "Profesi Konsultan Audit K3 Sektor Rumah Sakit K3RS",
  "metaTitle": "Profesi Konsultan Audit K3 Sektor Rumah Sakit K3RS: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Konsultan Audit K3 Sektor Rumah Sakit K3RS: lingkup tugas operasional di undefined, wewenang hukum, estimasi gaji industri Rp 6.000.000 - Rp 15.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Konsultan Audit K3 Sektor Rumah Sakit K3RS?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Konsultan Audit K3 Sektor Rumah Sakit K3RS?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Konsultan Audit K3 Sektor Rumah Sakit K3RS di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-konsultan-audit-k3-sektor-rumah-sakit-k3rs tugas wewenang gaji syarat",
  "primaryKeyword": "profesi konsultan audit k3 sektor rumah sakit k3rs",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Konsultan Audit K3 Sektor Rumah Sakit K3RS",
