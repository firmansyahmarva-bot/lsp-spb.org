...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-hse-manager-proyek-konstruksi-epc",
  "title": "Profesi HSE Manager Proyek Konstruksi EPC",
  "metaTitle": "Profesi HSE Manager Proyek Konstruksi EPC: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi HSE Manager Proyek Konstruksi EPC: lingkup tugas operasional di Manajemen Strategis & Leadership K3, wewenang hukum, estimasi gaji industri Rp 16.000.000 - Rp 45.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "blocks": [
    {
      "heading": "Peran & Tanggung Jawab Profesi HSE Manager Proyek Konstruksi EPC",
      "paragraphs": [
        "Posisi Profesi HSE Manager Proyek Konstruksi EPC memegang peranan krusial dalam menjamin operasional berjalan aman tanpa insiden (Zero Accident) di sektor Manajemen Strategis & Leadership K3. Personel pada posisi ini bertanggung jawab mengidentifikasi bahaya spesifik, memantau penerapan SOP, dan mengawal kepatuhan tim lapangan.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi HSE Manager Proyek Konstruksi EPC?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi HSE Manager Proyek Konstruksi EPC?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi HSE Manager Proyek Konstruksi EPC di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-hse-manager-proyek-konstruksi-epc tugas wewenang gaji syarat",
  "primaryKeyword": "profesi hse manager proyek konstruksi epc",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi HSE Manager Proyek Konstruksi EPC",
