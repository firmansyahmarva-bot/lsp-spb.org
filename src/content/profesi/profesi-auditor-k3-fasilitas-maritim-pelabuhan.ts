...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-auditor-k3-fasilitas-maritim-pelabuhan",
  "title": "Profesi Auditor K3 Fasilitas Maritim Pelabuhan",
  "metaTitle": "Profesi Auditor K3 Fasilitas Maritim Pelabuhan: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Auditor K3 Fasilitas Maritim Pelabuhan: lingkup tugas operasional di undefined, wewenang hukum, estimasi gaji industri Rp 10.000.000 - Rp 25.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Auditor K3 Fasilitas Maritim Pelabuhan?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Auditor K3 Fasilitas Maritim Pelabuhan?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Auditor K3 Fasilitas Maritim Pelabuhan di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-auditor-k3-fasilitas-maritim-pelabuhan tugas wewenang gaji syarat",
  "primaryKeyword": "profesi auditor k3 fasilitas maritim pelabuhan",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Auditor K3 Fasilitas Maritim Pelabuhan",
