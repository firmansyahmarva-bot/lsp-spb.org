...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-teknisi-k3-deteksi-gas-kalibrasi",
  "title": "Profesi Teknisi K3 Deteksi Gas Kalibrasi",
  "metaTitle": "Profesi Teknisi K3 Deteksi Gas Kalibrasi: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Teknisi K3 Deteksi Gas Kalibrasi: lingkup tugas operasional di undefined, wewenang hukum, estimasi gaji industri Rp 6.000.000 - Rp 15.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "blocks": [
    ...
    },
    {
      ...
      "paragraphs": [
        "Berdasarkan survei remunerasi industri Indonesia, pendapatan untuk Profesi Teknisi K3 Deteksi Gas Kalibrasi berada pada rentang Rp 6.000.000 - Rp 15.000.000 / bulan. Besaran ini bervariasi bergantung pada skala risiko fasilitas, lokasi geografis (remote site allowance), serta sertifikasi lisensi yang dikuasai.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Teknisi K3 Deteksi Gas Kalibrasi?",
      "answer": "Pendidikan minimal D3/S1 teknik atau latar belakang relevan, memiliki sertifikat pembinaan K3 yang diakui pemerintah, dan memahami regulasi Regulasi Teknis Spesialis Kemnaker RI."
    },
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Teknisi K3 Deteksi Gas Kalibrasi?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Teknisi K3 Deteksi Gas Kalibrasi di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-teknisi-k3-deteksi-gas-kalibrasi tugas wewenang gaji syarat",
  "primaryKeyword": "profesi teknisi k3 deteksi gas kalibrasi",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Teknisi K3 Deteksi Gas Kalibrasi",
  "intentType": "informational",
  "parentTopic": "Profesi Teknisi K3 Spesialis",
  "cannibalizationGroup": "profesi-teknisi-k3",
