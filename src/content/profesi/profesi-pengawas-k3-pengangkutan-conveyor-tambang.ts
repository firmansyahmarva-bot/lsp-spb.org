...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-pengawas-k3-pengangkutan-conveyor-tambang",
  "title": "Profesi Pengawas K3 Pengangkutan Conveyor Tambang",
  "metaTitle": "Profesi Pengawas K3 Pengangkutan Conveyor Tambang: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Pengawas K3 Pengangkutan Conveyor Tambang: lingkup tugas operasional di undefined, wewenang hukum, estimasi gaji industri Rp 6.000.000 - Rp 15.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Pengawas K3 Pengangkutan Conveyor Tambang?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Pengawas K3 Pengangkutan Conveyor Tambang?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Pengawas K3 Pengangkutan Conveyor Tambang di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-pengawas-k3-pengangkutan-conveyor-tambang tugas wewenang gaji syarat",
  "primaryKeyword": "profesi pengawas k3 pengangkutan conveyor tambang",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Pengawas K3 Pengangkutan Conveyor Tambang",
