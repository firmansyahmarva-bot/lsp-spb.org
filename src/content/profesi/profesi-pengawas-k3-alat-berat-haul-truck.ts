...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-pengawas-k3-alat-berat-haul-truck",
  "title": "Profesi Pengawas K3 Alat Berat Haul Truck",
  "metaTitle": "Profesi Pengawas K3 Alat Berat Haul Truck: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Pengawas K3 Alat Berat Haul Truck: lingkup tugas operasional di undefined, wewenang hukum, estimasi gaji industri Rp 6.000.000 - Rp 15.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Pengawas K3 Alat Berat Haul Truck?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Pengawas K3 Alat Berat Haul Truck?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Pengawas K3 Alat Berat Haul Truck di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-pengawas-k3-alat-berat-haul-truck tugas wewenang gaji syarat",
  "primaryKeyword": "profesi pengawas k3 alat berat haul truck",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Pengawas K3 Alat Berat Haul Truck",
