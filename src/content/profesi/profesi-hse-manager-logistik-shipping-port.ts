...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-hse-manager-logistik-shipping-port",
  "title": "Profesi HSE Manager Logistik Shipping Port",
  "metaTitle": "Profesi HSE Manager Logistik Shipping Port: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi HSE Manager Logistik Shipping Port: lingkup tugas operasional di Manajemen Strategis & Leadership K3, wewenang hukum, estimasi gaji industri Rp 16.000.000 - Rp 45.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "blocks": [
    {
      "heading": "Peran & Tanggung Jawab Profesi HSE Manager Logistik Shipping Port",
      "paragraphs": [
        "Posisi Profesi HSE Manager Logistik Shipping Port memegang peranan krusial dalam menjamin operasional berjalan aman tanpa insiden (Zero Accident) di sektor Manajemen Strategis & Leadership K3. Personel pada posisi ini bertanggung jawab mengidentifikasi bahaya spesifik, memantau penerapan SOP, dan mengawal kepatuhan tim lapangan.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi HSE Manager Logistik Shipping Port?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi HSE Manager Logistik Shipping Port?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi HSE Manager Logistik Shipping Port di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-hse-manager-logistik-shipping-port tugas wewenang gaji syarat",
  "primaryKeyword": "profesi hse manager logistik shipping port",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi HSE Manager Logistik Shipping Port",
