...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-asesor-kompetensi-profesi-k3-bnsp",
  "title": "Profesi Asesor Kompetensi Profesi K3 BNSP",
  "metaTitle": "Profesi Asesor Kompetensi Profesi K3 BNSP: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Asesor Kompetensi Profesi K3 BNSP: lingkup tugas operasional di undefined, wewenang hukum, estimasi gaji industri Rp 6.000.000 - Rp 15.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Asesor Kompetensi Profesi K3 BNSP?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Asesor Kompetensi Profesi K3 BNSP?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Asesor Kompetensi Profesi K3 BNSP di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-asesor-kompetensi-profesi-k3-bnsp tugas wewenang gaji syarat",
  "primaryKeyword": "profesi asesor kompetensi profesi k3 bnsp",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Asesor Kompetensi Profesi K3 BNSP",
