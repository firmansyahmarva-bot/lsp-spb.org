...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-safety-officer-pekerjaan-confined-space",
  "title": "Profesi Safety Officer Pekerjaan Confined Space",
  "metaTitle": "Profesi Safety Officer Pekerjaan Confined Space: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Safety Officer Pekerjaan Confined Space: lingkup tugas operasional di Pengawasan Lapangan & Implementasi K3, wewenang hukum, estimasi gaji industri Rp 6.000.000 - Rp 15.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "blocks": [
    {
      "heading": "Peran & Tanggung Jawab Profesi Safety Officer Pekerjaan Confined Space",
      "paragraphs": [
        "Posisi Profesi Safety Officer Pekerjaan Confined Space memegang peranan krusial dalam menjamin operasional berjalan aman tanpa insiden (Zero Accident) di sektor Pengawasan Lapangan & Implementasi K3. Personel pada posisi ini bertanggung jawab mengidentifikasi bahaya spesifik, memantau penerapan SOP, dan mengawal kepatuhan tim lapangan.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Safety Officer Pekerjaan Confined Space?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Safety Officer Pekerjaan Confined Space?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Safety Officer Pekerjaan Confined Space di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-safety-officer-pekerjaan-confined-space tugas wewenang gaji syarat",
  "primaryKeyword": "profesi safety officer pekerjaan confined space",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Safety Officer Pekerjaan Confined Space",
