...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-hse-manager-industri-farmasi-medis",
  "title": "Profesi HSE Manager Industri Farmasi Medis",
  "metaTitle": "Profesi HSE Manager Industri Farmasi Medis: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi HSE Manager Industri Farmasi Medis: lingkup tugas operasional di Manajemen Strategis & Leadership K3, wewenang hukum, estimasi gaji industri Rp 16.000.000 - Rp 45.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "blocks": [
    {
      "heading": "Peran & Tanggung Jawab Profesi HSE Manager Industri Farmasi Medis",
      "paragraphs": [
        "Posisi Profesi HSE Manager Industri Farmasi Medis memegang peranan krusial dalam menjamin operasional berjalan aman tanpa insiden (Zero Accident) di sektor Manajemen Strategis & Leadership K3. Personel pada posisi ini bertanggung jawab mengidentifikasi bahaya spesifik, memantau penerapan SOP, dan mengawal kepatuhan tim lapangan.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi HSE Manager Industri Farmasi Medis?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi HSE Manager Industri Farmasi Medis?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi HSE Manager Industri Farmasi Medis di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-hse-manager-industri-farmasi-medis tugas wewenang gaji syarat",
  "primaryKeyword": "profesi hse manager industri farmasi medis",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi HSE Manager Industri Farmasi Medis",
