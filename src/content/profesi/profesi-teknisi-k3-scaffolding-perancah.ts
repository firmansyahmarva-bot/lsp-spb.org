...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-teknisi-k3-scaffolding-perancah",
  "title": "Profesi Teknisi K3 Scaffolding Perancah",
  "metaTitle": "Profesi Teknisi K3 Scaffolding Perancah: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Teknisi K3 Scaffolding Perancah: lingkup tugas operasional di undefined, wewenang hukum, estimasi gaji industri Rp 6.000.000 - Rp 15.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "blocks": [
    ...
    },
    {
      ...
      "paragraphs": [
        "Berdasarkan survei remunerasi industri Indonesia, pendapatan untuk Profesi Teknisi K3 Scaffolding Perancah berada pada rentang Rp 6.000.000 - Rp 15.000.000 / bulan. Besaran ini bervariasi bergantung pada skala risiko fasilitas, lokasi geografis (remote site allowance), serta sertifikasi lisensi yang dikuasai.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Teknisi K3 Scaffolding Perancah?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Teknisi K3 Scaffolding Perancah?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Teknisi K3 Scaffolding Perancah di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-teknisi-k3-scaffolding-perancah tugas wewenang gaji syarat",
  "primaryKeyword": "profesi teknisi k3 scaffolding perancah",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Teknisi K3 Scaffolding Perancah",
