...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-safety-inspector-riksa-uji-pjk3",
  "title": "Profesi Safety Inspector Riksa Uji PJK3",
  "metaTitle": "Profesi Safety Inspector Riksa Uji PJK3: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Safety Inspector Riksa Uji PJK3: lingkup tugas operasional di undefined, wewenang hukum, estimasi gaji industri Rp 10.000.000 - Rp 25.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "blocks": [
    ...
    },
    {
      ...
      "paragraphs": [
        "Berdasarkan survei remunerasi industri Indonesia, pendapatan untuk Profesi Safety Inspector Riksa Uji PJK3 berada pada rentang Rp 10.000.000 - Rp 25.000.000 / bulan. Besaran ini bervariasi bergantung pada skala risiko fasilitas, lokasi geografis (remote site allowance), serta sertifikasi lisensi yang dikuasai.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Safety Inspector Riksa Uji PJK3?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Safety Inspector Riksa Uji PJK3?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Safety Inspector Riksa Uji PJK3 di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-safety-inspector-riksa-uji-pjk3 tugas wewenang gaji syarat",
  "primaryKeyword": "profesi safety inspector riksa uji pjk3",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Safety Inspector Riksa Uji PJK3",
