...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-safety-officer-scaffolding-perancah",
  "title": "Profesi Safety Officer Scaffolding Perancah",
  "metaTitle": "Profesi Safety Officer Scaffolding Perancah: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Safety Officer Scaffolding Perancah: lingkup tugas operasional di Pengawasan Lapangan & Implementasi K3, wewenang hukum, estimasi gaji industri Rp 6.000.000 - Rp 15.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "blocks": [
    {
      "heading": "Peran & Tanggung Jawab Profesi Safety Officer Scaffolding Perancah",
      "paragraphs": [
        "Posisi Profesi Safety Officer Scaffolding Perancah memegang peranan krusial dalam menjamin operasional berjalan aman tanpa insiden (Zero Accident) di sektor Pengawasan Lapangan & Implementasi K3. Personel pada posisi ini bertanggung jawab mengidentifikasi bahaya spesifik, memantau penerapan SOP, dan mengawal kepatuhan tim lapangan.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Safety Officer Scaffolding Perancah?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Safety Officer Scaffolding Perancah?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Safety Officer Scaffolding Perancah di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-safety-officer-scaffolding-perancah tugas wewenang gaji syarat",
  "primaryKeyword": "profesi safety officer scaffolding perancah",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Safety Officer Scaffolding Perancah",
