...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-spesialis-penanganan-tumpahan-b3-spill-kit",
  "title": "Profesi Spesialis Penanganan Tumpahan B3 Spill Kit",
  "metaTitle": "Profesi Spesialis Penanganan Tumpahan B3 Spill Kit: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Spesialis Penanganan Tumpahan B3 Spill Kit: lingkup tugas operasional di undefined, wewenang hukum, estimasi gaji industri Rp 10.000.000 - Rp 25.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Spesialis Penanganan Tumpahan B3 Spill Kit?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Spesialis Penanganan Tumpahan B3 Spill Kit?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Spesialis Penanganan Tumpahan B3 Spill Kit di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-spesialis-penanganan-tumpahan-b3-spill-kit tugas wewenang gaji syarat",
  "primaryKeyword": "profesi spesialis penanganan tumpahan b3 spill kit",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Spesialis Penanganan Tumpahan B3 Spill Kit",
