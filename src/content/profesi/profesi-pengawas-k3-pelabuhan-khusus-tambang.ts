...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-pengawas-k3-pelabuhan-khusus-tambang",
  "title": "Profesi Pengawas K3 Pelabuhan Khusus Tambang",
  "metaTitle": "Profesi Pengawas K3 Pelabuhan Khusus Tambang: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Pengawas K3 Pelabuhan Khusus Tambang: lingkup tugas operasional di undefined, wewenang hukum, estimasi gaji industri Rp 6.000.000 - Rp 15.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Pengawas K3 Pelabuhan Khusus Tambang?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Pengawas K3 Pelabuhan Khusus Tambang?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Pengawas K3 Pelabuhan Khusus Tambang di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-pengawas-k3-pelabuhan-khusus-tambang tugas wewenang gaji syarat",
  "primaryKeyword": "profesi pengawas k3 pelabuhan khusus tambang",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Pengawas K3 Pelabuhan Khusus Tambang",
