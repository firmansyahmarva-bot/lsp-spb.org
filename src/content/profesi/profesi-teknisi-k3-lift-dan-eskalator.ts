...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-teknisi-k3-lift-dan-eskalator",
  "title": "Profesi Teknisi K3 Lift dan Eskalator",
  "metaTitle": "Profesi Teknisi K3 Lift dan Eskalator: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Teknisi K3 Lift dan Eskalator: lingkup tugas operasional di undefined, wewenang hukum, estimasi gaji industri Rp 6.000.000 - Rp 15.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "blocks": [
    ...
    },
    {
      ...
      "paragraphs": [
        "Berdasarkan survei remunerasi industri Indonesia, pendapatan untuk Profesi Teknisi K3 Lift dan Eskalator berada pada rentang Rp 6.000.000 - Rp 15.000.000 / bulan. Besaran ini bervariasi bergantung pada skala risiko fasilitas, lokasi geografis (remote site allowance), serta sertifikasi lisensi yang dikuasai.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Teknisi K3 Lift dan Eskalator?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Teknisi K3 Lift dan Eskalator?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Teknisi K3 Lift dan Eskalator di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-teknisi-k3-lift-dan-eskalator tugas wewenang gaji syarat",
  "primaryKeyword": "profesi teknisi k3 lift dan eskalator",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Teknisi K3 Lift dan Eskalator",
