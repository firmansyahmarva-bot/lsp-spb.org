...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-csms-manager-management-contractor",
  "title": "Profesi CSMS Manager Management Contractor",
  "metaTitle": "Profesi CSMS Manager Management Contractor: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi CSMS Manager Management Contractor: lingkup tugas operasional di Manajemen Strategis & Leadership K3, wewenang hukum, estimasi gaji industri Rp 16.000.000 - Rp 45.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "blocks": [
    {
      "heading": "Peran & Tanggung Jawab Profesi CSMS Manager Management Contractor",
      "paragraphs": [
        "Posisi Profesi CSMS Manager Management Contractor memegang peranan krusial dalam menjamin operasional berjalan aman tanpa insiden (Zero Accident) di sektor Manajemen Strategis & Leadership K3. Personel pada posisi ini bertanggung jawab mengidentifikasi bahaya spesifik, memantau penerapan SOP, dan mengawal kepatuhan tim lapangan.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi CSMS Manager Management Contractor?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi CSMS Manager Management Contractor?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi CSMS Manager Management Contractor di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-csms-manager-management-contractor tugas wewenang gaji syarat",
  "primaryKeyword": "profesi csms manager management contractor",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi CSMS Manager Management Contractor",
