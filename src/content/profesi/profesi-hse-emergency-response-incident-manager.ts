...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-hse-emergency-response-incident-manager",
  "title": "Profesi HSE Emergency Response Incident Manager",
  "metaTitle": "Profesi HSE Emergency Response Incident Manager: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi HSE Emergency Response Incident Manager: lingkup tugas operasional di Manajemen Strategis & Leadership K3, wewenang hukum, estimasi gaji industri Rp 16.000.000 - Rp 45.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "blocks": [
    {
      "heading": "Peran & Tanggung Jawab Profesi HSE Emergency Response Incident Manager",
      "paragraphs": [
        "Posisi Profesi HSE Emergency Response Incident Manager memegang peranan krusial dalam menjamin operasional berjalan aman tanpa insiden (Zero Accident) di sektor Manajemen Strategis & Leadership K3. Personel pada posisi ini bertanggung jawab mengidentifikasi bahaya spesifik, memantau penerapan SOP, dan mengawal kepatuhan tim lapangan.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi HSE Emergency Response Incident Manager?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi HSE Emergency Response Incident Manager?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi HSE Emergency Response Incident Manager di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-hse-emergency-response-incident-manager tugas wewenang gaji syarat",
  "primaryKeyword": "profesi hse emergency response incident manager",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi HSE Emergency Response Incident Manager",
