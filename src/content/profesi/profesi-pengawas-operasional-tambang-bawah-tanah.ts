...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-pengawas-operasional-tambang-bawah-tanah",
  "title": "Profesi Pengawas Operasional Tambang Bawah Tanah",
  "metaTitle": "Profesi Pengawas Operasional Tambang Bawah Tanah: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Pengawas Operasional Tambang Bawah Tanah: lingkup tugas operasional di undefined, wewenang hukum, estimasi gaji industri Rp 6.000.000 - Rp 15.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Pengawas Operasional Tambang Bawah Tanah?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Pengawas Operasional Tambang Bawah Tanah?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Pengawas Operasional Tambang Bawah Tanah di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-pengawas-operasional-tambang-bawah-tanah tugas wewenang gaji syarat",
  "primaryKeyword": "profesi pengawas operasional tambang bawah tanah",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Pengawas Operasional Tambang Bawah Tanah",
