...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-process-safety-management-psm-manager",
  "title": "Profesi Process Safety Management PSM Manager",
  "metaTitle": "Profesi Process Safety Management PSM Manager: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Process Safety Management PSM Manager: lingkup tugas operasional di Manajemen Strategis & Leadership K3, wewenang hukum, estimasi gaji industri Rp 16.000.000 - Rp 45.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "blocks": [
    {
      "heading": "Peran & Tanggung Jawab Profesi Process Safety Management PSM Manager",
      "paragraphs": [
        "Posisi Profesi Process Safety Management PSM Manager memegang peranan krusial dalam menjamin operasional berjalan aman tanpa insiden (Zero Accident) di sektor Manajemen Strategis & Leadership K3. Personel pada posisi ini bertanggung jawab mengidentifikasi bahaya spesifik, memantau penerapan SOP, dan mengawal kepatuhan tim lapangan.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Process Safety Management PSM Manager?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Process Safety Management PSM Manager?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Process Safety Management PSM Manager di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-process-safety-management-psm-manager tugas wewenang gaji syarat",
  "primaryKeyword": "profesi process safety management psm manager",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Process Safety Management PSM Manager",
