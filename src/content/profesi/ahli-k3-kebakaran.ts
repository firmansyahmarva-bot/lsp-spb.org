...
export const record: ContentRecord = {
  ...
  "metaTitle": "Profesi Ahli K3 Kebakaran (Kelas A): Tugas, Wewenang & Gaji Resmi",
  "description": "Profil lengkap Profesi Ahli K3 Kebakaran (Kelas A) di Indonesia: tugas operasional, wewenang hukum, kisaran gaji Rp 9.000.000 - Rp 22.000.000 / bulan, acuan Kepmenaker No. KEP.186/MEN/1999 Kelas A, dan alur penunjukan Kemnaker RI.",
  "answer": "Profesi Ahli K3 Kebakaran (Kelas A) adalah tenaga profesional keselamatan kerja resmi yang bertugas mengawasi ditaatinya norma K3 berdasarkan Permenaker No. PER.02/MEN/1992 & UU No. 1 Tahun 1970, memegang wewenang pengawasan hukum, dan menerima estimasi kompensasi industri berkisar Rp 9.000.000 - Rp 22.000.000 / bulan.",
  "highlights": [
    "Legalitas: Kepmenaker No. KEP.186/MEN/1999 Kelas A",
    "Kisaran Gaji Industri: Rp 9.000.000 - Rp 22.000.000 / bulan",
    "Wewenang: Stop Work Authority & Rekomendasi Manajemen Puncak",
    "Jalur Karir: Field Specialist -> Supervisor -> Corporate HSE Director"
  ],
  "blocks": [
    {
      "heading": "Kedudukan Hukum & Peran Strategis Profesi Ahli K3 Kebakaran (Kelas A)",
      "paragraphs": [
        "Profesi Ahli K3 Kebakaran (Kelas A) memegang posisi vital dalam struktur tata kelola keselamatan industri nasional. Berdasarkan Permenaker No. PER.02/MEN/1992 & UU No. 1 Tahun 1970, pemangku jabatan ini bertanggung jawab penuh untuk Perancangan dan pengawasan sistem proteksi kebakaran gedung/pabrik, perhitungan beban pemadaman hydrant/sprinkler, serta penyusunan Fire Emergency Plan..",
    ...
    },
    {
      ...
      "bullets": [
        "Wewenang mengaudit sistem proteksi aktif/pasif kebakaran dan menghentikan pengoperasian gedung yang tidak memiliki sistem evakuasi standar.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Untuk memperoleh penunjukan resmi (Kepmenaker No. KEP.186/MEN/1999 Kelas A), kandidat wajib memenuhi persyaratan ijazah formal D3/S1 teknik atau eksakta, mengiktui pembinaan resmi PJK3 terdaftar (seperti PT Kreasi Ultimate Berjaya), serta diajukan oleh perusahaan penugasan untuk penerbitan SKP & Lisensi Kewenangan."
      ]
    }
  ],
  "faqs": [
    {
      "question": "Apa perbedaan Ahli K3 Kebakaran Kelas A dengan Kelas B/C/D?",
      "answer": "Kelas A adalah tingkat tertinggi (Ahli Spesialis), sedangkan Kelas D (Petugas), Kelas C (Regu), dan Kelas B (Koordinator Unit)."
    },
    {
      "question": "Apakah Ahli K3 Kebakaran wajib menguasai NFPA Standards?",
      "answer": "Ya, wajib menguasai standar NFPA 10 (APAR), NFPA 13 (Sprinkler), NFPA 20 (Pompa Damkar), dan NFPA 72 (Alarm)."
    },
    {
      "question": "Berapa lama masa berlaku lisensi kewenangan Profesi Ahli K3 Kebakaran (Kelas A)?",
  ...
  "indexable": true,
  "intent": "profesi ahli-k3-kebakaran tugas wewenang gaji syarat",
  "primaryKeyword": "profesi ahli k3 kebakaran",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Ahli K3 Kebakaran (Kelas A)",
