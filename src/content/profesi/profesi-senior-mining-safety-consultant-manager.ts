...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-senior-mining-safety-consultant-manager",
  "title": "Profesi Senior Mining Safety Consultant Manager",
  "metaTitle": "Profesi Senior Mining Safety Consultant Manager: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Senior Mining Safety Consultant Manager: lingkup tugas operasional di undefined, wewenang hukum, estimasi gaji industri Rp 16.000.000 - Rp 45.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Senior Mining Safety Consultant Manager?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Senior Mining Safety Consultant Manager?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Senior Mining Safety Consultant Manager di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-senior-mining-safety-consultant-manager tugas wewenang gaji syarat",
  "primaryKeyword": "profesi senior mining safety consultant manager",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Senior Mining Safety Consultant Manager",
