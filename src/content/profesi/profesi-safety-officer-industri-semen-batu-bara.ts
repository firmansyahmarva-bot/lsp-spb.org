...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-safety-officer-industri-semen-batu-bara",
  "title": "Profesi Safety Officer Industri Semen Batu Bara",
  "metaTitle": "Profesi Safety Officer Industri Semen Batu Bara: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Safety Officer Industri Semen Batu Bara: lingkup tugas operasional di Pengawasan Lapangan & Implementasi K3, wewenang hukum, estimasi gaji industri Rp 6.000.000 - Rp 15.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "blocks": [
    {
      "heading": "Peran & Tanggung Jawab Profesi Safety Officer Industri Semen Batu Bara",
      "paragraphs": [
        "Posisi Profesi Safety Officer Industri Semen Batu Bara memegang peranan krusial dalam menjamin operasional berjalan aman tanpa insiden (Zero Accident) di sektor Pengawasan Lapangan & Implementasi K3. Personel pada posisi ini bertanggung jawab mengidentifikasi bahaya spesifik, memantau penerapan SOP, dan mengawal kepatuhan tim lapangan.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Safety Officer Industri Semen Batu Bara?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Safety Officer Industri Semen Batu Bara?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Safety Officer Industri Semen Batu Bara di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-safety-officer-industri-semen-batu-bara tugas wewenang gaji syarat",
  "primaryKeyword": "profesi safety officer industri semen batu bara",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Safety Officer Industri Semen Batu Bara",
