...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-senior-safety-risk-consulting-engineer",
  "title": "Profesi Senior Safety Risk Consulting Engineer",
  "metaTitle": "Profesi Senior Safety Risk Consulting Engineer: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Senior Safety Risk Consulting Engineer: lingkup tugas operasional di undefined, wewenang hukum, estimasi gaji industri Rp 9.500.000 - Rp 22.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Senior Safety Risk Consulting Engineer?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Senior Safety Risk Consulting Engineer?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Senior Safety Risk Consulting Engineer di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-senior-safety-risk-consulting-engineer tugas wewenang gaji syarat",
  "primaryKeyword": "profesi senior safety risk consulting engineer",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Senior Safety Risk Consulting Engineer",
