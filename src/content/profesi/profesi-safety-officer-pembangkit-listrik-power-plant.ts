...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-safety-officer-pembangkit-listrik-power-plant",
  "title": "Profesi Safety Officer Pembangkit Listrik Power Plant",
  "metaTitle": "Profesi Safety Officer Pembangkit Listrik Power Plant: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Safety Officer Pembangkit Listrik Power Plant: lingkup tugas operasional di Pengawasan Lapangan & Implementasi K3, wewenang hukum, estimasi gaji industri Rp 6.000.000 - Rp 15.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "blocks": [
    {
      "heading": "Peran & Tanggung Jawab Profesi Safety Officer Pembangkit Listrik Power Plant",
      "paragraphs": [
        "Posisi Profesi Safety Officer Pembangkit Listrik Power Plant memegang peranan krusial dalam menjamin operasional berjalan aman tanpa insiden (Zero Accident) di sektor Pengawasan Lapangan & Implementasi K3. Personel pada posisi ini bertanggung jawab mengidentifikasi bahaya spesifik, memantau penerapan SOP, dan mengawal kepatuhan tim lapangan.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Safety Officer Pembangkit Listrik Power Plant?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Safety Officer Pembangkit Listrik Power Plant?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Safety Officer Pembangkit Listrik Power Plant di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-safety-officer-pembangkit-listrik-power-plant tugas wewenang gaji syarat",
  "primaryKeyword": "profesi safety officer pembangkit listrik power plant",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Safety Officer Pembangkit Listrik Power Plant",
