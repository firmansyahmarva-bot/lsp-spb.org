...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-hse-manager-pembangkit-listrik-energi",
  "title": "Profesi HSE Manager Pembangkit Listrik Energi",
  "metaTitle": "Profesi HSE Manager Pembangkit Listrik Energi: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi HSE Manager Pembangkit Listrik Energi: lingkup tugas operasional di Manajemen Strategis & Leadership K3, wewenang hukum, estimasi gaji industri Rp 16.000.000 - Rp 45.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "blocks": [
    {
      "heading": "Peran & Tanggung Jawab Profesi HSE Manager Pembangkit Listrik Energi",
      "paragraphs": [
        "Posisi Profesi HSE Manager Pembangkit Listrik Energi memegang peranan krusial dalam menjamin operasional berjalan aman tanpa insiden (Zero Accident) di sektor Manajemen Strategis & Leadership K3. Personel pada posisi ini bertanggung jawab mengidentifikasi bahaya spesifik, memantau penerapan SOP, dan mengawal kepatuhan tim lapangan.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi HSE Manager Pembangkit Listrik Energi?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi HSE Manager Pembangkit Listrik Energi?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi HSE Manager Pembangkit Listrik Energi di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-hse-manager-pembangkit-listrik-energi tugas wewenang gaji syarat",
  "primaryKeyword": "profesi hse manager pembangkit listrik energi",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi HSE Manager Pembangkit Listrik Energi",
