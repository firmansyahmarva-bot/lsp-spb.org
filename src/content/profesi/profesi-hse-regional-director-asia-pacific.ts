...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-hse-regional-director-asia-pacific",
  "title": "Profesi HSE Regional Director Asia Pacific",
  "metaTitle": "Profesi HSE Regional Director Asia Pacific: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi HSE Regional Director Asia Pacific: lingkup tugas operasional di Manajemen Strategis & Leadership K3, wewenang hukum, estimasi gaji industri Rp 16.000.000 - Rp 45.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "blocks": [
    {
      "heading": "Peran & Tanggung Jawab Profesi HSE Regional Director Asia Pacific",
      "paragraphs": [
        "Posisi Profesi HSE Regional Director Asia Pacific memegang peranan krusial dalam menjamin operasional berjalan aman tanpa insiden (Zero Accident) di sektor Manajemen Strategis & Leadership K3. Personel pada posisi ini bertanggung jawab mengidentifikasi bahaya spesifik, memantau penerapan SOP, dan mengawal kepatuhan tim lapangan.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi HSE Regional Director Asia Pacific?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi HSE Regional Director Asia Pacific?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi HSE Regional Director Asia Pacific di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-hse-regional-director-asia-pacific tugas wewenang gaji syarat",
  "primaryKeyword": "profesi hse regional director asia pacific",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi HSE Regional Director Asia Pacific",
