...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-hse-manager-fasilitas-kilang-migas",
  "title": "Profesi HSE Manager Fasilitas Kilang Migas",
  "metaTitle": "Profesi HSE Manager Fasilitas Kilang Migas: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi HSE Manager Fasilitas Kilang Migas: lingkup tugas operasional di Manajemen Strategis & Leadership K3, wewenang hukum, estimasi gaji industri Rp 16.000.000 - Rp 45.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "blocks": [
    {
      "heading": "Peran & Tanggung Jawab Profesi HSE Manager Fasilitas Kilang Migas",
      "paragraphs": [
        "Posisi Profesi HSE Manager Fasilitas Kilang Migas memegang peranan krusial dalam menjamin operasional berjalan aman tanpa insiden (Zero Accident) di sektor Manajemen Strategis & Leadership K3. Personel pada posisi ini bertanggung jawab mengidentifikasi bahaya spesifik, memantau penerapan SOP, dan mengawal kepatuhan tim lapangan.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi HSE Manager Fasilitas Kilang Migas?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi HSE Manager Fasilitas Kilang Migas?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi HSE Manager Fasilitas Kilang Migas di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-hse-manager-fasilitas-kilang-migas tugas wewenang gaji syarat",
  "primaryKeyword": "profesi hse manager fasilitas kilang migas",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi HSE Manager Fasilitas Kilang Migas",
