...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-paramedis-lapangan-remote-site-tambang",
  "title": "Profesi Paramedis Lapangan Remote Site Tambang",
  "metaTitle": "Profesi Paramedis Lapangan Remote Site Tambang: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Paramedis Lapangan Remote Site Tambang: lingkup tugas operasional di undefined, wewenang hukum, estimasi gaji industri Rp 6.000.000 - Rp 15.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Paramedis Lapangan Remote Site Tambang?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Paramedis Lapangan Remote Site Tambang?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Paramedis Lapangan Remote Site Tambang di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-paramedis-lapangan-remote-site-tambang tugas wewenang gaji syarat",
  "primaryKeyword": "profesi paramedis lapangan remote site tambang",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Paramedis Lapangan Remote Site Tambang",
