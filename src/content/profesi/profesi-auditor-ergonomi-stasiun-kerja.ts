...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-auditor-ergonomi-stasiun-kerja",
  "title": "Profesi Auditor Ergonomi Stasiun Kerja",
  "metaTitle": "Profesi Auditor Ergonomi Stasiun Kerja: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Auditor Ergonomi Stasiun Kerja: lingkup tugas operasional di undefined, wewenang hukum, estimasi gaji industri Rp 10.000.000 - Rp 25.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "blocks": [
    ...
    },
    {
      ...
      "paragraphs": [
        "Berdasarkan survei remunerasi industri Indonesia, pendapatan untuk Profesi Auditor Ergonomi Stasiun Kerja berada pada rentang Rp 10.000.000 - Rp 25.000.000 / bulan. Besaran ini bervariasi bergantung pada skala risiko fasilitas, lokasi geografis (remote site allowance), serta sertifikasi lisensi yang dikuasai.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Auditor Ergonomi Stasiun Kerja?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Auditor Ergonomi Stasiun Kerja?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Auditor Ergonomi Stasiun Kerja di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-auditor-ergonomi-stasiun-kerja tugas wewenang gaji syarat",
  "primaryKeyword": "profesi auditor ergonomi stasiun kerja",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Auditor Ergonomi Stasiun Kerja",
