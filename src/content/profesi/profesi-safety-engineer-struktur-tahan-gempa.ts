...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-safety-engineer-struktur-tahan-gempa",
  "title": "Profesi Safety Engineer Struktur Tahan Gempa",
  "metaTitle": "Profesi Safety Engineer Struktur Tahan Gempa: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Safety Engineer Struktur Tahan Gempa: lingkup tugas operasional di undefined, wewenang hukum, estimasi gaji industri Rp 9.500.000 - Rp 22.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Safety Engineer Struktur Tahan Gempa?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Safety Engineer Struktur Tahan Gempa?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Safety Engineer Struktur Tahan Gempa di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-safety-engineer-struktur-tahan-gempa tugas wewenang gaji syarat",
  "primaryKeyword": "profesi safety engineer struktur tahan gempa",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Safety Engineer Struktur Tahan Gempa",
