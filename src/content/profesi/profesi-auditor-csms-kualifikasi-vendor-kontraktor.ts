...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-auditor-csms-kualifikasi-vendor-kontraktor",
  "title": "Profesi Auditor CSMS Kualifikasi Vendor Kontraktor",
  "metaTitle": "Profesi Auditor CSMS Kualifikasi Vendor Kontraktor: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Auditor CSMS Kualifikasi Vendor Kontraktor: lingkup tugas operasional di undefined, wewenang hukum, estimasi gaji industri Rp 10.000.000 - Rp 25.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Auditor CSMS Kualifikasi Vendor Kontraktor?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Auditor CSMS Kualifikasi Vendor Kontraktor?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Auditor CSMS Kualifikasi Vendor Kontraktor di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-auditor-csms-kualifikasi-vendor-kontraktor tugas wewenang gaji syarat",
  "primaryKeyword": "profesi auditor csms kualifikasi vendor kontraktor",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Auditor CSMS Kualifikasi Vendor Kontraktor",
