...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-pengawas-operasional-pertama-pop-tambang",
  "title": "Profesi Pengawas Operasional Pertama POP Tambang",
  "metaTitle": "Profesi Pengawas Operasional Pertama POP Tambang: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Pengawas Operasional Pertama POP Tambang: lingkup tugas operasional di undefined, wewenang hukum, estimasi gaji industri Rp 6.000.000 - Rp 15.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Pengawas Operasional Pertama POP Tambang?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Pengawas Operasional Pertama POP Tambang?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Pengawas Operasional Pertama POP Tambang di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-pengawas-operasional-pertama-pop-tambang tugas wewenang gaji syarat",
  "primaryKeyword": "profesi pengawas operasional pertama pop tambang",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Pengawas Operasional Pertama POP Tambang",
