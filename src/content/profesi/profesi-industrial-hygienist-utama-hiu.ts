...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-industrial-hygienist-utama-hiu",
  "title": "Profesi Industrial Hygienist Utama HIU",
  "metaTitle": "Profesi Industrial Hygienist Utama HIU: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Industrial Hygienist Utama HIU: lingkup tugas operasional di undefined, wewenang hukum, estimasi gaji industri Rp 6.000.000 - Rp 15.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "blocks": [
    ...
    },
    {
      ...
      "paragraphs": [
        "Berdasarkan survei remunerasi industri Indonesia, pendapatan untuk Profesi Industrial Hygienist Utama HIU berada pada rentang Rp 6.000.000 - Rp 15.000.000 / bulan. Besaran ini bervariasi bergantung pada skala risiko fasilitas, lokasi geografis (remote site allowance), serta sertifikasi lisensi yang dikuasai.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Industrial Hygienist Utama HIU?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Industrial Hygienist Utama HIU?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Industrial Hygienist Utama HIU di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-industrial-hygienist-utama-hiu tugas wewenang gaji syarat",
  "primaryKeyword": "profesi industrial hygienist utama hiu",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Industrial Hygienist Utama HIU",
