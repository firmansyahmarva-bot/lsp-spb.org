...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-safety-officer-anjungan-migas-offshore",
  "title": "Profesi Safety Officer Anjungan Migas Offshore",
  "metaTitle": "Profesi Safety Officer Anjungan Migas Offshore: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Safety Officer Anjungan Migas Offshore: lingkup tugas operasional di Pengawasan Lapangan & Implementasi K3, wewenang hukum, estimasi gaji industri Rp 6.000.000 - Rp 15.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "blocks": [
    {
      "heading": "Peran & Tanggung Jawab Profesi Safety Officer Anjungan Migas Offshore",
      "paragraphs": [
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Safety Officer Anjungan Migas Offshore?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Safety Officer Anjungan Migas Offshore?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Safety Officer Anjungan Migas Offshore di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-safety-officer-anjungan-migas-offshore tugas wewenang gaji syarat",
  "primaryKeyword": "profesi safety officer anjungan migas offshore",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Safety Officer Anjungan Migas Offshore",
