...
export const record: ContentRecord = {
  "section": "profesi",
  "slug": "profesi-auditor-higiene-sanitasi-kantin-pekerja",
  "title": "Profesi Auditor Higiene Sanitasi Kantin Pekerja",
  "metaTitle": "Profesi Auditor Higiene Sanitasi Kantin Pekerja: Tugas, Gaji & Kualifikasi",
  "description": "Profil lengkap Profesi Auditor Higiene Sanitasi Kantin Pekerja: lingkup tugas operasional di undefined, wewenang hukum, estimasi gaji industri Rp 10.000.000 - Rp 25.000.000 / bulan, dan syarat sertifikasi.",
  ...
  "faqs": [
    {
      "question": "Apa syarat utama untuk bekerja sebagai Profesi Auditor Higiene Sanitasi Kantin Pekerja?",
    ...
    {
      "question": "Sertifikasi apa yang paling direkomendasikan untuk Profesi Auditor Higiene Sanitasi Kantin Pekerja?",
    ...
    {
      "question": "Bagaimana peluang kerja Profesi Auditor Higiene Sanitasi Kantin Pekerja di Indonesia?",
  ...
  "indexable": true,
  "intent": "profesi profesi-auditor-higiene-sanitasi-kantin-pekerja tugas wewenang gaji syarat",
  "primaryKeyword": "profesi auditor higiene sanitasi kantin pekerja",
  "searchIntent": "tugas, wewenang hukum, kisaran gaji, dan syarat profesi Profesi Auditor Higiene Sanitasi Kantin Pekerja",
