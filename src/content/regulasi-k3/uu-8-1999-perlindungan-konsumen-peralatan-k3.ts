...
export const record: ContentRecord = {
  "section": "regulasi-k3",
  "slug": "uu-8-1999-perlindungan-konsumen-peralatan-k3",
  "title": "UU No. 8 Tahun 1999 tentang Perlindungan Konsumen (Mutu Peralatan Safety)",
  "metaTitle": "UU No. 8 Tahun 1999 tentang Perlindungan Konsumen (Mutu Peralatan Safety) | Status & Kepatuhan K3",
  "description": "Ulasan hukum resmi UU No. 8 Tahun 1999 tentang Perlindungan Konsumen (Mutu Peralatan Safety): status Wajib Secara Hukum di Indonesia (Mandatory Statutory Law), lingkup kewajiban Tanggung jawab produsen dan importir APD terhadap jaminan mutu dan sertifikasi uji, dampak kepatuhan, dan panduan audit SMK3.",
  "answer": "UU No. 8 Tahun 1999 tentang Perlindungan Konsumen (Mutu Peralatan Safety) yang diterbitkan oleh Pemerintah RI (1999) memiliki status Wajib Secara Hukum di Indonesia (Mandatory Statutory Law). Dokumen ini mencakup Tanggung jawab produsen dan importir APD terhadap jaminan mutu dan sertifikasi uji dan berfungsi sebagai peraturan perundang-undangan positif yang mengikat secara hukum bagi seluruh tempat kerja di wilayah Negara Kesatuan Republik Indonesia di Indonesia.",
  "highlights": [
    "Instansi Penerbit: Pemerintah RI",
    "Tahun Pengundangan / Rilis: 1999",
    "Ruang Lingkup: Tanggung jawab produsen dan importir APD terhadap jaminan mutu dan sertifikasi uji",
    "Status Hukum: Wajib Secara Hukum di Indonesia (Mandatory Statutory Law)"
  ],
  "blocks": [
    {
      "heading": "Status Yuridis & Ruang Lingkup UU No. 8 Tahun 1999 tentang Perlindungan Konsumen (Mutu Peralatan Safety)",
      "paragraphs": [
  ...
  "faqs": [
    {
      "question": "Apakah UU No. 8 Tahun 1999 tentang Perlindungan Konsumen (Mutu Peralatan Safety) wajib diterapkan oleh seluruh perusahaan di Indonesia?",
    ...
    {
      "question": "Siapa yang berwenang melakukan pengawasan penegakan UU No. 8 Tahun 1999 tentang Perlindungan Konsumen (Mutu Peralatan Safety)?",
    ...
    {
      "question": "Dokumen apa yang membuktikan kepatuhan terhadap UU No. 8 Tahun 1999 tentang Perlindungan Konsumen (Mutu Peralatan Safety)?",
  ...
  "indexable": true,
  "intent": "regulasi k3 uu-8-1999-perlindungan-konsumen-peralatan-k3 pasal kepatuhan hukum audit",
  "primaryKeyword": "uu 8 1999 perlindungan konsumen peralatan k3 kepatuhan k3",
  "searchIntent": "isi pasal, kewajiban kepatuhan hukum, status, dan audit UU No. 8 Tahun 1999 tentang Perlindungan Konsumen (Mutu Peralatan Safety)",
