...
export const record: ContentRecord = {
  "section": "regulasi-k3",
  "slug": "se-12-2024-pengawasan-k3-fasilitas-pengolahan-limbah-ipal",
  "title": "SE Menaker tentang Keselamatan Bekerja di Kolam IPAL & Bahaya Gas H2S / Metana",
  "metaTitle": "SE Menaker tentang Keselamatan Bekerja di Kolam IPAL & Bahaya Gas H2S / Metana | Status & Kepatuhan K3",
  "description": "Ulasan hukum resmi SE Menaker tentang Keselamatan Bekerja di Kolam IPAL & Bahaya Gas H2S / Metana: status Wajib Secara Hukum di Indonesia (Mandatory Statutory Law), lingkup kewajiban Kewajiban detektor gas 4-in-1, tali penyelamat lifeline, dan pelampung keselamatan air, dampak kepatuhan, dan panduan audit SMK3.",
  "answer": "SE Menaker tentang Keselamatan Bekerja di Kolam IPAL & Bahaya Gas H2S / Metana yang diterbitkan oleh Kemnaker RI (2024) memiliki status Wajib Secara Hukum di Indonesia (Mandatory Statutory Law). Dokumen ini mencakup Kewajiban detektor gas 4-in-1, tali penyelamat lifeline, dan pelampung keselamatan air dan berfungsi sebagai peraturan perundang-undangan positif yang mengikat secara hukum bagi seluruh tempat kerja di wilayah Negara Kesatuan Republik Indonesia di Indonesia.",
  "highlights": [
    "Instansi Penerbit: Kemnaker RI",
    "Tahun Pengundangan / Rilis: 2024",
    "Ruang Lingkup: Kewajiban detektor gas 4-in-1, tali penyelamat lifeline, dan pelampung keselamatan air",
    "Status Hukum: Wajib Secara Hukum di Indonesia (Mandatory Statutory Law)"
  ],
  "blocks": [
    {
      "heading": "Status Yuridis & Ruang Lingkup SE Menaker tentang Keselamatan Bekerja di Kolam IPAL & Bahaya Gas H2S / Metana",
      "paragraphs": [
  ...
  "faqs": [
    {
      "question": "Apakah SE Menaker tentang Keselamatan Bekerja di Kolam IPAL & Bahaya Gas H2S / Metana wajib diterapkan oleh seluruh perusahaan di Indonesia?",
    ...
    {
      "question": "Siapa yang berwenang melakukan pengawasan penegakan SE Menaker tentang Keselamatan Bekerja di Kolam IPAL & Bahaya Gas H2S / Metana?",
    ...
    {
      "question": "Dokumen apa yang membuktikan kepatuhan terhadap SE Menaker tentang Keselamatan Bekerja di Kolam IPAL & Bahaya Gas H2S / Metana?",
  ...
  "indexable": true,
  "intent": "regulasi k3 se-12-2024-pengawasan-k3-fasilitas-pengolahan-limbah-ipal pasal kepatuhan hukum audit",
  "primaryKeyword": "se 12 2024 pengawasan k3 fasilitas pengolahan limbah ipal kepatuhan k3",
  "searchIntent": "isi pasal, kewajiban kepatuhan hukum, status, dan audit SE Menaker tentang Keselamatan Bekerja di Kolam IPAL & Bahaya Gas H2S / Metana",
