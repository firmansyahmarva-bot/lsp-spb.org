...
export const record: ContentRecord = {
  "section": "regulasi-k3",
  "slug": "se-02-2025-integrasi-data-kecelakaan-bpjs-kemnaker-v2",
  "title": "SE Bersama Dirjen Binwasnaker & BPJS Integrasi Data Klaim Kecelakaan Kerja",
  "metaTitle": "SE Bersama Dirjen Binwasnaker & BPJS Integrasi Data Klaim Kecelakaan Kerja | Status & Kepatuhan K3",
  "description": "Ulasan hukum resmi SE Bersama Dirjen Binwasnaker & BPJS Integrasi Data Klaim Kecelakaan Kerja: status Wajib Secara Hukum di Indonesia (Mandatory Statutory Law), lingkup kewajiban Sinkronisasi pelaporan formulir kecelakaan tahap I dan tahap II secara real-time digital, dampak kepatuhan, dan panduan audit SMK3.",
  "answer": "SE Bersama Dirjen Binwasnaker & BPJS Integrasi Data Klaim Kecelakaan Kerja yang diterbitkan oleh Kemnaker RI (2025) memiliki status Wajib Secara Hukum di Indonesia (Mandatory Statutory Law). Dokumen ini mencakup Sinkronisasi pelaporan formulir kecelakaan tahap I dan tahap II secara real-time digital dan berfungsi sebagai peraturan perundang-undangan positif yang mengikat secara hukum bagi seluruh tempat kerja di wilayah Negara Kesatuan Republik Indonesia di Indonesia.",
  "highlights": [
    "Instansi Penerbit: Kemnaker RI",
    "Tahun Pengundangan / Rilis: 2025",
    "Ruang Lingkup: Sinkronisasi pelaporan formulir kecelakaan tahap I dan tahap II secara real-time digital",
    "Status Hukum: Wajib Secara Hukum di Indonesia (Mandatory Statutory Law)"
  ],
  "blocks": [
    {
      "heading": "Status Yuridis & Ruang Lingkup SE Bersama Dirjen Binwasnaker & BPJS Integrasi Data Klaim Kecelakaan Kerja",
      "paragraphs": [
  ...
  "faqs": [
    {
      "question": "Apakah SE Bersama Dirjen Binwasnaker & BPJS Integrasi Data Klaim Kecelakaan Kerja wajib diterapkan oleh seluruh perusahaan di Indonesia?",
    ...
    {
      "question": "Siapa yang berwenang melakukan pengawasan penegakan SE Bersama Dirjen Binwasnaker & BPJS Integrasi Data Klaim Kecelakaan Kerja?",
    ...
    {
      "question": "Dokumen apa yang membuktikan kepatuhan terhadap SE Bersama Dirjen Binwasnaker & BPJS Integrasi Data Klaim Kecelakaan Kerja?",
  ...
  "indexable": true,
  "intent": "regulasi k3 se-02-2025-integrasi-data-kecelakaan-bpjs-kemnaker-v2 pasal kepatuhan hukum audit",
  "primaryKeyword": "se 02 2025 integrasi data kecelakaan bpjs kemnaker v2 kepatuhan k3",
  "searchIntent": "isi pasal, kewajiban kepatuhan hukum, status, dan audit SE Bersama Dirjen Binwasnaker & BPJS Integrasi Data Klaim Kecelakaan Kerja",
