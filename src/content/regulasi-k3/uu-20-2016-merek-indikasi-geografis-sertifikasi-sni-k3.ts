...
export const record: ContentRecord = {
  "section": "regulasi-k3",
  "slug": "uu-20-2016-merek-indikasi-geografis-sertifikasi-sni-k3",
  "title": "Standar Regulasi Penggunaan Tanda SNI pada Peralatan Keselamatan Kerja",
  "metaTitle": "Standar Regulasi Penggunaan Tanda SNI pada Peralatan Keselamatan Kerja | Status & Kepatuhan K3",
  "description": "Ulasan hukum resmi Standar Regulasi Penggunaan Tanda SNI pada Peralatan Keselamatan Kerja: status Wajib Secara Hukum di Indonesia (Mandatory Statutory Law), lingkup kewajiban Perlindungan konsumen dan pekerja terhadap pemalsuan peralatan keselamatan APD, dampak kepatuhan, dan panduan audit SMK3.",
  "answer": "Standar Regulasi Penggunaan Tanda SNI pada Peralatan Keselamatan Kerja yang diterbitkan oleh Pemerintah RI (2016) memiliki status Wajib Secara Hukum di Indonesia (Mandatory Statutory Law). Dokumen ini mencakup Perlindungan konsumen dan pekerja terhadap pemalsuan peralatan keselamatan APD dan berfungsi sebagai peraturan perundang-undangan positif yang mengikat secara hukum bagi seluruh tempat kerja di wilayah Negara Kesatuan Republik Indonesia di Indonesia.",
  "highlights": [
    "Instansi Penerbit: Pemerintah RI",
    "Tahun Pengundangan / Rilis: 2016",
    "Ruang Lingkup: Perlindungan konsumen dan pekerja terhadap pemalsuan peralatan keselamatan APD",
    "Status Hukum: Wajib Secara Hukum di Indonesia (Mandatory Statutory Law)"
  ],
  "blocks": [
    {
      "heading": "Status Yuridis & Ruang Lingkup Standar Regulasi Penggunaan Tanda SNI pada Peralatan Keselamatan Kerja",
      "paragraphs": [
  ...
  "faqs": [
    {
      "question": "Apakah Standar Regulasi Penggunaan Tanda SNI pada Peralatan Keselamatan Kerja wajib diterapkan oleh seluruh perusahaan di Indonesia?",
    ...
    {
      "question": "Siapa yang berwenang melakukan pengawasan penegakan Standar Regulasi Penggunaan Tanda SNI pada Peralatan Keselamatan Kerja?",
    ...
    {
      "question": "Dokumen apa yang membuktikan kepatuhan terhadap Standar Regulasi Penggunaan Tanda SNI pada Peralatan Keselamatan Kerja?",
  ...
  "indexable": true,
  "intent": "regulasi k3 uu-20-2016-merek-indikasi-geografis-sertifikasi-sni-k3 pasal kepatuhan hukum audit",
  "primaryKeyword": "uu 20 2016 merek indikasi geografis sertifikasi sni k3 kepatuhan k3",
  "searchIntent": "isi pasal, kewajiban kepatuhan hukum, status, dan audit Standar Regulasi Penggunaan Tanda SNI pada Peralatan Keselamatan Kerja",
