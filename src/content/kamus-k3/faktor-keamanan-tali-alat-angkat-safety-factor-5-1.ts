...
export const record: ContentRecord = {
  "section": "kamus-k3",
  "slug": "faktor-keamanan-tali-alat-angkat-safety-factor-5-1",
  "title": "Faktor Keamanan Tali & Alat Angkat (Safety Factor 5:1)",
  "metaTitle": "Faktor Keamanan Tali & Alat Angkat (Safety Factor 5:1): Definisi, Rumus & Standar K3",
  "description": "Penjelasan lengkap Faktor Keamanan Tali & Alat Angkat (Safety Factor 5:1) dalam domain Keselamatan Listrik & Mekanikal Industri: pengertian, prinsip rekayasa keselamatan, dasar hukum Permenaker No. 12/2015, Permenaker No. 38/2016 & PUIL 2020, dan implementasi mitigasi di industri.",
  "answer": "Faktor Keamanan Tali & Alat Angkat (Safety Factor 5:1) adalah parameter, metodologi, dan standar teknis fundamental dalam domain Keselamatan Listrik & Mekanikal Industri yang diterapkan untuk mengidentifikasi potensi kegagalan sistem, mengukur paparan bahaya, serta menetapkan kontrol rekayasa dan kepatuhan hukum berdasarkan Permenaker No. 12/2015, Permenaker No. 38/2016 & PUIL 2020.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Konsep & Definisi Teknis Faktor Keamanan Tali & Alat Angkat (Safety Factor 5:1)",
      "paragraphs": [
  ...
  "faqs": [
    {
      "question": "Mengapa Faktor Keamanan Tali & Alat Angkat (Safety Factor 5:1) krusial dipahami dalam manajemen risiko K3?",
      "answer": "Karena Faktor Keamanan Tali & Alat Angkat (Safety Factor 5:1) menjadi dasar ilmiah dalam mendeteksi potensi bahaya, menghitung skor risiko, dan menentukan langkah mitigasi rekayasa yang terukur di tempat kerja."
    },
    {
      "question": "Regulasi apa yang menjadi rujukan kepatuhan terkait Faktor Keamanan Tali & Alat Angkat (Safety Factor 5:1)?",
    ...
    {
      "question": "Bagaimana cara menguji atau mengukur pemenuhan Faktor Keamanan Tali & Alat Angkat (Safety Factor 5:1) di lapangan?",
  ...
  "indexable": true,
  "intent": "kamus k3 faktor-keamanan-tali-alat-angkat-safety-factor-5-1 definisi rumus standar penerapan",
  "primaryKeyword": "faktor keamanan tali alat angkat safety factor 5 1 k3",
  "searchIntent": "pengertian, rumus, standar teknis, dan penerapan Faktor Keamanan Tali & Alat Angkat (Safety Factor 5:1)",
