...
export const record: ContentRecord = {
  "section": "kamus-k3",
  "slug": "pemutus-sirkuit-udara-air-circuit-breaker-acb",
  "title": "Pemutus Sirkuit Udara (Air Circuit Breaker - ACB)",
  "metaTitle": "Pemutus Sirkuit Udara (Air Circuit Breaker - ACB): Definisi, Rumus & Standar K3",
  "description": "Penjelasan lengkap Pemutus Sirkuit Udara (Air Circuit Breaker - ACB) dalam domain Keselamatan Listrik & Mekanikal Industri: pengertian, prinsip rekayasa keselamatan, dasar hukum Permenaker No. 12/2015, Permenaker No. 38/2016 & PUIL 2020, dan implementasi mitigasi di industri.",
  "answer": "Pemutus Sirkuit Udara (Air Circuit Breaker - ACB) adalah parameter, metodologi, dan standar teknis fundamental dalam domain Keselamatan Listrik & Mekanikal Industri yang diterapkan untuk mengidentifikasi potensi kegagalan sistem, mengukur paparan bahaya, serta menetapkan kontrol rekayasa dan kepatuhan hukum berdasarkan Permenaker No. 12/2015, Permenaker No. 38/2016 & PUIL 2020.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Konsep & Definisi Teknis Pemutus Sirkuit Udara (Air Circuit Breaker - ACB)",
      "paragraphs": [
        "Dalam rekayasa keselamatan dan kesehatan kerja modern, Pemutus Sirkuit Udara (Air Circuit Breaker - ACB) menjadi instrumen kritis untuk memetakan dinamika risiko di lingkungan kerja industri. Penerapannya memungkinkan para engineer dan praktisi HSE merancang sistem proteksi yang efektif sebelum terjadinya kegagalan fatal.",
  ...
  "faqs": [
    {
      "question": "Mengapa Pemutus Sirkuit Udara (Air Circuit Breaker - ACB) krusial dipahami dalam manajemen risiko K3?",
      "answer": "Karena Pemutus Sirkuit Udara (Air Circuit Breaker - ACB) menjadi dasar ilmiah dalam mendeteksi potensi bahaya, menghitung skor risiko, dan menentukan langkah mitigasi rekayasa yang terukur di tempat kerja."
    },
    {
      "question": "Regulasi apa yang menjadi rujukan kepatuhan terkait Pemutus Sirkuit Udara (Air Circuit Breaker - ACB)?",
    ...
    {
      "question": "Bagaimana cara menguji atau mengukur pemenuhan Pemutus Sirkuit Udara (Air Circuit Breaker - ACB) di lapangan?",
  ...
  "indexable": true,
  "intent": "kamus k3 pemutus-sirkuit-udara-air-circuit-breaker-acb definisi rumus standar penerapan",
  "primaryKeyword": "pemutus sirkuit udara air circuit breaker acb k3",
  "searchIntent": "pengertian, rumus, standar teknis, dan penerapan Pemutus Sirkuit Udara (Air Circuit Breaker - ACB)",
