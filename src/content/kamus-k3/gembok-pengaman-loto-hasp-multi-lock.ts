...
export const record: ContentRecord = {
  "section": "kamus-k3",
  "slug": "gembok-pengaman-loto-hasp-multi-lock",
  "title": "Gembok Pengaman LOTO & Hasp Multi-Lock",
  "metaTitle": "Gembok Pengaman LOTO & Hasp Multi-Lock: Definisi, Rumus & Standar K3",
  "description": "Penjelasan lengkap Gembok Pengaman LOTO & Hasp Multi-Lock dalam domain Keselamatan Listrik & Mekanikal Industri: pengertian, prinsip rekayasa keselamatan, dasar hukum Permenaker No. 12/2015, Permenaker No. 38/2016 & PUIL 2020, dan implementasi mitigasi di industri.",
  "answer": "Gembok Pengaman LOTO & Hasp Multi-Lock adalah parameter, metodologi, dan standar teknis fundamental dalam domain Keselamatan Listrik & Mekanikal Industri yang diterapkan untuk mengidentifikasi potensi kegagalan sistem, mengukur paparan bahaya, serta menetapkan kontrol rekayasa dan kepatuhan hukum berdasarkan Permenaker No. 12/2015, Permenaker No. 38/2016 & PUIL 2020.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Konsep & Definisi Teknis Gembok Pengaman LOTO & Hasp Multi-Lock",
      "paragraphs": [
        "Dalam rekayasa keselamatan dan kesehatan kerja modern, Gembok Pengaman LOTO & Hasp Multi-Lock menjadi instrumen kritis untuk memetakan dinamika risiko di lingkungan kerja industri. Penerapannya memungkinkan para engineer dan praktisi HSE merancang sistem proteksi yang efektif sebelum terjadinya kegagalan fatal.",
  ...
  "faqs": [
    {
      "question": "Mengapa Gembok Pengaman LOTO & Hasp Multi-Lock krusial dipahami dalam manajemen risiko K3?",
      "answer": "Karena Gembok Pengaman LOTO & Hasp Multi-Lock menjadi dasar ilmiah dalam mendeteksi potensi bahaya, menghitung skor risiko, dan menentukan langkah mitigasi rekayasa yang terukur di tempat kerja."
    },
    {
      "question": "Regulasi apa yang menjadi rujukan kepatuhan terkait Gembok Pengaman LOTO & Hasp Multi-Lock?",
    ...
    {
      "question": "Bagaimana cara menguji atau mengukur pemenuhan Gembok Pengaman LOTO & Hasp Multi-Lock di lapangan?",
  ...
  "indexable": true,
  "intent": "kamus k3 gembok-pengaman-loto-hasp-multi-lock definisi rumus standar penerapan",
  "primaryKeyword": "gembok pengaman loto hasp multi lock k3",
  "searchIntent": "pengertian, rumus, standar teknis, dan penerapan Gembok Pengaman LOTO & Hasp Multi-Lock",
