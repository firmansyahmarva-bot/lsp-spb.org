...
export const record: ContentRecord = {
  ...
  "title": "Kategori APD Arc Flash (Cal/cm2 Rating)",
  "metaTitle": "Kategori APD Arc Flash (Cal/cm2 Rating): Definisi, Rumus & Standar K3",
  "description": "Penjelasan lengkap Kategori APD Arc Flash (Cal/cm2 Rating) dalam domain Keselamatan Listrik & Mekanikal Industri: pengertian, prinsip rekayasa keselamatan, dasar hukum Permenaker No. 12/2015, Permenaker No. 38/2016 & PUIL 2020, dan implementasi mitigasi di industri.",
  "answer": "Kategori APD Arc Flash (Cal/cm2 Rating) adalah parameter, metodologi, dan standar teknis fundamental dalam domain Keselamatan Listrik & Mekanikal Industri yang diterapkan untuk mengidentifikasi potensi kegagalan sistem, mengukur paparan bahaya, serta menetapkan kontrol rekayasa dan kepatuhan hukum berdasarkan Permenaker No. 12/2015, Permenaker No. 38/2016 & PUIL 2020.",
  "highlights": [
  ...
  "faqs": [
    {
      "question": "Mengapa Kategori APD Arc Flash (Cal/cm2 Rating) krusial dipahami dalam manajemen risiko K3?",
      "answer": "Karena Kategori APD Arc Flash (Cal/cm2 Rating) menjadi dasar ilmiah dalam mendeteksi potensi bahaya, menghitung skor risiko, dan menentukan langkah mitigasi rekayasa yang terukur di tempat kerja."
    },
    {
      "question": "Regulasi apa yang menjadi rujukan kepatuhan terkait Kategori APD Arc Flash (Cal/cm2 Rating)?",
    ...
    {
      "question": "Bagaimana cara menguji atau mengukur pemenuhan Kategori APD Arc Flash (Cal/cm2 Rating) di lapangan?",
  ...
  "indexable": true,
  "intent": "kamus k3 kategori-apd-arc-flash-cal-cm2-rating definisi rumus standar penerapan",
  "primaryKeyword": "kategori apd arc flash cal cm2 rating k3",
  "searchIntent": "pengertian, rumus, standar teknis, dan penerapan Kategori APD Arc Flash (Cal/cm2 Rating)",
