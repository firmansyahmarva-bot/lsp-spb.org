...
export const record: ContentRecord = {
  ...
  "title": "Prosedur Lockout Tagout (LOTO 6 Langkah)",
  "metaTitle": "Prosedur Lockout Tagout (LOTO 6 Langkah): Definisi, Rumus & Standar K3",
  "description": "Penjelasan lengkap Prosedur Lockout Tagout (LOTO 6 Langkah) dalam domain Keselamatan Listrik & Mekanikal Industri: pengertian, prinsip rekayasa keselamatan, dasar hukum Permenaker No. 12/2015, Permenaker No. 38/2016 & PUIL 2020, dan implementasi mitigasi di industri.",
  "answer": "Prosedur Lockout Tagout (LOTO 6 Langkah) adalah parameter, metodologi, dan standar teknis fundamental dalam domain Keselamatan Listrik & Mekanikal Industri yang diterapkan untuk mengidentifikasi potensi kegagalan sistem, mengukur paparan bahaya, serta menetapkan kontrol rekayasa dan kepatuhan hukum berdasarkan Permenaker No. 12/2015, Permenaker No. 38/2016 & PUIL 2020.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Konsep & Definisi Teknis Prosedur Lockout Tagout (LOTO 6 Langkah)",
      "paragraphs": [
        "Dalam rekayasa keselamatan dan kesehatan kerja modern, Prosedur Lockout Tagout (LOTO 6 Langkah) menjadi instrumen kritis untuk memetakan dinamika risiko di lingkungan kerja industri. Penerapannya memungkinkan para engineer dan praktisi HSE merancang sistem proteksi yang efektif sebelum terjadinya kegagalan fatal.",
  ...
  "faqs": [
    {
      "question": "Mengapa Prosedur Lockout Tagout (LOTO 6 Langkah) krusial dipahami dalam manajemen risiko K3?",
      "answer": "Karena Prosedur Lockout Tagout (LOTO 6 Langkah) menjadi dasar ilmiah dalam mendeteksi potensi bahaya, menghitung skor risiko, dan menentukan langkah mitigasi rekayasa yang terukur di tempat kerja."
    },
    {
      "question": "Regulasi apa yang menjadi rujukan kepatuhan terkait Prosedur Lockout Tagout (LOTO 6 Langkah)?",
    ...
    {
      "question": "Bagaimana cara menguji atau mengukur pemenuhan Prosedur Lockout Tagout (LOTO 6 Langkah) di lapangan?",
  ...
  "indexable": true,
  "intent": "kamus k3 prosedur-lockout-tagout-loto-6-langkah definisi rumus standar penerapan",
  "primaryKeyword": "prosedur lockout tagout loto 6 langkah k3",
  "searchIntent": "pengertian, rumus, standar teknis, dan penerapan Prosedur Lockout Tagout (LOTO 6 Langkah)",
