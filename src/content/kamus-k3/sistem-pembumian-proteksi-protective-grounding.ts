...
export const record: ContentRecord = {
  "section": "kamus-k3",
  "slug": "sistem-pembumian-proteksi-protective-grounding",
  "title": "Sistem Pembumian Proteksi (Protective Grounding)",
  "metaTitle": "Sistem Pembumian Proteksi (Protective Grounding): Definisi, Rumus & Standar K3",
  "description": "Penjelasan lengkap Sistem Pembumian Proteksi (Protective Grounding) dalam domain Keselamatan Listrik & Mekanikal Industri: pengertian, prinsip rekayasa keselamatan, dasar hukum Permenaker No. 12/2015, Permenaker No. 38/2016 & PUIL 2020, dan implementasi mitigasi di industri.",
  "answer": "Sistem Pembumian Proteksi (Protective Grounding) adalah parameter, metodologi, dan standar teknis fundamental dalam domain Keselamatan Listrik & Mekanikal Industri yang diterapkan untuk mengidentifikasi potensi kegagalan sistem, mengukur paparan bahaya, serta menetapkan kontrol rekayasa dan kepatuhan hukum berdasarkan Permenaker No. 12/2015, Permenaker No. 38/2016 & PUIL 2020.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Konsep & Definisi Teknis Sistem Pembumian Proteksi (Protective Grounding)",
      "paragraphs": [
        "Dalam rekayasa keselamatan dan kesehatan kerja modern, Sistem Pembumian Proteksi (Protective Grounding) menjadi instrumen kritis untuk memetakan dinamika risiko di lingkungan kerja industri. Penerapannya memungkinkan para engineer dan praktisi HSE merancang sistem proteksi yang efektif sebelum terjadinya kegagalan fatal.",
  ...
  "faqs": [
    {
      "question": "Mengapa Sistem Pembumian Proteksi (Protective Grounding) krusial dipahami dalam manajemen risiko K3?",
      "answer": "Karena Sistem Pembumian Proteksi (Protective Grounding) menjadi dasar ilmiah dalam mendeteksi potensi bahaya, menghitung skor risiko, dan menentukan langkah mitigasi rekayasa yang terukur di tempat kerja."
    },
    {
      "question": "Regulasi apa yang menjadi rujukan kepatuhan terkait Sistem Pembumian Proteksi (Protective Grounding)?",
    ...
    {
      "question": "Bagaimana cara menguji atau mengukur pemenuhan Sistem Pembumian Proteksi (Protective Grounding) di lapangan?",
  ...
  "indexable": true,
  "intent": "kamus k3 sistem-pembumian-proteksi-protective-grounding definisi rumus standar penerapan",
  "primaryKeyword": "sistem pembumian proteksi protective grounding k3",
  "searchIntent": "pengertian, rumus, standar teknis, dan penerapan Sistem Pembumian Proteksi (Protective Grounding)",
