...
export const record: ContentRecord = {
  "section": "kamus-k3",
  "slug": "pengujian-tegangan-nol-zero-voltage-verification",
  "title": "Pengujian Tegangan Nol (Zero Voltage Verification)",
  "metaTitle": "Pengujian Tegangan Nol (Zero Voltage Verification): Definisi, Rumus & Standar K3",
  "description": "Penjelasan lengkap Pengujian Tegangan Nol (Zero Voltage Verification) dalam domain Keselamatan Listrik & Mekanikal Industri: pengertian, prinsip rekayasa keselamatan, dasar hukum Permenaker No. 12/2015, Permenaker No. 38/2016 & PUIL 2020, dan implementasi mitigasi di industri.",
  "answer": "Pengujian Tegangan Nol (Zero Voltage Verification) adalah parameter, metodologi, dan standar teknis fundamental dalam domain Keselamatan Listrik & Mekanikal Industri yang diterapkan untuk mengidentifikasi potensi kegagalan sistem, mengukur paparan bahaya, serta menetapkan kontrol rekayasa dan kepatuhan hukum berdasarkan Permenaker No. 12/2015, Permenaker No. 38/2016 & PUIL 2020.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Konsep & Definisi Teknis Pengujian Tegangan Nol (Zero Voltage Verification)",
      "paragraphs": [
        "Dalam rekayasa keselamatan dan kesehatan kerja modern, Pengujian Tegangan Nol (Zero Voltage Verification) menjadi instrumen kritis untuk memetakan dinamika risiko di lingkungan kerja industri. Penerapannya memungkinkan para engineer dan praktisi HSE merancang sistem proteksi yang efektif sebelum terjadinya kegagalan fatal.",
  ...
  "faqs": [
    {
      "question": "Mengapa Pengujian Tegangan Nol (Zero Voltage Verification) krusial dipahami dalam manajemen risiko K3?",
      "answer": "Karena Pengujian Tegangan Nol (Zero Voltage Verification) menjadi dasar ilmiah dalam mendeteksi potensi bahaya, menghitung skor risiko, dan menentukan langkah mitigasi rekayasa yang terukur di tempat kerja."
    },
    {
      "question": "Regulasi apa yang menjadi rujukan kepatuhan terkait Pengujian Tegangan Nol (Zero Voltage Verification)?",
    ...
    {
      "question": "Bagaimana cara menguji atau mengukur pemenuhan Pengujian Tegangan Nol (Zero Voltage Verification) di lapangan?",
  ...
  "indexable": true,
  "intent": "kamus k3 pengujian-tegangan-nol-zero-voltage-verification definisi rumus standar penerapan",
  "primaryKeyword": "pengujian tegangan nol zero voltage verification k3",
  "searchIntent": "pengertian, rumus, standar teknis, dan penerapan Pengujian Tegangan Nol (Zero Voltage Verification)",
