...
export const record: ContentRecord = {
  "section": "kamus-k3",
  "slug": "tag-bahaya-jangan-dioperasikan-danger-tag",
  "title": "Tag Bahaya Jangan Dioperasikan (Danger Tag)",
  "metaTitle": "Tag Bahaya Jangan Dioperasikan (Danger Tag): Definisi, Rumus & Standar K3",
  "description": "Penjelasan lengkap Tag Bahaya Jangan Dioperasikan (Danger Tag) dalam domain Keselamatan Listrik & Mekanikal Industri: pengertian, prinsip rekayasa keselamatan, dasar hukum Permenaker No. 12/2015, Permenaker No. 38/2016 & PUIL 2020, dan implementasi mitigasi di industri.",
  "answer": "Tag Bahaya Jangan Dioperasikan (Danger Tag) adalah parameter, metodologi, dan standar teknis fundamental dalam domain Keselamatan Listrik & Mekanikal Industri yang diterapkan untuk mengidentifikasi potensi kegagalan sistem, mengukur paparan bahaya, serta menetapkan kontrol rekayasa dan kepatuhan hukum berdasarkan Permenaker No. 12/2015, Permenaker No. 38/2016 & PUIL 2020.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Konsep & Definisi Teknis Tag Bahaya Jangan Dioperasikan (Danger Tag)",
      "paragraphs": [
        "Dalam rekayasa keselamatan dan kesehatan kerja modern, Tag Bahaya Jangan Dioperasikan (Danger Tag) menjadi instrumen kritis untuk memetakan dinamika risiko di lingkungan kerja industri. Penerapannya memungkinkan para engineer dan praktisi HSE merancang sistem proteksi yang efektif sebelum terjadinya kegagalan fatal.",
  ...
  "faqs": [
    {
      "question": "Mengapa Tag Bahaya Jangan Dioperasikan (Danger Tag) krusial dipahami dalam manajemen risiko K3?",
      "answer": "Karena Tag Bahaya Jangan Dioperasikan (Danger Tag) menjadi dasar ilmiah dalam mendeteksi potensi bahaya, menghitung skor risiko, dan menentukan langkah mitigasi rekayasa yang terukur di tempat kerja."
    },
    {
      "question": "Regulasi apa yang menjadi rujukan kepatuhan terkait Tag Bahaya Jangan Dioperasikan (Danger Tag)?",
    ...
    {
      "question": "Bagaimana cara menguji atau mengukur pemenuhan Tag Bahaya Jangan Dioperasikan (Danger Tag) di lapangan?",
  ...
  "indexable": true,
  "intent": "kamus k3 tag-bahaya-jangan-dioperasikan-danger-tag definisi rumus standar penerapan",
  "primaryKeyword": "tag bahaya jangan dioperasikan danger tag k3",
  "searchIntent": "pengertian, rumus, standar teknis, dan penerapan Tag Bahaya Jangan Dioperasikan (Danger Tag)",
