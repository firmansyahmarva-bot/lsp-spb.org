...
export const record: ContentRecord = {
  "section": "kamus-k3",
  "slug": "bahaya-busur-api-listrik-arc-flash-boundary",
  "title": "Bahaya Busur Api Listrik (Arc Flash Boundary)",
  "metaTitle": "Bahaya Busur Api Listrik (Arc Flash Boundary): Definisi, Rumus & Standar K3",
  "description": "Penjelasan lengkap Bahaya Busur Api Listrik (Arc Flash Boundary) dalam domain Keselamatan Listrik & Mekanikal Industri: pengertian, prinsip rekayasa keselamatan, dasar hukum Permenaker No. 12/2015, Permenaker No. 38/2016 & PUIL 2020, dan implementasi mitigasi di industri.",
  "answer": "Bahaya Busur Api Listrik (Arc Flash Boundary) adalah parameter, metodologi, dan standar teknis fundamental dalam domain Keselamatan Listrik & Mekanikal Industri yang diterapkan untuk mengidentifikasi potensi kegagalan sistem, mengukur paparan bahaya, serta menetapkan kontrol rekayasa dan kepatuhan hukum berdasarkan Permenaker No. 12/2015, Permenaker No. 38/2016 & PUIL 2020.",
  "highlights": [
  ...
  "faqs": [
    {
      "question": "Mengapa Bahaya Busur Api Listrik (Arc Flash Boundary) krusial dipahami dalam manajemen risiko K3?",
      "answer": "Karena Bahaya Busur Api Listrik (Arc Flash Boundary) menjadi dasar ilmiah dalam mendeteksi potensi bahaya, menghitung skor risiko, dan menentukan langkah mitigasi rekayasa yang terukur di tempat kerja."
    },
    {
      "question": "Regulasi apa yang menjadi rujukan kepatuhan terkait Bahaya Busur Api Listrik (Arc Flash Boundary)?",
    ...
    {
      "question": "Bagaimana cara menguji atau mengukur pemenuhan Bahaya Busur Api Listrik (Arc Flash Boundary) di lapangan?",
  ...
  "indexable": true,
  "intent": "kamus k3 bahaya-busur-api-listrik-arc-flash-boundary definisi rumus standar penerapan",
  "primaryKeyword": "bahaya busur api listrik arc flash boundary k3",
  "searchIntent": "pengertian, rumus, standar teknis, dan penerapan Bahaya Busur Api Listrik (Arc Flash Boundary)",
