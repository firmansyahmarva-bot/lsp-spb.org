...
export const record: ContentRecord = {
  "section": "alat",
  "slug": "sepatu-keselamatan-bahaya-sengatan-listrik-eh-electrical-hazard-rated-boots",
  "title": "Sepatu Keselamatan Bahaya Sengatan Listrik EH (Electrical Hazard Rated Boots)",
  "metaTitle": "Sepatu Keselamatan Bahaya Sengatan Listrik EH (Electrical Hazard Rated Boots) | Spesifikasi & Riksa Uji",
  "description": "Spesifikasi teknis, standar keselamatan Permenaker No. 09/2016 & Standar EN 361 / ASTM, prosedur riksa uji, panduan inspeksi berkala, dan perawatan Sepatu Keselamatan Bahaya Sengatan Listrik EH (Electrical Hazard Rated Boots) di tempat kerja.",
  "answer": "Sepatu Keselamatan Bahaya Sengatan Listrik EH (Electrical Hazard Rated Boots) adalah peralatan keselamatan kerja dalam kategori APD Tubuh, Tangan, Kaki & Proteksi Jatuh yang dirancang untuk memberikan proteksi langsung, deteksi bahaya, atau penanganan darurat di fasilitas industri sesuai dengan Permenaker No. 09/2016 & Standar EN 361 / ASTM.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Fungsi & Spesifikasi Teknis Sepatu Keselamatan Bahaya Sengatan Listrik EH (Electrical Hazard Rated Boots)",
      "paragraphs": [
  ...
  "faqs": [
    {
      "question": "Berapa lama masa pakai (lifetime) efektif untuk Sepatu Keselamatan Bahaya Sengatan Listrik EH (Electrical Hazard Rated Boots)?",
    ...
    {
      "question": "Bagaimana mengetahui apakah Sepatu Keselamatan Bahaya Sengatan Listrik EH (Electrical Hazard Rated Boots) telah memenuhi standar resmi?",
    ...
    {
      "question": "Apakah operator yang menggunakan Sepatu Keselamatan Bahaya Sengatan Listrik EH (Electrical Hazard Rated Boots) memerlukan pelatihan khusus?",
  ...
  "indexable": true,
  "intent": "alat k3 sepatu-keselamatan-bahaya-sengatan-listrik-eh-electrical-hazard-rated-boots spesifikasi riksa uji standar inspeksi",
  "primaryKeyword": "sepatu keselamatan bahaya sengatan listrik eh electrical hazard rated boots spesifikasi riksa uji",
  "searchIntent": "spesifikasi teknis, standar keselamatan, cara inspeksi, dan riksa uji Sepatu Keselamatan Bahaya Sengatan Listrik EH (Electrical Hazard Rated Boots)",
