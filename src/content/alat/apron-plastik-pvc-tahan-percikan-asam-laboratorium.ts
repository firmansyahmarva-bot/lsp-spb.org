...
export const record: ContentRecord = {
  "section": "alat",
  "slug": "apron-plastik-pvc-tahan-percikan-asam-laboratorium",
  "title": "Apron Plastik PVC Tahan Percikan Asam Laboratorium",
  "metaTitle": "Apron Plastik PVC Tahan Percikan Asam Laboratorium | Spesifikasi & Riksa Uji",
  "description": "Spesifikasi teknis, standar keselamatan Permenaker No. 09/2016 & Standar EN 361 / ASTM, prosedur riksa uji, panduan inspeksi berkala, dan perawatan Apron Plastik PVC Tahan Percikan Asam Laboratorium di tempat kerja.",
  "answer": "Apron Plastik PVC Tahan Percikan Asam Laboratorium adalah peralatan keselamatan kerja dalam kategori APD Tubuh, Tangan, Kaki & Proteksi Jatuh yang dirancang untuk memberikan proteksi langsung, deteksi bahaya, atau penanganan darurat di fasilitas industri sesuai dengan Permenaker No. 09/2016 & Standar EN 361 / ASTM.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Fungsi & Spesifikasi Teknis Apron Plastik PVC Tahan Percikan Asam Laboratorium",
      "paragraphs": [
        "Dalam sistem keselamatan kerja industri terpadu, Apron Plastik PVC Tahan Percikan Asam Laboratorium memegang peranan krusial untuk melindungi integritas fisik tenaga kerja dan mendeteksi kondisi tidak aman sejak dini.",
  ...
  "faqs": [
    {
      "question": "Berapa lama masa pakai (lifetime) efektif untuk Apron Plastik PVC Tahan Percikan Asam Laboratorium?",
    ...
    {
      "question": "Bagaimana mengetahui apakah Apron Plastik PVC Tahan Percikan Asam Laboratorium telah memenuhi standar resmi?",
    ...
    {
      "question": "Apakah operator yang menggunakan Apron Plastik PVC Tahan Percikan Asam Laboratorium memerlukan pelatihan khusus?",
  ...
  "indexable": true,
  "intent": "alat k3 apron-plastik-pvc-tahan-percikan-asam-laboratorium spesifikasi riksa uji standar inspeksi",
  "primaryKeyword": "apron plastik pvc tahan percikan asam laboratorium spesifikasi riksa uji",
  "searchIntent": "spesifikasi teknis, standar keselamatan, cara inspeksi, dan riksa uji Apron Plastik PVC Tahan Percikan Asam Laboratorium",
