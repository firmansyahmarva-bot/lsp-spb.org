...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Penanganan Patah Tulang Pembidaian Dan Pembentukan P3K?",
      "answer": "Biaya resmi pelatihan Penanganan Patah Tulang Pembidaian Dan Pembentukan P3K adalah Rp 3.750.000 (2 Hari). Investasi mencakup modul kurikulum medis kerja, alat peraga praktikum darurat, pembekalan dokter praktisi, dan penerbitan sertifikasi resmi."
    },
    {
