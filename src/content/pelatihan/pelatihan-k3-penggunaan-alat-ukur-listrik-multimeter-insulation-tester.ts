...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Penggunaan Alat Ukur Listrik Multimeter Insulation Tester?",
      "answer": "Biaya resmi pembinaan K3 Penggunaan Alat Ukur Listrik Multimeter Insulation Tester adalah Rp 4.250.000 untuk durasi 2 Hari. Investasi ini mencakup modul teknis PUIL 2020, bimbingan instruktur bersertifikasi, ujian evaluasi, serta penerbitan sertifikat dan lisensi resmi Kemnaker RI."
    },
    {
