...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Penggunaan Alat Pelindung Diri Apd Listrik Sarung Tangan Isolasi",
    ...
    "priceInfo": "Investasi pembinaan K3 teknis kelistrikan resmi mulai Rp 3.250.000 (1 Hari). Sudah termasuk modul PUIL 2020 & prosedur LOTO, bimbingan instruktur ahli Kemnaker RI, evaluasi kompetensi, dan sertifikasi resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 K3 Penggunaan Alat Pelindung Diri Apd Listrik Sarung Tangan Isolasi",
      "paragraphs": [
        "Penyelenggaraan Pelatihan K3 Penggunaan Alat Pelindung Diri Apd Listrik Sarung Tangan Isolasi merupakan kewajiban strategis dalam memitigasi bahaya operasional sengatan listrik tegangan tinggi, bahaya busur listrik (Arc Flash), dan potensi kebakaran akibat hubungan pendek jaringan panel di tempat kerja. Berdasarkan Permenaker No. 12 Tahun 2015, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Penggunaan Alat Pelindung Diri Apd Listrik Sarung Tangan Isolasi",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Penggunaan Alat Pelindung Diri Apd Listrik Sarung Tangan Isolasi melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Penggunaan Alat Pelindung Diri Apd Listrik Sarung Tangan Isolasi?",
      "answer": "Biaya resmi pembinaan K3 Penggunaan Alat Pelindung Diri Apd Listrik Sarung Tangan Isolasi adalah Rp 3.250.000 untuk durasi 1 Hari. Investasi ini mencakup modul teknis PUIL 2020, bimbingan instruktur bersertifikasi, ujian evaluasi, serta penerbitan sertifikat dan lisensi resmi Kemnaker RI."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 penggunaan alat pelindung diri apd listrik sarung tangan isolasi kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 penggunaan alat pelindung diri apd listrik sarung tangan isolasi",
  "primaryKeyword": "pelatihan k3 penggunaan alat pelindung diri apd listrik sarung tangan isolasi kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 penggunaan alat pelindung diri apd listrik sarung tangan isolasi",
