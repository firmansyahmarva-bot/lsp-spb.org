...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-pencegahan-kebakaran-instalasi-listrik-panel-gardu",
  "title": "Pelatihan Pencegahan Kebakaran Instalasi Listrik & Panel Gardu",
  "metaTitle": "Pelatihan Pencegahan Kebakaran Instalasi Listrik & Panel Gardu | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan kebakaran resmi Pelatihan Pencegahan Kebakaran Instalasi Listrik & Panel Gardu durasi 20 JP (2 Hari Kerja). Penguasaan APAR Permenaker 04/1980, hydran, sprinkler, clean agent FM200, Fire Drill, dan lisensi K3 Kemnaker RI dengan PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Pencegahan Kebakaran Instalasi Listrik & Panel Gardu adalah program pembinaan keselamatan kebakaran berdurasi 20 JP (2 Hari Kerja) berlandaskan Permenaker No. 12 Tahun 2015 & SNI PUIL. Pelatihan ini membekali petugas dan tim tanggap darurat dengan kemampuan teknis memadamkan api (Kelas A/B/C/D), menginspeksi sistem proteksi aktif/pasif, serta memimpin evakuasi darurat gedung bertingkat.",
  "highlights": [
    "Durasi Pelatihan: 20 JP (2 Hari Kerja)",
    "Landasan Hukum: Permenaker No. 12 Tahun 2015 & SNI PUIL",
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Pencegahan Kebakaran Instalasi Listrik & Panel Gardu",
  ...
  "blocks": [
    {
      "heading": "Landasan Hukum & Kewajiban Proteksi Kebakaran Pelatihan Pencegahan Kebakaran Instalasi Listrik & Panel Gardu",
      "paragraphs": [
        "Bahaya kebakaran di lingkungan pabrik, gedung bertingkat, dan gudang logistik merupakan ancaman fatalitas terbesar yang dapat menghentikan kelangsungan bisnis. Oleh karena itu, Permenaker No. 12 Tahun 2015 & SNI PUIL mewajibkan pengurus tempat kerja membentuk unit penanggulangan kebakaran yang rasional sesuai jumlah tenaga kerja dan tingkat risiko.",
        "Mengikuti Pelatihan Pencegahan Kebakaran Instalasi Listrik & Panel Gardu menjamin organisasi Anda memiliki personel berlisensi sah yang mampu bertindak cepat dalam 3 menit pertama kejadian sebelum bantuan pemadam kebakaran kota tiba."
      ]
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan pencegahan kebakaran instalasi listrik & panel gardu kemnaker jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran pencegahan kebakaran instalasi listrik & panel gardu",
  "primaryKeyword": "pelatihan pencegahan kebakaran instalasi listrik & panel gardu kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran pencegahan kebakaran instalasi listrik & panel gardu",
