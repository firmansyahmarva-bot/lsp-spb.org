...
export const record: ContentRecord = {
  ...
  "indexable": true,
  "intent": "pelatihan operator pneumatic tire roller vibro compactor kemnaker jadwal, biaya, syarat pendaftaran, dan silabus operator pneumatic tire roller vibro compactor kemnaker",
