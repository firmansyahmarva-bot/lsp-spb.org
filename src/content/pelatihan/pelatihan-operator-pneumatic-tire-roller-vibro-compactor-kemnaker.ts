...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Operator Pneumatic Tire Roller Vibro Compactor Kemnaker",
    ...
    "priceInfo": "Investasi resmi pembinaan Operator Pneumatic Tire Roller Vibro Compactor Kemnaker mulai Rp 4.500.000 (3 Hari). Fasilitas lengkap mencakup modul kurikulum berstandar industri, bimbingan instruktur praktisi senior, evaluasi kompetensi, dan sertifikasi resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 Operator Pneumatic Tire Roller Vibro Compactor Kemnaker",
      "paragraphs": [
        "Penyelenggaraan Pelatihan Operator Pneumatic Tire Roller Vibro Compactor Kemnaker merupakan kewajiban strategis dalam memitigasi bahaya operasional crane guling akibat kelebihan beban, tali sling putus, dan benturan beban gantung di area kerja logistik di tempat kerja. Berdasarkan Permenaker No. 08 Tahun 2020, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Operator Pneumatic Tire Roller Vibro Compactor Kemnaker",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Operator Pneumatic Tire Roller Vibro Compactor Kemnaker melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Operator Pneumatic Tire Roller Vibro Compactor Kemnaker?",
      "answer": "Investasi pembinaan resmi Operator Pneumatic Tire Roller Vibro Compactor Kemnaker adalah Rp 4.500.000 untuk durasi 3 Hari. Biaya sudah mencakup modul pelatihan komprehensif, bimbingan instruktur berpengalaman, evaluasi kelulusan, dan penerbitan sertifikat resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan operator pneumatic tire roller vibro compactor kemnaker kemnaker jadwal, biaya, syarat pendaftaran, dan silabus operator pneumatic tire roller vibro compactor kemnaker",
