...
export const record: ContentRecord = {
  ...
  "indexable": true,
  "intent": "pelatihan operator tower crane konstruksi gedung sertifikasi kemnaker jadwal, biaya, syarat pendaftaran, dan silabus operator tower crane konstruksi gedung sertifikasi kemnaker",
