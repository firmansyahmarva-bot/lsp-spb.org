...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Operator Tower Crane Konstruksi Gedung Sertifikasi Kemnaker",
    ...
    "priceInfo": "Biaya resmi pelatihan operator dan juru ikat mulai Rp 5.500.000 (3 Hari). Fasilitas mencakup materi Permenaker 08/2020, modul keselamatan pesawat angkat-angkut, simulasi/praktik alat, ujian evaluasi, dan pengurusan SIO Kemnaker RI."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 Operator Tower Crane Konstruksi Gedung Sertifikasi Kemnaker",
      "paragraphs": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Operator Tower Crane Konstruksi Gedung Sertifikasi Kemnaker",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Operator Tower Crane Konstruksi Gedung Sertifikasi Kemnaker melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Operator Tower Crane Konstruksi Gedung Sertifikasi Kemnaker?",
      "answer": "Investasi resmi pelatihan operator Operator Tower Crane Konstruksi Gedung Sertifikasi Kemnaker adalah Rp 5.500.000 (3 Hari). Biaya sudah mencakup modul materi keselamatan angkat-angkut, simulasi/praktik alat, evaluasi penguji Kemnaker RI, dan penerbitan SIO resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan operator tower crane konstruksi gedung sertifikasi kemnaker kemnaker jadwal, biaya, syarat pendaftaran, dan silabus operator tower crane konstruksi gedung sertifikasi kemnaker",
