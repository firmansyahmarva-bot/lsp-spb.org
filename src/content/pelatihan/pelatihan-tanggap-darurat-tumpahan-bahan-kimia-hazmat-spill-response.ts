...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Tanggap Darurat Tumpahan Bahan Kimia Hazmat Spill Response",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Tanggap Darurat Tumpahan Bahan Kimia Hazmat Spill Response",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Tanggap Darurat Tumpahan Bahan Kimia Hazmat Spill Response melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Tanggap Darurat Tumpahan Bahan Kimia Hazmat Spill Response?",
      "answer": "Investasi resmi pelatihan Tanggap Darurat Tumpahan Bahan Kimia Hazmat Spill Response adalah Rp 5.250.000 (3 Hari). Biaya mencakup modul penanganan B3 Kepmenaker 187/1999, pembekalan instruktur praktisi, ujian evaluasi, dan penerbitan sertifikat resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan tanggap darurat tumpahan bahan kimia hazmat spill response kemnaker jadwal, biaya, syarat pendaftaran, dan silabus tanggap darurat tumpahan bahan kimia hazmat spill response",
  "primaryKeyword": "pelatihan tanggap darurat tumpahan bahan kimia hazmat spill response kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus tanggap darurat tumpahan bahan kimia hazmat spill response",
