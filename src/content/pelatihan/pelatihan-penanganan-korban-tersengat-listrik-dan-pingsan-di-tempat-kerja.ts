...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-penanganan-korban-tersengat-listrik-dan-pingsan-di-tempat-kerja",
  "title": "Pelatihan Penanganan Korban Tersengat Listrik Dan Pingsan Di Tempat Kerja",
  "metaTitle": "Pelatihan Penanganan Korban Tersengat Listrik Dan Pingsan Di Tempat Kerja | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Penanganan Korban Tersengat Listrik Dan Pingsan Di Tempat Kerja durasi 30 JP (3 Hari Kerja) berlandaskan Permenaker No. PER.15/MEN/VIII/2008. Membahas pelaksanaan RJP/CPR 30:2, penggunaan defibrilator AED, triage luka bakar, dan penanganan trauma gawat darurat, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Penanganan Korban Tersengat Listrik Dan Pingsan Di Tempat Kerja adalah program pelatihan keselamatan kerja teknis berdurasi 30 JP (3 Hari Kerja) sesuai Permenaker No. PER.15/MEN/VIII/2008. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional penyelenggaraan pelayanan kesehatan kerja klinik perusahaan (Permen 03/1982), pemantauan audiometri, dan pertolongan pertama P3K 30 JP, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Penanganan Korban Tersengat Listrik Dan Pingsan Di Tempat Kerja",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Penanganan Korban Tersengat Listrik Dan Pingsan Di Tempat Kerja",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Penanganan Korban Tersengat Listrik Dan Pingsan Di Tempat Kerja melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan Penanganan Korban Tersengat Listrik Dan Pingsan Di Tempat Kerja?",
      "answer": "Biaya resmi pelatihan Pelatihan Penanganan Korban Tersengat Listrik Dan Pingsan Di Tempat Kerja adalah mulai Rp 4.750.000 untuk durasi 3 Hari (3 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan penanganan korban tersengat listrik dan pingsan di tempat kerja kemnaker jadwal, biaya, syarat pendaftaran, dan silabus penanganan korban tersengat listrik dan pingsan di tempat kerja",
  "primaryKeyword": "pelatihan penanganan korban tersengat listrik dan pingsan di tempat kerja kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus penanganan korban tersengat listrik dan pingsan di tempat kerja",
