...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Teknisi Pemeliharaan Pesawat Angkat Angkut Kemnaker",
    ...
    "priceInfo": "Biaya resmi pelatihan operator dan juru ikat mulai Rp 7.500.000 (5 Hari). Fasilitas mencakup materi Permenaker 08/2020, modul keselamatan pesawat angkat-angkut, simulasi/praktik alat, ujian evaluasi, dan pengurusan SIO Kemnaker RI."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 Teknisi Pemeliharaan Pesawat Angkat Angkut Kemnaker",
      "paragraphs": [
        "Penyelenggaraan Pelatihan Teknisi Pemeliharaan Pesawat Angkat Angkut Kemnaker merupakan kewajiban strategis dalam memitigasi bahaya operasional crane guling akibat kelebihan beban, tali sling putus, dan benturan beban gantung di area kerja logistik di tempat kerja. Berdasarkan Permenaker No. 08 Tahun 2020, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Teknisi Pemeliharaan Pesawat Angkat Angkut Kemnaker",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Teknisi Pemeliharaan Pesawat Angkat Angkut Kemnaker melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Teknisi Pemeliharaan Pesawat Angkat Angkut Kemnaker?",
      "answer": "Investasi resmi pelatihan operator Teknisi Pemeliharaan Pesawat Angkat Angkut Kemnaker adalah Rp 7.500.000 (5 Hari). Biaya sudah mencakup modul materi keselamatan angkat-angkut, simulasi/praktik alat, evaluasi penguji Kemnaker RI, dan penerbitan SIO resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan teknisi pemeliharaan pesawat angkat angkut kemnaker kemnaker jadwal, biaya, syarat pendaftaran, dan silabus teknisi pemeliharaan pesawat angkat angkut kemnaker",
