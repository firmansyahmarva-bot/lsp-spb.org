...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan Teknisi Pemeliharaan Pesawat Angkat Angkut Kemnaker?",
      "answer": "Biaya resmi pelatihan Pelatihan Teknisi Pemeliharaan Pesawat Angkat Angkut Kemnaker adalah mulai Rp 7.000.000 untuk durasi 8 Hari (8 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
