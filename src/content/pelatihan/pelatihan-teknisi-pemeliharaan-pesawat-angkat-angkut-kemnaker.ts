...
export const record: ContentRecord = {
  ...
  "indexable": true,
  "intent": "pelatihan teknisi pemeliharaan pesawat angkat angkut kemnaker jadwal, biaya, syarat pendaftaran, dan silabus teknisi pemeliharaan pesawat angkat angkut kemnaker",
