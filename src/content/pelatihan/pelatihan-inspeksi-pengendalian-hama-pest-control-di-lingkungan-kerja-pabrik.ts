...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-inspeksi-pengendalian-hama-pest-control-di-lingkungan-kerja-pabrik",
  "title": "Pelatihan Inspeksi Pengendalian Hama Pest Control Di Lingkungan Kerja Pabrik",
  "metaTitle": "Pelatihan Inspeksi Pengendalian Hama Pest Control Di Lingkungan Kerja Pabrik | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Inspeksi Pengendalian Hama Pest Control Di Lingkungan Kerja Pabrik durasi 24 JP (3 Hari Kerja) berlandaskan Permenaker No. 05 Tahun 2018. Membahas pengukuran kebisingan (NAB 85 dBA 8 jam), evaluasi iklim kerja ISBB, sampling debu respirabel, dan analisis ergonomi REBA/RULA, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Inspeksi Pengendalian Hama Pest Control Di Lingkungan Kerja Pabrik adalah program pelatihan keselamatan kerja teknis berdurasi 24 JP (3 Hari Kerja) sesuai Permenaker No. 05 Tahun 2018. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional pengukuran faktor fisika, kimia, biologi, ergonomi, dan psikologi lingkungan kerja sesuai standar Permenaker 05/2018, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Inspeksi Pengendalian Hama Pest Control Di Lingkungan Kerja Pabrik",
    ...
    "priceInfo": "Investasi pelatihan K3 lingkungan kerja resmi mulai Rp 3.750.000 (2 Hari). Termasuk modul pengukuran faktor fisika-kimia Permenaker 05/2018, bimbingan penggunaan alat ukur lingkungan industri, evaluasi kompetensi, dan sertifikasi resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 Inspeksi Pengendalian Hama Pest Control Di Lingkungan Kerja Pabrik",
      "paragraphs": [
        "Penyelenggaraan Pelatihan Inspeksi Pengendalian Hama Pest Control Di Lingkungan Kerja Pabrik merupakan kewajiban strategis dalam memitigasi bahaya operasional penurunan pendengaran akibat kebisingan industri, stres panas (heat stress), dan gangguan otot rangka (MSDs) di tempat kerja. Berdasarkan Permenaker No. 05 Tahun 2018, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Inspeksi Pengendalian Hama Pest Control Di Lingkungan Kerja Pabrik",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Inspeksi Pengendalian Hama Pest Control Di Lingkungan Kerja Pabrik melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Inspeksi Pengendalian Hama Pest Control Di Lingkungan Kerja Pabrik?",
      "answer": "Investasi resmi pelatihan Inspeksi Pengendalian Hama Pest Control Di Lingkungan Kerja Pabrik adalah Rp 3.750.000 (2 Hari). Sudah termasuk modul pengukuran faktor fisika-kimia Permenaker 05/2018, bimbingan teknis laboratorium/lapangan, evaluasi kelulusan, dan sertifikat resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan inspeksi pengendalian hama pest control di lingkungan kerja pabrik kemnaker jadwal, biaya, syarat pendaftaran, dan silabus inspeksi pengendalian hama pest control di lingkungan kerja pabrik",
  "primaryKeyword": "pelatihan inspeksi pengendalian hama pest control di lingkungan kerja pabrik kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus inspeksi pengendalian hama pest control di lingkungan kerja pabrik",
