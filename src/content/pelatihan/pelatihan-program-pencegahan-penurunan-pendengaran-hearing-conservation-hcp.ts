...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-program-pencegahan-penurunan-pendengaran-hearing-conservation-hcp",
  "title": "Pelatihan Program Pencegahan Penurunan Pendengaran Hearing Conservation Hcp",
  "metaTitle": "Pelatihan Program Pencegahan Penurunan Pendengaran Hearing Conservation Hcp | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Program Pencegahan Penurunan Pendengaran Hearing Conservation Hcp durasi 24 JP (3 Hari Kerja) berlandaskan Permenaker No. 05 Tahun 2018. Membahas pengukuran kebisingan (NAB 85 dBA 8 jam), evaluasi iklim kerja ISBB, sampling debu respirabel, dan analisis ergonomi REBA/RULA, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Program Pencegahan Penurunan Pendengaran Hearing Conservation Hcp adalah program pelatihan keselamatan kerja teknis berdurasi 24 JP (3 Hari Kerja) sesuai Permenaker No. 05 Tahun 2018. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional pengukuran faktor fisika, kimia, biologi, ergonomi, dan psikologi lingkungan kerja sesuai standar Permenaker 05/2018, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Program Pencegahan Penurunan Pendengaran Hearing Conservation Hcp",
    ...
    "priceInfo": "Investasi resmi pembinaan Program Pencegahan Penurunan Pendengaran Hearing Conservation Hcp mulai Rp 3.750.000 (2 Hari). Fasilitas lengkap mencakup modul kurikulum berstandar industri, bimbingan instruktur praktisi senior, evaluasi kompetensi, dan sertifikasi resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 Program Pencegahan Penurunan Pendengaran Hearing Conservation Hcp",
      "paragraphs": [
        "Penyelenggaraan Pelatihan Program Pencegahan Penurunan Pendengaran Hearing Conservation Hcp merupakan kewajiban strategis dalam memitigasi bahaya operasional penurunan pendengaran akibat kebisingan industri, stres panas (heat stress), dan gangguan otot rangka (MSDs) di tempat kerja. Berdasarkan Permenaker No. 05 Tahun 2018, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Program Pencegahan Penurunan Pendengaran Hearing Conservation Hcp",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Program Pencegahan Penurunan Pendengaran Hearing Conservation Hcp melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Program Pencegahan Penurunan Pendengaran Hearing Conservation Hcp?",
      "answer": "Investasi pembinaan resmi Program Pencegahan Penurunan Pendengaran Hearing Conservation Hcp adalah Rp 3.750.000 untuk durasi 2 Hari. Biaya sudah mencakup modul pelatihan komprehensif, bimbingan instruktur berpengalaman, evaluasi kelulusan, dan penerbitan sertifikat resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan program pencegahan penurunan pendengaran hearing conservation hcp kemnaker jadwal, biaya, syarat pendaftaran, dan silabus program pencegahan penurunan pendengaran hearing conservation hcp",
  "primaryKeyword": "pelatihan program pencegahan penurunan pendengaran hearing conservation hcp kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus program pencegahan penurunan pendengaran hearing conservation hcp",
