...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-pengukuran-radiasi-mengenal-radiasi-pengion-dan-non-pengion",
  "title": "Pelatihan Pengukuran Radiasi Mengenal Radiasi Pengion Dan Non Pengion",
  "metaTitle": "Pelatihan Pengukuran Radiasi Mengenal Radiasi Pengion Dan Non Pengion | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Pengukuran Radiasi Mengenal Radiasi Pengion Dan Non Pengion durasi 24 JP (3 Hari Kerja) berlandaskan Permenaker No. 05 Tahun 2018. Membahas pengukuran kebisingan (NAB 85 dBA 8 jam), evaluasi iklim kerja ISBB, sampling debu respirabel, dan analisis ergonomi REBA/RULA, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Pengukuran Radiasi Mengenal Radiasi Pengion Dan Non Pengion adalah program pelatihan keselamatan kerja teknis berdurasi 24 JP (3 Hari Kerja) sesuai Permenaker No. 05 Tahun 2018. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional pengukuran faktor fisika, kimia, biologi, ergonomi, dan psikologi lingkungan kerja sesuai standar Permenaker 05/2018, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Pengukuran Radiasi Mengenal Radiasi Pengion Dan Non Pengion",
    ...
    "priceInfo": "Investasi resmi pembinaan Pengukuran Radiasi Mengenal Radiasi Pengion Dan Non Pengion mulai Rp 5.250.000 (3 Hari). Fasilitas lengkap mencakup modul kurikulum berstandar industri, bimbingan instruktur praktisi senior, evaluasi kompetensi, dan sertifikasi resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 Pengukuran Radiasi Mengenal Radiasi Pengion Dan Non Pengion",
      "paragraphs": [
        "Penyelenggaraan Pelatihan Pengukuran Radiasi Mengenal Radiasi Pengion Dan Non Pengion merupakan kewajiban strategis dalam memitigasi bahaya operasional penurunan pendengaran akibat kebisingan industri, stres panas (heat stress), dan gangguan otot rangka (MSDs) di tempat kerja. Berdasarkan Permenaker No. 05 Tahun 2018, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Pengukuran Radiasi Mengenal Radiasi Pengion Dan Non Pengion",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Pengukuran Radiasi Mengenal Radiasi Pengion Dan Non Pengion melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pengukuran Radiasi Mengenal Radiasi Pengion Dan Non Pengion?",
      "answer": "Investasi pembinaan resmi Pengukuran Radiasi Mengenal Radiasi Pengion Dan Non Pengion adalah Rp 5.250.000 untuk durasi 3 Hari. Biaya sudah mencakup modul pelatihan komprehensif, bimbingan instruktur berpengalaman, evaluasi kelulusan, dan penerbitan sertifikat resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan pengukuran radiasi mengenal radiasi pengion dan non pengion kemnaker jadwal, biaya, syarat pendaftaran, dan silabus pengukuran radiasi mengenal radiasi pengion dan non pengion",
  "primaryKeyword": "pelatihan pengukuran radiasi mengenal radiasi pengion dan non pengion kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus pengukuran radiasi mengenal radiasi pengion dan non pengion",
