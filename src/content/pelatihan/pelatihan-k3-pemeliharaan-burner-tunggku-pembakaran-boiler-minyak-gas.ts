...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Pemeliharaan Burner Tunggku Pembakaran Boiler Minyak Gas",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Pemeliharaan Burner Tunggku Pembakaran Boiler Minyak Gas",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Pemeliharaan Burner Tunggku Pembakaran Boiler Minyak Gas melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Pemeliharaan Burner Tunggku Pembakaran Boiler Minyak Gas?",
      "answer": "Biaya pembinaan resmi K3 Pemeliharaan Burner Tunggku Pembakaran Boiler Minyak Gas adalah Rp 5.250.000 untuk durasi 3 Hari. Investasi mencakup modul teknis Permenaker 37/2016, bimbingan operasional pesawat uap/bejana tekan, evaluasi kelulusan, dan sertifikasi lisensi resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 pemeliharaan burner tunggku pembakaran boiler minyak gas kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 pemeliharaan burner tunggku pembakaran boiler minyak gas",
  "primaryKeyword": "pelatihan k3 pemeliharaan burner tunggku pembakaran boiler minyak gas kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 pemeliharaan burner tunggku pembakaran boiler minyak gas",
