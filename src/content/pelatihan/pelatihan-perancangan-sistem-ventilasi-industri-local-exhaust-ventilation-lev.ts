...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "priceInfo": "Investasi resmi pembinaan Perancangan Sistem Ventilasi Industri Local Exhaust Ventilation Lev mulai Rp 4.750.000 (3 Hari). Fasilitas lengkap mencakup modul kurikulum berstandar industri, bimbingan instruktur praktisi senior, evaluasi kompetensi, dan sertifikasi resmi."
  },
  "blocks": [
    {
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Perancangan Sistem Ventilasi Industri Local Exhaust Ventilation Lev?",
      "answer": "Investasi pembinaan resmi Perancangan Sistem Ventilasi Industri Local Exhaust Ventilation Lev adalah Rp 4.750.000 untuk durasi 3 Hari. Biaya sudah mencakup modul pelatihan komprehensif, bimbingan instruktur berpengalaman, evaluasi kelulusan, dan penerbitan sertifikat resmi."
    },
    {
