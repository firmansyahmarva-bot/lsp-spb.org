...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-perancangan-sistem-ventilasi-industri-local-exhaust-ventilation-lev",
  "title": "Pelatihan Perancangan Sistem Ventilasi Industri Local Exhaust Ventilation Lev",
  "metaTitle": "Pelatihan Perancangan Sistem Ventilasi Industri Local Exhaust Ventilation Lev | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Perancangan Sistem Ventilasi Industri Local Exhaust Ventilation Lev durasi 24 JP (3 Hari Kerja) berlandaskan Permenaker No. 05 Tahun 2018. Membahas pengukuran kebisingan (NAB 85 dBA 8 jam), evaluasi iklim kerja ISBB, sampling debu respirabel, dan analisis ergonomi REBA/RULA, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Perancangan Sistem Ventilasi Industri Local Exhaust Ventilation Lev adalah program pelatihan keselamatan kerja teknis berdurasi 24 JP (3 Hari Kerja) sesuai Permenaker No. 05 Tahun 2018. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional pengukuran faktor fisika, kimia, biologi, ergonomi, dan psikologi lingkungan kerja sesuai standar Permenaker 05/2018, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Perancangan Sistem Ventilasi Industri Local Exhaust Ventilation Lev",
    ...
    "priceInfo": "Investasi resmi mulai Rp 4.750.000 (3 Hari / 3 Hari Kerja). Sudah mencakup modul pelatihan komprehensif, bimbingan instruktur praktisi, evaluasi kelulusan, dan sertifikasi resmi. Paket penawaran khusus tersedia untuk In-House Training perusahaan."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 Perancangan Sistem Ventilasi Industri Local Exhaust Ventilation Lev",
      "paragraphs": [
        "Penyelenggaraan Pelatihan Perancangan Sistem Ventilasi Industri Local Exhaust Ventilation Lev merupakan kewajiban strategis dalam memitigasi bahaya operasional penurunan pendengaran akibat kebisingan industri, stres panas (heat stress), dan gangguan otot rangka (MSDs) di tempat kerja. Berdasarkan Permenaker No. 05 Tahun 2018, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Perancangan Sistem Ventilasi Industri Local Exhaust Ventilation Lev",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Perancangan Sistem Ventilasi Industri Local Exhaust Ventilation Lev melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan Perancangan Sistem Ventilasi Industri Local Exhaust Ventilation Lev?",
      "answer": "Biaya resmi pelatihan Pelatihan Perancangan Sistem Ventilasi Industri Local Exhaust Ventilation Lev adalah mulai Rp 4.750.000 untuk durasi 3 Hari (3 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan perancangan sistem ventilasi industri local exhaust ventilation lev kemnaker jadwal, biaya, syarat pendaftaran, dan silabus perancangan sistem ventilasi industri local exhaust ventilation lev",
  "primaryKeyword": "pelatihan perancangan sistem ventilasi industri local exhaust ventilation lev kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus perancangan sistem ventilasi industri local exhaust ventilation lev",
