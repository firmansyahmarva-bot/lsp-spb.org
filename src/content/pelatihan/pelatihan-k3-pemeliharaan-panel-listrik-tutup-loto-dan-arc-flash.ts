...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Pemeliharaan Panel Listrik Tutup Loto Dan Arc Flash",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Pemeliharaan Panel Listrik Tutup Loto Dan Arc Flash",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Pemeliharaan Panel Listrik Tutup Loto Dan Arc Flash melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Pemeliharaan Panel Listrik Tutup Loto Dan Arc Flash?",
      "answer": "Biaya resmi pembinaan K3 Pemeliharaan Panel Listrik Tutup Loto Dan Arc Flash adalah Rp 4.250.000 untuk durasi 2 Hari. Investasi ini mencakup modul teknis PUIL 2020, bimbingan instruktur bersertifikasi, ujian evaluasi, serta penerbitan sertifikat dan lisensi resmi Kemnaker RI."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 pemeliharaan panel listrik tutup loto dan arc flash kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 pemeliharaan panel listrik tutup loto dan arc flash",
  "primaryKeyword": "pelatihan k3 pemeliharaan panel listrik tutup loto dan arc flash kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 pemeliharaan panel listrik tutup loto dan arc flash",
