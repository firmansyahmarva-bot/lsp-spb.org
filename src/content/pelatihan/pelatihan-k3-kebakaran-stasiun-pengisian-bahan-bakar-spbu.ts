...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-k3-kebakaran-stasiun-pengisian-bahan-bakar-spbu",
  "title": "Pelatihan K3 Kebakaran Stasiun Pengisian Bahan Bakar (SPBU / SPBE)",
  "metaTitle": "Pelatihan K3 Kebakaran Stasiun Pengisian Bahan Bakar (SPBU / SPBE) | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan kebakaran resmi Pelatihan K3 Kebakaran Stasiun Pengisian Bahan Bakar (SPBU / SPBE) durasi 20 JP (2 Hari Kerja). Penguasaan APAR Permenaker 04/1980, hydran, sprinkler, clean agent FM200, Fire Drill, dan lisensi K3 Kemnaker RI dengan PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan K3 Kebakaran Stasiun Pengisian Bahan Bakar (SPBU / SPBE) adalah program pembinaan keselamatan kebakaran berdurasi 20 JP (2 Hari Kerja) berlandaskan Kepmenaker KEP.186/MEN/1999 & Standar Pertamina. Pelatihan ini membekali petugas dan tim tanggap darurat dengan kemampuan teknis memadamkan api (Kelas A/B/C/D), menginspeksi sistem proteksi aktif/pasif, serta memimpin evakuasi darurat gedung bertingkat.",
  "highlights": [
    "Durasi Pelatihan: 20 JP (2 Hari Kerja)",
    "Landasan Hukum: Kepmenaker KEP.186/MEN/1999 & Standar Pertamina",
  ...
  "courseDetails": {
    ...
    "legalBasis": "Kepmenaker KEP.186/MEN/1999 & Standar Pertamina",
    "targetAudience": [
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Kebakaran Stasiun Pengisian Bahan Bakar",
  ...
  "blocks": [
    {
      "heading": "Landasan Hukum & Kewajiban Proteksi Kebakaran Pelatihan K3 Kebakaran Stasiun Pengisian Bahan Bakar (SPBU / SPBE)",
      "paragraphs": [
        "Bahaya kebakaran di lingkungan pabrik, gedung bertingkat, dan gudang logistik merupakan ancaman fatalitas terbesar yang dapat menghentikan kelangsungan bisnis. Oleh karena itu, Kepmenaker KEP.186/MEN/1999 & Standar Pertamina mewajibkan pengurus tempat kerja membentuk unit penanggulangan kebakaran yang rasional sesuai jumlah tenaga kerja dan tingkat risiko.",
        "Mengikuti Pelatihan K3 Kebakaran Stasiun Pengisian Bahan Bakar (SPBU / SPBE) menjamin organisasi Anda memiliki personel berlisensi sah yang mampu bertindak cepat dalam 3 menit pertama kejadian sebelum bantuan pemadam kebakaran kota tiba."
      ]
    },
    {
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan K3 Kebakaran Stasiun Pengisian Bahan Bakar (SPBU / SPBE)?",
      "answer": "Biaya resmi pelatihan Pelatihan K3 Kebakaran Stasiun Pengisian Bahan Bakar (SPBU / SPBE) adalah mulai Rp 4.250.000 untuk durasi 2 Hari (2 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 kebakaran stasiun pengisian bahan bakar kemnaker jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran k3 kebakaran stasiun pengisian bahan bakar",
  "primaryKeyword": "pelatihan k3 kebakaran stasiun pengisian bahan bakar kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran k3 kebakaran stasiun pengisian bahan bakar",
