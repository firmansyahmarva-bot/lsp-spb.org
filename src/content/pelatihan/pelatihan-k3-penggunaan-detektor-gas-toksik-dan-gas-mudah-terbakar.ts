...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Penggunaan Detektor Gas Toksik Dan Gas Mudah Terbakar",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Penggunaan Detektor Gas Toksik Dan Gas Mudah Terbakar",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Penggunaan Detektor Gas Toksik Dan Gas Mudah Terbakar melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan K3 Penggunaan Detektor Gas Toksik Dan Gas Mudah Terbakar?",
      "answer": "Biaya resmi pelatihan Pelatihan K3 Penggunaan Detektor Gas Toksik Dan Gas Mudah Terbakar adalah mulai Rp 4.250.000 untuk durasi 2 Hari (2 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 penggunaan detektor gas toksik dan gas mudah terbakar kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 penggunaan detektor gas toksik dan gas mudah terbakar",
  "primaryKeyword": "pelatihan k3 penggunaan detektor gas toksik dan gas mudah terbakar kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 penggunaan detektor gas toksik dan gas mudah terbakar",
