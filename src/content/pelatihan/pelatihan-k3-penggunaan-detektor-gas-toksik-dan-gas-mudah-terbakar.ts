...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Penggunaan Detektor Gas Toksik Dan Gas Mudah Terbakar?",
      "answer": "Investasi resmi pelatihan K3 Penggunaan Detektor Gas Toksik Dan Gas Mudah Terbakar adalah Rp 3.750.000 (2 Hari). Biaya mencakup modul penanganan B3 Kepmenaker 187/1999, pembekalan instruktur praktisi, ujian evaluasi, dan penerbitan sertifikat resmi."
    },
    {
