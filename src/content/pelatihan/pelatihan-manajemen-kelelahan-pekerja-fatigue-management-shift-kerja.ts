...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-manajemen-kelelahan-pekerja-fatigue-management-shift-kerja",
  "title": "Pelatihan Manajemen Kelelahan Pekerja Fatigue Management Shift Kerja",
  "metaTitle": "Pelatihan Manajemen Kelelahan Pekerja Fatigue Management Shift Kerja | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Manajemen Kelelahan Pekerja Fatigue Management Shift Kerja durasi 30 JP (3 Hari Kerja) berlandaskan Permenaker No. PER.15/MEN/VIII/2008. Membahas pelaksanaan RJP/CPR 30:2, penggunaan defibrilator AED, triage luka bakar, dan penanganan trauma gawat darurat, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Manajemen Kelelahan Pekerja Fatigue Management Shift Kerja adalah program pelatihan keselamatan kerja teknis berdurasi 30 JP (3 Hari Kerja) sesuai Permenaker No. PER.15/MEN/VIII/2008. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional penyelenggaraan pelayanan kesehatan kerja klinik perusahaan (Permen 03/1982), pemantauan audiometri, dan pertolongan pertama P3K 30 JP, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Manajemen Kelelahan Pekerja Fatigue Management Shift Kerja",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Manajemen Kelelahan Pekerja Fatigue Management Shift Kerja",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Manajemen Kelelahan Pekerja Fatigue Management Shift Kerja melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan Manajemen Kelelahan Pekerja Fatigue Management Shift Kerja?",
      "answer": "Biaya resmi pelatihan Pelatihan Manajemen Kelelahan Pekerja Fatigue Management Shift Kerja adalah mulai Rp 3.750.000 untuk durasi 2 Hari (2 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan manajemen kelelahan pekerja fatigue management shift kerja kemnaker jadwal, biaya, syarat pendaftaran, dan silabus manajemen kelelahan pekerja fatigue management shift kerja",
  "primaryKeyword": "pelatihan manajemen kelelahan pekerja fatigue management shift kerja kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus manajemen kelelahan pekerja fatigue management shift kerja",
