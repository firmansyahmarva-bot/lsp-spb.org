...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Manajemen Kelelahan Pekerja Fatigue Management Shift Kerja?",
      "answer": "Biaya resmi pelatihan Manajemen Kelelahan Pekerja Fatigue Management Shift Kerja adalah Rp 3.750.000 (2 Hari). Investasi mencakup modul kurikulum medis kerja, alat peraga praktikum darurat, pembekalan dokter praktisi, dan penerbitan sertifikasi resmi."
    },
    {
