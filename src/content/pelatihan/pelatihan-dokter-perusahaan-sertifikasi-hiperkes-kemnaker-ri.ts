...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Dokter Perusahaan Sertifikasi Hiperkes Kemnaker RI",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Dokter Perusahaan Sertifikasi Hiperkes Kemnaker RI melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
  ...
  "indexable": true,
  "intent": "pelatihan dokter perusahaan sertifikasi hiperkes kemnaker ri kemnaker jadwal, biaya, syarat pendaftaran, dan silabus dokter perusahaan sertifikasi hiperkes kemnaker ri",
