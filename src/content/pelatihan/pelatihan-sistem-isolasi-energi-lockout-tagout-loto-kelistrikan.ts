...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Sistem Isolasi Energi Lockout Tagout Loto Kelistrikan",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Sistem Isolasi Energi Lockout Tagout Loto Kelistrikan",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Sistem Isolasi Energi Lockout Tagout Loto Kelistrikan melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan Sistem Isolasi Energi Lockout Tagout Loto Kelistrikan?",
      "answer": "Biaya resmi pelatihan Pelatihan Sistem Isolasi Energi Lockout Tagout Loto Kelistrikan adalah mulai Rp 4.250.000 untuk durasi 2 Hari (2 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan sistem isolasi energi lockout tagout loto kelistrikan kemnaker jadwal, biaya, syarat pendaftaran, dan silabus sistem isolasi energi lockout tagout loto kelistrikan",
  "primaryKeyword": "pelatihan sistem isolasi energi lockout tagout loto kelistrikan kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus sistem isolasi energi lockout tagout loto kelistrikan",
