...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Sistem Isolasi Energi Lockout Tagout Loto Kelistrikan?",
      "answer": "Biaya resmi pembinaan Sistem Isolasi Energi Lockout Tagout Loto Kelistrikan adalah Rp 4.250.000 untuk durasi 2 Hari. Investasi ini mencakup modul teknis PUIL 2020, bimbingan instruktur bersertifikasi, ujian evaluasi, serta penerbitan sertifikat dan lisensi resmi Kemnaker RI."
    },
    {
