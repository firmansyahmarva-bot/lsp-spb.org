...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Manajemen Keselamatan Operasional Alat Berat Proyek",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Manajemen Keselamatan Operasional Alat Berat Proyek",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Manajemen Keselamatan Operasional Alat Berat Proyek melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Manajemen Keselamatan Operasional Alat Berat Proyek?",
      "answer": "Investasi resmi pelatihan operator K3 Manajemen Keselamatan Operasional Alat Berat Proyek adalah Rp 5.250.000 (3 Hari). Biaya sudah mencakup modul materi keselamatan angkat-angkut, simulasi/praktik alat, evaluasi penguji Kemnaker RI, dan penerbitan SIO resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 manajemen keselamatan operasional alat berat proyek kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 manajemen keselamatan operasional alat berat proyek",
  "primaryKeyword": "pelatihan k3 manajemen keselamatan operasional alat berat proyek kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 manajemen keselamatan operasional alat berat proyek",
