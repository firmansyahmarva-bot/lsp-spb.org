...
export const record: ContentRecord = {
  ...
  "indexable": true,
  "intent": "pelatihan operator winch derek kapstank tarik tambang kemnaker jadwal, biaya, syarat pendaftaran, dan silabus operator winch derek kapstank tarik tambang kemnaker",
