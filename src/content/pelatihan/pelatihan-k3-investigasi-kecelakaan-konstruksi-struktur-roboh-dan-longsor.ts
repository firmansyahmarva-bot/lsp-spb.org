...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-k3-investigasi-kecelakaan-konstruksi-struktur-roboh-dan-longsor",
  "title": "Pelatihan K3 Investigasi Kecelakaan Konstruksi Struktur Roboh Dan Longsor",
  "metaTitle": "Pelatihan K3 Investigasi Kecelakaan Konstruksi Struktur Roboh Dan Longsor | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan K3 Investigasi Kecelakaan Konstruksi Struktur Roboh Dan Longsor durasi 24 JP (3 Hari Kerja) berlandaskan Permen PUPR No. 10 Tahun 2021. Membahas penyusunan Rencana Keselamatan Konstruksi (RKK), proteksi penggalian tanah trenching shoring, dan inspeksi scaffolding Permen PUPR 10/2021, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan K3 Investigasi Kecelakaan Konstruksi Struktur Roboh Dan Longsor adalah program pelatihan keselamatan kerja teknis berdurasi 24 JP (3 Hari Kerja) sesuai Permen PUPR No. 10 Tahun 2021. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional penerapan Sistem Manajemen Keselamatan Konstruksi (SMKK), inspeksi safety patrol proyek, dan pengawasan pekerjaan risiko tinggi, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Investigasi Kecelakaan Konstruksi Struktur Roboh Dan Longsor",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Investigasi Kecelakaan Konstruksi Struktur Roboh Dan Longsor",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Investigasi Kecelakaan Konstruksi Struktur Roboh Dan Longsor melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan K3 Investigasi Kecelakaan Konstruksi Struktur Roboh Dan Longsor?",
      "answer": "Biaya resmi pelatihan Pelatihan K3 Investigasi Kecelakaan Konstruksi Struktur Roboh Dan Longsor adalah mulai Rp 5.250.000 untuk durasi 3 Hari (3 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 investigasi kecelakaan konstruksi struktur roboh dan longsor kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 investigasi kecelakaan konstruksi struktur roboh dan longsor",
  "primaryKeyword": "pelatihan k3 investigasi kecelakaan konstruksi struktur roboh dan longsor kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 investigasi kecelakaan konstruksi struktur roboh dan longsor",
