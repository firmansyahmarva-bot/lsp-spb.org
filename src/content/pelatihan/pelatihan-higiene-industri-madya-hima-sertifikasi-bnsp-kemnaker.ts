...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-higiene-industri-madya-hima-sertifikasi-bnsp-kemnaker",
  "title": "Pelatihan Higiene Industri Madya Hima Sertifikasi BNSP Kemnaker",
  "metaTitle": "Pelatihan Higiene Industri Madya Hima Sertifikasi BNSP Kemnaker | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Higiene Industri Madya Hima Sertifikasi BNSP Kemnaker durasi 24 JP (3 Hari Kerja) berlandaskan Permenaker No. 05 Tahun 2018. Membahas pengukuran kebisingan (NAB 85 dBA 8 jam), evaluasi iklim kerja ISBB, sampling debu respirabel, dan analisis ergonomi REBA/RULA, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Higiene Industri Madya Hima Sertifikasi BNSP Kemnaker adalah program pelatihan keselamatan kerja teknis berdurasi 24 JP (3 Hari Kerja) sesuai Permenaker No. 05 Tahun 2018. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional pengukuran faktor fisika, kimia, biologi, ergonomi, dan psikologi lingkungan kerja sesuai standar Permenaker 05/2018, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Kompetensi BNSP untuk Higiene Industri Madya Hima Sertifikasi BNSP Kemnaker",
    ...
    "priceInfo": "Investasi pelatihan K3 lingkungan kerja resmi mulai Rp 7.500.000 (6 Hari). Termasuk modul pengukuran faktor fisika-kimia Permenaker 05/2018, bimbingan penggunaan alat ukur lingkungan industri, evaluasi kompetensi, dan sertifikasi resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 Higiene Industri Madya Hima Sertifikasi BNSP Kemnaker",
      "paragraphs": [
        "Penyelenggaraan Pelatihan Higiene Industri Madya Hima Sertifikasi BNSP Kemnaker merupakan kewajiban strategis dalam memitigasi bahaya operasional penurunan pendengaran akibat kebisingan industri, stres panas (heat stress), dan gangguan otot rangka (MSDs) di tempat kerja. Berdasarkan Permenaker No. 05 Tahun 2018, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Higiene Industri Madya Hima Sertifikasi BNSP Kemnaker",
      "paragraphs": [
    ...
    {
      "heading": "Jalur Sertifikasi BNSP / LSP",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Higiene Industri Madya Hima Sertifikasi BNSP Kemnaker melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Higiene Industri Madya Hima Sertifikasi BNSP Kemnaker?",
      "answer": "Investasi resmi pelatihan Higiene Industri Madya Hima Sertifikasi BNSP Kemnaker adalah Rp 7.500.000 (6 Hari). Sudah termasuk modul pengukuran faktor fisika-kimia Permenaker 05/2018, bimbingan teknis laboratorium/lapangan, evaluasi kelulusan, dan sertifikat resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "sertifikasi higiene industri madya hima sertifikasi bnsp kemnaker bnsp jadwal, biaya, syarat pendaftaran, dan silabus higiene industri madya hima sertifikasi bnsp kemnaker",
  "primaryKeyword": "sertifikasi higiene industri madya hima sertifikasi bnsp kemnaker bnsp",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus higiene industri madya hima sertifikasi bnsp kemnaker",
