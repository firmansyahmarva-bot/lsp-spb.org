...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Inspeksi Ketebalan Dinding Bejana Tekan Ultrasonic Thickness Gauge",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Inspeksi Ketebalan Dinding Bejana Tekan Ultrasonic Thickness Gauge",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Inspeksi Ketebalan Dinding Bejana Tekan Ultrasonic Thickness Gauge melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Inspeksi Ketebalan Dinding Bejana Tekan Ultrasonic Thickness Gauge?",
      "answer": "Biaya pembinaan resmi K3 Inspeksi Ketebalan Dinding Bejana Tekan Ultrasonic Thickness Gauge adalah Rp 5.250.000 untuk durasi 3 Hari. Investasi mencakup modul teknis Permenaker 37/2016, bimbingan operasional pesawat uap/bejana tekan, evaluasi kelulusan, dan sertifikasi lisensi resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 inspeksi ketebalan dinding bejana tekan ultrasonic thickness gauge kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 inspeksi ketebalan dinding bejana tekan ultrasonic thickness gauge",
  "primaryKeyword": "pelatihan k3 inspeksi ketebalan dinding bejana tekan ultrasonic thickness gauge kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 inspeksi ketebalan dinding bejana tekan ultrasonic thickness gauge",
