...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-penyusunan-program-kembali-kerja-return-to-work-rtw-pasca-kecelakaan",
  "title": "Pelatihan Penyusunan Program Kembali Kerja Return To Work Rtw Pasca Kecelakaan",
  "metaTitle": "Pelatihan Penyusunan Program Kembali Kerja Return To Work Rtw Pasca Kecelakaan | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Penyusunan Program Kembali Kerja Return To Work Rtw Pasca Kecelakaan durasi 30 JP (3 Hari Kerja) berlandaskan Permenaker No. PER.15/MEN/VIII/2008. Membahas pelaksanaan RJP/CPR 30:2, penggunaan defibrilator AED, triage luka bakar, dan penanganan trauma gawat darurat, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Penyusunan Program Kembali Kerja Return To Work Rtw Pasca Kecelakaan adalah program pelatihan keselamatan kerja teknis berdurasi 30 JP (3 Hari Kerja) sesuai Permenaker No. PER.15/MEN/VIII/2008. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional penyelenggaraan pelayanan kesehatan kerja klinik perusahaan (Permen 03/1982), pemantauan audiometri, dan pertolongan pertama P3K 30 JP, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Penyusunan Program Kembali Kerja Return To Work Rtw Pasca Kecelakaan",
    ...
    "priceInfo": "Investasi resmi pembinaan Penyusunan Program Kembali Kerja Return To Work Rtw Pasca Kecelakaan mulai Rp 2.750.000 (1 Hari). Fasilitas lengkap mencakup modul kurikulum berstandar industri, bimbingan instruktur praktisi senior, evaluasi kompetensi, dan sertifikasi resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 Penyusunan Program Kembali Kerja Return To Work Rtw Pasca Kecelakaan",
      "paragraphs": [
        "Penyelenggaraan Pelatihan Penyusunan Program Kembali Kerja Return To Work Rtw Pasca Kecelakaan merupakan kewajiban strategis dalam memitigasi bahaya operasional serangan jantung mendadak tempat kerja, pendarahan hebat kecelakaan mesin, dan kecelakaan trauma fisik di tempat kerja. Berdasarkan Permenaker No. PER.15/MEN/VIII/2008, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Penyusunan Program Kembali Kerja Return To Work Rtw Pasca Kecelakaan",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Penyusunan Program Kembali Kerja Return To Work Rtw Pasca Kecelakaan melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Penyusunan Program Kembali Kerja Return To Work Rtw Pasca Kecelakaan?",
      "answer": "Investasi pembinaan resmi Penyusunan Program Kembali Kerja Return To Work Rtw Pasca Kecelakaan adalah Rp 2.750.000 untuk durasi 1 Hari. Biaya sudah mencakup modul pelatihan komprehensif, bimbingan instruktur berpengalaman, evaluasi kelulusan, dan penerbitan sertifikat resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan penyusunan program kembali kerja return to work rtw pasca kecelakaan kemnaker jadwal, biaya, syarat pendaftaran, dan silabus penyusunan program kembali kerja return to work rtw pasca kecelakaan",
  "primaryKeyword": "pelatihan penyusunan program kembali kerja return to work rtw pasca kecelakaan kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus penyusunan program kembali kerja return to work rtw pasca kecelakaan",
