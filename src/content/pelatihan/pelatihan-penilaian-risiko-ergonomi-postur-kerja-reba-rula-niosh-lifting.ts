...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Penilaian Risiko Ergonomi Postur Kerja Reba Rula Niosh Lifting?",
      "answer": "Biaya resmi pelatihan Penilaian Risiko Ergonomi Postur Kerja Reba Rula Niosh Lifting adalah Rp 3.750.000 (2 Hari). Investasi mencakup modul kurikulum medis kerja, alat peraga praktikum darurat, pembekalan dokter praktisi, dan penerbitan sertifikasi resmi."
    },
    {
