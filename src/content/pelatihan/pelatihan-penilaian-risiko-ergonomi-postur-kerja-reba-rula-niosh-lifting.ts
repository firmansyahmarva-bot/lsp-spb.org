...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-penilaian-risiko-ergonomi-postur-kerja-reba-rula-niosh-lifting",
  "title": "Pelatihan Penilaian Risiko Ergonomi Postur Kerja Reba Rula Niosh Lifting",
  "metaTitle": "Pelatihan Penilaian Risiko Ergonomi Postur Kerja Reba Rula Niosh Lifting | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Penilaian Risiko Ergonomi Postur Kerja Reba Rula Niosh Lifting durasi 24 JP (3 Hari Kerja) berlandaskan Permenaker No. 05 Tahun 2018. Membahas pengukuran kebisingan (NAB 85 dBA 8 jam), evaluasi iklim kerja ISBB, sampling debu respirabel, dan analisis ergonomi REBA/RULA, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Penilaian Risiko Ergonomi Postur Kerja Reba Rula Niosh Lifting adalah program pelatihan keselamatan kerja teknis berdurasi 24 JP (3 Hari Kerja) sesuai Permenaker No. 05 Tahun 2018. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional pengukuran faktor fisika, kimia, biologi, ergonomi, dan psikologi lingkungan kerja sesuai standar Permenaker 05/2018, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Penilaian Risiko Ergonomi Postur Kerja Reba Rula Niosh Lifting",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Penilaian Risiko Ergonomi Postur Kerja Reba Rula Niosh Lifting",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Penilaian Risiko Ergonomi Postur Kerja Reba Rula Niosh Lifting melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan Penilaian Risiko Ergonomi Postur Kerja Reba Rula Niosh Lifting?",
      "answer": "Biaya resmi pelatihan Pelatihan Penilaian Risiko Ergonomi Postur Kerja Reba Rula Niosh Lifting adalah mulai Rp 4.250.000 untuk durasi 2 Hari (2 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan penilaian risiko ergonomi postur kerja reba rula niosh lifting kemnaker jadwal, biaya, syarat pendaftaran, dan silabus penilaian risiko ergonomi postur kerja reba rula niosh lifting",
  "primaryKeyword": "pelatihan penilaian risiko ergonomi postur kerja reba rula niosh lifting kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus penilaian risiko ergonomi postur kerja reba rula niosh lifting",
