...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Operator Gondola Bangunan Gedung Sertifikasi Kemnaker",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Operator Gondola Bangunan Gedung Sertifikasi Kemnaker",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Operator Gondola Bangunan Gedung Sertifikasi Kemnaker melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
  ...
  "indexable": true,
  "intent": "pelatihan operator gondola bangunan gedung sertifikasi kemnaker kemnaker jadwal, biaya, syarat pendaftaran, dan silabus operator gondola bangunan gedung sertifikasi kemnaker",
