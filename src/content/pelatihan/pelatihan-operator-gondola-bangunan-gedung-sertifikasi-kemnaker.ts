...
export const record: ContentRecord = {
  ...
  "indexable": true,
  "intent": "pelatihan operator gondola bangunan gedung sertifikasi kemnaker jadwal, biaya, syarat pendaftaran, dan silabus operator gondola bangunan gedung sertifikasi kemnaker",
