...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-k3-konstruksi-bangunan-air-bendungan-dan-irigasi-sipil",
  "title": "Pelatihan K3 Konstruksi Bangunan Air Bendungan Dan Irigasi Sipil",
  "metaTitle": "Pelatihan K3 Konstruksi Bangunan Air Bendungan Dan Irigasi Sipil | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan K3 Konstruksi Bangunan Air Bendungan Dan Irigasi Sipil durasi 24 JP (3 Hari Kerja) berlandaskan Permen PUPR No. 10 Tahun 2021. Membahas penyusunan Rencana Keselamatan Konstruksi (RKK), proteksi penggalian tanah trenching shoring, dan inspeksi scaffolding Permen PUPR 10/2021, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan K3 Konstruksi Bangunan Air Bendungan Dan Irigasi Sipil adalah program pelatihan keselamatan kerja teknis berdurasi 24 JP (3 Hari Kerja) sesuai Permen PUPR No. 10 Tahun 2021. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional penerapan Sistem Manajemen Keselamatan Konstruksi (SMKK), inspeksi safety patrol proyek, dan pengawasan pekerjaan risiko tinggi, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Konstruksi Bangunan Air Bendungan Dan Irigasi Sipil",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Konstruksi Bangunan Air Bendungan Dan Irigasi Sipil",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Konstruksi Bangunan Air Bendungan Dan Irigasi Sipil melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan K3 Konstruksi Bangunan Air Bendungan Dan Irigasi Sipil?",
      "answer": "Biaya resmi pelatihan Pelatihan K3 Konstruksi Bangunan Air Bendungan Dan Irigasi Sipil adalah mulai Rp 5.250.000 untuk durasi 3 Hari (3 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 konstruksi bangunan air bendungan dan irigasi sipil kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 konstruksi bangunan air bendungan dan irigasi sipil",
  "primaryKeyword": "pelatihan k3 konstruksi bangunan air bendungan dan irigasi sipil kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 konstruksi bangunan air bendungan dan irigasi sipil",
