...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Konstruksi Bangunan Air Bendungan Dan Irigasi Sipil?",
      "answer": "Biaya pelatihan resmi K3 Konstruksi Bangunan Air Bendungan Dan Irigasi Sipil adalah Rp 5.250.000 (3 Hari). Mencakup kurikulum SMKK Permen PUPR 10/2021, panduan implementasi RKK proyek, bimbingan instruktur ahli, dan sertifikasi kompetensi resmi."
    },
    {
