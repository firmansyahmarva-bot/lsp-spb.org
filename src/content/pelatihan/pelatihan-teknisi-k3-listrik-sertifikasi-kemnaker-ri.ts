...
export const record: ContentRecord = {
  ...
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 Teknisi K3 Listrik Sertifikasi Kemnaker RI",
      "paragraphs": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Teknisi K3 Listrik Sertifikasi Kemnaker RI",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Teknisi K3 Listrik Sertifikasi Kemnaker RI melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
