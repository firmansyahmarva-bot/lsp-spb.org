...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "legalBasis": "PP No. 50 Tahun 2012 & Standar Process Safety Management",
    "targetAudience": [
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI Resmi untuk Management of Change Keselamatan Kerja",
  ...
  "indexable": true,
  "intent": "pelatihan management of change keselamatan kerja kemnaker jadwal, biaya, syarat pendaftaran, dan sertifikasi management of change keselamatan kerja",
  "primaryKeyword": "pelatihan management of change keselamatan kerja kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan sertifikasi management of change keselamatan kerja",
