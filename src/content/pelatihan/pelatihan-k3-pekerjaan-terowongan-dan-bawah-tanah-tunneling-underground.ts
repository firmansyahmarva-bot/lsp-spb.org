...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-k3-pekerjaan-terowongan-dan-bawah-tanah-tunneling-underground",
  "title": "Pelatihan K3 Pekerjaan Terowongan Dan Bawah Tanah Tunneling Underground",
  "metaTitle": "Pelatihan K3 Pekerjaan Terowongan Dan Bawah Tanah Tunneling Underground | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan K3 Pekerjaan Terowongan Dan Bawah Tanah Tunneling Underground durasi 24 JP (3 Hari Kerja) berlandaskan Permen PUPR No. 10 Tahun 2021. Membahas penyusunan Rencana Keselamatan Konstruksi (RKK), proteksi penggalian tanah trenching shoring, dan inspeksi scaffolding Permen PUPR 10/2021, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan K3 Pekerjaan Terowongan Dan Bawah Tanah Tunneling Underground adalah program pelatihan keselamatan kerja teknis berdurasi 24 JP (3 Hari Kerja) sesuai Permen PUPR No. 10 Tahun 2021. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional penerapan Sistem Manajemen Keselamatan Konstruksi (SMKK), inspeksi safety patrol proyek, dan pengawasan pekerjaan risiko tinggi, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Pekerjaan Terowongan Dan Bawah Tanah Tunneling Underground",
    ...
    "priceInfo": "Investasi resmi pembinaan K3 Pekerjaan Terowongan Dan Bawah Tanah Tunneling Underground mulai Rp 3.750.000 (2 Hari). Fasilitas lengkap mencakup modul kurikulum berstandar industri, bimbingan instruktur praktisi senior, evaluasi kompetensi, dan sertifikasi resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 K3 Pekerjaan Terowongan Dan Bawah Tanah Tunneling Underground",
      "paragraphs": [
        "Penyelenggaraan Pelatihan K3 Pekerjaan Terowongan Dan Bawah Tanah Tunneling Underground merupakan kewajiban strategis dalam memitigasi bahaya operasional struktur bangunan roboh, tertimbun tanah galian trenching, dan jatuh dari perancah scaffolding di tempat kerja. Berdasarkan Permen PUPR No. 10 Tahun 2021, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Pekerjaan Terowongan Dan Bawah Tanah Tunneling Underground",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Pekerjaan Terowongan Dan Bawah Tanah Tunneling Underground melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Pekerjaan Terowongan Dan Bawah Tanah Tunneling Underground?",
      "answer": "Investasi pembinaan resmi K3 Pekerjaan Terowongan Dan Bawah Tanah Tunneling Underground adalah Rp 3.750.000 untuk durasi 2 Hari. Biaya sudah mencakup modul pelatihan komprehensif, bimbingan instruktur berpengalaman, evaluasi kelulusan, dan penerbitan sertifikat resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 pekerjaan terowongan dan bawah tanah tunneling underground kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 pekerjaan terowongan dan bawah tanah tunneling underground",
  "primaryKeyword": "pelatihan k3 pekerjaan terowongan dan bawah tanah tunneling underground kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 pekerjaan terowongan dan bawah tanah tunneling underground",
