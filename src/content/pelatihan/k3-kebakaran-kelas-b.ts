...
export const record: ContentRecord = {
  ...
  "metaTitle": "Pelatihan Koordinator Unit Penanggulangan Kebakaran (Kelas B Kemnaker) | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan kebakaran resmi Pelatihan Koordinator Unit Penanggulangan Kebakaran (Kelas B Kemnaker) durasi 40 JP (4 Hari Kerja). Penguasaan APAR Permenaker 04/1980, hydran, sprinkler, clean agent FM200, Fire Drill, dan lisensi K3 Kemnaker RI dengan PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Koordinator Unit Penanggulangan Kebakaran (Kelas B Kemnaker) adalah program pembinaan keselamatan kebakaran berdurasi 40 JP (4 Hari Kerja) berlandaskan Kepmenaker No. KEP.186/MEN/1999 Lampiran III. Pelatihan ini membekali petugas dan tim tanggap darurat dengan kemampuan teknis memadamkan api (Kelas A/B/C/D), menginspeksi sistem proteksi aktif/pasif, serta memimpin evakuasi darurat gedung bertingkat.",
  "highlights": [
    "Durasi Pelatihan: 40 JP (4 Hari Kerja)",
    "Landasan Hukum: Kepmenaker No. KEP.186/MEN/1999 Lampiran III",
  ...
  "courseDetails": {
    ...
    "legalBasis": "Kepmenaker No. KEP.186/MEN/1999 Lampiran III",
    "targetAudience": [
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Koordinator Unit Penanggulangan Kebakaran",
  ...
  "blocks": [
    {
      "heading": "Landasan Hukum & Kewajiban Proteksi Kebakaran Pelatihan Koordinator Unit Penanggulangan Kebakaran (Kelas B Kemnaker)",
      "paragraphs": [
        "Bahaya kebakaran di lingkungan pabrik, gedung bertingkat, dan gudang logistik merupakan ancaman fatalitas terbesar yang dapat menghentikan kelangsungan bisnis. Oleh karena itu, Kepmenaker No. KEP.186/MEN/1999 Lampiran III mewajibkan pengurus tempat kerja membentuk unit penanggulangan kebakaran yang rasional sesuai jumlah tenaga kerja dan tingkat risiko.",
        "Mengikuti Pelatihan Koordinator Unit Penanggulangan Kebakaran (Kelas B Kemnaker) menjamin organisasi Anda memiliki personel berlisensi sah yang mampu bertindak cepat dalam 3 menit pertama kejadian sebelum bantuan pemadam kebakaran kota tiba."
      ]
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan koordinator unit penanggulangan kebakaran kemnaker jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran koordinator unit penanggulangan kebakaran",
  "primaryKeyword": "pelatihan koordinator unit penanggulangan kebakaran kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran koordinator unit penanggulangan kebakaran",
