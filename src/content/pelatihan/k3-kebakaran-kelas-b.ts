...
export const record: ContentRecord = {
  ...
  "indexable": true,
  "intent": "pelatihan koordinator unit penanggulangan kebakaran (kelas b kemnaker) silabus biaya jadwal materi sertifikasi resmi",
  ...
  "image": {
    ...
    "alt": "Instruktur dan peserta berdiskusi merumuskan struktur Incident Command System tanggap darurat kebakaran di ruang kelas"
  },
  "gallery": [
    {
      "src": "/images/content/diskusi-instruktur-dan-peserta-di-ruang-seminar-1.webp",
      "alt": "Diskusi instruktur dan peserta mengenai Incident Command System"
    },
    {
      "src": "/images/content/peserta-menyimak-presentasi-di-ruang-kelas-1.webp",
      "alt": "Pemaparan modul audit sistem proteksi kebakaran gedung bertingkat"
    },
    {
      "src": "/images/content/diskusi-kelompok-dalam-sesi-kelas-1.webp",
      "alt": "Workshop penyusunan dokumen Fire Emergency Plan"
    },
    {
      "src": "/images/content/asesmen-individu-dengan-pengisian-dokumen-1.webp",
      "alt": "Evaluasi berkas rencana kontinjensi kebakaran industri"
    }
  ]
};
