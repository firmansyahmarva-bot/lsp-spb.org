...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-sistem-pemadam-gas-bersih-clean-agent-co2-fm200",
  "title": "Pelatihan Sistem Pemadam Gas Bersih (Clean Agent CO2 & FM200)",
  "metaTitle": "Pelatihan Sistem Pemadam Gas Bersih (Clean Agent CO2 & FM200) | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan kebakaran resmi Pelatihan Sistem Pemadam Gas Bersih (Clean Agent CO2 & FM200) durasi 20 JP (2 Hari Kerja). Penguasaan APAR Permenaker 04/1980, hydran, sprinkler, clean agent FM200, Fire Drill, dan lisensi K3 Kemnaker RI dengan PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Sistem Pemadam Gas Bersih (Clean Agent CO2 & FM200) adalah program pembinaan keselamatan kebakaran berdurasi 20 JP (2 Hari Kerja) berlandaskan NFPA 2001 & Permenaker 02/1983. Pelatihan ini membekali petugas dan tim tanggap darurat dengan kemampuan teknis memadamkan api (Kelas A/B/C/D), menginspeksi sistem proteksi aktif/pasif, serta memimpin evakuasi darurat gedung bertingkat.",
  "highlights": [
    "Durasi Pelatihan: 20 JP (2 Hari Kerja)",
    "Landasan Hukum: NFPA 2001 & Permenaker 02/1983",
  ...
  "courseDetails": {
    ...
    "legalBasis": "NFPA 2001 & Permenaker 02/1983",
    "targetAudience": [
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Sistem Pemadam Gas Bersih",
    ...
    "priceInfo": "Investasi resmi pembinaan Sistem Pemadam Gas Bersih (Clean Agent CO2 & FM200) mulai Rp 4.250.000 (2 Hari). Fasilitas lengkap mencakup modul kurikulum berstandar industri, bimbingan instruktur praktisi senior, evaluasi kompetensi, dan sertifikasi resmi."
  },
  "blocks": [
    {
      "heading": "Landasan Hukum & Kewajiban Proteksi Kebakaran Pelatihan Sistem Pemadam Gas Bersih (Clean Agent CO2 & FM200)",
      "paragraphs": [
        "Bahaya kebakaran di lingkungan pabrik, gedung bertingkat, dan gudang logistik merupakan ancaman fatalitas terbesar yang dapat menghentikan kelangsungan bisnis. Oleh karena itu, NFPA 2001 & Permenaker 02/1983 mewajibkan pengurus tempat kerja membentuk unit penanggulangan kebakaran yang rasional sesuai jumlah tenaga kerja dan tingkat risiko.",
        "Mengikuti Pelatihan Sistem Pemadam Gas Bersih (Clean Agent CO2 & FM200) menjamin organisasi Anda memiliki personel berlisensi sah yang mampu bertindak cepat dalam 3 menit pertama kejadian sebelum bantuan pemadam kebakaran kota tiba."
      ]
    },
    {
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Sistem Pemadam Gas Bersih (Clean Agent CO2 & FM200)?",
      "answer": "Investasi pembinaan resmi Sistem Pemadam Gas Bersih (Clean Agent CO2 & FM200) adalah Rp 4.250.000 untuk durasi 2 Hari. Biaya sudah mencakup modul pelatihan komprehensif, bimbingan instruktur berpengalaman, evaluasi kelulusan, dan penerbitan sertifikat resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan sistem pemadam gas bersih kemnaker jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran sistem pemadam gas bersih",
  "primaryKeyword": "pelatihan sistem pemadam gas bersih kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran sistem pemadam gas bersih",
