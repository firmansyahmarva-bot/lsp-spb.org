...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Sistem Pembangkit Listrik Genset Diesel Turbin Gas",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Sistem Pembangkit Listrik Genset Diesel Turbin Gas",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Sistem Pembangkit Listrik Genset Diesel Turbin Gas melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan K3 Sistem Pembangkit Listrik Genset Diesel Turbin Gas?",
      "answer": "Biaya resmi pelatihan Pelatihan K3 Sistem Pembangkit Listrik Genset Diesel Turbin Gas adalah mulai Rp 4.250.000 untuk durasi 2 Hari (2 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 sistem pembangkit listrik genset diesel turbin gas kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 sistem pembangkit listrik genset diesel turbin gas",
  "primaryKeyword": "pelatihan k3 sistem pembangkit listrik genset diesel turbin gas kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 sistem pembangkit listrik genset diesel turbin gas",
