...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Sistem Pembangkit Listrik Genset Diesel Turbin Gas?",
      "answer": "Biaya resmi pembinaan K3 Sistem Pembangkit Listrik Genset Diesel Turbin Gas adalah Rp 4.250.000 untuk durasi 2 Hari. Investasi ini mencakup modul teknis PUIL 2020, bimbingan instruktur bersertifikasi, ujian evaluasi, serta penerbitan sertifikat dan lisensi resmi Kemnaker RI."
    },
    {
