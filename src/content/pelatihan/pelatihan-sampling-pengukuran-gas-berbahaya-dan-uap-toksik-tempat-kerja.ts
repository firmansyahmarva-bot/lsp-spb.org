...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-sampling-pengukuran-gas-berbahaya-dan-uap-toksik-tempat-kerja",
  "title": "Pelatihan Sampling Pengukuran Gas Berbahaya Dan Uap Toksik Tempat Kerja",
  "metaTitle": "Pelatihan Sampling Pengukuran Gas Berbahaya Dan Uap Toksik Tempat Kerja | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Sampling Pengukuran Gas Berbahaya Dan Uap Toksik Tempat Kerja durasi 24 JP (3 Hari Kerja) berlandaskan Permenaker No. 05 Tahun 2018. Membahas pengukuran kebisingan (NAB 85 dBA 8 jam), evaluasi iklim kerja ISBB, sampling debu respirabel, dan analisis ergonomi REBA/RULA, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Sampling Pengukuran Gas Berbahaya Dan Uap Toksik Tempat Kerja adalah program pelatihan keselamatan kerja teknis berdurasi 24 JP (3 Hari Kerja) sesuai Permenaker No. 05 Tahun 2018. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional pengukuran faktor fisika, kimia, biologi, ergonomi, dan psikologi lingkungan kerja sesuai standar Permenaker 05/2018, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Sampling Pengukuran Gas Berbahaya Dan Uap Toksik Tempat Kerja",
    ...
    "priceInfo": "Investasi pembinaan K3 pesawat uap dan bejana tekan resmi mulai Rp 5.250.000 (3 Hari). Sudah mencakup regulasi Permenaker 37/2016, modul inspeksi operasional, pendampingan ujian evaluasi, dan legalitas sertifikasi Kemnaker RI."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 Sampling Pengukuran Gas Berbahaya Dan Uap Toksik Tempat Kerja",
      "paragraphs": [
        "Penyelenggaraan Pelatihan Sampling Pengukuran Gas Berbahaya Dan Uap Toksik Tempat Kerja merupakan kewajiban strategis dalam memitigasi bahaya operasional penurunan pendengaran akibat kebisingan industri, stres panas (heat stress), dan gangguan otot rangka (MSDs) di tempat kerja. Berdasarkan Permenaker No. 05 Tahun 2018, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Sampling Pengukuran Gas Berbahaya Dan Uap Toksik Tempat Kerja",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Sampling Pengukuran Gas Berbahaya Dan Uap Toksik Tempat Kerja melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Sampling Pengukuran Gas Berbahaya Dan Uap Toksik Tempat Kerja?",
      "answer": "Biaya pembinaan resmi Sampling Pengukuran Gas Berbahaya Dan Uap Toksik Tempat Kerja adalah Rp 5.250.000 untuk durasi 3 Hari. Investasi mencakup modul teknis Permenaker 37/2016, bimbingan operasional pesawat uap/bejana tekan, evaluasi kelulusan, dan sertifikasi lisensi resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan sampling pengukuran gas berbahaya dan uap toksik tempat kerja kemnaker jadwal, biaya, syarat pendaftaran, dan silabus sampling pengukuran gas berbahaya dan uap toksik tempat kerja",
  "primaryKeyword": "pelatihan sampling pengukuran gas berbahaya dan uap toksik tempat kerja kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus sampling pengukuran gas berbahaya dan uap toksik tempat kerja",
