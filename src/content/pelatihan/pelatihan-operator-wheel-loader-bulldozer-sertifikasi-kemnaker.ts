...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Operator Wheel Loader Bulldozer Sertifikasi Kemnaker",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Operator Wheel Loader Bulldozer Sertifikasi Kemnaker",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Operator Wheel Loader Bulldozer Sertifikasi Kemnaker melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Operator Wheel Loader Bulldozer Sertifikasi Kemnaker?",
      "answer": "Investasi resmi pelatihan operator Operator Wheel Loader Bulldozer Sertifikasi Kemnaker adalah Rp 4.500.000 (3 Hari). Biaya sudah mencakup modul materi keselamatan angkat-angkut, simulasi/praktik alat, evaluasi penguji Kemnaker RI, dan penerbitan SIO resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan operator wheel loader bulldozer sertifikasi kemnaker kemnaker jadwal, biaya, syarat pendaftaran, dan silabus operator wheel loader bulldozer sertifikasi kemnaker",
