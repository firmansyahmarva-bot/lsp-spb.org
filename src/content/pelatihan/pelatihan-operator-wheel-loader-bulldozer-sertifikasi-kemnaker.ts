...
export const record: ContentRecord = {
  ...
  "indexable": true,
  "intent": "pelatihan operator wheel loader bulldozer sertifikasi kemnaker jadwal, biaya, syarat pendaftaran, dan silabus operator wheel loader bulldozer sertifikasi kemnaker",
