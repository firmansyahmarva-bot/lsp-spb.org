...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Pemeliharaan Sistem Perpipaan Uap Steam Piping System",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Pemeliharaan Sistem Perpipaan Uap Steam Piping System",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Pemeliharaan Sistem Perpipaan Uap Steam Piping System melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Pemeliharaan Sistem Perpipaan Uap Steam Piping System?",
      "answer": "Biaya pembinaan resmi K3 Pemeliharaan Sistem Perpipaan Uap Steam Piping System adalah Rp 3.750.000 untuk durasi 2 Hari. Investasi mencakup modul teknis Permenaker 37/2016, bimbingan operasional pesawat uap/bejana tekan, evaluasi kelulusan, dan sertifikasi lisensi resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 pemeliharaan sistem perpipaan uap steam piping system kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 pemeliharaan sistem perpipaan uap steam piping system",
  "primaryKeyword": "pelatihan k3 pemeliharaan sistem perpipaan uap steam piping system kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 pemeliharaan sistem perpipaan uap steam piping system",
