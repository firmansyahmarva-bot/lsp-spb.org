...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-higiene-industri-utama-hiu-sertifikasi-bnsp-kemnaker",
  "title": "Pelatihan Higiene Industri Utama Hiu Sertifikasi BNSP Kemnaker",
  "metaTitle": "Pelatihan Higiene Industri Utama Hiu Sertifikasi BNSP Kemnaker | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Higiene Industri Utama Hiu Sertifikasi BNSP Kemnaker durasi 24 JP (3 Hari Kerja) berlandaskan Permenaker No. 05 Tahun 2018. Membahas pengukuran kebisingan (NAB 85 dBA 8 jam), evaluasi iklim kerja ISBB, sampling debu respirabel, dan analisis ergonomi REBA/RULA, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Higiene Industri Utama Hiu Sertifikasi BNSP Kemnaker adalah program pelatihan keselamatan kerja teknis berdurasi 24 JP (3 Hari Kerja) sesuai Permenaker No. 05 Tahun 2018. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional pengukuran faktor fisika, kimia, biologi, ergonomi, dan psikologi lingkungan kerja sesuai standar Permenaker 05/2018, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Kompetensi BNSP untuk Higiene Industri Utama Hiu Sertifikasi BNSP Kemnaker",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Higiene Industri Utama Hiu Sertifikasi BNSP Kemnaker",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Higiene Industri Utama Hiu Sertifikasi BNSP Kemnaker melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
  ...
  "indexable": true,
  "intent": "sertifikasi higiene industri utama hiu sertifikasi bnsp kemnaker bnsp jadwal, biaya, syarat pendaftaran, dan silabus higiene industri utama hiu sertifikasi bnsp kemnaker",
  "primaryKeyword": "sertifikasi higiene industri utama hiu sertifikasi bnsp kemnaker bnsp",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus higiene industri utama hiu sertifikasi bnsp kemnaker",
