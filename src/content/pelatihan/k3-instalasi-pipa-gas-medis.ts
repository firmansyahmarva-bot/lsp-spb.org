...
export const record: ContentRecord = {
  ...
  "metaTitle": "Pelatihan K3 Instalasi Pipa Gas Medis & Tabung Oksigen Rumah Sakit | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan kebakaran resmi Pelatihan K3 Instalasi Pipa Gas Medis & Tabung Oksigen Rumah Sakit durasi 24 JP (3 Hari Kerja). Penguasaan APAR Permenaker 04/1980, hydran, sprinkler, clean agent FM200, Fire Drill, dan lisensi K3 Kemnaker RI dengan PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan K3 Instalasi Pipa Gas Medis & Tabung Oksigen Rumah Sakit adalah program pembinaan keselamatan kebakaran berdurasi 24 JP (3 Hari Kerja) berlandaskan Permenkes No. 66 Tahun 2016 & Permenaker 37/2016. Pelatihan ini membekali petugas dan tim tanggap darurat dengan kemampuan teknis memadamkan api (Kelas A/B/C/D), menginspeksi sistem proteksi aktif/pasif, serta memimpin evakuasi darurat gedung bertingkat.",
  "highlights": [
    "Durasi Pelatihan: 24 JP (3 Hari Kerja)",
    "Landasan Hukum: Permenkes No. 66 Tahun 2016 & Permenaker 37/2016",
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Instalasi Pipa Gas Medis & Tabung Oksigen Rumah Sakit",
  ...
  "blocks": [
    {
      "heading": "Landasan Hukum & Kewajiban Proteksi Kebakaran Pelatihan K3 Instalasi Pipa Gas Medis & Tabung Oksigen Rumah Sakit",
      "paragraphs": [
        "Bahaya kebakaran di lingkungan pabrik, gedung bertingkat, dan gudang logistik merupakan ancaman fatalitas terbesar yang dapat menghentikan kelangsungan bisnis. Oleh karena itu, Permenkes No. 66 Tahun 2016 & Permenaker 37/2016 mewajibkan pengurus tempat kerja membentuk unit penanggulangan kebakaran yang rasional sesuai jumlah tenaga kerja dan tingkat risiko.",
        "Mengikuti Pelatihan K3 Instalasi Pipa Gas Medis & Tabung Oksigen Rumah Sakit menjamin organisasi Anda memiliki personel berlisensi sah yang mampu bertindak cepat dalam 3 menit pertama kejadian sebelum bantuan pemadam kebakaran kota tiba."
      ]
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 instalasi pipa gas medis & tabung oksigen rumah sakit kemnaker jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran k3 instalasi pipa gas medis & tabung oksigen rumah sakit",
  "primaryKeyword": "pelatihan k3 instalasi pipa gas medis & tabung oksigen rumah sakit kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran k3 instalasi pipa gas medis & tabung oksigen rumah sakit",
