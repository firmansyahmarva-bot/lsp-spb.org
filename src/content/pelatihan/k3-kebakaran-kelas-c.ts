...
export const record: ContentRecord = {
  ...
  "metaTitle": "Pelatihan Regu Penanggulangan Kebakaran (Kelas C Sertifikasi Kemnaker) | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan kebakaran resmi Pelatihan Regu Penanggulangan Kebakaran (Kelas C Sertifikasi Kemnaker) durasi 60 JP (6 Hari Kerja). Penguasaan APAR Permenaker 04/1980, hydran, sprinkler, clean agent FM200, Fire Drill, dan lisensi K3 Kemnaker RI dengan PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Regu Penanggulangan Kebakaran (Kelas C Sertifikasi Kemnaker) adalah program pembinaan keselamatan kebakaran berdurasi 60 JP (6 Hari Kerja) berlandaskan Kepmenaker No. KEP.186/MEN/1999 Lampiran II. Pelatihan ini membekali petugas dan tim tanggap darurat dengan kemampuan teknis memadamkan api (Kelas A/B/C/D), menginspeksi sistem proteksi aktif/pasif, serta memimpin evakuasi darurat gedung bertingkat.",
  "highlights": [
    "Durasi Pelatihan: 60 JP (6 Hari Kerja)",
    "Landasan Hukum: Kepmenaker No. KEP.186/MEN/1999 Lampiran II",
  ...
  "courseDetails": {
    ...
    "legalBasis": "Kepmenaker No. KEP.186/MEN/1999 Lampiran II",
    "targetAudience": [
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Regu Penanggulangan Kebakaran",
  ...
  "blocks": [
    {
      "heading": "Landasan Hukum & Kewajiban Proteksi Kebakaran Pelatihan Regu Penanggulangan Kebakaran (Kelas C Sertifikasi Kemnaker)",
      "paragraphs": [
        "Bahaya kebakaran di lingkungan pabrik, gedung bertingkat, dan gudang logistik merupakan ancaman fatalitas terbesar yang dapat menghentikan kelangsungan bisnis. Oleh karena itu, Kepmenaker No. KEP.186/MEN/1999 Lampiran II mewajibkan pengurus tempat kerja membentuk unit penanggulangan kebakaran yang rasional sesuai jumlah tenaga kerja dan tingkat risiko.",
        "Mengikuti Pelatihan Regu Penanggulangan Kebakaran (Kelas C Sertifikasi Kemnaker) menjamin organisasi Anda memiliki personel berlisensi sah yang mampu bertindak cepat dalam 3 menit pertama kejadian sebelum bantuan pemadam kebakaran kota tiba."
      ]
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan regu penanggulangan kebakaran kemnaker jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran regu penanggulangan kebakaran",
  "primaryKeyword": "pelatihan regu penanggulangan kebakaran kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran regu penanggulangan kebakaran",
