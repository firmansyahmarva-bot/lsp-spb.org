...
export const record: ContentRecord = {
  ...
  "indexable": true,
  "intent": "pelatihan regu penanggulangan kebakaran (kelas c sertifikasi kemnaker) silabus biaya jadwal materi sertifikasi resmi",
  ...
  "image": {
    ...
    "alt": "Regu pemadam kebakaran industri berseragam APD lengkap dan SCBA siap melakukan simulasi pemadaman hidran"
  },
  "gallery": [
    {
      "src": "/images/content/briefing-pekerja-beralat-pelindung-di-fasilitas-industri-1.webp",
      "alt": "Regu pemadam kebakaran bersiap di fasilitas industri"
    },
    {
      "src": "/images/content/foto-bersama-pekerja-di-fasilitas-industri-1.webp",
      "alt": "Foto bersama peserta regu penanggulangan kebakaran kelas C"
    },
    {
      "src": "/images/content/peserta-mengikuti-pelatihan-di-kelas-1.webp",
      "alt": "Pembekalan teori taktik pemadaman api ofensif dan manajemen SCBA"
    },
    {
      "src": "/images/content/asesmen-individu-peserta-di-ruang-kelas-1.webp",
      "alt": "Ujian teori regulasi keselamatan kebakaran Kemnaker RI"
    }
  ]
};
