...
export const record: ContentRecord = {
  ...
  "indexable": true,
  "intent": "pelatihan operator dump truck hauling mining truck kemnaker jadwal, biaya, syarat pendaftaran, dan silabus operator dump truck hauling mining truck kemnaker",
