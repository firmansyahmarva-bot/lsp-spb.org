...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Operator Dump Truck Hauling Mining Truck Kemnaker",
    ...
    "priceInfo": "Investasi resmi pembinaan Operator Dump Truck Hauling Mining Truck Kemnaker mulai Rp 4.500.000 (3 Hari). Fasilitas lengkap mencakup modul kurikulum berstandar industri, bimbingan instruktur praktisi senior, evaluasi kompetensi, dan sertifikasi resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 Operator Dump Truck Hauling Mining Truck Kemnaker",
      "paragraphs": [
        "Penyelenggaraan Pelatihan Operator Dump Truck Hauling Mining Truck Kemnaker merupakan kewajiban strategis dalam memitigasi bahaya operasional crane guling akibat kelebihan beban, tali sling putus, dan benturan beban gantung di area kerja logistik di tempat kerja. Berdasarkan Permenaker No. 08 Tahun 2020, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Operator Dump Truck Hauling Mining Truck Kemnaker",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Operator Dump Truck Hauling Mining Truck Kemnaker melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Operator Dump Truck Hauling Mining Truck Kemnaker?",
      "answer": "Investasi pembinaan resmi Operator Dump Truck Hauling Mining Truck Kemnaker adalah Rp 4.500.000 untuk durasi 3 Hari. Biaya sudah mencakup modul pelatihan komprehensif, bimbingan instruktur berpengalaman, evaluasi kelulusan, dan penerbitan sertifikat resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan operator dump truck hauling mining truck kemnaker kemnaker jadwal, biaya, syarat pendaftaran, dan silabus operator dump truck hauling mining truck kemnaker",
