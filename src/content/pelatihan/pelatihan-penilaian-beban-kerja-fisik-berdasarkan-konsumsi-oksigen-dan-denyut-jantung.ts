...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-penilaian-beban-kerja-fisik-berdasarkan-konsumsi-oksigen-dan-denyut-jantung",
  "title": "Pelatihan Penilaian Beban Kerja Fisik Berdasarkan Konsumsi Oksigen Dan Denyut Jantung",
  "metaTitle": "Pelatihan Penilaian Beban Kerja Fisik Berdasarkan Konsumsi Oksigen Dan Denyut Jantung | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Penilaian Beban Kerja Fisik Berdasarkan Konsumsi Oksigen Dan Denyut Jantung durasi 24 JP (3 Hari Kerja) berlandaskan Permenaker No. 05 Tahun 2018. Membahas pengukuran kebisingan (NAB 85 dBA 8 jam), evaluasi iklim kerja ISBB, sampling debu respirabel, dan analisis ergonomi REBA/RULA, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Penilaian Beban Kerja Fisik Berdasarkan Konsumsi Oksigen Dan Denyut Jantung adalah program pelatihan keselamatan kerja teknis berdurasi 24 JP (3 Hari Kerja) sesuai Permenaker No. 05 Tahun 2018. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional pengukuran faktor fisika, kimia, biologi, ergonomi, dan psikologi lingkungan kerja sesuai standar Permenaker 05/2018, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Penilaian Beban Kerja Fisik Berdasarkan Konsumsi Oksigen Dan Denyut Jantung",
    ...
    "priceInfo": "Investasi resmi pembinaan Penilaian Beban Kerja Fisik Berdasarkan Konsumsi Oksigen Dan Denyut Jantung mulai Rp 3.750.000 (2 Hari). Fasilitas lengkap mencakup modul kurikulum berstandar industri, bimbingan instruktur praktisi senior, evaluasi kompetensi, dan sertifikasi resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 Penilaian Beban Kerja Fisik Berdasarkan Konsumsi Oksigen Dan Denyut Jantung",
      "paragraphs": [
        "Penyelenggaraan Pelatihan Penilaian Beban Kerja Fisik Berdasarkan Konsumsi Oksigen Dan Denyut Jantung merupakan kewajiban strategis dalam memitigasi bahaya operasional penurunan pendengaran akibat kebisingan industri, stres panas (heat stress), dan gangguan otot rangka (MSDs) di tempat kerja. Berdasarkan Permenaker No. 05 Tahun 2018, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Penilaian Beban Kerja Fisik Berdasarkan Konsumsi Oksigen Dan Denyut Jantung",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Penilaian Beban Kerja Fisik Berdasarkan Konsumsi Oksigen Dan Denyut Jantung melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Penilaian Beban Kerja Fisik Berdasarkan Konsumsi Oksigen Dan Denyut Jantung?",
      "answer": "Investasi pembinaan resmi Penilaian Beban Kerja Fisik Berdasarkan Konsumsi Oksigen Dan Denyut Jantung adalah Rp 3.750.000 untuk durasi 2 Hari. Biaya sudah mencakup modul pelatihan komprehensif, bimbingan instruktur berpengalaman, evaluasi kelulusan, dan penerbitan sertifikat resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan penilaian beban kerja fisik berdasarkan konsumsi oksigen dan denyut jantung kemnaker jadwal, biaya, syarat pendaftaran, dan silabus penilaian beban kerja fisik berdasarkan konsumsi oksigen dan denyut jantung",
  "primaryKeyword": "pelatihan penilaian beban kerja fisik berdasarkan konsumsi oksigen dan denyut jantung kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus penilaian beban kerja fisik berdasarkan konsumsi oksigen dan denyut jantung",
