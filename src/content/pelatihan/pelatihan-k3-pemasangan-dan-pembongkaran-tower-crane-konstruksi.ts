...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-k3-pemasangan-dan-pembongkaran-tower-crane-konstruksi",
  "title": "Pelatihan K3 Pemasangan Dan Pembongkaran Tower Crane Konstruksi",
  "metaTitle": "Pelatihan K3 Pemasangan Dan Pembongkaran Tower Crane Konstruksi | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan K3 Pemasangan Dan Pembongkaran Tower Crane Konstruksi durasi 24 JP (3 Hari Kerja) berlandaskan Permen PUPR No. 10 Tahun 2021. Membahas penyusunan Rencana Keselamatan Konstruksi (RKK), proteksi penggalian tanah trenching shoring, dan inspeksi scaffolding Permen PUPR 10/2021, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Pemasangan Dan Pembongkaran Tower Crane Konstruksi",
  ...
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 K3 Pemasangan Dan Pembongkaran Tower Crane Konstruksi",
      "paragraphs": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Pemasangan Dan Pembongkaran Tower Crane Konstruksi",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Pemasangan Dan Pembongkaran Tower Crane Konstruksi melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Pemasangan Dan Pembongkaran Tower Crane Konstruksi?",
      "answer": "Investasi resmi pelatihan operator K3 Pemasangan Dan Pembongkaran Tower Crane Konstruksi adalah Rp 5.250.000 (3 Hari). Biaya sudah mencakup modul materi keselamatan angkat-angkut, simulasi/praktik alat, evaluasi penguji Kemnaker RI, dan penerbitan SIO resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 pemasangan dan pembongkaran tower crane konstruksi kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 pemasangan dan pembongkaran tower crane konstruksi",
  "primaryKeyword": "pelatihan k3 pemasangan dan pembongkaran tower crane konstruksi kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 pemasangan dan pembongkaran tower crane konstruksi",
