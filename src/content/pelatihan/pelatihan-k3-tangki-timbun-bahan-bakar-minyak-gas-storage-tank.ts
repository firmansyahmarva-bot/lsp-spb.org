...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Tangki Timbun Bahan Bakar Minyak Gas Storage Tank?",
      "answer": "Biaya pembinaan resmi K3 Tangki Timbun Bahan Bakar Minyak Gas Storage Tank adalah Rp 4.750.000 untuk durasi 3 Hari. Investasi mencakup modul teknis Permenaker 37/2016, bimbingan operasional pesawat uap/bejana tekan, evaluasi kelulusan, dan sertifikasi lisensi resmi."
    },
    {
