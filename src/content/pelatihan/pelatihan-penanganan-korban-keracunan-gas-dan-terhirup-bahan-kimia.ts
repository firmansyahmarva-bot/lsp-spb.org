...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-penanganan-korban-keracunan-gas-dan-terhirup-bahan-kimia",
  "title": "Pelatihan Penanganan Korban Keracunan Gas Dan Terhirup Bahan Kimia",
  "metaTitle": "Pelatihan Penanganan Korban Keracunan Gas Dan Terhirup Bahan Kimia | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Penanganan Korban Keracunan Gas Dan Terhirup Bahan Kimia durasi 30 JP (3 Hari Kerja) berlandaskan Permenaker No. PER.15/MEN/VIII/2008. Membahas pelaksanaan RJP/CPR 30:2, penggunaan defibrilator AED, triage luka bakar, dan penanganan trauma gawat darurat, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Penanganan Korban Keracunan Gas Dan Terhirup Bahan Kimia adalah program pelatihan keselamatan kerja teknis berdurasi 30 JP (3 Hari Kerja) sesuai Permenaker No. PER.15/MEN/VIII/2008. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional penyelenggaraan pelayanan kesehatan kerja klinik perusahaan (Permen 03/1982), pemantauan audiometri, dan pertolongan pertama P3K 30 JP, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Penanganan Korban Keracunan Gas Dan Terhirup Bahan Kimia",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Penanganan Korban Keracunan Gas Dan Terhirup Bahan Kimia",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Penanganan Korban Keracunan Gas Dan Terhirup Bahan Kimia melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan Penanganan Korban Keracunan Gas Dan Terhirup Bahan Kimia?",
      "answer": "Biaya resmi pelatihan Pelatihan Penanganan Korban Keracunan Gas Dan Terhirup Bahan Kimia adalah mulai Rp 4.750.000 untuk durasi 3 Hari (3 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan penanganan korban keracunan gas dan terhirup bahan kimia kemnaker jadwal, biaya, syarat pendaftaran, dan silabus penanganan korban keracunan gas dan terhirup bahan kimia",
  "primaryKeyword": "pelatihan penanganan korban keracunan gas dan terhirup bahan kimia kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus penanganan korban keracunan gas dan terhirup bahan kimia",
