...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Penanganan Korban Keracunan Gas Dan Terhirup Bahan Kimia?",
      "answer": "Investasi resmi pelatihan Penanganan Korban Keracunan Gas Dan Terhirup Bahan Kimia adalah Rp 4.250.000 (2 Hari). Biaya mencakup modul penanganan B3 Kepmenaker 187/1999, pembekalan instruktur praktisi, ujian evaluasi, dan penerbitan sertifikat resmi."
    },
    {
