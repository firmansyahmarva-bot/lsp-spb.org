...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Pemeliharaan Motor Listrik Industri Dan Vfd Variable Frequency Drive",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Pemeliharaan Motor Listrik Industri Dan Vfd Variable Frequency Drive",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Pemeliharaan Motor Listrik Industri Dan Vfd Variable Frequency Drive melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Pemeliharaan Motor Listrik Industri Dan Vfd Variable Frequency Drive?",
      "answer": "Biaya resmi pembinaan K3 Pemeliharaan Motor Listrik Industri Dan Vfd Variable Frequency Drive adalah Rp 4.250.000 untuk durasi 2 Hari. Investasi ini mencakup modul teknis PUIL 2020, bimbingan instruktur bersertifikasi, ujian evaluasi, serta penerbitan sertifikat dan lisensi resmi Kemnaker RI."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 pemeliharaan motor listrik industri dan vfd variable frequency drive kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 pemeliharaan motor listrik industri dan vfd variable frequency drive",
  "primaryKeyword": "pelatihan k3 pemeliharaan motor listrik industri dan vfd variable frequency drive kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 pemeliharaan motor listrik industri dan vfd variable frequency drive",
