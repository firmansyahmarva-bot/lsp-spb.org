...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Operator Lift Barang Passenger Hoist Konstruksi Kemnaker",
    ...
    "priceInfo": "Biaya pelatihan K3 konstruksi dan SMKK resmi mulai Rp 4.500.000 (3 Hari). Fasilitas meliputi kurikulum Permen PUPR 10/2021, panduan penyusunan RKK & JSA konstruksi, evaluasi kompetensi, serta sertifikat resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 Operator Lift Barang Passenger Hoist Konstruksi Kemnaker",
      "paragraphs": [
        "Penyelenggaraan Pelatihan Operator Lift Barang Passenger Hoist Konstruksi Kemnaker merupakan kewajiban strategis dalam memitigasi bahaya operasional crane guling akibat kelebihan beban, tali sling putus, dan benturan beban gantung di area kerja logistik di tempat kerja. Berdasarkan Permenaker No. 08 Tahun 2020, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Operator Lift Barang Passenger Hoist Konstruksi Kemnaker",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Operator Lift Barang Passenger Hoist Konstruksi Kemnaker melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Operator Lift Barang Passenger Hoist Konstruksi Kemnaker?",
      "answer": "Biaya pelatihan resmi Operator Lift Barang Passenger Hoist Konstruksi Kemnaker adalah Rp 4.500.000 (3 Hari). Mencakup kurikulum SMKK Permen PUPR 10/2021, panduan implementasi RKK proyek, bimbingan instruktur ahli, dan sertifikasi kompetensi resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan operator lift barang passenger hoist konstruksi kemnaker kemnaker jadwal, biaya, syarat pendaftaran, dan silabus operator lift barang passenger hoist konstruksi kemnaker",
