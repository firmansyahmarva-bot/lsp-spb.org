...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Pemeliharaan Trafo Transformator Daya Dan Minyak Trafo",
    ...
    "priceInfo": "Investasi resmi pembinaan K3 Pemeliharaan Trafo Transformator Daya Dan Minyak Trafo mulai Rp 3.750.000 (2 Hari). Fasilitas lengkap mencakup modul kurikulum berstandar industri, bimbingan instruktur praktisi senior, evaluasi kompetensi, dan sertifikasi resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 K3 Pemeliharaan Trafo Transformator Daya Dan Minyak Trafo",
      "paragraphs": [
        "Penyelenggaraan Pelatihan K3 Pemeliharaan Trafo Transformator Daya Dan Minyak Trafo merupakan kewajiban strategis dalam memitigasi bahaya operasional sengatan listrik tegangan tinggi, bahaya busur listrik (Arc Flash), dan potensi kebakaran akibat hubungan pendek jaringan panel di tempat kerja. Berdasarkan Permenaker No. 12 Tahun 2015, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Pemeliharaan Trafo Transformator Daya Dan Minyak Trafo",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Pemeliharaan Trafo Transformator Daya Dan Minyak Trafo melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Pemeliharaan Trafo Transformator Daya Dan Minyak Trafo?",
      "answer": "Investasi pembinaan resmi K3 Pemeliharaan Trafo Transformator Daya Dan Minyak Trafo adalah Rp 3.750.000 untuk durasi 2 Hari. Biaya sudah mencakup modul pelatihan komprehensif, bimbingan instruktur berpengalaman, evaluasi kelulusan, dan penerbitan sertifikat resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 pemeliharaan trafo transformator daya dan minyak trafo kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 pemeliharaan trafo transformator daya dan minyak trafo",
  "primaryKeyword": "pelatihan k3 pemeliharaan trafo transformator daya dan minyak trafo kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 pemeliharaan trafo transformator daya dan minyak trafo",
