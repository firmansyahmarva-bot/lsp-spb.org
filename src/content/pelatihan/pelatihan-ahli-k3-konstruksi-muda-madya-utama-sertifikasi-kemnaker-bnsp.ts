...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Ahli K3 Konstruksi Muda Madya Utama Sertifikasi Kemnaker BNSP",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Ahli K3 Konstruksi Muda Madya Utama Sertifikasi Kemnaker BNSP melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
