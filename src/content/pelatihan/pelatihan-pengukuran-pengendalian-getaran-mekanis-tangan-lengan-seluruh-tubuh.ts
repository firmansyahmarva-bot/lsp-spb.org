...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pengukuran Pengendalian Getaran Mekanis Tangan Lengan Seluruh Tubuh?",
      "answer": "Investasi resmi pelatihan Pengukuran Pengendalian Getaran Mekanis Tangan Lengan Seluruh Tubuh adalah Rp 5.250.000 (3 Hari). Sudah termasuk modul pengukuran faktor fisika-kimia Permenaker 05/2018, bimbingan teknis laboratorium/lapangan, evaluasi kelulusan, dan sertifikat resmi."
    },
    {
