...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-pengukuran-pengendalian-getaran-mekanis-tangan-lengan-seluruh-tubuh",
  "title": "Pelatihan Pengukuran Pengendalian Getaran Mekanis Tangan Lengan Seluruh Tubuh",
  "metaTitle": "Pelatihan Pengukuran Pengendalian Getaran Mekanis Tangan Lengan Seluruh Tubuh | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Pengukuran Pengendalian Getaran Mekanis Tangan Lengan Seluruh Tubuh durasi 24 JP (3 Hari Kerja) berlandaskan Permenaker No. 05 Tahun 2018. Membahas pengukuran kebisingan (NAB 85 dBA 8 jam), evaluasi iklim kerja ISBB, sampling debu respirabel, dan analisis ergonomi REBA/RULA, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Pengukuran Pengendalian Getaran Mekanis Tangan Lengan Seluruh Tubuh adalah program pelatihan keselamatan kerja teknis berdurasi 24 JP (3 Hari Kerja) sesuai Permenaker No. 05 Tahun 2018. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional pengukuran faktor fisika, kimia, biologi, ergonomi, dan psikologi lingkungan kerja sesuai standar Permenaker 05/2018, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Pengukuran Pengendalian Getaran Mekanis Tangan Lengan Seluruh Tubuh",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Pengukuran Pengendalian Getaran Mekanis Tangan Lengan Seluruh Tubuh",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Pengukuran Pengendalian Getaran Mekanis Tangan Lengan Seluruh Tubuh melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan Pengukuran Pengendalian Getaran Mekanis Tangan Lengan Seluruh Tubuh?",
      "answer": "Biaya resmi pelatihan Pelatihan Pengukuran Pengendalian Getaran Mekanis Tangan Lengan Seluruh Tubuh adalah mulai Rp 5.250.000 untuk durasi 3 Hari (3 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan pengukuran pengendalian getaran mekanis tangan lengan seluruh tubuh kemnaker jadwal, biaya, syarat pendaftaran, dan silabus pengukuran pengendalian getaran mekanis tangan lengan seluruh tubuh",
  "primaryKeyword": "pelatihan pengukuran pengendalian getaran mekanis tangan lengan seluruh tubuh kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus pengukuran pengendalian getaran mekanis tangan lengan seluruh tubuh",
