...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-inspeksi-keselamatan-konstruksi-harian-safety-patrol-proyek",
  "title": "Pelatihan Inspeksi Keselamatan Konstruksi Harian Safety Patrol Proyek",
  "metaTitle": "Pelatihan Inspeksi Keselamatan Konstruksi Harian Safety Patrol Proyek | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Inspeksi Keselamatan Konstruksi Harian Safety Patrol Proyek durasi 24 JP (3 Hari Kerja) berlandaskan Permen PUPR No. 10 Tahun 2021. Membahas penyusunan Rencana Keselamatan Konstruksi (RKK), proteksi penggalian tanah trenching shoring, dan inspeksi scaffolding Permen PUPR 10/2021, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Inspeksi Keselamatan Konstruksi Harian Safety Patrol Proyek adalah program pelatihan keselamatan kerja teknis berdurasi 24 JP (3 Hari Kerja) sesuai Permen PUPR No. 10 Tahun 2021. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional penerapan Sistem Manajemen Keselamatan Konstruksi (SMKK), inspeksi safety patrol proyek, dan pengawasan pekerjaan risiko tinggi, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Inspeksi Keselamatan Konstruksi Harian Safety Patrol Proyek",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Inspeksi Keselamatan Konstruksi Harian Safety Patrol Proyek",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Inspeksi Keselamatan Konstruksi Harian Safety Patrol Proyek melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Inspeksi Keselamatan Konstruksi Harian Safety Patrol Proyek?",
      "answer": "Biaya pelatihan resmi Inspeksi Keselamatan Konstruksi Harian Safety Patrol Proyek adalah Rp 5.250.000 (3 Hari). Mencakup kurikulum SMKK Permen PUPR 10/2021, panduan implementasi RKK proyek, bimbingan instruktur ahli, dan sertifikasi kompetensi resmi."
    },
    {
  ...
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus inspeksi keselamatan konstruksi harian safety patrol proyek",
