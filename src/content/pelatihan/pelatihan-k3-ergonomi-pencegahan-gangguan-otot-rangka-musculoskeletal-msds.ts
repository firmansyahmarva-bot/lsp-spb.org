...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Ergonomi Pencegahan Gangguan Otot Rangka Musculoskeletal Msds?",
      "answer": "Biaya resmi pelatihan K3 Ergonomi Pencegahan Gangguan Otot Rangka Musculoskeletal Msds adalah Rp 3.750.000 (2 Hari). Investasi mencakup modul kurikulum medis kerja, alat peraga praktikum darurat, pembekalan dokter praktisi, dan penerbitan sertifikasi resmi."
    },
    {
