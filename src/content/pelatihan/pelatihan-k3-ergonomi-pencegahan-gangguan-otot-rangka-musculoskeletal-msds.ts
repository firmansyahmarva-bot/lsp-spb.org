...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-k3-ergonomi-pencegahan-gangguan-otot-rangka-musculoskeletal-msds",
  "title": "Pelatihan K3 Ergonomi Pencegahan Gangguan Otot Rangka Musculoskeletal Msds",
  "metaTitle": "Pelatihan K3 Ergonomi Pencegahan Gangguan Otot Rangka Musculoskeletal Msds | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan K3 Ergonomi Pencegahan Gangguan Otot Rangka Musculoskeletal Msds durasi 30 JP (3 Hari Kerja) berlandaskan Permenaker No. PER.15/MEN/VIII/2008. Membahas pelaksanaan RJP/CPR 30:2, penggunaan defibrilator AED, triage luka bakar, dan penanganan trauma gawat darurat, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan K3 Ergonomi Pencegahan Gangguan Otot Rangka Musculoskeletal Msds adalah program pelatihan keselamatan kerja teknis berdurasi 30 JP (3 Hari Kerja) sesuai Permenaker No. PER.15/MEN/VIII/2008. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional penyelenggaraan pelayanan kesehatan kerja klinik perusahaan (Permen 03/1982), pemantauan audiometri, dan pertolongan pertama P3K 30 JP, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Ergonomi Pencegahan Gangguan Otot Rangka Musculoskeletal Msds",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Ergonomi Pencegahan Gangguan Otot Rangka Musculoskeletal Msds",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Ergonomi Pencegahan Gangguan Otot Rangka Musculoskeletal Msds melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan K3 Ergonomi Pencegahan Gangguan Otot Rangka Musculoskeletal Msds?",
      "answer": "Biaya resmi pelatihan Pelatihan K3 Ergonomi Pencegahan Gangguan Otot Rangka Musculoskeletal Msds adalah mulai Rp 3.750.000 untuk durasi 2 Hari (2 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 ergonomi pencegahan gangguan otot rangka musculoskeletal msds kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 ergonomi pencegahan gangguan otot rangka musculoskeletal msds",
  "primaryKeyword": "pelatihan k3 ergonomi pencegahan gangguan otot rangka musculoskeletal msds kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 ergonomi pencegahan gangguan otot rangka musculoskeletal msds",
