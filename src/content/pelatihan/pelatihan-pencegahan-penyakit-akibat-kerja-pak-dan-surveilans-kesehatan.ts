...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pencegahan Penyakit Akibat Kerja Pak Dan Surveilans Kesehatan?",
      "answer": "Biaya resmi pelatihan Pencegahan Penyakit Akibat Kerja Pak Dan Surveilans Kesehatan adalah Rp 3.750.000 (2 Hari). Investasi mencakup modul kurikulum medis kerja, alat peraga praktikum darurat, pembekalan dokter praktisi, dan penerbitan sertifikasi resmi."
    },
    {
