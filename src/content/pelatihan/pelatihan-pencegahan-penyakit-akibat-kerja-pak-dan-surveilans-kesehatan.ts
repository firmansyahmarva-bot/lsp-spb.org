...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-pencegahan-penyakit-akibat-kerja-pak-dan-surveilans-kesehatan",
  "title": "Pelatihan Pencegahan Penyakit Akibat Kerja Pak Dan Surveilans Kesehatan",
  "metaTitle": "Pelatihan Pencegahan Penyakit Akibat Kerja Pak Dan Surveilans Kesehatan | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Pencegahan Penyakit Akibat Kerja Pak Dan Surveilans Kesehatan durasi 30 JP (3 Hari Kerja) berlandaskan Permenaker No. PER.15/MEN/VIII/2008. Membahas pelaksanaan RJP/CPR 30:2, penggunaan defibrilator AED, triage luka bakar, dan penanganan trauma gawat darurat, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Pencegahan Penyakit Akibat Kerja Pak Dan Surveilans Kesehatan adalah program pelatihan keselamatan kerja teknis berdurasi 30 JP (3 Hari Kerja) sesuai Permenaker No. PER.15/MEN/VIII/2008. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional penyelenggaraan pelayanan kesehatan kerja klinik perusahaan (Permen 03/1982), pemantauan audiometri, dan pertolongan pertama P3K 30 JP, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Pencegahan Penyakit Akibat Kerja Pak Dan Surveilans Kesehatan",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Pencegahan Penyakit Akibat Kerja Pak Dan Surveilans Kesehatan",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Pencegahan Penyakit Akibat Kerja Pak Dan Surveilans Kesehatan melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan Pencegahan Penyakit Akibat Kerja Pak Dan Surveilans Kesehatan?",
      "answer": "Biaya resmi pelatihan Pelatihan Pencegahan Penyakit Akibat Kerja Pak Dan Surveilans Kesehatan adalah mulai Rp 4.250.000 untuk durasi 2 Hari (2 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan pencegahan penyakit akibat kerja pak dan surveilans kesehatan kemnaker jadwal, biaya, syarat pendaftaran, dan silabus pencegahan penyakit akibat kerja pak dan surveilans kesehatan",
  "primaryKeyword": "pelatihan pencegahan penyakit akibat kerja pak dan surveilans kesehatan kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus pencegahan penyakit akibat kerja pak dan surveilans kesehatan",
