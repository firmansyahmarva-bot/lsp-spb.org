...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-inspeksi-keselamatan-kebakaran-gedung-fire-safety-inspection",
  "title": "Pelatihan Inspeksi Keselamatan Kebakaran Gedung (Fire Safety Audit)",
  "metaTitle": "Pelatihan Inspeksi Keselamatan Kebakaran Gedung (Fire Safety Audit) | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan kebakaran resmi Pelatihan Inspeksi Keselamatan Kebakaran Gedung (Fire Safety Audit) durasi 24 JP (3 Hari Kerja). Penguasaan APAR Permenaker 04/1980, hydran, sprinkler, clean agent FM200, Fire Drill, dan lisensi K3 Kemnaker RI dengan PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Inspeksi Keselamatan Kebakaran Gedung (Fire Safety Audit) adalah program pembinaan keselamatan kebakaran berdurasi 24 JP (3 Hari Kerja) berlandaskan Permenaker No. PER.02/MEN/1983. Pelatihan ini membekali petugas dan tim tanggap darurat dengan kemampuan teknis memadamkan api (Kelas A/B/C/D), menginspeksi sistem proteksi aktif/pasif, serta memimpin evakuasi darurat gedung bertingkat.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Inspeksi Keselamatan Kebakaran Gedung",
  ...
  "blocks": [
    {
      "heading": "Landasan Hukum & Kewajiban Proteksi Kebakaran Pelatihan Inspeksi Keselamatan Kebakaran Gedung (Fire Safety Audit)",
      "paragraphs": [
        ...
        "Mengikuti Pelatihan Inspeksi Keselamatan Kebakaran Gedung (Fire Safety Audit) menjamin organisasi Anda memiliki personel berlisensi sah yang mampu bertindak cepat dalam 3 menit pertama kejadian sebelum bantuan pemadam kebakaran kota tiba."
      ]
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan inspeksi keselamatan kebakaran gedung kemnaker jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran inspeksi keselamatan kebakaran gedung",
  "primaryKeyword": "pelatihan inspeksi keselamatan kebakaran gedung kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran inspeksi keselamatan kebakaran gedung",
