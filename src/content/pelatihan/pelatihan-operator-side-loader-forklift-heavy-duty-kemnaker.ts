...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Operator Side Loader Forklift Heavy Duty Kemnaker",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Operator Side Loader Forklift Heavy Duty Kemnaker",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Operator Side Loader Forklift Heavy Duty Kemnaker melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Operator Side Loader Forklift Heavy Duty Kemnaker?",
      "answer": "Investasi resmi pelatihan operator Operator Side Loader Forklift Heavy Duty Kemnaker adalah Rp 4.500.000 (3 Hari). Biaya sudah mencakup modul materi keselamatan angkat-angkut, simulasi/praktik alat, evaluasi penguji Kemnaker RI, dan penerbitan SIO resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan operator side loader forklift heavy duty kemnaker kemnaker jadwal, biaya, syarat pendaftaran, dan silabus operator side loader forklift heavy duty kemnaker",
