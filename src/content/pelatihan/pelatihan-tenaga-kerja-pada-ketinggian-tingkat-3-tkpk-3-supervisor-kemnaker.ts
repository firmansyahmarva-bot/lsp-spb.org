...
export const record: ContentRecord = {
  ...
  "metaTitle": "Pelatihan Tenaga Kerja Pada Ketinggian Tingkat 3 Tkpk 3 Supervisor Kemnaker | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Tenaga Kerja Pada Ketinggian Tingkat 3 Tkpk 3 Supervisor Kemnaker durasi 30 JP (3 Hari Kerja) berlandaskan Permenaker No. 09 Tahun 2016. Membahas penerapan 3-point contact TKBT/TKPK, inspek harness lanyard, dan prosedur penanganan kecelakaan Suspension Trauma rescue, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Tenaga Kerja Pada Ketinggian Tingkat 3 Tkpk 3 Supervisor Kemnaker adalah program pelatihan keselamatan kerja teknis berdurasi 30 JP (3 Hari Kerja) sesuai Permenaker No. 09 Tahun 2016. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional penggunaan APD jatuh (fall arrest system), teknik perancangan titik angkur lifeline, serta pengoperasian SCBA di ruang terbatas, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Tenaga Kerja Pada Ketinggian Tingkat 3 Tkpk 3 Supervisor Kemnaker",
    ...
    "priceInfo": "Investasi resmi pelatihan keselamatan bekerja di ketinggian mulai Rp 12.500.000 (10 Hari). Sudah termasuk modul standar Permenaker 09/2016, pengenalan APD full body harness, bimbingan praktik instruktur berpengalaman, dan lisensi kerja resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 Tenaga Kerja Pada Ketinggian Tingkat 3 Tkpk 3 Supervisor Kemnaker",
      "paragraphs": [
        "Penyelenggaraan Pelatihan Tenaga Kerja Pada Ketinggian Tingkat 3 Tkpk 3 Supervisor Kemnaker merupakan kewajiban strategis dalam memitigasi bahaya operasional jatuh dari ketinggian fatalitas, kejebak gas H2S beracun di ruang terbatas, dan kehabisan oksigen di tempat kerja. Berdasarkan Permenaker No. 09 Tahun 2016, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Tenaga Kerja Pada Ketinggian Tingkat 3 Tkpk 3 Supervisor Kemnaker",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Tenaga Kerja Pada Ketinggian Tingkat 3 Tkpk 3 Supervisor Kemnaker melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Tenaga Kerja Pada Ketinggian Tingkat 3 Tkpk 3 Supervisor Kemnaker?",
      "answer": "Investasi resmi pembinaan Tenaga Kerja Pada Ketinggian Tingkat 3 Tkpk 3 Supervisor Kemnaker adalah Rp 12.500.000 (10 Hari). Fasilitas sudah termasuk modul teknis Permenaker 09/2016, instruktur bersertifikat, praktik penggunaan APD keselamatan kerja, dan penerbitan lisensi resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan tenaga kerja pada ketinggian tingkat 3 tkpk 3 supervisor kemnaker kemnaker jadwal, biaya, syarat pendaftaran, dan silabus tenaga kerja pada ketinggian tingkat 3 tkpk 3 supervisor kemnaker",
