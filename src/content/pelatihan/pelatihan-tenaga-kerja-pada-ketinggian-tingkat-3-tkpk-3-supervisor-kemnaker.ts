...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan Tenaga Kerja Pada Ketinggian Tingkat 3 Tkpk 3 Supervisor Kemnaker?",
      "answer": "Biaya resmi pelatihan Pelatihan Tenaga Kerja Pada Ketinggian Tingkat 3 Tkpk 3 Supervisor Kemnaker adalah mulai Rp 4.500.000 untuk durasi 3 Hari (3 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
