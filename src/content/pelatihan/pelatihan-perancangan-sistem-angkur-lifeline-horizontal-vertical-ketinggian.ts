...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "priceInfo": "Investasi resmi pelatihan keselamatan bekerja di ketinggian mulai Rp 4.750.000 (3 Hari). Sudah termasuk modul standar Permenaker 09/2016, pengenalan APD full body harness, bimbingan praktik instruktur berpengalaman, dan lisensi kerja resmi."
  },
  "blocks": [
    {
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Perancangan Sistem Angkur Lifeline Horizontal Vertical Ketinggian?",
      "answer": "Investasi resmi pembinaan Perancangan Sistem Angkur Lifeline Horizontal Vertical Ketinggian adalah Rp 4.750.000 (3 Hari). Fasilitas sudah termasuk modul teknis Permenaker 09/2016, instruktur bersertifikat, praktik penggunaan APD keselamatan kerja, dan penerbitan lisensi resmi."
    },
    {
