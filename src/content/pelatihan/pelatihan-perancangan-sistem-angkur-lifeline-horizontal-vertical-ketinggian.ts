...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-perancangan-sistem-angkur-lifeline-horizontal-vertical-ketinggian",
  "title": "Pelatihan Perancangan Sistem Angkur Lifeline Horizontal Vertical Ketinggian",
  "metaTitle": "Pelatihan Perancangan Sistem Angkur Lifeline Horizontal Vertical Ketinggian | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Perancangan Sistem Angkur Lifeline Horizontal Vertical Ketinggian durasi 30 JP (3 Hari Kerja) berlandaskan Permenaker No. 09 Tahun 2016. Membahas penerapan 3-point contact TKBT/TKPK, inspek harness lanyard, dan prosedur penanganan kecelakaan Suspension Trauma rescue, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Perancangan Sistem Angkur Lifeline Horizontal Vertical Ketinggian adalah program pelatihan keselamatan kerja teknis berdurasi 30 JP (3 Hari Kerja) sesuai Permenaker No. 09 Tahun 2016. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional penggunaan APD jatuh (fall arrest system), teknik perancangan titik angkur lifeline, serta pengoperasian SCBA di ruang terbatas, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Perancangan Sistem Angkur Lifeline Horizontal Vertical Ketinggian",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Perancangan Sistem Angkur Lifeline Horizontal Vertical Ketinggian",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Perancangan Sistem Angkur Lifeline Horizontal Vertical Ketinggian melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan Perancangan Sistem Angkur Lifeline Horizontal Vertical Ketinggian?",
      "answer": "Biaya resmi pelatihan Pelatihan Perancangan Sistem Angkur Lifeline Horizontal Vertical Ketinggian adalah mulai Rp 4.750.000 untuk durasi 3 Hari (3 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan perancangan sistem angkur lifeline horizontal vertical ketinggian kemnaker jadwal, biaya, syarat pendaftaran, dan silabus perancangan sistem angkur lifeline horizontal vertical ketinggian",
  "primaryKeyword": "pelatihan perancangan sistem angkur lifeline horizontal vertical ketinggian kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus perancangan sistem angkur lifeline horizontal vertical ketinggian",
