...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "priceInfo": "Biaya resmi pelatihan kesehatan kerja dan P3K mulai Rp 2.750.000 (1 Hari). Sudah mencakup pedoman standar medis kerja Permenaker 15/2008 atau Hiperkes Kemnaker, modul materi, kit praktikum medis darurat, dan sertifikat resmi."
  },
  "blocks": [
    {
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Penanganan Krisis Kesehatan Mental Dan Psychological First Aid Pfa?",
      "answer": "Biaya resmi pelatihan Penanganan Krisis Kesehatan Mental Dan Psychological First Aid Pfa adalah Rp 2.750.000 (1 Hari). Investasi mencakup modul kurikulum medis kerja, alat peraga praktikum darurat, pembekalan dokter praktisi, dan penerbitan sertifikasi resmi."
    },
    {
