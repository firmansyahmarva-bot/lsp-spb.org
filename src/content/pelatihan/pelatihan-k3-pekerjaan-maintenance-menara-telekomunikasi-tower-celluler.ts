...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Pekerjaan Maintenance Menara Telekomunikasi Tower Celluler",
    ...
    "priceInfo": "Investasi resmi pembinaan K3 Pekerjaan Maintenance Menara Telekomunikasi Tower Celluler mulai Rp 3.750.000 (2 Hari). Fasilitas lengkap mencakup modul kurikulum berstandar industri, bimbingan instruktur praktisi senior, evaluasi kompetensi, dan sertifikasi resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 K3 Pekerjaan Maintenance Menara Telekomunikasi Tower Celluler",
      "paragraphs": [
        "Penyelenggaraan Pelatihan K3 Pekerjaan Maintenance Menara Telekomunikasi Tower Celluler merupakan kewajiban strategis dalam memitigasi bahaya operasional jatuh dari ketinggian fatalitas, kejebak gas H2S beracun di ruang terbatas, dan kehabisan oksigen di tempat kerja. Berdasarkan Permenaker No. 09 Tahun 2016, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Pekerjaan Maintenance Menara Telekomunikasi Tower Celluler",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Pekerjaan Maintenance Menara Telekomunikasi Tower Celluler melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Pekerjaan Maintenance Menara Telekomunikasi Tower Celluler?",
      "answer": "Investasi pembinaan resmi K3 Pekerjaan Maintenance Menara Telekomunikasi Tower Celluler adalah Rp 3.750.000 untuk durasi 2 Hari. Biaya sudah mencakup modul pelatihan komprehensif, bimbingan instruktur berpengalaman, evaluasi kelulusan, dan penerbitan sertifikat resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 pekerjaan maintenance menara telekomunikasi tower celluler kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 pekerjaan maintenance menara telekomunikasi tower celluler",
  "primaryKeyword": "pelatihan k3 pekerjaan maintenance menara telekomunikasi tower celluler kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 pekerjaan maintenance menara telekomunikasi tower celluler",
