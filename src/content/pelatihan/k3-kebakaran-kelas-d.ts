...
export const record: ContentRecord = {
  ...
  "metaTitle": "Pelatihan Petugas Peran Kebakaran (Kelas D Sertifikasi Kemnaker RI) | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan kebakaran resmi Pelatihan Petugas Peran Kebakaran (Kelas D Sertifikasi Kemnaker RI) durasi 25 JP (3 Hari Kerja). Penguasaan APAR Permenaker 04/1980, hydran, sprinkler, clean agent FM200, Fire Drill, dan lisensi K3 Kemnaker RI dengan PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Petugas Peran Kebakaran (Kelas D Sertifikasi Kemnaker RI) adalah program pembinaan keselamatan kebakaran berdurasi 25 JP (3 Hari Kerja) berlandaskan Kepmenaker No. KEP.186/MEN/1999 Lampiran I. Pelatihan ini membekali petugas dan tim tanggap darurat dengan kemampuan teknis memadamkan api (Kelas A/B/C/D), menginspeksi sistem proteksi aktif/pasif, serta memimpin evakuasi darurat gedung bertingkat.",
  "highlights": [
    "Durasi Pelatihan: 25 JP (3 Hari Kerja)",
    "Landasan Hukum: Kepmenaker No. KEP.186/MEN/1999 Lampiran I",
  ...
  "courseDetails": {
    ...
    "legalBasis": "Kepmenaker No. KEP.186/MEN/1999 Lampiran I",
    "targetAudience": [
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Petugas Peran Kebakaran",
  ...
  "blocks": [
    {
      "heading": "Landasan Hukum & Kewajiban Proteksi Kebakaran Pelatihan Petugas Peran Kebakaran (Kelas D Sertifikasi Kemnaker RI)",
      "paragraphs": [
        "Bahaya kebakaran di lingkungan pabrik, gedung bertingkat, dan gudang logistik merupakan ancaman fatalitas terbesar yang dapat menghentikan kelangsungan bisnis. Oleh karena itu, Kepmenaker No. KEP.186/MEN/1999 Lampiran I mewajibkan pengurus tempat kerja membentuk unit penanggulangan kebakaran yang rasional sesuai jumlah tenaga kerja dan tingkat risiko.",
        "Mengikuti Pelatihan Petugas Peran Kebakaran (Kelas D Sertifikasi Kemnaker RI) menjamin organisasi Anda memiliki personel berlisensi sah yang mampu bertindak cepat dalam 3 menit pertama kejadian sebelum bantuan pemadam kebakaran kota tiba."
      ]
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan petugas peran kebakaran kemnaker jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran petugas peran kebakaran",
  "primaryKeyword": "pelatihan petugas peran kebakaran kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran petugas peran kebakaran",
