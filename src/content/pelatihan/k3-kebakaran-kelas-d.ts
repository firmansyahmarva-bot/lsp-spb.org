...
export const record: ContentRecord = {
  ...
  "indexable": true,
  "intent": "pelatihan petugas peran kebakaran (kelas d sertifikasi kemnaker ri) silabus biaya jadwal materi sertifikasi resmi",
  ...
  "image": {
    ...
    "alt": "Instruktur K3 memberikan pengarahan keselamatan sebelum simulasi pemadaman api APAR di lapangan"
  },
  "gallery": [
    {
      "src": "/images/content/briefing-pekerja-beralat-pelindung-di-fasilitas-industri-1.webp",
      "alt": "Briefing pekerja beralat pelindung diri sebelum simulasi kebakaran"
    },
    {
      "src": "/images/content/foto-bersama-pekerja-di-fasilitas-industri-1.webp",
      "alt": "Dokumentasi peserta pelatihan penanggulangan kebakaran di area industri"
    },
    {
      "src": "/images/content/peserta-mengikuti-pelatihan-di-kelas-1.webp",
      "alt": "Sesi penyampaian teori segitiga api dan regulasi Permenaker 04/1980"
    },
    {
      "src": "/images/content/asesmen-individu-peserta-di-ruang-kelas-1.webp",
      "alt": "Evaluasi tertulis kompetensi petugas peran kebakaran Kemnaker RI"
    }
  ]
};
