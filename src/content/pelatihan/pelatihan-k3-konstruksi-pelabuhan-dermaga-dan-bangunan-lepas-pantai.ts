...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-k3-konstruksi-pelabuhan-dermaga-dan-bangunan-lepas-pantai",
  "title": "Pelatihan K3 Konstruksi Pelabuhan Dermaga Dan Bangunan Lepas Pantai",
  "metaTitle": "Pelatihan K3 Konstruksi Pelabuhan Dermaga Dan Bangunan Lepas Pantai | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan K3 Konstruksi Pelabuhan Dermaga Dan Bangunan Lepas Pantai durasi 24 JP (3 Hari Kerja) berlandaskan Permen PUPR No. 10 Tahun 2021. Membahas penyusunan Rencana Keselamatan Konstruksi (RKK), proteksi penggalian tanah trenching shoring, dan inspeksi scaffolding Permen PUPR 10/2021, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan K3 Konstruksi Pelabuhan Dermaga Dan Bangunan Lepas Pantai adalah program pelatihan keselamatan kerja teknis berdurasi 24 JP (3 Hari Kerja) sesuai Permen PUPR No. 10 Tahun 2021. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional penerapan Sistem Manajemen Keselamatan Konstruksi (SMKK), inspeksi safety patrol proyek, dan pengawasan pekerjaan risiko tinggi, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Konstruksi Pelabuhan Dermaga Dan Bangunan Lepas Pantai",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Konstruksi Pelabuhan Dermaga Dan Bangunan Lepas Pantai",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Konstruksi Pelabuhan Dermaga Dan Bangunan Lepas Pantai melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Konstruksi Pelabuhan Dermaga Dan Bangunan Lepas Pantai?",
      "answer": "Biaya pelatihan resmi K3 Konstruksi Pelabuhan Dermaga Dan Bangunan Lepas Pantai adalah Rp 5.250.000 (3 Hari). Mencakup kurikulum SMKK Permen PUPR 10/2021, panduan implementasi RKK proyek, bimbingan instruktur ahli, dan sertifikasi kompetensi resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 konstruksi pelabuhan dermaga dan bangunan lepas pantai kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 konstruksi pelabuhan dermaga dan bangunan lepas pantai",
  "primaryKeyword": "pelatihan k3 konstruksi pelabuhan dermaga dan bangunan lepas pantai kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 konstruksi pelabuhan dermaga dan bangunan lepas pantai",
