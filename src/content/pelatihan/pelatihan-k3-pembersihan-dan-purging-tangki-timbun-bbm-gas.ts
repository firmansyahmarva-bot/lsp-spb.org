...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Pembersihan Dan Purging Tangki Timbun Bbm Gas?",
      "answer": "Biaya pembinaan resmi K3 Pembersihan Dan Purging Tangki Timbun Bbm Gas adalah Rp 4.750.000 untuk durasi 3 Hari. Investasi mencakup modul teknis Permenaker 37/2016, bimbingan operasional pesawat uap/bejana tekan, evaluasi kelulusan, dan sertifikasi lisensi resmi."
    },
    {
