...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-inspeksi-pengujian-katup-pengaman-tekanan-safety-valve-testing",
  "title": "Pelatihan Inspeksi Pengujian Katup Pengaman Tekanan Safety Valve Testing",
  "metaTitle": "Pelatihan Inspeksi Pengujian Katup Pengaman Tekanan Safety Valve Testing | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Inspeksi Pengujian Katup Pengaman Tekanan Safety Valve Testing durasi 30 JP (3 Hari Kerja) berlandaskan Permenaker No. 37 Tahun 2016. Membahas pengolahan air umpan boiler, kalibrasi katup pengaman (safety valve), dan pencegahan potensi ledakan BLEVE, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Inspeksi Pengujian Katup Pengaman Tekanan Safety Valve Testing adalah program pelatihan keselamatan kerja teknis berdurasi 30 JP (3 Hari Kerja) sesuai Permenaker No. 37 Tahun 2016. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional pengoperasian ketel uap bertekanan tinggi, kontrol blowdown air boiler, serta pengujian hydrostatic test bejana tekan, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Inspeksi Pengujian Katup Pengaman Tekanan Safety Valve Testing",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Inspeksi Pengujian Katup Pengaman Tekanan Safety Valve Testing",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Inspeksi Pengujian Katup Pengaman Tekanan Safety Valve Testing melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
  ...
  "indexable": true,
  "intent": "pelatihan inspeksi pengujian katup pengaman tekanan safety valve testing kemnaker jadwal, biaya, syarat pendaftaran, dan silabus inspeksi pengujian katup pengaman tekanan safety valve testing",
  "primaryKeyword": "pelatihan inspeksi pengujian katup pengaman tekanan safety valve testing kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus inspeksi pengujian katup pengaman tekanan safety valve testing",
