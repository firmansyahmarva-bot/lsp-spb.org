...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Operasional Gardu Induk Substation Listrik Tegangan Tinggi?",
      "answer": "Biaya resmi pembinaan K3 Operasional Gardu Induk Substation Listrik Tegangan Tinggi adalah Rp 5.250.000 untuk durasi 3 Hari. Investasi ini mencakup modul teknis PUIL 2020, bimbingan instruktur bersertifikasi, ujian evaluasi, serta penerbitan sertifikat dan lisensi resmi Kemnaker RI."
    },
    {
