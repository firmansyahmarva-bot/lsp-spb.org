...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Keselamatan Pengoperasian Stasiun Pengisian Kendaraan Listrik Spklu",
  ...
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 K3 Keselamatan Pengoperasian Stasiun Pengisian Kendaraan Listrik Spklu",
      "paragraphs": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Keselamatan Pengoperasian Stasiun Pengisian Kendaraan Listrik Spklu",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Keselamatan Pengoperasian Stasiun Pengisian Kendaraan Listrik Spklu melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Keselamatan Pengoperasian Stasiun Pengisian Kendaraan Listrik Spklu?",
      "answer": "Biaya resmi pembinaan K3 Keselamatan Pengoperasian Stasiun Pengisian Kendaraan Listrik Spklu adalah Rp 4.250.000 untuk durasi 2 Hari. Investasi ini mencakup modul teknis PUIL 2020, bimbingan instruktur bersertifikasi, ujian evaluasi, serta penerbitan sertifikat dan lisensi resmi Kemnaker RI."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 keselamatan pengoperasian stasiun pengisian kendaraan listrik spklu kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 keselamatan pengoperasian stasiun pengisian kendaraan listrik spklu",
  "primaryKeyword": "pelatihan k3 keselamatan pengoperasian stasiun pengisian kendaraan listrik spklu kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 keselamatan pengoperasian stasiun pengisian kendaraan listrik spklu",
