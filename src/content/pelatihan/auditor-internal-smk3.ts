...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "legalBasis": "PP No. 50 Tahun 2012 Pasal 14",
    "targetAudience": [
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI Resmi untuk Auditor Internal SMK3 Perusahaan",
  ...
  "indexable": true,
  "intent": "pelatihan auditor internal smk3 perusahaan kemnaker jadwal, biaya, syarat pendaftaran, dan sertifikasi auditor internal smk3 perusahaan",
  "primaryKeyword": "pelatihan auditor internal smk3 perusahaan kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan sertifikasi auditor internal smk3 perusahaan",
