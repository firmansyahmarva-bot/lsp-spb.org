...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-gizi-kerja-dan-penyelenggaraan-makanan-bagi-tenaga-kerja",
  "title": "Pelatihan Gizi Kerja Dan Penyelenggaraan Makanan Bagi Tenaga Kerja",
  "metaTitle": "Pelatihan Gizi Kerja Dan Penyelenggaraan Makanan Bagi Tenaga Kerja | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Gizi Kerja Dan Penyelenggaraan Makanan Bagi Tenaga Kerja durasi 30 JP (3 Hari Kerja) berlandaskan Permenaker No. PER.15/MEN/VIII/2008. Membahas pelaksanaan RJP/CPR 30:2, penggunaan defibrilator AED, triage luka bakar, dan penanganan trauma gawat darurat, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Gizi Kerja Dan Penyelenggaraan Makanan Bagi Tenaga Kerja adalah program pelatihan keselamatan kerja teknis berdurasi 30 JP (3 Hari Kerja) sesuai Permenaker No. PER.15/MEN/VIII/2008. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional penyelenggaraan pelayanan kesehatan kerja klinik perusahaan (Permen 03/1982), pemantauan audiometri, dan pertolongan pertama P3K 30 JP, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Gizi Kerja Dan Penyelenggaraan Makanan Bagi Tenaga Kerja",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Gizi Kerja Dan Penyelenggaraan Makanan Bagi Tenaga Kerja",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Gizi Kerja Dan Penyelenggaraan Makanan Bagi Tenaga Kerja melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Gizi Kerja Dan Penyelenggaraan Makanan Bagi Tenaga Kerja?",
      "answer": "Biaya resmi pelatihan Gizi Kerja Dan Penyelenggaraan Makanan Bagi Tenaga Kerja adalah Rp 2.750.000 (1 Hari). Investasi mencakup modul kurikulum medis kerja, alat peraga praktikum darurat, pembekalan dokter praktisi, dan penerbitan sertifikasi resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan gizi kerja dan penyelenggaraan makanan bagi tenaga kerja kemnaker jadwal, biaya, syarat pendaftaran, dan silabus gizi kerja dan penyelenggaraan makanan bagi tenaga kerja",
  "primaryKeyword": "pelatihan gizi kerja dan penyelenggaraan makanan bagi tenaga kerja kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus gizi kerja dan penyelenggaraan makanan bagi tenaga kerja",
