...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Pemasangan Sistem Proteksi Arus Bocor Elcb Rccd",
    ...
    "priceInfo": "Investasi resmi pembinaan K3 Pemasangan Sistem Proteksi Arus Bocor Elcb Rccd mulai Rp 3.750.000 (2 Hari). Fasilitas lengkap mencakup modul kurikulum berstandar industri, bimbingan instruktur praktisi senior, evaluasi kompetensi, dan sertifikasi resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 K3 Pemasangan Sistem Proteksi Arus Bocor Elcb Rccd",
      "paragraphs": [
        "Penyelenggaraan Pelatihan K3 Pemasangan Sistem Proteksi Arus Bocor Elcb Rccd merupakan kewajiban strategis dalam memitigasi bahaya operasional sengatan listrik tegangan tinggi, bahaya busur listrik (Arc Flash), dan potensi kebakaran akibat hubungan pendek jaringan panel di tempat kerja. Berdasarkan Permenaker No. 12 Tahun 2015, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Pemasangan Sistem Proteksi Arus Bocor Elcb Rccd",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Pemasangan Sistem Proteksi Arus Bocor Elcb Rccd melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Pemasangan Sistem Proteksi Arus Bocor Elcb Rccd?",
      "answer": "Investasi pembinaan resmi K3 Pemasangan Sistem Proteksi Arus Bocor Elcb Rccd adalah Rp 3.750.000 untuk durasi 2 Hari. Biaya sudah mencakup modul pelatihan komprehensif, bimbingan instruktur berpengalaman, evaluasi kelulusan, dan penerbitan sertifikat resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 pemasangan sistem proteksi arus bocor elcb rccd kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 pemasangan sistem proteksi arus bocor elcb rccd",
  "primaryKeyword": "pelatihan k3 pemasangan sistem proteksi arus bocor elcb rccd kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 pemasangan sistem proteksi arus bocor elcb rccd",
