...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Petugas K3 Kimia Sertifikasi Resmi Kemnaker RI",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Petugas K3 Kimia Sertifikasi Resmi Kemnaker RI melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan Petugas K3 Kimia Sertifikasi Resmi Kemnaker RI?",
      "answer": "Biaya resmi pelatihan Pelatihan Petugas K3 Kimia Sertifikasi Resmi Kemnaker RI adalah mulai Rp 4.250.000 untuk durasi 3 Hari (3 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan petugas k3 kimia sertifikasi resmi kemnaker ri jadwal, biaya, syarat pendaftaran, dan silabus petugas k3 kimia sertifikasi resmi kemnaker ri",
