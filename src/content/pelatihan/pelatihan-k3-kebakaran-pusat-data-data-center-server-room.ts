...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-k3-kebakaran-pusat-data-data-center-server-room",
  "title": "Pelatihan K3 Kebakaran Pusat Data (Data Center & Server Room)",
  "metaTitle": "Pelatihan K3 Kebakaran Pusat Data (Data Center & Server Room) | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan kebakaran resmi Pelatihan K3 Kebakaran Pusat Data (Data Center & Server Room) durasi 20 JP (2 Hari Kerja). Penguasaan APAR Permenaker 04/1980, hydran, sprinkler, clean agent FM200, Fire Drill, dan lisensi K3 Kemnaker RI dengan PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan K3 Kebakaran Pusat Data (Data Center & Server Room) adalah program pembinaan keselamatan kebakaran berdurasi 20 JP (2 Hari Kerja) berlandaskan NFPA 75 & Permenaker 02/1983. Pelatihan ini membekali petugas dan tim tanggap darurat dengan kemampuan teknis memadamkan api (Kelas A/B/C/D), menginspeksi sistem proteksi aktif/pasif, serta memimpin evakuasi darurat gedung bertingkat.",
  "highlights": [
    "Durasi Pelatihan: 20 JP (2 Hari Kerja)",
    "Landasan Hukum: NFPA 75 & Permenaker 02/1983",
  ...
  "courseDetails": {
    ...
    "legalBasis": "NFPA 75 & Permenaker 02/1983",
    "targetAudience": [
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Kebakaran Pusat Data",
  ...
  "blocks": [
    {
      "heading": "Landasan Hukum & Kewajiban Proteksi Kebakaran Pelatihan K3 Kebakaran Pusat Data (Data Center & Server Room)",
      "paragraphs": [
        "Bahaya kebakaran di lingkungan pabrik, gedung bertingkat, dan gudang logistik merupakan ancaman fatalitas terbesar yang dapat menghentikan kelangsungan bisnis. Oleh karena itu, NFPA 75 & Permenaker 02/1983 mewajibkan pengurus tempat kerja membentuk unit penanggulangan kebakaran yang rasional sesuai jumlah tenaga kerja dan tingkat risiko.",
        "Mengikuti Pelatihan K3 Kebakaran Pusat Data (Data Center & Server Room) menjamin organisasi Anda memiliki personel berlisensi sah yang mampu bertindak cepat dalam 3 menit pertama kejadian sebelum bantuan pemadam kebakaran kota tiba."
      ]
    },
    {
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan K3 Kebakaran Pusat Data (Data Center & Server Room)?",
      "answer": "Biaya resmi pelatihan Pelatihan K3 Kebakaran Pusat Data (Data Center & Server Room) adalah mulai Rp 4.250.000 untuk durasi 2 Hari (2 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 kebakaran pusat data kemnaker jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran k3 kebakaran pusat data",
  "primaryKeyword": "pelatihan k3 kebakaran pusat data kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran k3 kebakaran pusat data",
