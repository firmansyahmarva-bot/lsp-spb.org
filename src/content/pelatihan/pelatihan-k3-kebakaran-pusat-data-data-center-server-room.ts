...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Kebakaran Pusat Data (Data Center & Server Room)?",
      "answer": "Investasi resmi pembinaan penanggulangan kebakaran K3 Kebakaran Pusat Data (Data Center & Server Room) adalah Rp 4.250.000 (2 Hari). Biaya mencakup modul Kepmenaker 186/1999, praktik pemadaman api lapangan, evaluasi, dan sertifikat lisensi penunjukan resmi."
    },
    {
