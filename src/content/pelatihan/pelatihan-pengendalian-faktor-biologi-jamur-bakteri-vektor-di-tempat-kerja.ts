...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-pengendalian-faktor-biologi-jamur-bakteri-vektor-di-tempat-kerja",
  "title": "Pelatihan Pengendalian Faktor Biologi Jamur Bakteri Vektor Di Tempat Kerja",
  "metaTitle": "Pelatihan Pengendalian Faktor Biologi Jamur Bakteri Vektor Di Tempat Kerja | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Pengendalian Faktor Biologi Jamur Bakteri Vektor Di Tempat Kerja durasi 24 JP (3 Hari Kerja) berlandaskan Permenaker No. 05 Tahun 2018. Membahas pengukuran kebisingan (NAB 85 dBA 8 jam), evaluasi iklim kerja ISBB, sampling debu respirabel, dan analisis ergonomi REBA/RULA, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Pengendalian Faktor Biologi Jamur Bakteri Vektor Di Tempat Kerja adalah program pelatihan keselamatan kerja teknis berdurasi 24 JP (3 Hari Kerja) sesuai Permenaker No. 05 Tahun 2018. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional pengukuran faktor fisika, kimia, biologi, ergonomi, dan psikologi lingkungan kerja sesuai standar Permenaker 05/2018, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Pengendalian Faktor Biologi Jamur Bakteri Vektor Di Tempat Kerja",
    ...
    "priceInfo": "Investasi resmi pembinaan Pengendalian Faktor Biologi Jamur Bakteri Vektor Di Tempat Kerja mulai Rp 3.750.000 (2 Hari). Fasilitas lengkap mencakup modul kurikulum berstandar industri, bimbingan instruktur praktisi senior, evaluasi kompetensi, dan sertifikasi resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 Pengendalian Faktor Biologi Jamur Bakteri Vektor Di Tempat Kerja",
      "paragraphs": [
        "Penyelenggaraan Pelatihan Pengendalian Faktor Biologi Jamur Bakteri Vektor Di Tempat Kerja merupakan kewajiban strategis dalam memitigasi bahaya operasional penurunan pendengaran akibat kebisingan industri, stres panas (heat stress), dan gangguan otot rangka (MSDs) di tempat kerja. Berdasarkan Permenaker No. 05 Tahun 2018, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Pengendalian Faktor Biologi Jamur Bakteri Vektor Di Tempat Kerja",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Pengendalian Faktor Biologi Jamur Bakteri Vektor Di Tempat Kerja melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pengendalian Faktor Biologi Jamur Bakteri Vektor Di Tempat Kerja?",
      "answer": "Investasi pembinaan resmi Pengendalian Faktor Biologi Jamur Bakteri Vektor Di Tempat Kerja adalah Rp 3.750.000 untuk durasi 2 Hari. Biaya sudah mencakup modul pelatihan komprehensif, bimbingan instruktur berpengalaman, evaluasi kelulusan, dan penerbitan sertifikat resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan pengendalian faktor biologi jamur bakteri vektor di tempat kerja kemnaker jadwal, biaya, syarat pendaftaran, dan silabus pengendalian faktor biologi jamur bakteri vektor di tempat kerja",
  "primaryKeyword": "pelatihan pengendalian faktor biologi jamur bakteri vektor di tempat kerja kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus pengendalian faktor biologi jamur bakteri vektor di tempat kerja",
