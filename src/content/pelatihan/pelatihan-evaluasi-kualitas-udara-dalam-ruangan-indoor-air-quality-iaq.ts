...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan Evaluasi Kualitas Udara Dalam Ruangan Indoor Air Quality Iaq?",
      "answer": "Biaya resmi pelatihan Pelatihan Evaluasi Kualitas Udara Dalam Ruangan Indoor Air Quality Iaq adalah mulai Rp 3.750.000 untuk durasi 2 Hari (2 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
