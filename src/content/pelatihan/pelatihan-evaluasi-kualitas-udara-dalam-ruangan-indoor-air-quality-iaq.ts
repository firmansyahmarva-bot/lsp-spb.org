...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-evaluasi-kualitas-udara-dalam-ruangan-indoor-air-quality-iaq",
  "title": "Pelatihan Evaluasi Kualitas Udara Dalam Ruangan Indoor Air Quality Iaq",
  "metaTitle": "Pelatihan Evaluasi Kualitas Udara Dalam Ruangan Indoor Air Quality Iaq | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Evaluasi Kualitas Udara Dalam Ruangan Indoor Air Quality Iaq durasi 24 JP (3 Hari Kerja) berlandaskan Permenaker No. 05 Tahun 2018. Membahas pengukuran kebisingan (NAB 85 dBA 8 jam), evaluasi iklim kerja ISBB, sampling debu respirabel, dan analisis ergonomi REBA/RULA, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Evaluasi Kualitas Udara Dalam Ruangan Indoor Air Quality Iaq adalah program pelatihan keselamatan kerja teknis berdurasi 24 JP (3 Hari Kerja) sesuai Permenaker No. 05 Tahun 2018. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional pengukuran faktor fisika, kimia, biologi, ergonomi, dan psikologi lingkungan kerja sesuai standar Permenaker 05/2018, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Evaluasi Kualitas Udara Dalam Ruangan Indoor Air Quality Iaq",
    ...
    "priceInfo": "Investasi resmi pembinaan Evaluasi Kualitas Udara Dalam Ruangan Indoor Air Quality Iaq mulai Rp 3.750.000 (2 Hari). Fasilitas lengkap mencakup modul kurikulum berstandar industri, bimbingan instruktur praktisi senior, evaluasi kompetensi, dan sertifikasi resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 Evaluasi Kualitas Udara Dalam Ruangan Indoor Air Quality Iaq",
      "paragraphs": [
        "Penyelenggaraan Pelatihan Evaluasi Kualitas Udara Dalam Ruangan Indoor Air Quality Iaq merupakan kewajiban strategis dalam memitigasi bahaya operasional penurunan pendengaran akibat kebisingan industri, stres panas (heat stress), dan gangguan otot rangka (MSDs) di tempat kerja. Berdasarkan Permenaker No. 05 Tahun 2018, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Evaluasi Kualitas Udara Dalam Ruangan Indoor Air Quality Iaq",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Evaluasi Kualitas Udara Dalam Ruangan Indoor Air Quality Iaq melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Evaluasi Kualitas Udara Dalam Ruangan Indoor Air Quality Iaq?",
      "answer": "Investasi pembinaan resmi Evaluasi Kualitas Udara Dalam Ruangan Indoor Air Quality Iaq adalah Rp 3.750.000 untuk durasi 2 Hari. Biaya sudah mencakup modul pelatihan komprehensif, bimbingan instruktur berpengalaman, evaluasi kelulusan, dan penerbitan sertifikat resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan evaluasi kualitas udara dalam ruangan indoor air quality iaq kemnaker jadwal, biaya, syarat pendaftaran, dan silabus evaluasi kualitas udara dalam ruangan indoor air quality iaq",
  "primaryKeyword": "pelatihan evaluasi kualitas udara dalam ruangan indoor air quality iaq kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus evaluasi kualitas udara dalam ruangan indoor air quality iaq",
