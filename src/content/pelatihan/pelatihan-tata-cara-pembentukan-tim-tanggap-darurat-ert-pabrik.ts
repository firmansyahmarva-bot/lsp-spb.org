...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-tata-cara-pembentukan-tim-tanggap-darurat-ert-pabrik",
  "title": "Pelatihan Pembentukan Tim Tanggap Darurat (Emergency Response Team ERT)",
  "metaTitle": "Pelatihan Pembentukan Tim Tanggap Darurat (Emergency Response Team ERT) | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan kebakaran resmi Pelatihan Pembentukan Tim Tanggap Darurat (Emergency Response Team ERT) durasi 20 JP (2 Hari Kerja). Penguasaan APAR Permenaker 04/1980, hydran, sprinkler, clean agent FM200, Fire Drill, dan lisensi K3 Kemnaker RI dengan PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Pembentukan Tim Tanggap Darurat (Emergency Response Team ERT) adalah program pembinaan keselamatan kebakaran berdurasi 20 JP (2 Hari Kerja) berlandaskan Kepmenaker No. KEP.186/MEN/1999. Pelatihan ini membekali petugas dan tim tanggap darurat dengan kemampuan teknis memadamkan api (Kelas A/B/C/D), menginspeksi sistem proteksi aktif/pasif, serta memimpin evakuasi darurat gedung bertingkat.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Pembentukan Tim Tanggap Darurat",
  ...
  "blocks": [
    {
      "heading": "Landasan Hukum & Kewajiban Proteksi Kebakaran Pelatihan Pembentukan Tim Tanggap Darurat (Emergency Response Team ERT)",
      "paragraphs": [
        ...
        "Mengikuti Pelatihan Pembentukan Tim Tanggap Darurat (Emergency Response Team ERT) menjamin organisasi Anda memiliki personel berlisensi sah yang mampu bertindak cepat dalam 3 menit pertama kejadian sebelum bantuan pemadam kebakaran kota tiba."
      ]
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan pembentukan tim tanggap darurat kemnaker jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran pembentukan tim tanggap darurat",
  "primaryKeyword": "pelatihan pembentukan tim tanggap darurat kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran pembentukan tim tanggap darurat",
