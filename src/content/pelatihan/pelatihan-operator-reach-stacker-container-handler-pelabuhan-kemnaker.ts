...
export const record: ContentRecord = {
  ...
  "indexable": true,
  "intent": "pelatihan operator reach stacker container handler pelabuhan kemnaker jadwal, biaya, syarat pendaftaran, dan silabus operator reach stacker container handler pelabuhan kemnaker",
