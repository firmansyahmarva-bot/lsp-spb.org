...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Operator Reach Stacker Container Handler Pelabuhan Kemnaker",
    ...
    "priceInfo": "Investasi resmi pembinaan Operator Reach Stacker Container Handler Pelabuhan Kemnaker mulai Rp 5.000.000 (3 Hari). Fasilitas lengkap mencakup modul kurikulum berstandar industri, bimbingan instruktur praktisi senior, evaluasi kompetensi, dan sertifikasi resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 Operator Reach Stacker Container Handler Pelabuhan Kemnaker",
      "paragraphs": [
        "Penyelenggaraan Pelatihan Operator Reach Stacker Container Handler Pelabuhan Kemnaker merupakan kewajiban strategis dalam memitigasi bahaya operasional crane guling akibat kelebihan beban, tali sling putus, dan benturan beban gantung di area kerja logistik di tempat kerja. Berdasarkan Permenaker No. 08 Tahun 2020, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Operator Reach Stacker Container Handler Pelabuhan Kemnaker",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Operator Reach Stacker Container Handler Pelabuhan Kemnaker melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Operator Reach Stacker Container Handler Pelabuhan Kemnaker?",
      "answer": "Investasi pembinaan resmi Operator Reach Stacker Container Handler Pelabuhan Kemnaker adalah Rp 5.000.000 untuk durasi 3 Hari. Biaya sudah mencakup modul pelatihan komprehensif, bimbingan instruktur berpengalaman, evaluasi kelulusan, dan penerbitan sertifikat resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan operator reach stacker container handler pelabuhan kemnaker kemnaker jadwal, biaya, syarat pendaftaran, dan silabus operator reach stacker container handler pelabuhan kemnaker",
