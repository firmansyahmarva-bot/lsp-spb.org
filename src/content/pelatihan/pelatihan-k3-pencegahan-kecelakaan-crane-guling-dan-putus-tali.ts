...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Pencegahan Kecelakaan Crane Guling Dan Putus Tali",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Pencegahan Kecelakaan Crane Guling Dan Putus Tali",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Pencegahan Kecelakaan Crane Guling Dan Putus Tali melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Pencegahan Kecelakaan Crane Guling Dan Putus Tali?",
      "answer": "Investasi resmi pelatihan operator K3 Pencegahan Kecelakaan Crane Guling Dan Putus Tali adalah Rp 5.250.000 (3 Hari). Biaya sudah mencakup modul materi keselamatan angkat-angkut, simulasi/praktik alat, evaluasi penguji Kemnaker RI, dan penerbitan SIO resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 pencegahan kecelakaan crane guling dan putus tali kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 pencegahan kecelakaan crane guling dan putus tali",
  "primaryKeyword": "pelatihan k3 pencegahan kecelakaan crane guling dan putus tali kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 pencegahan kecelakaan crane guling dan putus tali",
