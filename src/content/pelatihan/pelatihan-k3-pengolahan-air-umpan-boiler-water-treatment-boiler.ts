...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Pengolahan Air Umpan Boiler Water Treatment Boiler",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Pengolahan Air Umpan Boiler Water Treatment Boiler",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Pengolahan Air Umpan Boiler Water Treatment Boiler melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Pengolahan Air Umpan Boiler Water Treatment Boiler?",
      "answer": "Biaya pembinaan resmi K3 Pengolahan Air Umpan Boiler Water Treatment Boiler adalah Rp 5.250.000 untuk durasi 3 Hari. Investasi mencakup modul teknis Permenaker 37/2016, bimbingan operasional pesawat uap/bejana tekan, evaluasi kelulusan, dan sertifikasi lisensi resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 pengolahan air umpan boiler water treatment boiler kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 pengolahan air umpan boiler water treatment boiler",
  "primaryKeyword": "pelatihan k3 pengolahan air umpan boiler water treatment boiler kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 pengolahan air umpan boiler water treatment boiler",
