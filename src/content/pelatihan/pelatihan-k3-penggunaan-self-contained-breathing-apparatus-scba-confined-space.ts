...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Penggunaan Self Contained Breathing Apparatus Scba Confined Space?",
      "answer": "Biaya resmi pelatihan K3 Penggunaan Self Contained Breathing Apparatus Scba Confined Space adalah Rp 3.750.000 untuk durasi 2 Hari. Fasilitas mencakup modul izin kerja confined space, deteksi gas berbahaya, simulasi evakuasi medis, dan sertifikasi resmi Kemnaker RI."
    },
    {
