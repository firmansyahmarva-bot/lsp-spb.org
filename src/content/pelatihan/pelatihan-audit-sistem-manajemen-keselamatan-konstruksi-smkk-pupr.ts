...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Audit Sistem Manajemen Keselamatan Konstruksi Smkk PUPR?",
      "answer": "Biaya pelatihan resmi Audit Sistem Manajemen Keselamatan Konstruksi Smkk PUPR adalah Rp 5.250.000 (3 Hari). Mencakup kurikulum SMKK Permen PUPR 10/2021, panduan implementasi RKK proyek, bimbingan instruktur ahli, dan sertifikasi kompetensi resmi."
    },
    {
