...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-audit-sistem-manajemen-keselamatan-konstruksi-smkk-pupr",
  "title": "Pelatihan Audit Sistem Manajemen Keselamatan Konstruksi Smkk PUPR",
  "metaTitle": "Pelatihan Audit Sistem Manajemen Keselamatan Konstruksi Smkk PUPR | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Audit Sistem Manajemen Keselamatan Konstruksi Smkk PUPR durasi 24 JP (3 Hari Kerja) berlandaskan Permen PUPR No. 10 Tahun 2021. Membahas penyusunan Rencana Keselamatan Konstruksi (RKK), proteksi penggalian tanah trenching shoring, dan inspeksi scaffolding Permen PUPR 10/2021, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Audit Sistem Manajemen Keselamatan Konstruksi Smkk PUPR adalah program pelatihan keselamatan kerja teknis berdurasi 24 JP (3 Hari Kerja) sesuai Permen PUPR No. 10 Tahun 2021. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional penerapan Sistem Manajemen Keselamatan Konstruksi (SMKK), inspeksi safety patrol proyek, dan pengawasan pekerjaan risiko tinggi, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Audit Sistem Manajemen Keselamatan Konstruksi Smkk PUPR",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Audit Sistem Manajemen Keselamatan Konstruksi Smkk PUPR",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Audit Sistem Manajemen Keselamatan Konstruksi Smkk PUPR melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan Audit Sistem Manajemen Keselamatan Konstruksi Smkk PUPR?",
      "answer": "Biaya resmi pelatihan Pelatihan Audit Sistem Manajemen Keselamatan Konstruksi Smkk PUPR adalah mulai Rp 5.250.000 untuk durasi 3 Hari (3 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan audit sistem manajemen keselamatan konstruksi smkk pupr kemnaker jadwal, biaya, syarat pendaftaran, dan silabus audit sistem manajemen keselamatan konstruksi smkk pupr",
  "primaryKeyword": "pelatihan audit sistem manajemen keselamatan konstruksi smkk pupr kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus audit sistem manajemen keselamatan konstruksi smkk pupr",
