...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-k3-pengukuran-dan-deteksi-gas-berbahaya-ruang-terbatas-gas-tester",
  "title": "Pelatihan K3 Pengukuran Dan Deteksi Gas Berbahaya Ruang Terbatas Gas Tester",
  "metaTitle": "Pelatihan K3 Pengukuran Dan Deteksi Gas Berbahaya Ruang Terbatas Gas Tester | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan K3 Pengukuran Dan Deteksi Gas Berbahaya Ruang Terbatas Gas Tester durasi 30 JP (3 Hari Kerja) berlandaskan Permenaker No. 09 Tahun 2016. Membahas penerapan 3-point contact TKBT/TKPK, inspek harness lanyard, dan prosedur penanganan kecelakaan Suspension Trauma rescue, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan K3 Pengukuran Dan Deteksi Gas Berbahaya Ruang Terbatas Gas Tester adalah program pelatihan keselamatan kerja teknis berdurasi 30 JP (3 Hari Kerja) sesuai Permenaker No. 09 Tahun 2016. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional penggunaan APD jatuh (fall arrest system), teknik perancangan titik angkur lifeline, serta pengoperasian SCBA di ruang terbatas, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Pengukuran Dan Deteksi Gas Berbahaya Ruang Terbatas Gas Tester",
    ...
    "priceInfo": "Biaya pembinaan K3 ruang terbatas (confined space) resmi mulai Rp 5.250.000 (3 Hari). Fasilitas mencakup modul izin kerja, pemantauan gas atmosferik berbahaya, simulasi prosedur tanggap darurat, dan sertifikasi resmi Kemnaker RI."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 K3 Pengukuran Dan Deteksi Gas Berbahaya Ruang Terbatas Gas Tester",
      "paragraphs": [
        "Penyelenggaraan Pelatihan K3 Pengukuran Dan Deteksi Gas Berbahaya Ruang Terbatas Gas Tester merupakan kewajiban strategis dalam memitigasi bahaya operasional jatuh dari ketinggian fatalitas, kejebak gas H2S beracun di ruang terbatas, dan kehabisan oksigen di tempat kerja. Berdasarkan Permenaker No. 09 Tahun 2016, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Pengukuran Dan Deteksi Gas Berbahaya Ruang Terbatas Gas Tester",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Pengukuran Dan Deteksi Gas Berbahaya Ruang Terbatas Gas Tester melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Pengukuran Dan Deteksi Gas Berbahaya Ruang Terbatas Gas Tester?",
      "answer": "Biaya resmi pelatihan K3 Pengukuran Dan Deteksi Gas Berbahaya Ruang Terbatas Gas Tester adalah Rp 5.250.000 untuk durasi 3 Hari. Fasilitas mencakup modul izin kerja confined space, deteksi gas berbahaya, simulasi evakuasi medis, dan sertifikasi resmi Kemnaker RI."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 pengukuran dan deteksi gas berbahaya ruang terbatas gas tester kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 pengukuran dan deteksi gas berbahaya ruang terbatas gas tester",
  "primaryKeyword": "pelatihan k3 pengukuran dan deteksi gas berbahaya ruang terbatas gas tester kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 pengukuran dan deteksi gas berbahaya ruang terbatas gas tester",
