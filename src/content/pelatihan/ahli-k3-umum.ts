...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "legalBasis": "Permenaker No. PER.02/MEN/1992 & UU No. 1 Tahun 1970",
    "targetAudience": [
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI Resmi untuk Ahli K3 Umum",
  ...
  "indexable": true,
  "intent": "pelatihan ahli k3 umum kemnaker jadwal, biaya, syarat pendaftaran, dan sertifikasi ahli k3 umum",
  "primaryKeyword": "pelatihan ahli k3 umum kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan sertifikasi ahli k3 umum",
