...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pemantauan Kesehatan Biologis Medical Surveillance Pekerja Kimia?",
      "answer": "Investasi resmi pelatihan Pemantauan Kesehatan Biologis Medical Surveillance Pekerja Kimia adalah Rp 4.250.000 (2 Hari). Biaya mencakup modul penanganan B3 Kepmenaker 187/1999, pembekalan instruktur praktisi, ujian evaluasi, dan penerbitan sertifikat resmi."
    },
    {
