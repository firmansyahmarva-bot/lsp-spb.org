...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Klasifikasi Pelabelan Bahan Kimia Berdasarkan Sistem Ghs?",
      "answer": "Investasi resmi pelatihan Klasifikasi Pelabelan Bahan Kimia Berdasarkan Sistem Ghs adalah Rp 3.250.000 (1 Hari). Biaya mencakup modul penanganan B3 Kepmenaker 187/1999, pembekalan instruktur praktisi, ujian evaluasi, dan penerbitan sertifikat resmi."
    },
    {
