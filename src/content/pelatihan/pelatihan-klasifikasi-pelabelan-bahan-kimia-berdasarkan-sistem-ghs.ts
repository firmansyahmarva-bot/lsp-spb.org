...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Klasifikasi Pelabelan Bahan Kimia Berdasarkan Sistem Ghs",
    ...
    "priceInfo": "Investasi resmi mulai Rp 3.250.000 (1 Hari / 1 Hari Kerja). Sudah mencakup modul pelatihan komprehensif, bimbingan instruktur praktisi, evaluasi kelulusan, dan sertifikasi resmi. Paket penawaran khusus tersedia untuk In-House Training perusahaan."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 Klasifikasi Pelabelan Bahan Kimia Berdasarkan Sistem Ghs",
      "paragraphs": [
        "Penyelenggaraan Pelatihan Klasifikasi Pelabelan Bahan Kimia Berdasarkan Sistem Ghs merupakan kewajiban strategis dalam memitigasi bahaya operasional kebocoran gas toksik amonia/klorin, tumpahan asam pekat korosif, dan risiko ledakan bahan kimia reaktif di tempat kerja. Berdasarkan Kepmenaker No. KEP.187/MEN/1999, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Klasifikasi Pelabelan Bahan Kimia Berdasarkan Sistem Ghs",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Klasifikasi Pelabelan Bahan Kimia Berdasarkan Sistem Ghs melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan Klasifikasi Pelabelan Bahan Kimia Berdasarkan Sistem Ghs?",
      "answer": "Biaya resmi pelatihan Pelatihan Klasifikasi Pelabelan Bahan Kimia Berdasarkan Sistem Ghs adalah mulai Rp 3.250.000 untuk durasi 1 Hari (1 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
      "question": "Kapan perusahaan kategori bahaya besar kimia wajib memiliki Ahli K3 Kimia?",
      "answer": "Perusahaan bahaya besar dengan kuantitas bahan kimia melebihi NAK wajib memiliki sekurang-kurangnya 1 orang Ahli K3 Kimia dan 2 orang Petugas K3 Kimia."
    },
    {
      "question": "Apa saja 16 bab utama yang wajib ada dalam dokumen SDS GHS?",
      "answer": "Antara lain Identifikasi Bahan, Bahaya, Komposisi, P3K, Pemadam Kebakaran, Tindakan Tumpahan, Penanganan/Penyimpanan, Kontrol Paparan/APD, Sifat Fisika Kimia, dan Stabilitas."
    },
    {
      "question": "Bagaimana cara menggunakan Spill Kit saat terjadi tumpahan bahan kimia di pabrik?",
      "answer": "Isolasi area tumpahan, gunakan APD respirator/sarung tangan sesuai SDS, tebarkan bahan penyerap (absorbent pad/granule), masukkan limbah ke kantong B3, dan lakukan dekontaminasi."
    }
  ],
  "related": [
  ...
  "indexable": true,
  "intent": "pelatihan klasifikasi pelabelan bahan kimia berdasarkan sistem ghs kemnaker jadwal, biaya, syarat pendaftaran, dan silabus klasifikasi pelabelan bahan kimia berdasarkan sistem ghs",
  "primaryKeyword": "pelatihan klasifikasi pelabelan bahan kimia berdasarkan sistem ghs kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus klasifikasi pelabelan bahan kimia berdasarkan sistem ghs",
  "intentType": "commercial",
  "parentTopic": "Pelatihan Bahan Kimia & B3",
  "cannibalizationGroup": "pelatihan-kimia",
  "contentKind": "program",
