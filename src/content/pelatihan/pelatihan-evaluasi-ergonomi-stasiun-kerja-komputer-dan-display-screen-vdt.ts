...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Evaluasi Ergonomi Stasiun Kerja Komputer Dan Display Screen Vdt?",
      "answer": "Biaya resmi pelatihan Evaluasi Ergonomi Stasiun Kerja Komputer Dan Display Screen Vdt adalah Rp 3.750.000 (2 Hari). Investasi mencakup modul kurikulum medis kerja, alat peraga praktikum darurat, pembekalan dokter praktisi, dan penerbitan sertifikasi resmi."
    },
    {
