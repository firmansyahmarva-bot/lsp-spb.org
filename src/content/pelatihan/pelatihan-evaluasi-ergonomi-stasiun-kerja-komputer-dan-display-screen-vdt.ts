...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-evaluasi-ergonomi-stasiun-kerja-komputer-dan-display-screen-vdt",
  "title": "Pelatihan Evaluasi Ergonomi Stasiun Kerja Komputer Dan Display Screen Vdt",
  "metaTitle": "Pelatihan Evaluasi Ergonomi Stasiun Kerja Komputer Dan Display Screen Vdt | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Evaluasi Ergonomi Stasiun Kerja Komputer Dan Display Screen Vdt durasi 24 JP (3 Hari Kerja) berlandaskan Permenaker No. 05 Tahun 2018. Membahas pengukuran kebisingan (NAB 85 dBA 8 jam), evaluasi iklim kerja ISBB, sampling debu respirabel, dan analisis ergonomi REBA/RULA, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Evaluasi Ergonomi Stasiun Kerja Komputer Dan Display Screen Vdt adalah program pelatihan keselamatan kerja teknis berdurasi 24 JP (3 Hari Kerja) sesuai Permenaker No. 05 Tahun 2018. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional pengukuran faktor fisika, kimia, biologi, ergonomi, dan psikologi lingkungan kerja sesuai standar Permenaker 05/2018, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Evaluasi Ergonomi Stasiun Kerja Komputer Dan Display Screen Vdt",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Evaluasi Ergonomi Stasiun Kerja Komputer Dan Display Screen Vdt",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Evaluasi Ergonomi Stasiun Kerja Komputer Dan Display Screen Vdt melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan Evaluasi Ergonomi Stasiun Kerja Komputer Dan Display Screen Vdt?",
      "answer": "Biaya resmi pelatihan Pelatihan Evaluasi Ergonomi Stasiun Kerja Komputer Dan Display Screen Vdt adalah mulai Rp 3.750.000 untuk durasi 2 Hari (2 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan evaluasi ergonomi stasiun kerja komputer dan display screen vdt kemnaker jadwal, biaya, syarat pendaftaran, dan silabus evaluasi ergonomi stasiun kerja komputer dan display screen vdt",
  "primaryKeyword": "pelatihan evaluasi ergonomi stasiun kerja komputer dan display screen vdt kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus evaluasi ergonomi stasiun kerja komputer dan display screen vdt",
