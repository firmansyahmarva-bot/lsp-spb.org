...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "priceInfo": "Investasi pelatihan K3 lingkungan kerja resmi mulai Rp 6.500.000 (5 Hari). Termasuk modul pengukuran faktor fisika-kimia Permenaker 05/2018, bimbingan penggunaan alat ukur lingkungan industri, evaluasi kompetensi, dan sertifikasi resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 Higiene Industri Muda Himu Sertifikasi BNSP Kemnaker",
      "paragraphs": [
        "Penyelenggaraan Pelatihan Higiene Industri Muda Himu Sertifikasi BNSP Kemnaker merupakan kewajiban strategis dalam memitigasi bahaya operasional penurunan pendengaran akibat kebisingan industri, stres panas (heat stress), dan gangguan otot rangka (MSDs) di tempat kerja. Berdasarkan Permenaker No. 05 Tahun 2018, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Higiene Industri Muda Himu Sertifikasi BNSP Kemnaker",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Higiene Industri Muda Himu Sertifikasi BNSP Kemnaker melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Higiene Industri Muda Himu Sertifikasi BNSP Kemnaker?",
      "answer": "Investasi resmi pelatihan Higiene Industri Muda Himu Sertifikasi BNSP Kemnaker adalah Rp 6.500.000 (5 Hari). Sudah termasuk modul pengukuran faktor fisika-kimia Permenaker 05/2018, bimbingan teknis laboratorium/lapangan, evaluasi kelulusan, dan sertifikat resmi."
    },
    {
