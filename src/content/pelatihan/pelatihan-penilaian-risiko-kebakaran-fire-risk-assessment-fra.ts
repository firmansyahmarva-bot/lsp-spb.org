...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-penilaian-risiko-kebakaran-fire-risk-assessment-fra",
  "title": "Pelatihan Penilaian Risiko Kebakaran (Fire Risk Assessment FRA)",
  "metaTitle": "Pelatihan Penilaian Risiko Kebakaran (Fire Risk Assessment FRA) | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan kebakaran resmi Pelatihan Penilaian Risiko Kebakaran (Fire Risk Assessment FRA) durasi 20 JP (2 Hari Kerja). Penguasaan APAR Permenaker 04/1980, hydran, sprinkler, clean agent FM200, Fire Drill, dan lisensi K3 Kemnaker RI dengan PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Penilaian Risiko Kebakaran (Fire Risk Assessment FRA) adalah program pembinaan keselamatan kebakaran berdurasi 20 JP (2 Hari Kerja) berlandaskan Kepmenaker No. KEP.186/MEN/1999. Pelatihan ini membekali petugas dan tim tanggap darurat dengan kemampuan teknis memadamkan api (Kelas A/B/C/D), menginspeksi sistem proteksi aktif/pasif, serta memimpin evakuasi darurat gedung bertingkat.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Penilaian Risiko Kebakaran",
  ...
  "blocks": [
    {
      "heading": "Landasan Hukum & Kewajiban Proteksi Kebakaran Pelatihan Penilaian Risiko Kebakaran (Fire Risk Assessment FRA)",
      "paragraphs": [
        ...
        "Mengikuti Pelatihan Penilaian Risiko Kebakaran (Fire Risk Assessment FRA) menjamin organisasi Anda memiliki personel berlisensi sah yang mampu bertindak cepat dalam 3 menit pertama kejadian sebelum bantuan pemadam kebakaran kota tiba."
      ]
    },
    {
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan Penilaian Risiko Kebakaran (Fire Risk Assessment FRA)?",
      "answer": "Biaya resmi pelatihan Pelatihan Penilaian Risiko Kebakaran (Fire Risk Assessment FRA) adalah mulai Rp 4.250.000 untuk durasi 2 Hari (2 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan penilaian risiko kebakaran kemnaker jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran penilaian risiko kebakaran",
  "primaryKeyword": "pelatihan penilaian risiko kebakaran kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran penilaian risiko kebakaran",
