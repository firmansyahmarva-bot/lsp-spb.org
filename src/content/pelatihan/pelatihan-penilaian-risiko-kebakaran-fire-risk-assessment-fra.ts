...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Penilaian Risiko Kebakaran (Fire Risk Assessment FRA)?",
      "answer": "Investasi resmi pembinaan penanggulangan kebakaran Penilaian Risiko Kebakaran (Fire Risk Assessment FRA) adalah Rp 4.250.000 (2 Hari). Biaya mencakup modul Kepmenaker 186/1999, praktik pemadaman api lapangan, evaluasi, dan sertifikat lisensi penunjukan resmi."
    },
    {
