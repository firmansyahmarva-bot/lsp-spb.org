...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-audit-kepatuhan-sistem-proteksi-kebakaran-permenaker-02-1983",
  "title": "Pelatihan Audit Kepatuhan Sistem Proteksi Kebakaran (Permenaker 02/1983)",
  "metaTitle": "Pelatihan Audit Kepatuhan Sistem Proteksi Kebakaran (Permenaker 02/1983) | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan kebakaran resmi Pelatihan Audit Kepatuhan Sistem Proteksi Kebakaran (Permenaker 02/1983) durasi 24 JP (3 Hari Kerja). Penguasaan APAR Permenaker 04/1980, hydran, sprinkler, clean agent FM200, Fire Drill, dan lisensi K3 Kemnaker RI dengan PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Audit Kepatuhan Sistem Proteksi Kebakaran (Permenaker 02/1983) adalah program pembinaan keselamatan kebakaran berdurasi 24 JP (3 Hari Kerja) berlandaskan Permenaker No. PER.02/MEN/1983. Pelatihan ini membekali petugas dan tim tanggap darurat dengan kemampuan teknis memadamkan api (Kelas A/B/C/D), menginspeksi sistem proteksi aktif/pasif, serta memimpin evakuasi darurat gedung bertingkat.",
  "highlights": [
    "Durasi Pelatihan: 24 JP (3 Hari Kerja)",
    "Landasan Hukum: Permenaker No. PER.02/MEN/1983",
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Audit Kepatuhan Sistem Proteksi Kebakaran",
  ...
  "blocks": [
    {
      "heading": "Landasan Hukum & Kewajiban Proteksi Kebakaran Pelatihan Audit Kepatuhan Sistem Proteksi Kebakaran (Permenaker 02/1983)",
      "paragraphs": [
        "Bahaya kebakaran di lingkungan pabrik, gedung bertingkat, dan gudang logistik merupakan ancaman fatalitas terbesar yang dapat menghentikan kelangsungan bisnis. Oleh karena itu, Permenaker No. PER.02/MEN/1983 mewajibkan pengurus tempat kerja membentuk unit penanggulangan kebakaran yang rasional sesuai jumlah tenaga kerja dan tingkat risiko.",
        "Mengikuti Pelatihan Audit Kepatuhan Sistem Proteksi Kebakaran (Permenaker 02/1983) menjamin organisasi Anda memiliki personel berlisensi sah yang mampu bertindak cepat dalam 3 menit pertama kejadian sebelum bantuan pemadam kebakaran kota tiba."
      ]
    },
    {
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan Audit Kepatuhan Sistem Proteksi Kebakaran (Permenaker 02/1983)?",
      "answer": "Biaya resmi pelatihan Pelatihan Audit Kepatuhan Sistem Proteksi Kebakaran (Permenaker 02/1983) adalah mulai Rp 5.250.000 untuk durasi 3 Hari (3 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan audit kepatuhan sistem proteksi kebakaran kemnaker jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran audit kepatuhan sistem proteksi kebakaran",
  "primaryKeyword": "pelatihan audit kepatuhan sistem proteksi kebakaran kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran audit kepatuhan sistem proteksi kebakaran",
