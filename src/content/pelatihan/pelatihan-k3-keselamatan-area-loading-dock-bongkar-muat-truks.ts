...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Keselamatan Area Loading Dock Bongkar Muat Truks",
    ...
    "priceInfo": "Investasi resmi pembinaan K3 Keselamatan Area Loading Dock Bongkar Muat Truks mulai Rp 2.750.000 (1 Hari). Fasilitas lengkap mencakup modul kurikulum berstandar industri, bimbingan instruktur praktisi senior, evaluasi kompetensi, dan sertifikasi resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 K3 Keselamatan Area Loading Dock Bongkar Muat Truks",
      "paragraphs": [
        "Penyelenggaraan Pelatihan K3 Keselamatan Area Loading Dock Bongkar Muat Truks merupakan kewajiban strategis dalam memitigasi bahaya operasional crane guling akibat kelebihan beban, tali sling putus, dan benturan beban gantung di area kerja logistik di tempat kerja. Berdasarkan Permenaker No. 08 Tahun 2020, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Keselamatan Area Loading Dock Bongkar Muat Truks",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Keselamatan Area Loading Dock Bongkar Muat Truks melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Keselamatan Area Loading Dock Bongkar Muat Truks?",
      "answer": "Investasi pembinaan resmi K3 Keselamatan Area Loading Dock Bongkar Muat Truks adalah Rp 2.750.000 untuk durasi 1 Hari. Biaya sudah mencakup modul pelatihan komprehensif, bimbingan instruktur berpengalaman, evaluasi kelulusan, dan penerbitan sertifikat resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 keselamatan area loading dock bongkar muat truks kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 keselamatan area loading dock bongkar muat truks",
  "primaryKeyword": "pelatihan k3 keselamatan area loading dock bongkar muat truks kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 keselamatan area loading dock bongkar muat truks",
