...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-inspeksi-pemeliharaan-full-body-harness-dan-lanyard-ketinggian",
  "title": "Pelatihan Inspeksi Pemeliharaan Full Body Harness Dan Lanyard Ketinggian",
  "metaTitle": "Pelatihan Inspeksi Pemeliharaan Full Body Harness Dan Lanyard Ketinggian | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Inspeksi Pemeliharaan Full Body Harness Dan Lanyard Ketinggian durasi 30 JP (3 Hari Kerja) berlandaskan Permenaker No. 09 Tahun 2016. Membahas penerapan 3-point contact TKBT/TKPK, inspek harness lanyard, dan prosedur penanganan kecelakaan Suspension Trauma rescue, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Inspeksi Pemeliharaan Full Body Harness Dan Lanyard Ketinggian adalah program pelatihan keselamatan kerja teknis berdurasi 30 JP (3 Hari Kerja) sesuai Permenaker No. 09 Tahun 2016. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional penggunaan APD jatuh (fall arrest system), teknik perancangan titik angkur lifeline, serta pengoperasian SCBA di ruang terbatas, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Inspeksi Pemeliharaan Full Body Harness Dan Lanyard Ketinggian",
    ...
    "priceInfo": "Investasi resmi pelatihan keselamatan bekerja di ketinggian mulai Rp 2.750.000 (1 Hari). Sudah termasuk modul standar Permenaker 09/2016, pengenalan APD full body harness, bimbingan praktik instruktur berpengalaman, dan lisensi kerja resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 Inspeksi Pemeliharaan Full Body Harness Dan Lanyard Ketinggian",
      "paragraphs": [
        "Penyelenggaraan Pelatihan Inspeksi Pemeliharaan Full Body Harness Dan Lanyard Ketinggian merupakan kewajiban strategis dalam memitigasi bahaya operasional jatuh dari ketinggian fatalitas, kejebak gas H2S beracun di ruang terbatas, dan kehabisan oksigen di tempat kerja. Berdasarkan Permenaker No. 09 Tahun 2016, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Inspeksi Pemeliharaan Full Body Harness Dan Lanyard Ketinggian",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Inspeksi Pemeliharaan Full Body Harness Dan Lanyard Ketinggian melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Inspeksi Pemeliharaan Full Body Harness Dan Lanyard Ketinggian?",
      "answer": "Investasi resmi pembinaan Inspeksi Pemeliharaan Full Body Harness Dan Lanyard Ketinggian adalah Rp 2.750.000 (1 Hari). Fasilitas sudah termasuk modul teknis Permenaker 09/2016, instruktur bersertifikat, praktik penggunaan APD keselamatan kerja, dan penerbitan lisensi resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan inspeksi pemeliharaan full body harness dan lanyard ketinggian kemnaker jadwal, biaya, syarat pendaftaran, dan silabus inspeksi pemeliharaan full body harness dan lanyard ketinggian",
  "primaryKeyword": "pelatihan inspeksi pemeliharaan full body harness dan lanyard ketinggian kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus inspeksi pemeliharaan full body harness dan lanyard ketinggian",
