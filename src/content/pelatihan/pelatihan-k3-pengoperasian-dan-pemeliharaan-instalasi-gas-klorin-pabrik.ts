...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-k3-pengoperasian-dan-pemeliharaan-instalasi-gas-klorin-pabrik",
  "title": "Pelatihan K3 Pengoperasian Dan Pemeliharaan Instalasi Gas Klorin Pabrik",
  "metaTitle": "Pelatihan K3 Pengoperasian Dan Pemeliharaan Instalasi Gas Klorin Pabrik | Jadwal, Biaya & Sertifikasi Resmi",
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Pengoperasian Dan Pemeliharaan Instalasi Gas Klorin Pabrik",
    ...
    "priceInfo": "Investasi resmi pembinaan K3 Pengoperasian Dan Pemeliharaan Instalasi Gas Klorin Pabrik mulai Rp 3.750.000 (2 Hari). Fasilitas lengkap mencakup modul kurikulum berstandar industri, bimbingan instruktur praktisi senior, evaluasi kompetensi, dan sertifikasi resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 K3 Pengoperasian Dan Pemeliharaan Instalasi Gas Klorin Pabrik",
      "paragraphs": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Pengoperasian Dan Pemeliharaan Instalasi Gas Klorin Pabrik",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Pengoperasian Dan Pemeliharaan Instalasi Gas Klorin Pabrik melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Pengoperasian Dan Pemeliharaan Instalasi Gas Klorin Pabrik?",
      "answer": "Investasi pembinaan resmi K3 Pengoperasian Dan Pemeliharaan Instalasi Gas Klorin Pabrik adalah Rp 3.750.000 untuk durasi 2 Hari. Biaya sudah mencakup modul pelatihan komprehensif, bimbingan instruktur berpengalaman, evaluasi kelulusan, dan penerbitan sertifikat resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 pengoperasian dan pemeliharaan instalasi gas klorin pabrik kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 pengoperasian dan pemeliharaan instalasi gas klorin pabrik",
  "primaryKeyword": "pelatihan k3 pengoperasian dan pemeliharaan instalasi gas klorin pabrik kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 pengoperasian dan pemeliharaan instalasi gas klorin pabrik",
