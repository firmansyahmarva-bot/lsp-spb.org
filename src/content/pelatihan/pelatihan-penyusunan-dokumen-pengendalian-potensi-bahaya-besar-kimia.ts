...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Penyusunan Dokumen Pengendalian Potensi Bahaya Besar Kimia",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Penyusunan Dokumen Pengendalian Potensi Bahaya Besar Kimia",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Penyusunan Dokumen Pengendalian Potensi Bahaya Besar Kimia melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan Penyusunan Dokumen Pengendalian Potensi Bahaya Besar Kimia?",
      "answer": "Biaya resmi pelatihan Pelatihan Penyusunan Dokumen Pengendalian Potensi Bahaya Besar Kimia adalah mulai Rp 3.750.000 untuk durasi 2 Hari (2 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan penyusunan dokumen pengendalian potensi bahaya besar kimia kemnaker jadwal, biaya, syarat pendaftaran, dan silabus penyusunan dokumen pengendalian potensi bahaya besar kimia",
  "primaryKeyword": "pelatihan penyusunan dokumen pengendalian potensi bahaya besar kimia kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus penyusunan dokumen pengendalian potensi bahaya besar kimia",
