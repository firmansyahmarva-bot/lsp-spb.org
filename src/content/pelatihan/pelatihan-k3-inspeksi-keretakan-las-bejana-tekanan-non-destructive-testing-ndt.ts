...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Inspeksi Keretakan Las Bejana Tekanan Non Destructive Testing Ndt",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Inspeksi Keretakan Las Bejana Tekanan Non Destructive Testing Ndt",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Inspeksi Keretakan Las Bejana Tekanan Non Destructive Testing Ndt melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Inspeksi Keretakan Las Bejana Tekanan Non Destructive Testing Ndt?",
      "answer": "Biaya pembinaan resmi K3 Inspeksi Keretakan Las Bejana Tekanan Non Destructive Testing Ndt adalah Rp 5.250.000 untuk durasi 3 Hari. Investasi mencakup modul teknis Permenaker 37/2016, bimbingan operasional pesawat uap/bejana tekan, evaluasi kelulusan, dan sertifikasi lisensi resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 inspeksi keretakan las bejana tekanan non destructive testing ndt kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 inspeksi keretakan las bejana tekanan non destructive testing ndt",
  "primaryKeyword": "pelatihan k3 inspeksi keretakan las bejana tekanan non destructive testing ndt kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 inspeksi keretakan las bejana tekanan non destructive testing ndt",
