...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Penanganan Material Secara Manual Manual Material Handling",
    ...
    "priceInfo": "Investasi resmi pembinaan K3 Penanganan Material Secara Manual Manual Material Handling mulai Rp 2.750.000 (1 Hari). Fasilitas lengkap mencakup modul kurikulum berstandar industri, bimbingan instruktur praktisi senior, evaluasi kompetensi, dan sertifikasi resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 K3 Penanganan Material Secara Manual Manual Material Handling",
      "paragraphs": [
        "Penyelenggaraan Pelatihan K3 Penanganan Material Secara Manual Manual Material Handling merupakan kewajiban strategis dalam memitigasi bahaya operasional crane guling akibat kelebihan beban, tali sling putus, dan benturan beban gantung di area kerja logistik di tempat kerja. Berdasarkan Permenaker No. 08 Tahun 2020, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Penanganan Material Secara Manual Manual Material Handling",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Penanganan Material Secara Manual Manual Material Handling melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Penanganan Material Secara Manual Manual Material Handling?",
      "answer": "Investasi pembinaan resmi K3 Penanganan Material Secara Manual Manual Material Handling adalah Rp 2.750.000 untuk durasi 1 Hari. Biaya sudah mencakup modul pelatihan komprehensif, bimbingan instruktur berpengalaman, evaluasi kelulusan, dan penerbitan sertifikat resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 penanganan material secara manual manual material handling kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 penanganan material secara manual manual material handling",
  "primaryKeyword": "pelatihan k3 penanganan material secara manual manual material handling kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 penanganan material secara manual manual material handling",
