...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-penyusunan-job-safety-analysis-jsa-pekerjaan-konstruksi-risiko-tinggi",
  "title": "Pelatihan Penyusunan Job Safety Analysis Jsa Pekerjaan Konstruksi Risiko Tinggi",
  "metaTitle": "Pelatihan Penyusunan Job Safety Analysis Jsa Pekerjaan Konstruksi Risiko Tinggi | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Penyusunan Job Safety Analysis Jsa Pekerjaan Konstruksi Risiko Tinggi durasi 24 JP (3 Hari Kerja) berlandaskan Permen PUPR No. 10 Tahun 2021. Membahas penyusunan Rencana Keselamatan Konstruksi (RKK), proteksi penggalian tanah trenching shoring, dan inspeksi scaffolding Permen PUPR 10/2021, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Penyusunan Job Safety Analysis Jsa Pekerjaan Konstruksi Risiko Tinggi adalah program pelatihan keselamatan kerja teknis berdurasi 24 JP (3 Hari Kerja) sesuai Permen PUPR No. 10 Tahun 2021. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional penerapan Sistem Manajemen Keselamatan Konstruksi (SMKK), inspeksi safety patrol proyek, dan pengawasan pekerjaan risiko tinggi, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Penyusunan Job Safety Analysis Jsa Pekerjaan Konstruksi Risiko Tinggi",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Penyusunan Job Safety Analysis Jsa Pekerjaan Konstruksi Risiko Tinggi",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Penyusunan Job Safety Analysis Jsa Pekerjaan Konstruksi Risiko Tinggi melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan Penyusunan Job Safety Analysis Jsa Pekerjaan Konstruksi Risiko Tinggi?",
      "answer": "Biaya resmi pelatihan Pelatihan Penyusunan Job Safety Analysis Jsa Pekerjaan Konstruksi Risiko Tinggi adalah mulai Rp 3.750.000 untuk durasi 2 Hari (2 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan penyusunan job safety analysis jsa pekerjaan konstruksi risiko tinggi kemnaker jadwal, biaya, syarat pendaftaran, dan silabus penyusunan job safety analysis jsa pekerjaan konstruksi risiko tinggi",
  "primaryKeyword": "pelatihan penyusunan job safety analysis jsa pekerjaan konstruksi risiko tinggi kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus penyusunan job safety analysis jsa pekerjaan konstruksi risiko tinggi",
