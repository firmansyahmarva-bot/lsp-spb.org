...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Penyusunan Job Safety Analysis Jsa Pekerjaan Konstruksi Risiko Tinggi?",
      "answer": "Biaya pelatihan resmi Penyusunan Job Safety Analysis Jsa Pekerjaan Konstruksi Risiko Tinggi adalah Rp 5.250.000 (3 Hari). Mencakup kurikulum SMKK Permen PUPR 10/2021, panduan implementasi RKK proyek, bimbingan instruktur ahli, dan sertifikasi kompetensi resmi."
    },
    {
