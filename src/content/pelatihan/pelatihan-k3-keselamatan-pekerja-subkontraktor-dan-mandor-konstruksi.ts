...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Keselamatan Pekerja Subkontraktor Dan Mandor Konstruksi?",
      "answer": "Biaya pelatihan resmi K3 Keselamatan Pekerja Subkontraktor Dan Mandor Konstruksi adalah Rp 5.250.000 (3 Hari). Mencakup kurikulum SMKK Permen PUPR 10/2021, panduan implementasi RKK proyek, bimbingan instruktur ahli, dan sertifikasi kompetensi resmi."
    },
    {
