...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-k3-pengoperasian-bejana-tekan-kompresor-udara-pabrik",
  "title": "Pelatihan K3 Pengoperasian Bejana Tekan Kompresor Udara Pabrik",
  "metaTitle": "Pelatihan K3 Pengoperasian Bejana Tekan Kompresor Udara Pabrik | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan K3 Pengoperasian Bejana Tekan Kompresor Udara Pabrik durasi 30 JP (3 Hari Kerja) berlandaskan Permenaker No. 37 Tahun 2016. Membahas pengolahan air umpan boiler, kalibrasi katup pengaman (safety valve), dan pencegahan potensi ledakan BLEVE, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Pengoperasian Bejana Tekan Kompresor Udara Pabrik",
  ...
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 K3 Pengoperasian Bejana Tekan Kompresor Udara Pabrik",
      "paragraphs": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Pengoperasian Bejana Tekan Kompresor Udara Pabrik",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Pengoperasian Bejana Tekan Kompresor Udara Pabrik melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Pengoperasian Bejana Tekan Kompresor Udara Pabrik?",
      "answer": "Biaya pembinaan resmi K3 Pengoperasian Bejana Tekan Kompresor Udara Pabrik adalah Rp 5.250.000 untuk durasi 3 Hari. Investasi mencakup modul teknis Permenaker 37/2016, bimbingan operasional pesawat uap/bejana tekan, evaluasi kelulusan, dan sertifikasi lisensi resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 pengoperasian bejana tekan kompresor udara pabrik kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 pengoperasian bejana tekan kompresor udara pabrik",
  "primaryKeyword": "pelatihan k3 pengoperasian bejana tekan kompresor udara pabrik kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 pengoperasian bejana tekan kompresor udara pabrik",
