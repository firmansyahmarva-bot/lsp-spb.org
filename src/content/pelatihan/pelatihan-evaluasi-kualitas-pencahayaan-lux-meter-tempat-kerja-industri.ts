...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-evaluasi-kualitas-pencahayaan-lux-meter-tempat-kerja-industri",
  "title": "Pelatihan Evaluasi Kualitas Pencahayaan Lux Meter Tempat Kerja Industri",
  "metaTitle": "Pelatihan Evaluasi Kualitas Pencahayaan Lux Meter Tempat Kerja Industri | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Evaluasi Kualitas Pencahayaan Lux Meter Tempat Kerja Industri durasi 24 JP (3 Hari Kerja) berlandaskan Permenaker No. 05 Tahun 2018. Membahas pengukuran kebisingan (NAB 85 dBA 8 jam), evaluasi iklim kerja ISBB, sampling debu respirabel, dan analisis ergonomi REBA/RULA, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Evaluasi Kualitas Pencahayaan Lux Meter Tempat Kerja Industri adalah program pelatihan keselamatan kerja teknis berdurasi 24 JP (3 Hari Kerja) sesuai Permenaker No. 05 Tahun 2018. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional pengukuran faktor fisika, kimia, biologi, ergonomi, dan psikologi lingkungan kerja sesuai standar Permenaker 05/2018, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Evaluasi Kualitas Pencahayaan Lux Meter Tempat Kerja Industri",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Evaluasi Kualitas Pencahayaan Lux Meter Tempat Kerja Industri",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Evaluasi Kualitas Pencahayaan Lux Meter Tempat Kerja Industri melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Evaluasi Kualitas Pencahayaan Lux Meter Tempat Kerja Industri?",
      "answer": "Investasi resmi pelatihan Evaluasi Kualitas Pencahayaan Lux Meter Tempat Kerja Industri adalah Rp 3.750.000 (2 Hari). Sudah termasuk modul pengukuran faktor fisika-kimia Permenaker 05/2018, bimbingan teknis laboratorium/lapangan, evaluasi kelulusan, dan sertifikat resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan evaluasi kualitas pencahayaan lux meter tempat kerja industri kemnaker jadwal, biaya, syarat pendaftaran, dan silabus evaluasi kualitas pencahayaan lux meter tempat kerja industri",
  "primaryKeyword": "pelatihan evaluasi kualitas pencahayaan lux meter tempat kerja industri kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus evaluasi kualitas pencahayaan lux meter tempat kerja industri",
