...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan Evaluasi Kualitas Pencahayaan Lux Meter Tempat Kerja Industri?",
      "answer": "Biaya resmi pelatihan Pelatihan Evaluasi Kualitas Pencahayaan Lux Meter Tempat Kerja Industri adalah mulai Rp 3.750.000 untuk durasi 2 Hari (2 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
