...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-manajemen-tanggap-darurat-kebakaran-emergency-response",
  "title": "Pelatihan Manajemen Tanggap Darurat Kebakaran (Emergency Response)",
  "metaTitle": "Pelatihan Manajemen Tanggap Darurat Kebakaran (Emergency Response) | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan kebakaran resmi Pelatihan Manajemen Tanggap Darurat Kebakaran (Emergency Response) durasi 24 JP (3 Hari Kerja). Penguasaan APAR Permenaker 04/1980, hydran, sprinkler, clean agent FM200, Fire Drill, dan lisensi K3 Kemnaker RI dengan PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Manajemen Tanggap Darurat Kebakaran (Emergency Response) adalah program pembinaan keselamatan kebakaran berdurasi 24 JP (3 Hari Kerja) berlandaskan Kepmenaker No. KEP.186/MEN/1999. Pelatihan ini membekali petugas dan tim tanggap darurat dengan kemampuan teknis memadamkan api (Kelas A/B/C/D), menginspeksi sistem proteksi aktif/pasif, serta memimpin evakuasi darurat gedung bertingkat.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Manajemen Tanggap Darurat Kebakaran",
  ...
  "blocks": [
    {
      "heading": "Landasan Hukum & Kewajiban Proteksi Kebakaran Pelatihan Manajemen Tanggap Darurat Kebakaran (Emergency Response)",
      "paragraphs": [
        ...
        "Mengikuti Pelatihan Manajemen Tanggap Darurat Kebakaran (Emergency Response) menjamin organisasi Anda memiliki personel berlisensi sah yang mampu bertindak cepat dalam 3 menit pertama kejadian sebelum bantuan pemadam kebakaran kota tiba."
      ]
    },
    {
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Manajemen Tanggap Darurat Kebakaran (Emergency Response)?",
      "answer": "Investasi resmi pembinaan penanggulangan kebakaran Manajemen Tanggap Darurat Kebakaran (Emergency Response) adalah Rp 5.250.000 (3 Hari). Biaya mencakup modul Kepmenaker 186/1999, praktik pemadaman api lapangan, evaluasi, dan sertifikat lisensi penunjukan resmi."
    },
    {
  ...
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan lisensi petugas kebakaran manajemen tanggap darurat kebakaran",
