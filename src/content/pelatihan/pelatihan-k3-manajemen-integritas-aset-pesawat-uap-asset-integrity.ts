...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Manajemen Integritas Aset Pesawat Uap Asset Integrity",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Manajemen Integritas Aset Pesawat Uap Asset Integrity",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Manajemen Integritas Aset Pesawat Uap Asset Integrity melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Manajemen Integritas Aset Pesawat Uap Asset Integrity?",
      "answer": "Biaya pembinaan resmi K3 Manajemen Integritas Aset Pesawat Uap Asset Integrity adalah Rp 4.750.000 untuk durasi 3 Hari. Investasi mencakup modul teknis Permenaker 37/2016, bimbingan operasional pesawat uap/bejana tekan, evaluasi kelulusan, dan sertifikasi lisensi resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 manajemen integritas aset pesawat uap asset integrity kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 manajemen integritas aset pesawat uap asset integrity",
  "primaryKeyword": "pelatihan k3 manajemen integritas aset pesawat uap asset integrity kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 manajemen integritas aset pesawat uap asset integrity",
