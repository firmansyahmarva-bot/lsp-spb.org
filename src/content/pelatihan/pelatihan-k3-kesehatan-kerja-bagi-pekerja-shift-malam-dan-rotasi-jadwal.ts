...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-k3-kesehatan-kerja-bagi-pekerja-shift-malam-dan-rotasi-jadwal",
  "title": "Pelatihan K3 Kesehatan Kerja Bagi Pekerja Shift Malam Dan Rotasi Jadwal",
  "metaTitle": "Pelatihan K3 Kesehatan Kerja Bagi Pekerja Shift Malam Dan Rotasi Jadwal | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan K3 Kesehatan Kerja Bagi Pekerja Shift Malam Dan Rotasi Jadwal durasi 30 JP (3 Hari Kerja) berlandaskan Permenaker No. PER.15/MEN/VIII/2008. Membahas pelaksanaan RJP/CPR 30:2, penggunaan defibrilator AED, triage luka bakar, dan penanganan trauma gawat darurat, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan K3 Kesehatan Kerja Bagi Pekerja Shift Malam Dan Rotasi Jadwal adalah program pelatihan keselamatan kerja teknis berdurasi 30 JP (3 Hari Kerja) sesuai Permenaker No. PER.15/MEN/VIII/2008. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional penyelenggaraan pelayanan kesehatan kerja klinik perusahaan (Permen 03/1982), pemantauan audiometri, dan pertolongan pertama P3K 30 JP, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk K3 Kesehatan Kerja Bagi Pekerja Shift Malam Dan Rotasi Jadwal",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter K3 Kesehatan Kerja Bagi Pekerja Shift Malam Dan Rotasi Jadwal",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan K3 Kesehatan Kerja Bagi Pekerja Shift Malam Dan Rotasi Jadwal melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Pelatihan K3 Kesehatan Kerja Bagi Pekerja Shift Malam Dan Rotasi Jadwal?",
      "answer": "Biaya resmi pelatihan Pelatihan K3 Kesehatan Kerja Bagi Pekerja Shift Malam Dan Rotasi Jadwal adalah mulai Rp 4.250.000 untuk durasi 2 Hari (2 Hari Kerja). Biaya sudah termasuk modul pelatihan, evaluasi kelulusan resmi, dan sertifikat pembinaan. Tersedia diskon khusus untuk pendaftaran kolektif atau In-House Training perusahaan."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan k3 kesehatan kerja bagi pekerja shift malam dan rotasi jadwal kemnaker jadwal, biaya, syarat pendaftaran, dan silabus k3 kesehatan kerja bagi pekerja shift malam dan rotasi jadwal",
  "primaryKeyword": "pelatihan k3 kesehatan kerja bagi pekerja shift malam dan rotasi jadwal kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus k3 kesehatan kerja bagi pekerja shift malam dan rotasi jadwal",
