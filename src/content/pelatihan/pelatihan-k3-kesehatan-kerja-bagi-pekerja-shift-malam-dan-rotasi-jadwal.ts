...
export const record: ContentRecord = {
  ...
  "blocks": [
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan K3 Kesehatan Kerja Bagi Pekerja Shift Malam Dan Rotasi Jadwal?",
      "answer": "Biaya resmi pelatihan K3 Kesehatan Kerja Bagi Pekerja Shift Malam Dan Rotasi Jadwal adalah Rp 3.750.000 (2 Hari). Investasi mencakup modul kurikulum medis kerja, alat peraga praktikum darurat, pembekalan dokter praktisi, dan penerbitan sertifikasi resmi."
    },
    {
