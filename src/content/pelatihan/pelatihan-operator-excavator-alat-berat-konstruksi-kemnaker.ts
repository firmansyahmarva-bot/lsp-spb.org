...
export const record: ContentRecord = {
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Operator Excavator Alat Berat Konstruksi Kemnaker",
  ...
  "blocks": [
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Operator Excavator Alat Berat Konstruksi Kemnaker",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Operator Excavator Alat Berat Konstruksi Kemnaker melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Operator Excavator Alat Berat Konstruksi Kemnaker?",
      "answer": "Investasi resmi pelatihan operator Operator Excavator Alat Berat Konstruksi Kemnaker adalah Rp 4.500.000 (3 Hari). Biaya sudah mencakup modul materi keselamatan angkat-angkut, simulasi/praktik alat, evaluasi penguji Kemnaker RI, dan penerbitan SIO resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan operator excavator alat berat konstruksi kemnaker kemnaker jadwal, biaya, syarat pendaftaran, dan silabus operator excavator alat berat konstruksi kemnaker",
