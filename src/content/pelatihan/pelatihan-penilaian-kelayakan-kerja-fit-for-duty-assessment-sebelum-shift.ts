...
export const record: ContentRecord = {
  "section": "pelatihan",
  "slug": "pelatihan-penilaian-kelayakan-kerja-fit-for-duty-assessment-sebelum-shift",
  "title": "Pelatihan Penilaian Kelayakan Kerja Fit For Duty Assessment Sebelum Shift",
  "metaTitle": "Pelatihan Penilaian Kelayakan Kerja Fit For Duty Assessment Sebelum Shift | Jadwal, Biaya & Sertifikasi Resmi",
  "description": "Pelatihan Penilaian Kelayakan Kerja Fit For Duty Assessment Sebelum Shift durasi 30 JP (3 Hari Kerja) berlandaskan Permenaker No. PER.15/MEN/VIII/2008. Membahas pelaksanaan RJP/CPR 30:2, penggunaan defibrilator AED, triage luka bakar, dan penanganan trauma gawat darurat, mitigasi risiko bahaya, dan uji sertifikasi resmi PT Kreasi Ultimate Berjaya.",
  "answer": "Pelatihan Penilaian Kelayakan Kerja Fit For Duty Assessment Sebelum Shift adalah program pelatihan keselamatan kerja teknis berdurasi 30 JP (3 Hari Kerja) sesuai Permenaker No. PER.15/MEN/VIII/2008. Pelatihan ini membekali teknisi dan pengawas dengan keahlian operasional penyelenggaraan pelayanan kesehatan kerja klinik perusahaan (Permen 03/1982), pemantauan audiometri, dan pertolongan pertama P3K 30 JP, inspeksi peralatan, dan pemenuhan regulasi K3 nasional.",
  "highlights": [
  ...
  "courseDetails": {
    ...
    "certificationOutput": [
      "Sertifikat Pembinaan Kemnaker RI untuk Penilaian Kelayakan Kerja Fit For Duty Assessment Sebelum Shift",
    ...
    "priceInfo": "Investasi resmi pembinaan Penilaian Kelayakan Kerja Fit For Duty Assessment Sebelum Shift mulai Rp 2.750.000 (1 Hari). Fasilitas lengkap mencakup modul kurikulum berstandar industri, bimbingan instruktur praktisi senior, evaluasi kompetensi, dan sertifikasi resmi."
  },
  "blocks": [
    {
      "heading": "Urgensi & Penegakan Regulasi K3 Penilaian Kelayakan Kerja Fit For Duty Assessment Sebelum Shift",
      "paragraphs": [
        "Penyelenggaraan Pelatihan Penilaian Kelayakan Kerja Fit For Duty Assessment Sebelum Shift merupakan kewajiban strategis dalam memitigasi bahaya operasional serangan jantung mendadak tempat kerja, pendarahan hebat kecelakaan mesin, dan kecelakaan trauma fisik di tempat kerja. Berdasarkan Permenaker No. PER.15/MEN/VIII/2008, pengurus tempat kerja diwajibkan memastikan seluruh personel teknis dan pengawas memiliki kompetensi teruji.",
    ...
    {
      "heading": "Silabus Teknis & Penguasaan Parameter Penilaian Kelayakan Kerja Fit For Duty Assessment Sebelum Shift",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        "PT Kreasi Ultimate Berjaya menyelenggarakan Pelatihan Penilaian Kelayakan Kerja Fit For Duty Assessment Sebelum Shift melalui Public Class Blended Learning serta layanan In-House Training on-site di seluruh Indonesia.",
    ...
    "faqs": [
    {
      "question": "Berapa biaya resmi pelatihan Penilaian Kelayakan Kerja Fit For Duty Assessment Sebelum Shift?",
      "answer": "Investasi pembinaan resmi Penilaian Kelayakan Kerja Fit For Duty Assessment Sebelum Shift adalah Rp 2.750.000 untuk durasi 1 Hari. Biaya sudah mencakup modul pelatihan komprehensif, bimbingan instruktur berpengalaman, evaluasi kelulusan, dan penerbitan sertifikat resmi."
    },
    {
  ...
  "indexable": true,
  "intent": "pelatihan penilaian kelayakan kerja fit for duty assessment sebelum shift kemnaker jadwal, biaya, syarat pendaftaran, dan silabus penilaian kelayakan kerja fit for duty assessment sebelum shift",
  "primaryKeyword": "pelatihan penilaian kelayakan kerja fit for duty assessment sebelum shift kemnaker",
  "searchIntent": "jadwal, biaya, syarat pendaftaran, dan silabus penilaian kelayakan kerja fit for duty assessment sebelum shift",
