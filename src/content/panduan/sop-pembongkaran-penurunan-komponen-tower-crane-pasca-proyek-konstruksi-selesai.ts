...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pembongkaran-penurunan-komponen-tower-crane-pasca-proyek-konstruksi-selesai",
  "title": "SOP Pembongkaran & Penurunan Komponen Tower Crane Pasca-Proyek Konstruksi Selesai",
  "metaTitle": "SOP Pembongkaran & Penurunan Komponen Tower Crane Pasca-Proyek Konstruksi Selesai | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pembongkaran & Penurunan Komponen Tower Crane Pasca-Proyek Konstruksi Selesai di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut, dan tindakan darurat.",
  "answer": "SOP Pembongkaran & Penurunan Komponen Tower Crane Pasca-Proyek Konstruksi Selesai adalah instruksi kerja keselamatan baku dalam klaster Pesawat Angkat & Pesawat Angkut (PAA & Rigging) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pembongkaran & Penurunan Komponen Tower Crane Pasca-Proyek Konstruksi Selesai",
      "paragraphs": [
        "Penerapan SOP Pembongkaran & Penurunan Komponen Tower Crane Pasca-Proyek Konstruksi Selesai bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Angkat & Pesawat Angkut (PAA & Rigging). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya beban gantung jatuh, crane guling akibat kelebihan beban, dan jepitan sling mekanik telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pembongkaran-penurunan-komponen-tower-crane-pasca-proyek-konstruksi-selesai sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pembongkaran penurunan komponen tower crane pasca proyek konstruksi selesai kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pembongkaran & Penurunan Komponen Tower Crane Pasca-Proyek Konstruksi Selesai",
