...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-penerapan-housekeeping-5s-5r-di-area-workshop-gudang-produksi",
  "title": "SOP Penerapan Housekeeping 5S / 5R Di Area Workshop & Gudang Produksi",
  "metaTitle": "SOP Penerapan Housekeeping 5S / 5R Di Area Workshop & Gudang Produksi | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Penerapan Housekeeping 5S / 5R Di Area Workshop & Gudang Produksi di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 05 Tahun 2018 tentang K3 Lingkungan Kerja, dan tindakan darurat.",
  "answer": "SOP Penerapan Housekeeping 5S / 5R Di Area Workshop & Gudang Produksi adalah instruksi kerja keselamatan baku dalam klaster Higiene Industri & Lingkungan Kerja (Occupational Hygiene) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 05 Tahun 2018 tentang K3 Lingkungan Kerja guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Penerapan Housekeeping 5S / 5R Di Area Workshop & Gudang Produksi",
      "paragraphs": [
        "Penerapan SOP Penerapan Housekeeping 5S / 5R Di Area Workshop & Gudang Produksi bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Higiene Industri & Lingkungan Kerja (Occupational Hygiene). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya penurunan pendengaran kebisingan (NIHL), stres panas iklim kerja, dan gangguan otot MSDs telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-penerapan-housekeeping-5s-5r-di-area-workshop-gudang-produksi sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop penerapan housekeeping 5s 5r di area workshop gudang produksi kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Penerapan Housekeeping 5S / 5R Di Area Workshop & Gudang Produksi",
