...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-penanganan-darurat-sengatan-listrik-evakuasi-personel-maintenance-bertegangan",
  "title": "SOP Penanganan Darurat Sengatan Listrik & Evakuasi Personel Maintenance Bertegangan",
  "metaTitle": "SOP Penanganan Darurat Sengatan Listrik & Evakuasi Personel Maintenance Bertegangan | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Penanganan Darurat Sengatan Listrik & Evakuasi Personel Maintenance Bertegangan di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 12 Tahun 2015 & SNI 0225:2020 PUIL 2020, dan tindakan darurat.",
  "answer": "SOP Penanganan Darurat Sengatan Listrik & Evakuasi Personel Maintenance Bertegangan adalah instruksi kerja keselamatan baku dalam klaster Kelistrikan & Isolasi Energi (Electrical LOTO) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 12 Tahun 2015 & SNI 0225:2020 PUIL 2020 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Penanganan Darurat Sengatan Listrik & Evakuasi Personel Maintenance Bertegangan",
      "paragraphs": [
        "Penerapan SOP Penanganan Darurat Sengatan Listrik & Evakuasi Personel Maintenance Bertegangan bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Kelistrikan & Isolasi Energi (Electrical LOTO). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya sengatan listrik tegangan tinggi, busur api Arc Flash, dan hubungan pendek arus listrik telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-penanganan-darurat-sengatan-listrik-evakuasi-personel-maintenance-bertegangan sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop penanganan darurat sengatan listrik evakuasi personel maintenance bertegangan kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Penanganan Darurat Sengatan Listrik & Evakuasi Personel Maintenance Bertegangan",
