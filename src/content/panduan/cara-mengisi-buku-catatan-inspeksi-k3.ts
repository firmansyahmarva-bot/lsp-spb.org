...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "cara-mengisi-buku-catatan-inspeksi-k3",
  "title": "Panduan Cara Mengisi Logbook & Buku Catatan Inspeksi K3 Terjadwal",
  "metaTitle": "Panduan Cara Mengisi Logbook & Buku Catatan Inspeksi K3 Terjadwal | Informasi & Persyaratan Resmi",
  "description": "Format pencatatan temuan unsafe action, unsafe condition, tindakan korektif sementara, dan tanggal verifikasi penutupan (closing).",
  "answer": "Panduan Cara Mengisi Logbook & Buku Catatan Inspeksi K3 Terjadwal memberikan instruksi komprehensif berlandaskan PP No. 50 Tahun 2012 untuk membantu calon peserta, praktisi HSE, dan manajemen perusahaan memenuhi persyaratan regulasi, estimasi biaya, serta kelengkapan administrasi K3 secara tepat.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Kerangka Acuan & Regulasi Panduan Cara Mengisi Logbook & Buku Catatan Inspeksi K3 Terjadwal",
      "paragraphs": [
        "Penjelasan lengkap mengenai Panduan Cara Mengisi Logbook & Buku Catatan Inspeksi K3 Terjadwal disusun secara mendalam berdasarkan PP No. 50 Tahun 2012 dan petunjuk teknis Kementerian Ketenagakerjaan RI. Memahami panduan ini sangat penting bagi individu maupun instansi perusahaan untuk memastikan seluruh proses administrasi dan teknis berjalan sesuai standar hukum.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Hubungi tim admisi kami untuk konsultasi langsung mengenai Panduan Cara Mengisi Logbook & Buku Catatan Inspeksi K3 Terjadwal. Kami melayani verifikasi kelayakan ijazah gratis dan penyusunan proposal corporate in-house training."
      ]
    }
  ],
  "faqs": [
    {
      "question": "Apa langkah pertama dalam mengurus Panduan Cara Mengisi Logbook & Buku Catatan Inspeksi K3 Terjadwal?",
    ...
    {
      "question": "Berapa lama estimasi waktu proses pengurusan Panduan Cara Mengisi Logbook & Buku Catatan Inspeksi K3 Terjadwal?",
  ...
  "indexable": true,
  "intent": "panduan cara mengisi buku catatan inspeksi k3 Format pencatatan temuan unsafe action, unsafe condition, tindakan korektif sementara, dan tanggal verifikasi penutupan (closing).",
  "primaryKeyword": "panduan cara mengisi buku catatan inspeksi k3",
  "searchIntent": "Format pencatatan temuan unsafe action, unsafe condition, tindakan korektif sementara, dan tanggal verifikasi penutupan (closing).",
