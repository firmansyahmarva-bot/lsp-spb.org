...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-penanganan-insiden-struktur-roboh-evakuasi-pekerja-proyek",
  "title": "SOP Penanganan Insiden Struktur Roboh & Evakuasi Pekerja Proyek",
  "metaTitle": "SOP Penanganan Insiden Struktur Roboh & Evakuasi Pekerja Proyek | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Penanganan Insiden Struktur Roboh & Evakuasi Pekerja Proyek di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permen PUPR No. 10 Tahun 2021 tentang SMKK, dan tindakan darurat.",
  "answer": "SOP Penanganan Insiden Struktur Roboh & Evakuasi Pekerja Proyek adalah instruksi kerja keselamatan baku dalam klaster Konstruksi & SMKK PUPR (Construction Safety) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permen PUPR No. 10 Tahun 2021 tentang SMKK guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Penanganan Insiden Struktur Roboh & Evakuasi Pekerja Proyek",
      "paragraphs": [
        "Penerapan SOP Penanganan Insiden Struktur Roboh & Evakuasi Pekerja Proyek bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Konstruksi & SMKK PUPR (Construction Safety). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya runtuhan penggalian tanah, guling alat berat, dan jatuh dari struktur bekisting telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-penanganan-insiden-struktur-roboh-evakuasi-pekerja-proyek sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop penanganan insiden struktur roboh evakuasi pekerja proyek kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Penanganan Insiden Struktur Roboh & Evakuasi Pekerja Proyek",
