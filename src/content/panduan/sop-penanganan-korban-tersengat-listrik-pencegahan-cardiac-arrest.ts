...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-penanganan-korban-tersengat-listrik-pencegahan-cardiac-arrest",
  "title": "SOP Penanganan Korban Tersengat Listrik & Pencegahan Cardiac Arrest",
  "metaTitle": "SOP Penanganan Korban Tersengat Listrik & Pencegahan Cardiac Arrest | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Penanganan Korban Tersengat Listrik & Pencegahan Cardiac Arrest di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. PER.15/MEN/VIII/2008 tentang P3K di Tempat Kerja, dan tindakan darurat.",
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Penanganan Korban Tersengat Listrik & Pencegahan Cardiac Arrest",
      "paragraphs": [
  ...
  "indexable": true,
  "intent": "panduan sop-penanganan-korban-tersengat-listrik-pencegahan-cardiac-arrest sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop penanganan korban tersengat listrik pencegahan cardiac arrest kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Penanganan Korban Tersengat Listrik & Pencegahan Cardiac Arrest",
