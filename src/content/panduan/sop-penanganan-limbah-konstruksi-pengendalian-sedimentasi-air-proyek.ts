...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-penanganan-limbah-konstruksi-pengendalian-sedimentasi-air-proyek",
  "title": "SOP Penanganan Limbah Konstruksi & Pengendalian Sedimentasi Air Proyek",
  "metaTitle": "SOP Penanganan Limbah Konstruksi & Pengendalian Sedimentasi Air Proyek | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Penanganan Limbah Konstruksi & Pengendalian Sedimentasi Air Proyek di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permen PUPR No. 10 Tahun 2021 tentang SMKK, dan tindakan darurat.",
  "answer": "SOP Penanganan Limbah Konstruksi & Pengendalian Sedimentasi Air Proyek adalah instruksi kerja keselamatan baku dalam klaster Konstruksi & SMKK PUPR (Construction Safety) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permen PUPR No. 10 Tahun 2021 tentang SMKK guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Penanganan Limbah Konstruksi & Pengendalian Sedimentasi Air Proyek",
      "paragraphs": [
        "Penerapan SOP Penanganan Limbah Konstruksi & Pengendalian Sedimentasi Air Proyek bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Konstruksi & SMKK PUPR (Construction Safety). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya runtuhan penggalian tanah, guling alat berat, dan jatuh dari struktur bekisting telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-penanganan-limbah-konstruksi-pengendalian-sedimentasi-air-proyek sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop penanganan limbah konstruksi pengendalian sedimentasi air proyek kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Penanganan Limbah Konstruksi & Pengendalian Sedimentasi Air Proyek",
