...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pelaksanaan-program-konservasi-pendengaran-hearing-conservation-program",
  "title": "SOP Pelaksanaan Program Konservasi Pendengaran (Hearing Conservation Program)",
  "metaTitle": "SOP Pelaksanaan Program Konservasi Pendengaran (Hearing Conservation Program) | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pelaksanaan Program Konservasi Pendengaran (Hearing Conservation Program) di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 05 Tahun 2018 tentang K3 Lingkungan Kerja, dan tindakan darurat.",
  "answer": "SOP Pelaksanaan Program Konservasi Pendengaran (Hearing Conservation Program) adalah instruksi kerja keselamatan baku dalam klaster Higiene Industri & Lingkungan Kerja (Occupational Hygiene) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 05 Tahun 2018 tentang K3 Lingkungan Kerja guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pelaksanaan Program Konservasi Pendengaran (Hearing Conservation Program)",
      "paragraphs": [
        "Penerapan SOP Pelaksanaan Program Konservasi Pendengaran (Hearing Conservation Program) bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Higiene Industri & Lingkungan Kerja (Occupational Hygiene). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya penurunan pendengaran kebisingan (NIHL), stres panas iklim kerja, dan gangguan otot MSDs telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pelaksanaan-program-konservasi-pendengaran-hearing-conservation-program sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pelaksanaan program konservasi pendengaran hearing conservation program kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pelaksanaan Program Konservasi Pendengaran (Hearing Conservation Program)",
