...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pengoperasian-tangki-spherical-lpg-tekanan-tinggi-pengawasan-valve-emergency",
  "title": "SOP Pengoperasian Tangki Spherical LPG Tekanan Tinggi & Pengawasan Valve Emergency",
  "metaTitle": "SOP Pengoperasian Tangki Spherical LPG Tekanan Tinggi & Pengawasan Valve Emergency | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pengoperasian Tangki Spherical LPG Tekanan Tinggi & Pengawasan Valve Emergency di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988, dan tindakan darurat.",
  "answer": "SOP Pengoperasian Tangki Spherical LPG Tekanan Tinggi & Pengawasan Valve Emergency adalah instruksi kerja keselamatan baku dalam klaster Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pengoperasian Tangki Spherical LPG Tekanan Tinggi & Pengawasan Valve Emergency",
      "paragraphs": [
        "Penerapan SOP Pengoperasian Tangki Spherical LPG Tekanan Tinggi & Pengawasan Valve Emergency bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya ledakan uap bertekanan tinggi (BLEVE), keretakan dinding bejana, dan scaling kerak telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pengoperasian-tangki-spherical-lpg-tekanan-tinggi-pengawasan-valve-emergency sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pengoperasian tangki spherical lpg tekanan tinggi pengawasan valve emergency kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pengoperasian Tangki Spherical LPG Tekanan Tinggi & Pengawasan Valve Emergency",
