...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-perancangan-pemeliharaan-sistem-ventilasi-industri-local-exhaust-lev",
  "title": "SOP Perancangan & Pemeliharaan Sistem Ventilasi Industri Local Exhaust (LEV)",
  "metaTitle": "SOP Perancangan & Pemeliharaan Sistem Ventilasi Industri Local Exhaust (LEV) | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Perancangan & Pemeliharaan Sistem Ventilasi Industri Local Exhaust (LEV) di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 05 Tahun 2018 tentang K3 Lingkungan Kerja, dan tindakan darurat.",
  "answer": "SOP Perancangan & Pemeliharaan Sistem Ventilasi Industri Local Exhaust (LEV) adalah instruksi kerja keselamatan baku dalam klaster Higiene Industri & Lingkungan Kerja (Occupational Hygiene) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 05 Tahun 2018 tentang K3 Lingkungan Kerja guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Perancangan & Pemeliharaan Sistem Ventilasi Industri Local Exhaust (LEV)",
      "paragraphs": [
        "Penerapan SOP Perancangan & Pemeliharaan Sistem Ventilasi Industri Local Exhaust (LEV) bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Higiene Industri & Lingkungan Kerja (Occupational Hygiene). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya penurunan pendengaran kebisingan (NIHL), stres panas iklim kerja, dan gangguan otot MSDs telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-perancangan-pemeliharaan-sistem-ventilasi-industri-local-exhaust-lev sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop perancangan pemeliharaan sistem ventilasi industri local exhaust lev kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Perancangan & Pemeliharaan Sistem Ventilasi Industri Local Exhaust (LEV)",
