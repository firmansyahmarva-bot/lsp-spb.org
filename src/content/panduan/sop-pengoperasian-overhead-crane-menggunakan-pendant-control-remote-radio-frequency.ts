...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pengoperasian-overhead-crane-menggunakan-pendant-control-remote-radio-frequency",
  "title": "SOP Pengoperasian Overhead Crane Menggunakan Pendant Control & Remote Radio Frequency",
  "metaTitle": "SOP Pengoperasian Overhead Crane Menggunakan Pendant Control & Remote Radio Frequency | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pengoperasian Overhead Crane Menggunakan Pendant Control & Remote Radio Frequency di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut, dan tindakan darurat.",
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pengoperasian Overhead Crane Menggunakan Pendant Control & Remote Radio Frequency",
      "paragraphs": [
  ...
  "indexable": true,
  "intent": "panduan sop-pengoperasian-overhead-crane-menggunakan-pendant-control-remote-radio-frequency sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pengoperasian overhead crane menggunakan pendant control remote radio frequency kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pengoperasian Overhead Crane Menggunakan Pendant Control & Remote Radio Frequency",
