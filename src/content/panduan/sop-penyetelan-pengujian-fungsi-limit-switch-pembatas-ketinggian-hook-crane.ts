...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-penyetelan-pengujian-fungsi-limit-switch-pembatas-ketinggian-hook-crane",
  "title": "SOP Penyetelan & Pengujian Fungsi Limit Switch Pembatas Ketinggian Hook Crane",
  "metaTitle": "SOP Penyetelan & Pengujian Fungsi Limit Switch Pembatas Ketinggian Hook Crane | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Penyetelan & Pengujian Fungsi Limit Switch Pembatas Ketinggian Hook Crane di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut, dan tindakan darurat.",
  "answer": "SOP Penyetelan & Pengujian Fungsi Limit Switch Pembatas Ketinggian Hook Crane adalah instruksi kerja keselamatan baku dalam klaster Pesawat Angkat & Pesawat Angkut (PAA & Rigging) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Penyetelan & Pengujian Fungsi Limit Switch Pembatas Ketinggian Hook Crane",
      "paragraphs": [
        "Penerapan SOP Penyetelan & Pengujian Fungsi Limit Switch Pembatas Ketinggian Hook Crane bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Angkat & Pesawat Angkut (PAA & Rigging). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya beban gantung jatuh, crane guling akibat kelebihan beban, dan jepitan sling mekanik telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-penyetelan-pengujian-fungsi-limit-switch-pembatas-ketinggian-hook-crane sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop penyetelan pengujian fungsi limit switch pembatas ketinggian hook crane kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Penyetelan & Pengujian Fungsi Limit Switch Pembatas Ketinggian Hook Crane",
