...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "tata-cara-klaim-jkk-bpjs-ketenagakerjaan",
  "title": "Panduan Tata Cara Pengajuan Klaim Jaminan Kecelakaan Kerja (JKK)",
  "metaTitle": "Panduan Tata Cara Pengajuan Klaim Jaminan Kecelakaan Kerja (JKK) | Informasi & Persyaratan Resmi",
  "description": "Alur pelaporan tahap 1 (2x24 jam), pengisian formulir KK2, verifikasi rumah sakit trauma center, dan pencairan santunan.",
  "answer": "Panduan Tata Cara Pengajuan Klaim Jaminan Kecelakaan Kerja (JKK) memberikan instruksi komprehensif berlandaskan Peraturan BPJS Ketenagakerjaan untuk membantu calon peserta, praktisi HSE, dan manajemen perusahaan memenuhi persyaratan regulasi, estimasi biaya, serta kelengkapan administrasi K3 secara tepat.",
  "highlights": [
    "Kategori Panduan: PROCEDURE",
    "Dasar Regulasi: Peraturan BPJS Ketenagakerjaan",
    "Penyelenggara: Konsultasi Resmi PT Kreasi Ultimate Berjaya",
    "Verifikasi Berkas: Pre-Screening Gratis Sebelum Pendaftaran"
  ],
  "blocks": [
    {
      "heading": "Kerangka Acuan & Regulasi Panduan Tata Cara Pengajuan Klaim Jaminan Kecelakaan Kerja (JKK)",
      "paragraphs": [
        "Penjelasan lengkap mengenai Panduan Tata Cara Pengajuan Klaim Jaminan Kecelakaan Kerja (JKK) disusun secara mendalam berdasarkan Peraturan BPJS Ketenagakerjaan dan petunjuk teknis Kementerian Ketenagakerjaan RI. Memahami panduan ini sangat penting bagi individu maupun instansi perusahaan untuk memastikan seluruh proses administrasi dan teknis berjalan sesuai standar hukum.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Hubungi tim admisi kami untuk konsultasi langsung mengenai Panduan Tata Cara Pengajuan Klaim Jaminan Kecelakaan Kerja (JKK). Kami melayani verifikasi kelayakan ijazah gratis dan penyusunan proposal corporate in-house training."
      ]
    }
  ],
  "faqs": [
    {
      "question": "Apa langkah pertama dalam mengurus Panduan Tata Cara Pengajuan Klaim Jaminan Kecelakaan Kerja (JKK)?",
    ...
    {
      "question": "Berapa lama estimasi waktu proses pengurusan Panduan Tata Cara Pengajuan Klaim Jaminan Kecelakaan Kerja (JKK)?",
  ...
  "indexable": true,
  "intent": "panduan tata cara klaim jkk bpjs ketenagakerjaan Alur pelaporan tahap 1 (2x24 jam), pengisian formulir KK2, verifikasi rumah sakit trauma center, dan pencairan santunan.",
  "primaryKeyword": "panduan tata cara klaim jkk bpjs ketenagakerjaan",
  "searchIntent": "Alur pelaporan tahap 1 (2x24 jam), pengisian formulir KK2, verifikasi rumah sakit trauma center, dan pencairan santunan.",
