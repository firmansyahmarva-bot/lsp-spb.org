...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-inspeksi-tangki-timbun-bahan-bakar-minyak-bbm-menggunakan-api-653-inspection",
  "title": "SOP Inspeksi Tangki Timbun Bahan Bakar Minyak BBM Menggunakan API 653 Inspection",
  "metaTitle": "SOP Inspeksi Tangki Timbun Bahan Bakar Minyak BBM Menggunakan API 653 Inspection | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Inspeksi Tangki Timbun Bahan Bakar Minyak BBM Menggunakan API 653 Inspection di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988, dan tindakan darurat.",
  "answer": "SOP Inspeksi Tangki Timbun Bahan Bakar Minyak BBM Menggunakan API 653 Inspection adalah instruksi kerja keselamatan baku dalam klaster Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Inspeksi Tangki Timbun Bahan Bakar Minyak BBM Menggunakan API 653 Inspection",
      "paragraphs": [
        "Penerapan SOP Inspeksi Tangki Timbun Bahan Bakar Minyak BBM Menggunakan API 653 Inspection bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya ledakan uap bertekanan tinggi (BLEVE), keretakan dinding bejana, dan scaling kerak telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-inspeksi-tangki-timbun-bahan-bakar-minyak-bbm-menggunakan-api-653-inspection sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop inspeksi tangki timbun bahan bakar minyak bbm menggunakan api 653 inspection kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Inspeksi Tangki Timbun Bahan Bakar Minyak BBM Menggunakan API 653 Inspection",
