...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pemilihan-fit-testing-alat-pelindung-pendengaran-earplug-earmuff",
  "title": "SOP Pemilihan & Fit Testing Alat Pelindung Pendengaran (Earplug & Earmuff)",
  "metaTitle": "SOP Pemilihan & Fit Testing Alat Pelindung Pendengaran (Earplug & Earmuff) | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pemilihan & Fit Testing Alat Pelindung Pendengaran (Earplug & Earmuff) di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 05 Tahun 2018 tentang K3 Lingkungan Kerja, dan tindakan darurat.",
  "answer": "SOP Pemilihan & Fit Testing Alat Pelindung Pendengaran (Earplug & Earmuff) adalah instruksi kerja keselamatan baku dalam klaster Higiene Industri & Lingkungan Kerja (Occupational Hygiene) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 05 Tahun 2018 tentang K3 Lingkungan Kerja guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pemilihan & Fit Testing Alat Pelindung Pendengaran (Earplug & Earmuff)",
      "paragraphs": [
        "Penerapan SOP Pemilihan & Fit Testing Alat Pelindung Pendengaran (Earplug & Earmuff) bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Higiene Industri & Lingkungan Kerja (Occupational Hygiene). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya penurunan pendengaran kebisingan (NIHL), stres panas iklim kerja, dan gangguan otot MSDs telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pemilihan-fit-testing-alat-pelindung-pendengaran-earplug-earmuff sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pemilihan fit testing alat pelindung pendengaran earplug earmuff kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pemilihan & Fit Testing Alat Pelindung Pendengaran (Earplug & Earmuff)",
