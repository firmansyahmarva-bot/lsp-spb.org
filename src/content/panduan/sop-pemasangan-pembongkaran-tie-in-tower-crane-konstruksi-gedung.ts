...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pemasangan-pembongkaran-tie-in-tower-crane-konstruksi-gedung",
  "title": "SOP Pemasangan & Pembongkaran Tie-in Tower Crane Konstruksi Gedung",
  "metaTitle": "SOP Pemasangan & Pembongkaran Tie-in Tower Crane Konstruksi Gedung | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pemasangan & Pembongkaran Tie-in Tower Crane Konstruksi Gedung di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permen PUPR No. 10 Tahun 2021 tentang SMKK, dan tindakan darurat.",
  "answer": "SOP Pemasangan & Pembongkaran Tie-in Tower Crane Konstruksi Gedung adalah instruksi kerja keselamatan baku dalam klaster Konstruksi & SMKK PUPR (Construction Safety) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permen PUPR No. 10 Tahun 2021 tentang SMKK guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pemasangan & Pembongkaran Tie-in Tower Crane Konstruksi Gedung",
      "paragraphs": [
        "Penerapan SOP Pemasangan & Pembongkaran Tie-in Tower Crane Konstruksi Gedung bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Konstruksi & SMKK PUPR (Construction Safety). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya runtuhan penggalian tanah, guling alat berat, dan jatuh dari struktur bekisting telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pemasangan-pembongkaran-tie-in-tower-crane-konstruksi-gedung sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pemasangan pembongkaran tie in tower crane konstruksi gedung kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pemasangan & Pembongkaran Tie-in Tower Crane Konstruksi Gedung",
