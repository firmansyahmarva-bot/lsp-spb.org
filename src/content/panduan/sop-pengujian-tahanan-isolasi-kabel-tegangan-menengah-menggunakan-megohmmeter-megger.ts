...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pengujian-tahanan-isolasi-kabel-tegangan-menengah-menggunakan-megohmmeter-megger",
  "title": "SOP Pengujian Tahanan Isolasi Kabel Tegangan Menengah Menggunakan Megohmmeter (Megger)",
  "metaTitle": "SOP Pengujian Tahanan Isolasi Kabel Tegangan Menengah Menggunakan Megohmmeter (Megger) | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pengujian Tahanan Isolasi Kabel Tegangan Menengah Menggunakan Megohmmeter (Megger) di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 12 Tahun 2015 & SNI 0225:2020 PUIL 2020, dan tindakan darurat.",
  "answer": "SOP Pengujian Tahanan Isolasi Kabel Tegangan Menengah Menggunakan Megohmmeter (Megger) adalah instruksi kerja keselamatan baku dalam klaster Kelistrikan & Isolasi Energi (Electrical LOTO) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 12 Tahun 2015 & SNI 0225:2020 PUIL 2020 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pengujian Tahanan Isolasi Kabel Tegangan Menengah Menggunakan Megohmmeter (Megger)",
      "paragraphs": [
        "Penerapan SOP Pengujian Tahanan Isolasi Kabel Tegangan Menengah Menggunakan Megohmmeter (Megger) bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Kelistrikan & Isolasi Energi (Electrical LOTO). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya sengatan listrik tegangan tinggi, busur api Arc Flash, dan hubungan pendek arus listrik telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pengujian-tahanan-isolasi-kabel-tegangan-menengah-menggunakan-megohmmeter-megger sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pengujian tahanan isolasi kabel tegangan menengah menggunakan megohmmeter megger kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pengujian Tahanan Isolasi Kabel Tegangan Menengah Menggunakan Megohmmeter (Megger)",
