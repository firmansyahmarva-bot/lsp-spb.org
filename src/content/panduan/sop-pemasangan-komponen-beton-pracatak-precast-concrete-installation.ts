...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pemasangan-komponen-beton-pracatak-precast-concrete-installation",
  "title": "SOP Pemasangan Komponen Beton Pracatak Precast Concrete Installation",
  "metaTitle": "SOP Pemasangan Komponen Beton Pracatak Precast Concrete Installation | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pemasangan Komponen Beton Pracatak Precast Concrete Installation di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permen PUPR No. 10 Tahun 2021 tentang SMKK, dan tindakan darurat.",
  "answer": "SOP Pemasangan Komponen Beton Pracatak Precast Concrete Installation adalah instruksi kerja keselamatan baku dalam klaster Konstruksi & SMKK PUPR (Construction Safety) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permen PUPR No. 10 Tahun 2021 tentang SMKK guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pemasangan Komponen Beton Pracatak Precast Concrete Installation",
      "paragraphs": [
        "Penerapan SOP Pemasangan Komponen Beton Pracatak Precast Concrete Installation bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Konstruksi & SMKK PUPR (Construction Safety). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya runtuhan penggalian tanah, guling alat berat, dan jatuh dari struktur bekisting telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pemasangan-komponen-beton-pracatak-precast-concrete-installation sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pemasangan komponen beton pracatak precast concrete installation kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pemasangan Komponen Beton Pracatak Precast Concrete Installation",
