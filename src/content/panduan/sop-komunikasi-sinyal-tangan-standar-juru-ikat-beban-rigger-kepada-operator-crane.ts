...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-komunikasi-sinyal-tangan-standar-juru-ikat-beban-rigger-kepada-operator-crane",
  "title": "SOP Komunikasi Sinyal Tangan Standar Juru Ikat Beban (Rigger) Kepada Operator Crane",
  "metaTitle": "SOP Komunikasi Sinyal Tangan Standar Juru Ikat Beban (Rigger) Kepada Operator Crane | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Komunikasi Sinyal Tangan Standar Juru Ikat Beban (Rigger) Kepada Operator Crane di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut, dan tindakan darurat.",
  "answer": "SOP Komunikasi Sinyal Tangan Standar Juru Ikat Beban (Rigger) Kepada Operator Crane adalah instruksi kerja keselamatan baku dalam klaster Pesawat Angkat & Pesawat Angkut (PAA & Rigging) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
    "Klaster Keselamatan: Pesawat Angkat & Pesawat Angkut (PAA & Rigging)",
    "Kategori: Lifting SOP",
    "Standar Rujukan: Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut",
    "Fokus Pengendalian: Rigging Load Calculation & Inspeksi Afkir Wire Rope / Sling"
  ],
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Komunikasi Sinyal Tangan Standar Juru Ikat Beban (Rigger) Kepada Operator Crane",
      "paragraphs": [
        "Penerapan SOP Komunikasi Sinyal Tangan Standar Juru Ikat Beban (Rigger) Kepada Operator Crane bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Angkat & Pesawat Angkut (PAA & Rigging). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya beban gantung jatuh, crane guling akibat kelebihan beban, dan jepitan sling mekanik telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "faqs": [
    {
      "question": "Mengapa trial lift 10 cm dari permukaan tanah wajib dilakukan?",
      "answer": "Trial lift bertujuan menguji efektivitas pengereman crane, keseimbangan pengikatan rigger, dan keutuhan rantai/sling sebelum beban diangkat tinggi."
    },
    {
      "question": "Kapan kegiatan pengangkatan crane outdoor wajib dihentikan?",
      "answer": "Pengangkatan wajib dihentikan apabila kecepatan angin melebihi 20 knot (atau standar manufaktur), timbul badai petir, atau pandangan operator terhalang hujan lebat."
    },
    {
      "question": "Siapa yang berhak memberikan sinyal Stop kepada operator crane?",
      "answer": "Dalam kondisi darurat bahaya, SIAPAPUN di area kerja berhak meneriakkan atau memberikan sinyal STOP kepada operator crane."
    }
  ],
  "related": [
  ...
  "indexable": true,
  "intent": "panduan sop-komunikasi-sinyal-tangan-standar-juru-ikat-beban-rigger-kepada-operator-crane sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop komunikasi sinyal tangan standar juru ikat beban rigger kepada operator crane kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Komunikasi Sinyal Tangan Standar Juru Ikat Beban (Rigger) Kepada Operator Crane",
  "intentType": "informational",
  "parentTopic": "Panduan SOP Pesawat Angkat & Pesawat Angkut (PAA & Rigging)",
  "cannibalizationGroup": "panduan-lifting-sop",
  "contentKind": "guide",
