...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pemasangan-outrigger-jack-base-mobile-crane-pada-tanah-permukaan-miring",
  "title": "SOP Pemasangan Outrigger & Jack Base Mobile Crane Pada Tanah Permukaan Miring",
  "metaTitle": "SOP Pemasangan Outrigger & Jack Base Mobile Crane Pada Tanah Permukaan Miring | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pemasangan Outrigger & Jack Base Mobile Crane Pada Tanah Permukaan Miring di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut, dan tindakan darurat.",
  "answer": "SOP Pemasangan Outrigger & Jack Base Mobile Crane Pada Tanah Permukaan Miring adalah instruksi kerja keselamatan baku dalam klaster Pesawat Angkat & Pesawat Angkut (PAA & Rigging) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pemasangan Outrigger & Jack Base Mobile Crane Pada Tanah Permukaan Miring",
      "paragraphs": [
        "Penerapan SOP Pemasangan Outrigger & Jack Base Mobile Crane Pada Tanah Permukaan Miring bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Angkat & Pesawat Angkut (PAA & Rigging). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya beban gantung jatuh, crane guling akibat kelebihan beban, dan jepitan sling mekanik telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pemasangan-outrigger-jack-base-mobile-crane-pada-tanah-permukaan-miring sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pemasangan outrigger jack base mobile crane pada tanah permukaan miring kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pemasangan Outrigger & Jack Base Mobile Crane Pada Tanah Permukaan Miring",
