...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pekerjaan-akses-tali-rope-access-tkpk-pembersihan-dinding-kaca-gedung",
  "title": "SOP Pekerjaan Akses Tali (Rope Access TKPK) Pembersihan Dinding Kaca Gedung",
  "metaTitle": "SOP Pekerjaan Akses Tali (Rope Access TKPK) Pembersihan Dinding Kaca Gedung | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pekerjaan Akses Tali (Rope Access TKPK) Pembersihan Dinding Kaca Gedung di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 09/2016 & SE Menakertrans SE.01/2012, dan tindakan darurat.",
  "answer": "SOP Pekerjaan Akses Tali (Rope Access TKPK) Pembersihan Dinding Kaca Gedung adalah instruksi kerja keselamatan baku dalam klaster Bekerja di Ketinggian & Ruang Terbatas (Work at Height & Confined Space) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 09/2016 & SE Menakertrans SE.01/2012 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "indexable": true,
  "intent": "panduan sop-pekerjaan-akses-tali-rope-access-tkpk-pembersihan-dinding-kaca-gedung sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pekerjaan akses tali rope access tkpk pembersihan dinding kaca gedung kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pekerjaan Akses Tali (Rope Access TKPK) Pembersihan Dinding Kaca Gedung",
