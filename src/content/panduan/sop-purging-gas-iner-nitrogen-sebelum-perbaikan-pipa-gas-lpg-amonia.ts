...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-purging-gas-iner-nitrogen-sebelum-perbaikan-pipa-gas-lpg-amonia",
  "title": "SOP Purging Gas Iner Nitrogen Sebelum Perbaikan Pipa Gas LPG / Amonia",
  "metaTitle": "SOP Purging Gas Iner Nitrogen Sebelum Perbaikan Pipa Gas LPG / Amonia | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Purging Gas Iner Nitrogen Sebelum Perbaikan Pipa Gas LPG / Amonia di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988, dan tindakan darurat.",
  "answer": "SOP Purging Gas Iner Nitrogen Sebelum Perbaikan Pipa Gas LPG / Amonia adalah instruksi kerja keselamatan baku dalam klaster Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Purging Gas Iner Nitrogen Sebelum Perbaikan Pipa Gas LPG / Amonia",
      "paragraphs": [
        "Penerapan SOP Purging Gas Iner Nitrogen Sebelum Perbaikan Pipa Gas LPG / Amonia bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya ledakan uap bertekanan tinggi (BLEVE), keretakan dinding bejana, dan scaling kerak telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-purging-gas-iner-nitrogen-sebelum-perbaikan-pipa-gas-lpg-amonia sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop purging gas iner nitrogen sebelum perbaikan pipa gas lpg amonia kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Purging Gas Iner Nitrogen Sebelum Perbaikan Pipa Gas LPG / Amonia",
