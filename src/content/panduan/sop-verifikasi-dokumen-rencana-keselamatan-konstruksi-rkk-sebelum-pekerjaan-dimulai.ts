...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-verifikasi-dokumen-rencana-keselamatan-konstruksi-rkk-sebelum-pekerjaan-dimulai",
  "title": "SOP Verifikasi Dokumen Rencana Keselamatan Konstruksi (RKK) Sebelum Pekerjaan Dimulai",
  "metaTitle": "SOP Verifikasi Dokumen Rencana Keselamatan Konstruksi (RKK) Sebelum Pekerjaan Dimulai | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Verifikasi Dokumen Rencana Keselamatan Konstruksi (RKK) Sebelum Pekerjaan Dimulai di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permen PUPR No. 10 Tahun 2021 tentang SMKK, dan tindakan darurat.",
  "answer": "SOP Verifikasi Dokumen Rencana Keselamatan Konstruksi (RKK) Sebelum Pekerjaan Dimulai adalah instruksi kerja keselamatan baku dalam klaster Konstruksi & SMKK PUPR (Construction Safety) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permen PUPR No. 10 Tahun 2021 tentang SMKK guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
    "Klaster Keselamatan: Konstruksi & SMKK PUPR (Construction Safety)",
    "Kategori: Construction SOP",
    "Standar Rujukan: Permen PUPR No. 10 Tahun 2021 tentang SMKK",
    "Fokus Pengendalian: SMKK PUPR Permen 10/2021 & Trenching Shoring Safety Controls"
  ],
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Verifikasi Dokumen Rencana Keselamatan Konstruksi (RKK) Sebelum Pekerjaan Dimulai",
      "paragraphs": [
        "Penerapan SOP Verifikasi Dokumen Rencana Keselamatan Konstruksi (RKK) Sebelum Pekerjaan Dimulai bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Konstruksi & SMKK PUPR (Construction Safety). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya runtuhan penggalian tanah, guling alat berat, dan jatuh dari struktur bekisting telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "faqs": [
    {
      "question": "Berapa kedalaman penggalian tanah yang wajib memasang sistem dinding penahan (shoring)?",
      "answer": "Penggalian tanah dengan kedalaman 1.5 meter atau lebih wajib dipasang sistem dinding penahan (shoring/benching) untuk mencegah bahaya tertimbun."
    },
    {
      "question": "Siapa yang bertugas menyusun dokumen RKK Tender proyek konstruksi?",
      "answer": "Dokumen RKK Tender disusun oleh Ahli K3 Konstruksi / Petugas Keselamatan Konstruksi penyedia jasa (kontraktor)."
    },
    {
      "question": "Apa sanksi jika kontraktor tidak menerapkan SMKK PUPR di proyek?",
      "answer": "Pekerjaan dapat dihentikan sementara (Stop Work Order), pemotongan pembayaran biaya K3, hingga penghentian kontrak kerja."
    }
  ],
  "related": [
  ...
  "indexable": true,
  "intent": "panduan sop-verifikasi-dokumen-rencana-keselamatan-konstruksi-rkk-sebelum-pekerjaan-dimulai sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop verifikasi dokumen rencana keselamatan konstruksi rkk sebelum pekerjaan dimulai kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Verifikasi Dokumen Rencana Keselamatan Konstruksi (RKK) Sebelum Pekerjaan Dimulai",
  "intentType": "informational",
  "parentTopic": "Panduan SOP Konstruksi & SMKK PUPR (Construction Safety)",
  "cannibalizationGroup": "panduan-construction-sop",
  "contentKind": "guide",
