...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pekerjaan-dalam-keadaan-bertegangan-pdkb-menggunakan-sarung-tangan-isolasi-karet",
  "title": "SOP Pekerjaan Dalam Keadaan Bertegangan (PDKB) Menggunakan Sarung Tangan Isolasi Karet",
  "metaTitle": "SOP Pekerjaan Dalam Keadaan Bertegangan (PDKB) Menggunakan Sarung Tangan Isolasi Karet | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pekerjaan Dalam Keadaan Bertegangan (PDKB) Menggunakan Sarung Tangan Isolasi Karet di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 12 Tahun 2015 & SNI 0225:2020 PUIL 2020, dan tindakan darurat.",
  "answer": "SOP Pekerjaan Dalam Keadaan Bertegangan (PDKB) Menggunakan Sarung Tangan Isolasi Karet adalah instruksi kerja keselamatan baku dalam klaster Kelistrikan & Isolasi Energi (Electrical LOTO) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 12 Tahun 2015 & SNI 0225:2020 PUIL 2020 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pekerjaan Dalam Keadaan Bertegangan (PDKB) Menggunakan Sarung Tangan Isolasi Karet",
      "paragraphs": [
        "Penerapan SOP Pekerjaan Dalam Keadaan Bertegangan (PDKB) Menggunakan Sarung Tangan Isolasi Karet bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Kelistrikan & Isolasi Energi (Electrical LOTO). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya sengatan listrik tegangan tinggi, busur api Arc Flash, dan hubungan pendek arus listrik telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pekerjaan-dalam-keadaan-bertegangan-pdkb-menggunakan-sarung-tangan-isolasi-karet sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pekerjaan dalam keadaan bertegangan pdkb menggunakan sarung tangan isolasi karet kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pekerjaan Dalam Keadaan Bertegangan (PDKB) Menggunakan Sarung Tangan Isolasi Karet",
