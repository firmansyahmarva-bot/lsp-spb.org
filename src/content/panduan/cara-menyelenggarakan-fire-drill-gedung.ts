...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "cara-menyelenggarakan-fire-drill-gedung",
  "title": "Panduan Tahapan Menyelenggarakan Simulasi Evakuasi Fire Drill Gedung",
  "metaTitle": "Panduan Tahapan Menyelenggarakan Simulasi Evakuasi Fire Drill Gedung | Informasi & Persyaratan Resmi",
  "description": "Skenario latihan: pembunyian alarm, pergerakan floor warden, evakuasi tanpa lift, penghitungan headcount, dan debriefing.",
  "answer": "Panduan Tahapan Menyelenggarakan Simulasi Evakuasi Fire Drill Gedung memberikan instruksi komprehensif berlandaskan Kepmenaker No. KEP.186/MEN/1999 untuk membantu calon peserta, praktisi HSE, dan manajemen perusahaan memenuhi persyaratan regulasi, estimasi biaya, serta kelengkapan administrasi K3 secara tepat.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Kerangka Acuan & Regulasi Panduan Tahapan Menyelenggarakan Simulasi Evakuasi Fire Drill Gedung",
      "paragraphs": [
        "Penjelasan lengkap mengenai Panduan Tahapan Menyelenggarakan Simulasi Evakuasi Fire Drill Gedung disusun secara mendalam berdasarkan Kepmenaker No. KEP.186/MEN/1999 dan petunjuk teknis Kementerian Ketenagakerjaan RI. Memahami panduan ini sangat penting bagi individu maupun instansi perusahaan untuk memastikan seluruh proses administrasi dan teknis berjalan sesuai standar hukum.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Hubungi tim admisi kami untuk konsultasi langsung mengenai Panduan Tahapan Menyelenggarakan Simulasi Evakuasi Fire Drill Gedung. Kami melayani verifikasi kelayakan ijazah gratis dan penyusunan proposal corporate in-house training."
      ]
    }
  ],
  "faqs": [
    {
      "question": "Apa langkah pertama dalam mengurus Panduan Tahapan Menyelenggarakan Simulasi Evakuasi Fire Drill Gedung?",
    ...
    {
      "question": "Berapa lama estimasi waktu proses pengurusan Panduan Tahapan Menyelenggarakan Simulasi Evakuasi Fire Drill Gedung?",
  ...
  "indexable": true,
  "intent": "panduan cara menyelenggarakan fire drill gedung Skenario latihan: pembunyian alarm, pergerakan floor warden, evakuasi tanpa lift, penghitungan headcount, dan debriefing.",
  "primaryKeyword": "panduan cara menyelenggarakan fire drill gedung",
  "searchIntent": "Skenario latihan: pembunyian alarm, pergerakan floor warden, evakuasi tanpa lift, penghitungan headcount, dan debriefing.",
