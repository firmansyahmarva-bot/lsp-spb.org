...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-penghentian-darurat-power-supply-pabrik-menggunakan-emergency-stop-push-button",
  "title": "SOP Penghentian Darurat Power Supply Pabrik Menggunakan Emergency Stop Push Button",
  "metaTitle": "SOP Penghentian Darurat Power Supply Pabrik Menggunakan Emergency Stop Push Button | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Penghentian Darurat Power Supply Pabrik Menggunakan Emergency Stop Push Button di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 12 Tahun 2015 & SNI 0225:2020 PUIL 2020, dan tindakan darurat.",
  "answer": "SOP Penghentian Darurat Power Supply Pabrik Menggunakan Emergency Stop Push Button adalah instruksi kerja keselamatan baku dalam klaster Kelistrikan & Isolasi Energi (Electrical LOTO) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 12 Tahun 2015 & SNI 0225:2020 PUIL 2020 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Penghentian Darurat Power Supply Pabrik Menggunakan Emergency Stop Push Button",
      "paragraphs": [
        "Penerapan SOP Penghentian Darurat Power Supply Pabrik Menggunakan Emergency Stop Push Button bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Kelistrikan & Isolasi Energi (Electrical LOTO). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya sengatan listrik tegangan tinggi, busur api Arc Flash, dan hubungan pendek arus listrik telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-penghentian-darurat-power-supply-pabrik-menggunakan-emergency-stop-push-button sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop penghentian darurat power supply pabrik menggunakan emergency stop push button kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Penghentian Darurat Power Supply Pabrik Menggunakan Emergency Stop Push Button",
