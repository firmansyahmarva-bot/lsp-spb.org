...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-penanganan-kejadian-crane-guling-evakuasi-operator-dari-kabin-kemudi",
  "title": "SOP Penanganan Kejadian Crane Guling & Evakuasi Operator Dari Kabin Kemudi",
  "metaTitle": "SOP Penanganan Kejadian Crane Guling & Evakuasi Operator Dari Kabin Kemudi | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Penanganan Kejadian Crane Guling & Evakuasi Operator Dari Kabin Kemudi di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut, dan tindakan darurat.",
  "answer": "SOP Penanganan Kejadian Crane Guling & Evakuasi Operator Dari Kabin Kemudi adalah instruksi kerja keselamatan baku dalam klaster Pesawat Angkat & Pesawat Angkut (PAA & Rigging) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Penanganan Kejadian Crane Guling & Evakuasi Operator Dari Kabin Kemudi",
      "paragraphs": [
        "Penerapan SOP Penanganan Kejadian Crane Guling & Evakuasi Operator Dari Kabin Kemudi bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Angkat & Pesawat Angkut (PAA & Rigging). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya beban gantung jatuh, crane guling akibat kelebihan beban, dan jepitan sling mekanik telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-penanganan-kejadian-crane-guling-evakuasi-operator-dari-kabin-kemudi sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop penanganan kejadian crane guling evakuasi operator dari kabin kemudi kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Penanganan Kejadian Crane Guling & Evakuasi Operator Dari Kabin Kemudi",
