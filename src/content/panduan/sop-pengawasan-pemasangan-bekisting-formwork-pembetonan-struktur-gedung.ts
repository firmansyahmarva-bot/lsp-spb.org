...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pengawasan-pemasangan-bekisting-formwork-pembetonan-struktur-gedung",
  "title": "SOP Pengawasan Pemasangan Bekisting Formwork & Pembetonan Struktur Gedung",
  "metaTitle": "SOP Pengawasan Pemasangan Bekisting Formwork & Pembetonan Struktur Gedung | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pengawasan Pemasangan Bekisting Formwork & Pembetonan Struktur Gedung di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permen PUPR No. 10 Tahun 2021 tentang SMKK, dan tindakan darurat.",
  "answer": "SOP Pengawasan Pemasangan Bekisting Formwork & Pembetonan Struktur Gedung adalah instruksi kerja keselamatan baku dalam klaster Konstruksi & SMKK PUPR (Construction Safety) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permen PUPR No. 10 Tahun 2021 tentang SMKK guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pengawasan Pemasangan Bekisting Formwork & Pembetonan Struktur Gedung",
      "paragraphs": [
        "Penerapan SOP Pengawasan Pemasangan Bekisting Formwork & Pembetonan Struktur Gedung bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Konstruksi & SMKK PUPR (Construction Safety). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya runtuhan penggalian tanah, guling alat berat, dan jatuh dari struktur bekisting telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pengawasan-pemasangan-bekisting-formwork-pembetonan-struktur-gedung sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pengawasan pemasangan bekisting formwork pembetonan struktur gedung kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pengawasan Pemasangan Bekisting Formwork & Pembetonan Struktur Gedung",
