...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pemeriksaan-harian-pre-operational-checklist-forklift-diesel-electric-battery",
  "title": "SOP Pemeriksaan Harian Pre-Operational Checklist Forklift Diesel & Electric Battery",
  "metaTitle": "SOP Pemeriksaan Harian Pre-Operational Checklist Forklift Diesel & Electric Battery | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pemeriksaan Harian Pre-Operational Checklist Forklift Diesel & Electric Battery di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut, dan tindakan darurat.",
  "answer": "SOP Pemeriksaan Harian Pre-Operational Checklist Forklift Diesel & Electric Battery adalah instruksi kerja keselamatan baku dalam klaster Pesawat Angkat & Pesawat Angkut (PAA & Rigging) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pemeriksaan Harian Pre-Operational Checklist Forklift Diesel & Electric Battery",
      "paragraphs": [
        "Penerapan SOP Pemeriksaan Harian Pre-Operational Checklist Forklift Diesel & Electric Battery bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Angkat & Pesawat Angkut (PAA & Rigging). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya beban gantung jatuh, crane guling akibat kelebihan beban, dan jepitan sling mekanik telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pemeriksaan-harian-pre-operational-checklist-forklift-diesel-electric-battery sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pemeriksaan harian pre operational checklist forklift diesel electric battery kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pemeriksaan Harian Pre-Operational Checklist Forklift Diesel & Electric Battery",
