...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pengendalian-bakteri-legionella-pada-sistem-cooling-tower-ac-central",
  "title": "SOP Pengendalian Bakteri Legionella Pada Sistem Cooling Tower AC Central",
  "metaTitle": "SOP Pengendalian Bakteri Legionella Pada Sistem Cooling Tower AC Central | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pengendalian Bakteri Legionella Pada Sistem Cooling Tower AC Central di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 05 Tahun 2018 tentang K3 Lingkungan Kerja, dan tindakan darurat.",
  "answer": "SOP Pengendalian Bakteri Legionella Pada Sistem Cooling Tower AC Central adalah instruksi kerja keselamatan baku dalam klaster Higiene Industri & Lingkungan Kerja (Occupational Hygiene) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 05 Tahun 2018 tentang K3 Lingkungan Kerja guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pengendalian Bakteri Legionella Pada Sistem Cooling Tower AC Central",
      "paragraphs": [
        "Penerapan SOP Pengendalian Bakteri Legionella Pada Sistem Cooling Tower AC Central bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Higiene Industri & Lingkungan Kerja (Occupational Hygiene). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya penurunan pendengaran kebisingan (NIHL), stres panas iklim kerja, dan gangguan otot MSDs telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pengendalian-bakteri-legionella-pada-sistem-cooling-tower-ac-central sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pengendalian bakteri legionella pada sistem cooling tower ac central kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pengendalian Bakteri Legionella Pada Sistem Cooling Tower AC Central",
