...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pengisian-tabung-gas-bertekanan-silinder-lpg-argon-dan-oksigen-medis",
  "title": "SOP Pengisian Tabung Gas Bertekanan Silinder LPG, Argon, dan Oksigen Medis",
  "metaTitle": "SOP Pengisian Tabung Gas Bertekanan Silinder LPG, Argon, dan Oksigen Medis | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pengisian Tabung Gas Bertekanan Silinder LPG, Argon, dan Oksigen Medis di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988, dan tindakan darurat.",
  "answer": "SOP Pengisian Tabung Gas Bertekanan Silinder LPG, Argon, dan Oksigen Medis adalah instruksi kerja keselamatan baku dalam klaster Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pengisian Tabung Gas Bertekanan Silinder LPG, Argon, dan Oksigen Medis",
      "paragraphs": [
        "Penerapan SOP Pengisian Tabung Gas Bertekanan Silinder LPG, Argon, dan Oksigen Medis bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya ledakan uap bertekanan tinggi (BLEVE), keretakan dinding bejana, dan scaling kerak telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pengisian-tabung-gas-bertekanan-silinder-lpg-argon-dan-oksigen-medis sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pengisian tabung gas bertekanan silinder lpg argon dan oksigen medis kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pengisian Tabung Gas Bertekanan Silinder LPG, Argon, dan Oksigen Medis",
