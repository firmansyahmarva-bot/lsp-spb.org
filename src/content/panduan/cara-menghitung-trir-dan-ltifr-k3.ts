...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "cara-menghitung-trir-dan-ltifr-k3",
  "title": "Panduan Cara Menghitung Rumus TRIR, LTIFR & Severity Rate K3",
  "metaTitle": "Panduan Cara Menghitung Rumus TRIR, LTIFR & Severity Rate K3 | Informasi & Persyaratan Resmi",
  "description": "Rumus matematis kalkulasi frekuensi kecelakaan kerja per 200.000 atau 1.000.000 jam kerja selamat dan contoh perhitungannya.",
  "answer": "Panduan Cara Menghitung Rumus TRIR, LTIFR & Severity Rate K3 memberikan instruksi komprehensif berlandaskan PP No. 50 Tahun 2012 untuk membantu calon peserta, praktisi HSE, dan manajemen perusahaan memenuhi persyaratan regulasi, estimasi biaya, serta kelengkapan administrasi K3 secara tepat.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Kerangka Acuan & Regulasi Panduan Cara Menghitung Rumus TRIR, LTIFR & Severity Rate K3",
      "paragraphs": [
        "Penjelasan lengkap mengenai Panduan Cara Menghitung Rumus TRIR, LTIFR & Severity Rate K3 disusun secara mendalam berdasarkan PP No. 50 Tahun 2012 dan petunjuk teknis Kementerian Ketenagakerjaan RI. Memahami panduan ini sangat penting bagi individu maupun instansi perusahaan untuk memastikan seluruh proses administrasi dan teknis berjalan sesuai standar hukum.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Hubungi tim admisi kami untuk konsultasi langsung mengenai Panduan Cara Menghitung Rumus TRIR, LTIFR & Severity Rate K3. Kami melayani verifikasi kelayakan ijazah gratis dan penyusunan proposal corporate in-house training."
      ]
    }
  ],
  "faqs": [
    {
      "question": "Apa langkah pertama dalam mengurus Panduan Cara Menghitung Rumus TRIR, LTIFR & Severity Rate K3?",
    ...
    {
      "question": "Berapa lama estimasi waktu proses pengurusan Panduan Cara Menghitung Rumus TRIR, LTIFR & Severity Rate K3?",
  ...
  "indexable": true,
  "intent": "panduan cara menghitung trir dan ltifr k3 Rumus matematis kalkulasi frekuensi kecelakaan kerja per 200.000 atau 1.000.000 jam kerja selamat dan contoh perhitungannya.",
  "primaryKeyword": "panduan cara menghitung trir dan ltifr k3",
  "searchIntent": "Rumus matematis kalkulasi frekuensi kecelakaan kerja per 200.000 atau 1.000.000 jam kerja selamat dan contoh perhitungannya.",
