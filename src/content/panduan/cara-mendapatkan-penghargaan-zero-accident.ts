...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "cara-mendapatkan-penghargaan-zero-accident",
  "title": "Panduan Syarat & Verifikasi Berkas Penghargaan Kecelakaan Nihil (Zero Accident)",
  "metaTitle": "Panduan Syarat & Verifikasi Berkas Penghargaan Kecelakaan Nihil (Zero Accident) | Informasi & Persyaratan Resmi",
  "description": "Ketentuan penghitungan jam kerja selamat tanpa fatality, audit tim penilai Disnaker, dan penganugerahan piagam Menteri.",
  "answer": "Panduan Syarat & Verifikasi Berkas Penghargaan Kecelakaan Nihil (Zero Accident) memberikan instruksi komprehensif berlandaskan Peraturan Kemnaker RI untuk membantu calon peserta, praktisi HSE, dan manajemen perusahaan memenuhi persyaratan regulasi, estimasi biaya, serta kelengkapan administrasi K3 secara tepat.",
  "highlights": [
    "Kategori Panduan: COMPLIANCE",
    "Dasar Regulasi: Peraturan Kemnaker RI",
    "Penyelenggara: Konsultasi Resmi PT Kreasi Ultimate Berjaya",
    "Verifikasi Berkas: Pre-Screening Gratis Sebelum Pendaftaran"
  ],
  "blocks": [
    {
      "heading": "Kerangka Acuan & Regulasi Panduan Syarat & Verifikasi Berkas Penghargaan Kecelakaan Nihil (Zero Accident)",
      "paragraphs": [
        "Penjelasan lengkap mengenai Panduan Syarat & Verifikasi Berkas Penghargaan Kecelakaan Nihil (Zero Accident) disusun secara mendalam berdasarkan Peraturan Kemnaker RI dan petunjuk teknis Kementerian Ketenagakerjaan RI. Memahami panduan ini sangat penting bagi individu maupun instansi perusahaan untuk memastikan seluruh proses administrasi dan teknis berjalan sesuai standar hukum.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Hubungi tim admisi kami untuk konsultasi langsung mengenai Panduan Syarat & Verifikasi Berkas Penghargaan Kecelakaan Nihil (Zero Accident). Kami melayani verifikasi kelayakan ijazah gratis dan penyusunan proposal corporate in-house training."
      ]
    }
  ],
  "faqs": [
    {
      "question": "Apa langkah pertama dalam mengurus Panduan Syarat & Verifikasi Berkas Penghargaan Kecelakaan Nihil (Zero Accident)?",
    ...
    {
      "question": "Berapa lama estimasi waktu proses pengurusan Panduan Syarat & Verifikasi Berkas Penghargaan Kecelakaan Nihil (Zero Accident)?",
  ...
  "indexable": true,
  "intent": "panduan cara mendapatkan penghargaan zero accident Ketentuan penghitungan jam kerja selamat tanpa fatality, audit tim penilai Disnaker, dan penganugerahan piagam Menteri.",
  "primaryKeyword": "panduan cara mendapatkan penghargaan zero accident",
  "searchIntent": "Ketentuan penghitungan jam kerja selamat tanpa fatality, audit tim penilai Disnaker, dan penganugerahan piagam Menteri.",
