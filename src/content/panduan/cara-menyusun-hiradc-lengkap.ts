...
export const record: ContentRecord = {
  ...
  "title": "Panduan Praktis Cara Menyusun Tabel HIRADC Matriks Risiko 5x5",
  "metaTitle": "Panduan Praktis Cara Menyusun Tabel HIRADC Matriks Risiko 5x5 | Informasi & Persyaratan Resmi",
  "description": "Langkah menentukan aktivitas rutin/non-rutin, identifikasi bahaya, skor kemungkinan x keparahan, dan hierarki pengendalian.",
  "answer": "Panduan Praktis Cara Menyusun Tabel HIRADC Matriks Risiko 5x5 memberikan instruksi komprehensif berlandaskan PP No. 50 Tahun 2012 untuk membantu calon peserta, praktisi HSE, dan manajemen perusahaan memenuhi persyaratan regulasi, estimasi biaya, serta kelengkapan administrasi K3 secara tepat.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Kerangka Acuan & Regulasi Panduan Praktis Cara Menyusun Tabel HIRADC Matriks Risiko 5x5",
      "paragraphs": [
        "Penjelasan lengkap mengenai Panduan Praktis Cara Menyusun Tabel HIRADC Matriks Risiko 5x5 disusun secara mendalam berdasarkan PP No. 50 Tahun 2012 dan petunjuk teknis Kementerian Ketenagakerjaan RI. Memahami panduan ini sangat penting bagi individu maupun instansi perusahaan untuk memastikan seluruh proses administrasi dan teknis berjalan sesuai standar hukum.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Hubungi tim admisi kami untuk konsultasi langsung mengenai Panduan Praktis Cara Menyusun Tabel HIRADC Matriks Risiko 5x5. Kami melayani verifikasi kelayakan ijazah gratis dan penyusunan proposal corporate in-house training."
      ]
    }
  ],
  "faqs": [
    {
      "question": "Apa langkah pertama dalam mengurus Panduan Praktis Cara Menyusun Tabel HIRADC Matriks Risiko 5x5?",
    ...
    {
      "question": "Berapa lama estimasi waktu proses pengurusan Panduan Praktis Cara Menyusun Tabel HIRADC Matriks Risiko 5x5?",
  ...
  "indexable": true,
  "intent": "panduan cara menyusun hiradc lengkap Langkah menentukan aktivitas rutin/non-rutin, identifikasi bahaya, skor kemungkinan x keparahan, dan hierarki pengendalian.",
  "primaryKeyword": "panduan cara menyusun hiradc lengkap",
  "searchIntent": "Langkah menentukan aktivitas rutin/non-rutin, identifikasi bahaya, skor kemungkinan x keparahan, dan hierarki pengendalian.",
