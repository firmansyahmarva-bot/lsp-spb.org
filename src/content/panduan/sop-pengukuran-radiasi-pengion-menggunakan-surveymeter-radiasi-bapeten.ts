...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pengukuran-radiasi-pengion-menggunakan-surveymeter-radiasi-bapeten",
  "title": "SOP Pengukuran Radiasi Pengion Menggunakan Surveymeter Radiasi BAPETEN",
  "metaTitle": "SOP Pengukuran Radiasi Pengion Menggunakan Surveymeter Radiasi BAPETEN | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pengukuran Radiasi Pengion Menggunakan Surveymeter Radiasi BAPETEN di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 05 Tahun 2018 tentang K3 Lingkungan Kerja, dan tindakan darurat.",
  "answer": "SOP Pengukuran Radiasi Pengion Menggunakan Surveymeter Radiasi BAPETEN adalah instruksi kerja keselamatan baku dalam klaster Higiene Industri & Lingkungan Kerja (Occupational Hygiene) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 05 Tahun 2018 tentang K3 Lingkungan Kerja guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pengukuran Radiasi Pengion Menggunakan Surveymeter Radiasi BAPETEN",
      "paragraphs": [
        "Penerapan SOP Pengukuran Radiasi Pengion Menggunakan Surveymeter Radiasi BAPETEN bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Higiene Industri & Lingkungan Kerja (Occupational Hygiene). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya penurunan pendengaran kebisingan (NIHL), stres panas iklim kerja, dan gangguan otot MSDs telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pengukuran-radiasi-pengion-menggunakan-surveymeter-radiasi-bapeten sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pengukuran radiasi pengion menggunakan surveymeter radiasi bapeten kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pengukuran Radiasi Pengion Menggunakan Surveymeter Radiasi BAPETEN",
