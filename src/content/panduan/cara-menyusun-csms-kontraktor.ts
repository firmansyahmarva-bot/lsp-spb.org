...
export const record: ContentRecord = {
  ...
  "title": "Panduan Menyusun Dokumen Contractor Safety Management System (CSMS)",
  "metaTitle": "Panduan Menyusun Dokumen Contractor Safety Management System (CSMS) | Informasi & Persyaratan Resmi",
  "description": "Panduan pembuatan dokumen kuesioner prakualifikasi CSMS, risk assessment vendor, dan penilaian kinerja safety kontraktor.",
  "answer": "Panduan Menyusun Dokumen Contractor Safety Management System (CSMS) memberikan instruksi komprehensif berlandaskan PP No. 50 Tahun 2012 untuk membantu calon peserta, praktisi HSE, dan manajemen perusahaan memenuhi persyaratan regulasi, estimasi biaya, serta kelengkapan administrasi K3 secara tepat.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Kerangka Acuan & Regulasi Panduan Menyusun Dokumen Contractor Safety Management System (CSMS)",
      "paragraphs": [
        "Penjelasan lengkap mengenai Panduan Menyusun Dokumen Contractor Safety Management System (CSMS) disusun secara mendalam berdasarkan PP No. 50 Tahun 2012 dan petunjuk teknis Kementerian Ketenagakerjaan RI. Memahami panduan ini sangat penting bagi individu maupun instansi perusahaan untuk memastikan seluruh proses administrasi dan teknis berjalan sesuai standar hukum.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Hubungi tim admisi kami untuk konsultasi langsung mengenai Panduan Menyusun Dokumen Contractor Safety Management System (CSMS). Kami melayani verifikasi kelayakan ijazah gratis dan penyusunan proposal corporate in-house training."
      ]
    }
  ],
  "faqs": [
    {
      "question": "Apa langkah pertama dalam mengurus Panduan Menyusun Dokumen Contractor Safety Management System (CSMS)?",
    ...
    {
      "question": "Berapa lama estimasi waktu proses pengurusan Panduan Menyusun Dokumen Contractor Safety Management System (CSMS)?",
  ...
  "indexable": true,
  "intent": "panduan cara menyusun csms kontraktor Panduan pembuatan dokumen kuesioner prakualifikasi CSMS, risk assessment vendor, dan penilaian kinerja safety kontraktor.",
  "primaryKeyword": "panduan cara menyusun csms kontraktor",
  "searchIntent": "Panduan pembuatan dokumen kuesioner prakualifikasi CSMS, risk assessment vendor, dan penilaian kinerja safety kontraktor.",
