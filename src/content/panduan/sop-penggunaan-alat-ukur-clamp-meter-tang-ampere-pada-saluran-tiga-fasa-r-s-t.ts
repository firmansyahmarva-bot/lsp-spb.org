...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-penggunaan-alat-ukur-clamp-meter-tang-ampere-pada-saluran-tiga-fasa-r-s-t",
  "title": "SOP Penggunaan Alat Ukur Clamp Meter Tang Ampere Pada Saluran Tiga Fasa R-S-T",
  "metaTitle": "SOP Penggunaan Alat Ukur Clamp Meter Tang Ampere Pada Saluran Tiga Fasa R-S-T | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Penggunaan Alat Ukur Clamp Meter Tang Ampere Pada Saluran Tiga Fasa R-S-T di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 12 Tahun 2015 & SNI 0225:2020 PUIL 2020, dan tindakan darurat.",
  "answer": "SOP Penggunaan Alat Ukur Clamp Meter Tang Ampere Pada Saluran Tiga Fasa R-S-T adalah instruksi kerja keselamatan baku dalam klaster Kelistrikan & Isolasi Energi (Electrical LOTO) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 12 Tahun 2015 & SNI 0225:2020 PUIL 2020 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Penggunaan Alat Ukur Clamp Meter Tang Ampere Pada Saluran Tiga Fasa R-S-T",
      "paragraphs": [
  ...
  "indexable": true,
  "intent": "panduan sop-penggunaan-alat-ukur-clamp-meter-tang-ampere-pada-saluran-tiga-fasa-r-s-t sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop penggunaan alat ukur clamp meter tang ampere pada saluran tiga fasa r s t kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Penggunaan Alat Ukur Clamp Meter Tang Ampere Pada Saluran Tiga Fasa R-S-T",
