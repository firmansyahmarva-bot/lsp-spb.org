...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-demolisi-pembongkaran-struktur-bangunan-tua-secara-bertahap",
  "title": "SOP Demolisi Pembongkaran Struktur Bangunan Tua Secara Bertahap",
  "metaTitle": "SOP Demolisi Pembongkaran Struktur Bangunan Tua Secara Bertahap | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Demolisi Pembongkaran Struktur Bangunan Tua Secara Bertahap di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permen PUPR No. 10 Tahun 2021 tentang SMKK, dan tindakan darurat.",
  "answer": "SOP Demolisi Pembongkaran Struktur Bangunan Tua Secara Bertahap adalah instruksi kerja keselamatan baku dalam klaster Konstruksi & SMKK PUPR (Construction Safety) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permen PUPR No. 10 Tahun 2021 tentang SMKK guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Demolisi Pembongkaran Struktur Bangunan Tua Secara Bertahap",
      "paragraphs": [
        "Penerapan SOP Demolisi Pembongkaran Struktur Bangunan Tua Secara Bertahap bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Konstruksi & SMKK PUPR (Construction Safety). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya runtuhan penggalian tanah, guling alat berat, dan jatuh dari struktur bekisting telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-demolisi-pembongkaran-struktur-bangunan-tua-secara-bertahap sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop demolisi pembongkaran struktur bangunan tua secara bertahap kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Demolisi Pembongkaran Struktur Bangunan Tua Secara Bertahap",
