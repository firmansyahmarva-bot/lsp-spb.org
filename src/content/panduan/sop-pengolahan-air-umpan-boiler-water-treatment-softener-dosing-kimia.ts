...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pengolahan-air-umpan-boiler-water-treatment-softener-dosing-kimia",
  "title": "SOP Pengolahan Air Umpan Boiler (Water Treatment Softener & Dosing Kimia)",
  "metaTitle": "SOP Pengolahan Air Umpan Boiler (Water Treatment Softener & Dosing Kimia) | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pengolahan Air Umpan Boiler (Water Treatment Softener & Dosing Kimia) di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988, dan tindakan darurat.",
  "answer": "SOP Pengolahan Air Umpan Boiler (Water Treatment Softener & Dosing Kimia) adalah instruksi kerja keselamatan baku dalam klaster Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pengolahan Air Umpan Boiler (Water Treatment Softener & Dosing Kimia)",
      "paragraphs": [
        "Penerapan SOP Pengolahan Air Umpan Boiler (Water Treatment Softener & Dosing Kimia) bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya ledakan uap bertekanan tinggi (BLEVE), keretakan dinding bejana, dan scaling kerak telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pengolahan-air-umpan-boiler-water-treatment-softener-dosing-kimia sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pengolahan air umpan boiler water treatment softener dosing kimia kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pengolahan Air Umpan Boiler (Water Treatment Softener & Dosing Kimia)",
