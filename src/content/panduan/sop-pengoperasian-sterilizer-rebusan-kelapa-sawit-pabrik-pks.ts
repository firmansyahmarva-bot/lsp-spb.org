...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pengoperasian-sterilizer-rebusan-kelapa-sawit-pabrik-pks",
  "title": "SOP Pengoperasian Sterilizer Rebusan Kelapa Sawit Pabrik PKS",
  "metaTitle": "SOP Pengoperasian Sterilizer Rebusan Kelapa Sawit Pabrik PKS | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pengoperasian Sterilizer Rebusan Kelapa Sawit Pabrik PKS di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988, dan tindakan darurat.",
  "answer": "SOP Pengoperasian Sterilizer Rebusan Kelapa Sawit Pabrik PKS adalah instruksi kerja keselamatan baku dalam klaster Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pengoperasian Sterilizer Rebusan Kelapa Sawit Pabrik PKS",
      "paragraphs": [
        "Penerapan SOP Pengoperasian Sterilizer Rebusan Kelapa Sawit Pabrik PKS bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya ledakan uap bertekanan tinggi (BLEVE), keretakan dinding bejana, dan scaling kerak telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pengoperasian-sterilizer-rebusan-kelapa-sawit-pabrik-pks sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pengoperasian sterilizer rebusan kelapa sawit pabrik pks kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pengoperasian Sterilizer Rebusan Kelapa Sawit Pabrik PKS",
