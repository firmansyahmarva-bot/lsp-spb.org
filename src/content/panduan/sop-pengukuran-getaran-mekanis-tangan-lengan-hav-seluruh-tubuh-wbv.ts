...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pengukuran-getaran-mekanis-tangan-lengan-hav-seluruh-tubuh-wbv",
  "title": "SOP Pengukuran Getaran Mekanis Tangan-Lengan (HAV) & Seluruh Tubuh (WBV)",
  "metaTitle": "SOP Pengukuran Getaran Mekanis Tangan-Lengan (HAV) & Seluruh Tubuh (WBV) | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pengukuran Getaran Mekanis Tangan-Lengan (HAV) & Seluruh Tubuh (WBV) di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 05 Tahun 2018 tentang K3 Lingkungan Kerja, dan tindakan darurat.",
  "answer": "SOP Pengukuran Getaran Mekanis Tangan-Lengan (HAV) & Seluruh Tubuh (WBV) adalah instruksi kerja keselamatan baku dalam klaster Higiene Industri & Lingkungan Kerja (Occupational Hygiene) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 05 Tahun 2018 tentang K3 Lingkungan Kerja guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pengukuran Getaran Mekanis Tangan-Lengan (HAV) & Seluruh Tubuh (WBV)",
      "paragraphs": [
        "Penerapan SOP Pengukuran Getaran Mekanis Tangan-Lengan (HAV) & Seluruh Tubuh (WBV) bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Higiene Industri & Lingkungan Kerja (Occupational Hygiene). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya penurunan pendengaran kebisingan (NIHL), stres panas iklim kerja, dan gangguan otot MSDs telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pengukuran-getaran-mekanis-tangan-lengan-hav-seluruh-tubuh-wbv sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pengukuran getaran mekanis tangan lengan hav seluruh tubuh wbv kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pengukuran Getaran Mekanis Tangan-Lengan (HAV) & Seluruh Tubuh (WBV)",
