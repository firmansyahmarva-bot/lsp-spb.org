...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pengoperasian-manlift-boom-lift-aerial-work-platform-awp-ketinggian",
  "title": "SOP Pengoperasian Manlift Boom Lift Aerial Work Platform (AWP) Ketinggian",
  "metaTitle": "SOP Pengoperasian Manlift Boom Lift Aerial Work Platform (AWP) Ketinggian | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pengoperasian Manlift Boom Lift Aerial Work Platform (AWP) Ketinggian di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut, dan tindakan darurat.",
  "answer": "SOP Pengoperasian Manlift Boom Lift Aerial Work Platform (AWP) Ketinggian adalah instruksi kerja keselamatan baku dalam klaster Pesawat Angkat & Pesawat Angkut (PAA & Rigging) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pengoperasian Manlift Boom Lift Aerial Work Platform (AWP) Ketinggian",
      "paragraphs": [
        "Penerapan SOP Pengoperasian Manlift Boom Lift Aerial Work Platform (AWP) Ketinggian bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Angkat & Pesawat Angkut (PAA & Rigging). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya beban gantung jatuh, crane guling akibat kelebihan beban, dan jepitan sling mekanik telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pengoperasian-manlift-boom-lift-aerial-work-platform-awp-ketinggian sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pengoperasian manlift boom lift aerial work platform awp ketinggian kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pengoperasian Manlift Boom Lift Aerial Work Platform (AWP) Ketinggian",
