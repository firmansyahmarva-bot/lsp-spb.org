...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pengoperasian-wheel-loader-pemindahan-material-curah-pasir-batu-tambang",
  "title": "SOP Pengoperasian Wheel Loader Pemindahan Material Curah Pasir & Batu Tambang",
  "metaTitle": "SOP Pengoperasian Wheel Loader Pemindahan Material Curah Pasir & Batu Tambang | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pengoperasian Wheel Loader Pemindahan Material Curah Pasir & Batu Tambang di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut, dan tindakan darurat.",
  "answer": "SOP Pengoperasian Wheel Loader Pemindahan Material Curah Pasir & Batu Tambang adalah instruksi kerja keselamatan baku dalam klaster Pesawat Angkat & Pesawat Angkut (PAA & Rigging) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pengoperasian Wheel Loader Pemindahan Material Curah Pasir & Batu Tambang",
      "paragraphs": [
        "Penerapan SOP Pengoperasian Wheel Loader Pemindahan Material Curah Pasir & Batu Tambang bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Angkat & Pesawat Angkut (PAA & Rigging). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya beban gantung jatuh, crane guling akibat kelebihan beban, dan jepitan sling mekanik telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pengoperasian-wheel-loader-pemindahan-material-curah-pasir-batu-tambang sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pengoperasian wheel loader pemindahan material curah pasir batu tambang kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pengoperasian Wheel Loader Pemindahan Material Curah Pasir & Batu Tambang",
