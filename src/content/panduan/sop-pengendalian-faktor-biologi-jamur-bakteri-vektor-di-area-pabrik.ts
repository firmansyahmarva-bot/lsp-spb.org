...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pengendalian-faktor-biologi-jamur-bakteri-vektor-di-area-pabrik",
  "title": "SOP Pengendalian Faktor Biologi Jamur, Bakteri & Vektor Di Area Pabrik",
  "metaTitle": "SOP Pengendalian Faktor Biologi Jamur, Bakteri & Vektor Di Area Pabrik | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pengendalian Faktor Biologi Jamur, Bakteri & Vektor Di Area Pabrik di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 05 Tahun 2018 tentang K3 Lingkungan Kerja, dan tindakan darurat.",
  "answer": "SOP Pengendalian Faktor Biologi Jamur, Bakteri & Vektor Di Area Pabrik adalah instruksi kerja keselamatan baku dalam klaster Higiene Industri & Lingkungan Kerja (Occupational Hygiene) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 05 Tahun 2018 tentang K3 Lingkungan Kerja guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pengendalian Faktor Biologi Jamur, Bakteri & Vektor Di Area Pabrik",
      "paragraphs": [
        "Penerapan SOP Pengendalian Faktor Biologi Jamur, Bakteri & Vektor Di Area Pabrik bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Higiene Industri & Lingkungan Kerja (Occupational Hygiene). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya penurunan pendengaran kebisingan (NIHL), stres panas iklim kerja, dan gangguan otot MSDs telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pengendalian-faktor-biologi-jamur-bakteri-vektor-di-area-pabrik sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pengendalian faktor biologi jamur bakteri vektor di area pabrik kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pengendalian Faktor Biologi Jamur, Bakteri & Vektor Di Area Pabrik",
