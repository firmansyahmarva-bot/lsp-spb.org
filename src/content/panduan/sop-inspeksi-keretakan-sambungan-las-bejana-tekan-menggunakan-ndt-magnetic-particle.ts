...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-inspeksi-keretakan-sambungan-las-bejana-tekan-menggunakan-ndt-magnetic-particle",
  "title": "SOP Inspeksi Keretakan Sambungan Las Bejana Tekan Menggunakan NDT Magnetic Particle",
  "metaTitle": "SOP Inspeksi Keretakan Sambungan Las Bejana Tekan Menggunakan NDT Magnetic Particle | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Inspeksi Keretakan Sambungan Las Bejana Tekan Menggunakan NDT Magnetic Particle di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988, dan tindakan darurat.",
  "answer": "SOP Inspeksi Keretakan Sambungan Las Bejana Tekan Menggunakan NDT Magnetic Particle adalah instruksi kerja keselamatan baku dalam klaster Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
    "Klaster Keselamatan: Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel)",
    "Kategori: Boiler SOP",
    "Standar Rujukan: Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988",
    "Fokus Pengendalian: Boiler Water Treatment & Safety Valve Popping Pressure Inspection"
  ],
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Inspeksi Keretakan Sambungan Las Bejana Tekan Menggunakan NDT Magnetic Particle",
      "paragraphs": [
        "Penerapan SOP Inspeksi Keretakan Sambungan Las Bejana Tekan Menggunakan NDT Magnetic Particle bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya ledakan uap bertekanan tinggi (BLEVE), keretakan dinding bejana, dan scaling kerak telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "faqs": [
    {
      "question": "Apa akibatnya jika level air dalam boiler berada di bawah batas minimum (Low Water Level)?",
      "answer": "Kondisi air kering dapat menyebabkan pipa uap memerah dan melengkung (overheating) yang berisiko fatal memicu ledakan ketel uap."
    },
    {
      "question": "Berapa kali pengujian blowdown boiler sebaiknya dilakukan?",
      "answer": "Blowdown permukaan dilakukan kontinu, sedangkan blowdown dasar dilakukan 1-2 kali per shift sesuai hasil uji laboratorium kadar TDS air boiler."
    },
    {
      "question": "Mengapa katup pengaman (safety valve) wajib disegel oleh pengawas K3 Kemnaker?",
      "answer": "Segel memastikan posisi penyetelan tekanan leleh tidak diubah secara ilegal oleh pihak tidak berwenang demi keselamatan tempat kerja."
    }
  ],
  "related": [
  ...
  "indexable": true,
  "intent": "panduan sop-inspeksi-keretakan-sambungan-las-bejana-tekan-menggunakan-ndt-magnetic-particle sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop inspeksi keretakan sambungan las bejana tekan menggunakan ndt magnetic particle kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Inspeksi Keretakan Sambungan Las Bejana Tekan Menggunakan NDT Magnetic Particle",
  "intentType": "informational",
  "parentTopic": "Panduan SOP Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel)",
  "cannibalizationGroup": "panduan-boiler-sop",
  "contentKind": "guide",
