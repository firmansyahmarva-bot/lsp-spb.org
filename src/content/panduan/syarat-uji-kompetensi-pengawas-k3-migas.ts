...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "syarat-uji-kompetensi-pengawas-k3-migas",
  ...
  "indexable": true,
  "intent": "panduan syarat uji kompetensi pengawas k3 migas Daftar dokumen portofolio inspeksi migas, izin kerja PTW, laporan investigasi, dan wawancara teknis asesor BNSP.",
  "primaryKeyword": "panduan syarat uji kompetensi pengawas k3 migas",
  "searchIntent": "Daftar dokumen portofolio inspeksi migas, izin kerja PTW, laporan investigasi, dan wawancara teknis asesor BNSP.",
