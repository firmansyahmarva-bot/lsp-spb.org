...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-penyulutan-awal-firing-up-burner-ketel-uap-boiler-bahan-bakar-minyak-gas",
  "title": "SOP Penyulutan Awal (Firing Up) Burner Ketel Uap Boiler Bahan Bakar Minyak/Gas",
  "metaTitle": "SOP Penyulutan Awal (Firing Up) Burner Ketel Uap Boiler Bahan Bakar Minyak/Gas | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Penyulutan Awal (Firing Up) Burner Ketel Uap Boiler Bahan Bakar Minyak/Gas di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988, dan tindakan darurat.",
  "answer": "SOP Penyulutan Awal (Firing Up) Burner Ketel Uap Boiler Bahan Bakar Minyak/Gas adalah instruksi kerja keselamatan baku dalam klaster Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Penyulutan Awal (Firing Up) Burner Ketel Uap Boiler Bahan Bakar Minyak/Gas",
      "paragraphs": [
        "Penerapan SOP Penyulutan Awal (Firing Up) Burner Ketel Uap Boiler Bahan Bakar Minyak/Gas bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya ledakan uap bertekanan tinggi (BLEVE), keretakan dinding bejana, dan scaling kerak telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-penyulutan-awal-firing-up-burner-ketel-uap-boiler-bahan-bakar-minyak-gas sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop penyulutan awal firing up burner ketel uap boiler bahan bakar minyak gas kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Penyulutan Awal (Firing Up) Burner Ketel Uap Boiler Bahan Bakar Minyak/Gas",
