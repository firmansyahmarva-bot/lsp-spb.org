...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pengikatan-matriks-besi-beton-pemotongan-steel-rebar-cutter",
  "title": "SOP Pengikatan Matriks Besi Beton & Pemotongan Steel Rebar Cutter",
  "metaTitle": "SOP Pengikatan Matriks Besi Beton & Pemotongan Steel Rebar Cutter | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pengikatan Matriks Besi Beton & Pemotongan Steel Rebar Cutter di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permen PUPR No. 10 Tahun 2021 tentang SMKK, dan tindakan darurat.",
  "answer": "SOP Pengikatan Matriks Besi Beton & Pemotongan Steel Rebar Cutter adalah instruksi kerja keselamatan baku dalam klaster Konstruksi & SMKK PUPR (Construction Safety) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permen PUPR No. 10 Tahun 2021 tentang SMKK guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "indexable": true,
  "intent": "panduan sop-pengikatan-matriks-besi-beton-pemotongan-steel-rebar-cutter sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pengikatan matriks besi beton pemotongan steel rebar cutter kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pengikatan Matriks Besi Beton & Pemotongan Steel Rebar Cutter",
