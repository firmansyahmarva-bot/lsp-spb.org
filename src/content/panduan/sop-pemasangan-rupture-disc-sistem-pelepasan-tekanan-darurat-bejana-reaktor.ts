...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pemasangan-rupture-disc-sistem-pelepasan-tekanan-darurat-bejana-reaktor",
  "title": "SOP Pemasangan Rupture Disc Sistem Pelepasan Tekanan Darurat Bejana Reaktor",
  "metaTitle": "SOP Pemasangan Rupture Disc Sistem Pelepasan Tekanan Darurat Bejana Reaktor | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pemasangan Rupture Disc Sistem Pelepasan Tekanan Darurat Bejana Reaktor di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988, dan tindakan darurat.",
  "answer": "SOP Pemasangan Rupture Disc Sistem Pelepasan Tekanan Darurat Bejana Reaktor adalah instruksi kerja keselamatan baku dalam klaster Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "indexable": true,
  "intent": "panduan sop-pemasangan-rupture-disc-sistem-pelepasan-tekanan-darurat-bejana-reaktor sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pemasangan rupture disc sistem pelepasan tekanan darurat bejana reaktor kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pemasangan Rupture Disc Sistem Pelepasan Tekanan Darurat Bejana Reaktor",
