...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-penanganan-kebakaran-korsleting-panel-listrik-menggunakan-apar-co2",
  "title": "SOP Penanganan Kebakaran Korsleting Panel Listrik Menggunakan APAR CO2",
  "metaTitle": "SOP Penanganan Kebakaran Korsleting Panel Listrik Menggunakan APAR CO2 | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Penanganan Kebakaran Korsleting Panel Listrik Menggunakan APAR CO2 di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Kepmenaker No. KEP.186/MEN/1999 & Permenaker 04/1980, dan tindakan darurat.",
  "answer": "SOP Penanganan Kebakaran Korsleting Panel Listrik Menggunakan APAR CO2 adalah instruksi kerja keselamatan baku dalam klaster Penanggulangan Kebakaran & Proteksi Api (Fire Safety) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Kepmenaker No. KEP.186/MEN/1999 & Permenaker 04/1980 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Penanganan Kebakaran Korsleting Panel Listrik Menggunakan APAR CO2",
      "paragraphs": [
        "Penerapan SOP Penanganan Kebakaran Korsleting Panel Listrik Menggunakan APAR CO2 bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Penanggulangan Kebakaran & Proteksi Api (Fire Safety). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya penyebaran api cepat, hirupan asap karbon monoksida, dan terjebak di ruangan terkunci telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-penanganan-kebakaran-korsleting-panel-listrik-menggunakan-apar-co2 sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop penanganan kebakaran korsleting panel listrik menggunakan apar co2 kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Penanganan Kebakaran Korsleting Panel Listrik Menggunakan APAR CO2",
