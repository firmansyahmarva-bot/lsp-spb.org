...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-inspeksi-kelayakan-lifter-passenger-hoist-elevator-konstruksi-bangunan",
  "title": "SOP Inspeksi Kelayakan Lifter Passenger Hoist & Elevator Konstruksi Bangunan",
  "metaTitle": "SOP Inspeksi Kelayakan Lifter Passenger Hoist & Elevator Konstruksi Bangunan | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Inspeksi Kelayakan Lifter Passenger Hoist & Elevator Konstruksi Bangunan di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut, dan tindakan darurat.",
  "answer": "SOP Inspeksi Kelayakan Lifter Passenger Hoist & Elevator Konstruksi Bangunan adalah instruksi kerja keselamatan baku dalam klaster Pesawat Angkat & Pesawat Angkut (PAA & Rigging) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Inspeksi Kelayakan Lifter Passenger Hoist & Elevator Konstruksi Bangunan",
      "paragraphs": [
        "Penerapan SOP Inspeksi Kelayakan Lifter Passenger Hoist & Elevator Konstruksi Bangunan bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Angkat & Pesawat Angkut (PAA & Rigging). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya beban gantung jatuh, crane guling akibat kelebihan beban, dan jepitan sling mekanik telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-inspeksi-kelayakan-lifter-passenger-hoist-elevator-konstruksi-bangunan sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop inspeksi kelayakan lifter passenger hoist elevator konstruksi bangunan kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Inspeksi Kelayakan Lifter Passenger Hoist & Elevator Konstruksi Bangunan",
