...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-penanganan-pestisida-bahan-kimia-agrokimia-area-perkebunan",
  "title": "SOP Penanganan Pestisida & Bahan Kimia Agrokimia Area Perkebunan",
  "metaTitle": "SOP Penanganan Pestisida & Bahan Kimia Agrokimia Area Perkebunan | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Penanganan Pestisida & Bahan Kimia Agrokimia Area Perkebunan di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Kepmenaker No. KEP.187/MEN/1999 tentang Pengendalian Bahan Kimia, dan tindakan darurat.",
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Penanganan Pestisida & Bahan Kimia Agrokimia Area Perkebunan",
      "paragraphs": [
  ...
  "indexable": true,
  "intent": "panduan sop-penanganan-pestisida-bahan-kimia-agrokimia-area-perkebunan sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop penanganan pestisida bahan kimia agrokimia area perkebunan kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Penanganan Pestisida & Bahan Kimia Agrokimia Area Perkebunan",
