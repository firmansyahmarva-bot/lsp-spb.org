...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pengikatan-pipa-baja-panjang-menggunakan-metode-double-wrap-choker-hitch",
  "title": "SOP Pengikatan Pipa Baja Panjang Menggunakan Metode Double Wrap Choker Hitch",
  "metaTitle": "SOP Pengikatan Pipa Baja Panjang Menggunakan Metode Double Wrap Choker Hitch | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pengikatan Pipa Baja Panjang Menggunakan Metode Double Wrap Choker Hitch di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut, dan tindakan darurat.",
  "answer": "SOP Pengikatan Pipa Baja Panjang Menggunakan Metode Double Wrap Choker Hitch adalah instruksi kerja keselamatan baku dalam klaster Pesawat Angkat & Pesawat Angkut (PAA & Rigging) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pengikatan Pipa Baja Panjang Menggunakan Metode Double Wrap Choker Hitch",
      "paragraphs": [
        "Penerapan SOP Pengikatan Pipa Baja Panjang Menggunakan Metode Double Wrap Choker Hitch bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Angkat & Pesawat Angkut (PAA & Rigging). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya beban gantung jatuh, crane guling akibat kelebihan beban, dan jepitan sling mekanik telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pengikatan-pipa-baja-panjang-menggunakan-metode-double-wrap-choker-hitch sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pengikatan pipa baja panjang menggunakan metode double wrap choker hitch kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pengikatan Pipa Baja Panjang Menggunakan Metode Double Wrap Choker Hitch",
