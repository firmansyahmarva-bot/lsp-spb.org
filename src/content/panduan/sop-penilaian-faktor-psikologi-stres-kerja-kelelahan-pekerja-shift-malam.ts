...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-penilaian-faktor-psikologi-stres-kerja-kelelahan-pekerja-shift-malam",
  "title": "SOP Penilaian Faktor Psikologi Stres Kerja & Kelelahan Pekerja Shift Malam",
  "metaTitle": "SOP Penilaian Faktor Psikologi Stres Kerja & Kelelahan Pekerja Shift Malam | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Penilaian Faktor Psikologi Stres Kerja & Kelelahan Pekerja Shift Malam di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 05 Tahun 2018 tentang K3 Lingkungan Kerja, dan tindakan darurat.",
  "answer": "SOP Penilaian Faktor Psikologi Stres Kerja & Kelelahan Pekerja Shift Malam adalah instruksi kerja keselamatan baku dalam klaster Higiene Industri & Lingkungan Kerja (Occupational Hygiene) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 05 Tahun 2018 tentang K3 Lingkungan Kerja guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "indexable": true,
  "intent": "panduan sop-penilaian-faktor-psikologi-stres-kerja-kelelahan-pekerja-shift-malam sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop penilaian faktor psikologi stres kerja kelelahan pekerja shift malam kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Penilaian Faktor Psikologi Stres Kerja & Kelelahan Pekerja Shift Malam",
