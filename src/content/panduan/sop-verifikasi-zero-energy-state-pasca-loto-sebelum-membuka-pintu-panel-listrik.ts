...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-verifikasi-zero-energy-state-pasca-loto-sebelum-membuka-pintu-panel-listrik",
  "title": "SOP Verifikasi Zero Energy State Pasca-LOTO Sebelum Membuka Pintu Panel Listrik",
  "metaTitle": "SOP Verifikasi Zero Energy State Pasca-LOTO Sebelum Membuka Pintu Panel Listrik | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Verifikasi Zero Energy State Pasca-LOTO Sebelum Membuka Pintu Panel Listrik di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 12 Tahun 2015 & SNI 0225:2020 PUIL 2020, dan tindakan darurat.",
  "answer": "SOP Verifikasi Zero Energy State Pasca-LOTO Sebelum Membuka Pintu Panel Listrik adalah instruksi kerja keselamatan baku dalam klaster Kelistrikan & Isolasi Energi (Electrical LOTO) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 12 Tahun 2015 & SNI 0225:2020 PUIL 2020 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Verifikasi Zero Energy State Pasca-LOTO Sebelum Membuka Pintu Panel Listrik",
      "paragraphs": [
        "Penerapan SOP Verifikasi Zero Energy State Pasca-LOTO Sebelum Membuka Pintu Panel Listrik bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Kelistrikan & Isolasi Energi (Electrical LOTO). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya sengatan listrik tegangan tinggi, busur api Arc Flash, dan hubungan pendek arus listrik telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-verifikasi-zero-energy-state-pasca-loto-sebelum-membuka-pintu-panel-listrik sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop verifikasi zero energy state pasca loto sebelum membuka pintu panel listrik kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Verifikasi Zero Energy State Pasca-LOTO Sebelum Membuka Pintu Panel Listrik",
