...
export const record: ContentRecord = {
  ...
  "title": "Panduan Penyusunan Matriks Training & Kompetensi K3 Jabatan Karyawan",
  "metaTitle": "Panduan Penyusunan Matriks Training & Kompetensi K3 Jabatan Karyawan | Informasi & Persyaratan Resmi",
  "description": "Langkah pemetaan kebutuhan sertifikasi lisensi Kemnaker / BNSP berdasarkan risiko posisi pekerjaan di pabrik.",
  "answer": "Panduan Penyusunan Matriks Training & Kompetensi K3 Jabatan Karyawan memberikan instruksi komprehensif berlandaskan PP No. 50 Tahun 2012 untuk membantu calon peserta, praktisi HSE, dan manajemen perusahaan memenuhi persyaratan regulasi, estimasi biaya, serta kelengkapan administrasi K3 secara tepat.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Kerangka Acuan & Regulasi Panduan Penyusunan Matriks Training & Kompetensi K3 Jabatan Karyawan",
      "paragraphs": [
        "Penjelasan lengkap mengenai Panduan Penyusunan Matriks Training & Kompetensi K3 Jabatan Karyawan disusun secara mendalam berdasarkan PP No. 50 Tahun 2012 dan petunjuk teknis Kementerian Ketenagakerjaan RI. Memahami panduan ini sangat penting bagi individu maupun instansi perusahaan untuk memastikan seluruh proses administrasi dan teknis berjalan sesuai standar hukum.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Hubungi tim admisi kami untuk konsultasi langsung mengenai Panduan Penyusunan Matriks Training & Kompetensi K3 Jabatan Karyawan. Kami melayani verifikasi kelayakan ijazah gratis dan penyusunan proposal corporate in-house training."
      ]
    }
  ],
  "faqs": [
    {
      "question": "Apa langkah pertama dalam mengurus Panduan Penyusunan Matriks Training & Kompetensi K3 Jabatan Karyawan?",
    ...
    {
      "question": "Berapa lama estimasi waktu proses pengurusan Panduan Penyusunan Matriks Training & Kompetensi K3 Jabatan Karyawan?",
  ...
  "indexable": true,
  "intent": "panduan cara membuat matriks kompetensi k3 karyawan Langkah pemetaan kebutuhan sertifikasi lisensi Kemnaker / BNSP berdasarkan risiko posisi pekerjaan di pabrik.",
  "primaryKeyword": "panduan cara membuat matriks kompetensi k3 karyawan",
  "searchIntent": "Langkah pemetaan kebutuhan sertifikasi lisensi Kemnaker / BNSP berdasarkan risiko posisi pekerjaan di pabrik.",
