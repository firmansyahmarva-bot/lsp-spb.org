...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "tata-cara-audit-internal-smk3-tahunan",
  "title": "Panduan Langkah Praktis Pelaksanaan Audit Internal SMK3 Perusahaan",
  "metaTitle": "Panduan Langkah Praktis Pelaksanaan Audit Internal SMK3 Perusahaan | Informasi & Persyaratan Resmi",
  "description": "Tahapan opening meeting, sampling dokumen, verifikasi observasi lapangan, wawancara pekerja, hingga closing meeting.",
  "answer": "Panduan Langkah Praktis Pelaksanaan Audit Internal SMK3 Perusahaan memberikan instruksi komprehensif berlandaskan PP No. 50 Tahun 2012 untuk membantu calon peserta, praktisi HSE, dan manajemen perusahaan memenuhi persyaratan regulasi, estimasi biaya, serta kelengkapan administrasi K3 secara tepat.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Kerangka Acuan & Regulasi Panduan Langkah Praktis Pelaksanaan Audit Internal SMK3 Perusahaan",
      "paragraphs": [
        "Penjelasan lengkap mengenai Panduan Langkah Praktis Pelaksanaan Audit Internal SMK3 Perusahaan disusun secara mendalam berdasarkan PP No. 50 Tahun 2012 dan petunjuk teknis Kementerian Ketenagakerjaan RI. Memahami panduan ini sangat penting bagi individu maupun instansi perusahaan untuk memastikan seluruh proses administrasi dan teknis berjalan sesuai standar hukum.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Hubungi tim admisi kami untuk konsultasi langsung mengenai Panduan Langkah Praktis Pelaksanaan Audit Internal SMK3 Perusahaan. Kami melayani verifikasi kelayakan ijazah gratis dan penyusunan proposal corporate in-house training."
      ]
    }
  ],
  "faqs": [
    {
      "question": "Apa langkah pertama dalam mengurus Panduan Langkah Praktis Pelaksanaan Audit Internal SMK3 Perusahaan?",
    ...
    {
      "question": "Berapa lama estimasi waktu proses pengurusan Panduan Langkah Praktis Pelaksanaan Audit Internal SMK3 Perusahaan?",
  ...
  "indexable": true,
  "intent": "panduan tata cara audit internal smk3 tahunan Tahapan opening meeting, sampling dokumen, verifikasi observasi lapangan, wawancara pekerja, hingga closing meeting.",
  "primaryKeyword": "panduan tata cara audit internal smk3 tahunan",
  "searchIntent": "Tahapan opening meeting, sampling dokumen, verifikasi observasi lapangan, wawancara pekerja, hingga closing meeting.",
