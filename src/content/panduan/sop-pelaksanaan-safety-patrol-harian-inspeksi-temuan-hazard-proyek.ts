...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pelaksanaan-safety-patrol-harian-inspeksi-temuan-hazard-proyek",
  "title": "SOP Pelaksanaan Safety Patrol Harian & Inspeksi Temuan Hazard Proyek",
  "metaTitle": "SOP Pelaksanaan Safety Patrol Harian & Inspeksi Temuan Hazard Proyek | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pelaksanaan Safety Patrol Harian & Inspeksi Temuan Hazard Proyek di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permen PUPR No. 10 Tahun 2021 tentang SMKK, dan tindakan darurat.",
  "answer": "SOP Pelaksanaan Safety Patrol Harian & Inspeksi Temuan Hazard Proyek adalah instruksi kerja keselamatan baku dalam klaster Konstruksi & SMKK PUPR (Construction Safety) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permen PUPR No. 10 Tahun 2021 tentang SMKK guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pelaksanaan Safety Patrol Harian & Inspeksi Temuan Hazard Proyek",
      "paragraphs": [
        "Penerapan SOP Pelaksanaan Safety Patrol Harian & Inspeksi Temuan Hazard Proyek bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Konstruksi & SMKK PUPR (Construction Safety). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya runtuhan penggalian tanah, guling alat berat, dan jatuh dari struktur bekisting telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pelaksanaan-safety-patrol-harian-inspeksi-temuan-hazard-proyek sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pelaksanaan safety patrol harian inspeksi temuan hazard proyek kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pelaksanaan Safety Patrol Harian & Inspeksi Temuan Hazard Proyek",
