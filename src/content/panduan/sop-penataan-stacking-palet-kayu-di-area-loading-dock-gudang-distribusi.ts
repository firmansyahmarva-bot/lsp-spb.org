...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-penataan-stacking-palet-kayu-di-area-loading-dock-gudang-distribusi",
  "title": "SOP Penataan & Stacking Palet Kayu Di Area Loading Dock Gudang Distribusi",
  "metaTitle": "SOP Penataan & Stacking Palet Kayu Di Area Loading Dock Gudang Distribusi | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Penataan & Stacking Palet Kayu Di Area Loading Dock Gudang Distribusi di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut, dan tindakan darurat.",
  "answer": "SOP Penataan & Stacking Palet Kayu Di Area Loading Dock Gudang Distribusi adalah instruksi kerja keselamatan baku dalam klaster Pesawat Angkat & Pesawat Angkut (PAA & Rigging) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "indexable": true,
  "intent": "panduan sop-penataan-stacking-palet-kayu-di-area-loading-dock-gudang-distribusi sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop penataan stacking palet kayu di area loading dock gudang distribusi kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Penataan & Stacking Palet Kayu Di Area Loading Dock Gudang Distribusi",
