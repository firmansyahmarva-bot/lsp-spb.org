...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pengoperasian-automated-guided-vehicle-agv-di-area-gudang-logistik-otomatis",
  "title": "SOP Pengoperasian Automated Guided Vehicle (AGV) Di Area Gudang Logistik Otomatis",
  "metaTitle": "SOP Pengoperasian Automated Guided Vehicle (AGV) Di Area Gudang Logistik Otomatis | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pengoperasian Automated Guided Vehicle (AGV) Di Area Gudang Logistik Otomatis di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut, dan tindakan darurat.",
  "answer": "SOP Pengoperasian Automated Guided Vehicle (AGV) Di Area Gudang Logistik Otomatis adalah instruksi kerja keselamatan baku dalam klaster Pesawat Angkat & Pesawat Angkut (PAA & Rigging) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pengoperasian Automated Guided Vehicle (AGV) Di Area Gudang Logistik Otomatis",
      "paragraphs": [
        "Penerapan SOP Pengoperasian Automated Guided Vehicle (AGV) Di Area Gudang Logistik Otomatis bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Angkat & Pesawat Angkut (PAA & Rigging). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya beban gantung jatuh, crane guling akibat kelebihan beban, dan jepitan sling mekanik telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pengoperasian-automated-guided-vehicle-agv-di-area-gudang-logistik-otomatis sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pengoperasian automated guided vehicle agv di area gudang logistik otomatis kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pengoperasian Automated Guided Vehicle (AGV) Di Area Gudang Logistik Otomatis",
