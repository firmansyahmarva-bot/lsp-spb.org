...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-penilaian-risiko-ergonomi-postur-kerja-menggunakan-metode-reba-rula",
  "title": "SOP Penilaian Risiko Ergonomi Postur Kerja Menggunakan Metode REBA & RULA",
  "metaTitle": "SOP Penilaian Risiko Ergonomi Postur Kerja Menggunakan Metode REBA & RULA | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Penilaian Risiko Ergonomi Postur Kerja Menggunakan Metode REBA & RULA di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 05 Tahun 2018 tentang K3 Lingkungan Kerja, dan tindakan darurat.",
  "answer": "SOP Penilaian Risiko Ergonomi Postur Kerja Menggunakan Metode REBA & RULA adalah instruksi kerja keselamatan baku dalam klaster Higiene Industri & Lingkungan Kerja (Occupational Hygiene) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 05 Tahun 2018 tentang K3 Lingkungan Kerja guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Penilaian Risiko Ergonomi Postur Kerja Menggunakan Metode REBA & RULA",
      "paragraphs": [
        "Penerapan SOP Penilaian Risiko Ergonomi Postur Kerja Menggunakan Metode REBA & RULA bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Higiene Industri & Lingkungan Kerja (Occupational Hygiene). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya penurunan pendengaran kebisingan (NIHL), stres panas iklim kerja, dan gangguan otot MSDs telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-penilaian-risiko-ergonomi-postur-kerja-menggunakan-metode-reba-rula sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop penilaian risiko ergonomi postur kerja menggunakan metode reba rula kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Penilaian Risiko Ergonomi Postur Kerja Menggunakan Metode REBA & RULA",
