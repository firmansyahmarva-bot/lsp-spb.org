...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-k3-pekerjaan-pemancangan-tiang-pancang-pile-driving-foundation",
  "title": "SOP K3 Pekerjaan Pemancangan Tiang Pancang Pile Driving Foundation",
  "metaTitle": "SOP K3 Pekerjaan Pemancangan Tiang Pancang Pile Driving Foundation | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP K3 Pekerjaan Pemancangan Tiang Pancang Pile Driving Foundation di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permen PUPR No. 10 Tahun 2021 tentang SMKK, dan tindakan darurat.",
  "answer": "SOP K3 Pekerjaan Pemancangan Tiang Pancang Pile Driving Foundation adalah instruksi kerja keselamatan baku dalam klaster Konstruksi & SMKK PUPR (Construction Safety) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permen PUPR No. 10 Tahun 2021 tentang SMKK guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP K3 Pekerjaan Pemancangan Tiang Pancang Pile Driving Foundation",
      "paragraphs": [
        "Penerapan SOP K3 Pekerjaan Pemancangan Tiang Pancang Pile Driving Foundation bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Konstruksi & SMKK PUPR (Construction Safety). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya runtuhan penggalian tanah, guling alat berat, dan jatuh dari struktur bekisting telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-k3-pekerjaan-pemancangan-tiang-pancang-pile-driving-foundation sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop k3 pekerjaan pemancangan tiang pancang pile driving foundation kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP K3 Pekerjaan Pemancangan Tiang Pancang Pile Driving Foundation",
