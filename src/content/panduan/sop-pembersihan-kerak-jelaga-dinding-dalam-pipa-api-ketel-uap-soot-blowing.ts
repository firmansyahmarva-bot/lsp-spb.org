...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pembersihan-kerak-jelaga-dinding-dalam-pipa-api-ketel-uap-soot-blowing",
  "title": "SOP Pembersihan Kerak Jelaga Dinding Dalam Pipa Api Ketel Uap (Soot Blowing)",
  "metaTitle": "SOP Pembersihan Kerak Jelaga Dinding Dalam Pipa Api Ketel Uap (Soot Blowing) | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pembersihan Kerak Jelaga Dinding Dalam Pipa Api Ketel Uap (Soot Blowing) di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988, dan tindakan darurat.",
  "answer": "SOP Pembersihan Kerak Jelaga Dinding Dalam Pipa Api Ketel Uap (Soot Blowing) adalah instruksi kerja keselamatan baku dalam klaster Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pembersihan Kerak Jelaga Dinding Dalam Pipa Api Ketel Uap (Soot Blowing)",
      "paragraphs": [
        "Penerapan SOP Pembersihan Kerak Jelaga Dinding Dalam Pipa Api Ketel Uap (Soot Blowing) bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya ledakan uap bertekanan tinggi (BLEVE), keretakan dinding bejana, dan scaling kerak telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pembersihan-kerak-jelaga-dinding-dalam-pipa-api-ketel-uap-soot-blowing sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pembersihan kerak jelaga dinding dalam pipa api ketel uap soot blowing kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pembersihan Kerak Jelaga Dinding Dalam Pipa Api Ketel Uap (Soot Blowing)",
