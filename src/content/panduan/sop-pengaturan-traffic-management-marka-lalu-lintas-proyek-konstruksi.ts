...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pengaturan-traffic-management-marka-lalu-lintas-proyek-konstruksi",
  "title": "SOP Pengaturan Traffic Management & Marka Lalu Lintas Proyek Konstruksi",
  "metaTitle": "SOP Pengaturan Traffic Management & Marka Lalu Lintas Proyek Konstruksi | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pengaturan Traffic Management & Marka Lalu Lintas Proyek Konstruksi di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permen PUPR No. 10 Tahun 2021 tentang SMKK, dan tindakan darurat.",
  "answer": "SOP Pengaturan Traffic Management & Marka Lalu Lintas Proyek Konstruksi adalah instruksi kerja keselamatan baku dalam klaster Konstruksi & SMKK PUPR (Construction Safety) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permen PUPR No. 10 Tahun 2021 tentang SMKK guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pengaturan Traffic Management & Marka Lalu Lintas Proyek Konstruksi",
      "paragraphs": [
        "Penerapan SOP Pengaturan Traffic Management & Marka Lalu Lintas Proyek Konstruksi bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Konstruksi & SMKK PUPR (Construction Safety). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya runtuhan penggalian tanah, guling alat berat, dan jatuh dari struktur bekisting telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pengaturan-traffic-management-marka-lalu-lintas-proyek-konstruksi sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pengaturan traffic management marka lalu lintas proyek konstruksi kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pengaturan Traffic Management & Marka Lalu Lintas Proyek Konstruksi",
