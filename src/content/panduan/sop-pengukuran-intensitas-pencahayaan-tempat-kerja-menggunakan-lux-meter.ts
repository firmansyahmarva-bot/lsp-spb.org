...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pengukuran-intensitas-pencahayaan-tempat-kerja-menggunakan-lux-meter",
  "title": "SOP Pengukuran Intensitas Pencahayaan Tempat Kerja Menggunakan Lux Meter",
  "metaTitle": "SOP Pengukuran Intensitas Pencahayaan Tempat Kerja Menggunakan Lux Meter | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pengukuran Intensitas Pencahayaan Tempat Kerja Menggunakan Lux Meter di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 05 Tahun 2018 tentang K3 Lingkungan Kerja, dan tindakan darurat.",
  "answer": "SOP Pengukuran Intensitas Pencahayaan Tempat Kerja Menggunakan Lux Meter adalah instruksi kerja keselamatan baku dalam klaster Higiene Industri & Lingkungan Kerja (Occupational Hygiene) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 05 Tahun 2018 tentang K3 Lingkungan Kerja guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "indexable": true,
  "intent": "panduan sop-pengukuran-intensitas-pencahayaan-tempat-kerja-menggunakan-lux-meter sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pengukuran intensitas pencahayaan tempat kerja menggunakan lux meter kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pengukuran Intensitas Pencahayaan Tempat Kerja Menggunakan Lux Meter",
