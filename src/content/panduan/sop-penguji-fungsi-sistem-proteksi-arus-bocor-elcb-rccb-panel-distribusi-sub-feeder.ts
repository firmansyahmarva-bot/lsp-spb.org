...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-penguji-fungsi-sistem-proteksi-arus-bocor-elcb-rccb-panel-distribusi-sub-feeder",
  "title": "SOP Penguji Fungsi Sistem Proteksi Arus Bocor ELCB / RCCB Panel Distribusi Sub-Feeder",
  "metaTitle": "SOP Penguji Fungsi Sistem Proteksi Arus Bocor ELCB / RCCB Panel Distribusi Sub-Feeder | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Penguji Fungsi Sistem Proteksi Arus Bocor ELCB / RCCB Panel Distribusi Sub-Feeder di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 12 Tahun 2015 & SNI 0225:2020 PUIL 2020, dan tindakan darurat.",
  "answer": "SOP Penguji Fungsi Sistem Proteksi Arus Bocor ELCB / RCCB Panel Distribusi Sub-Feeder adalah instruksi kerja keselamatan baku dalam klaster Kelistrikan & Isolasi Energi (Electrical LOTO) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 12 Tahun 2015 & SNI 0225:2020 PUIL 2020 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "indexable": true,
  "intent": "panduan sop-penguji-fungsi-sistem-proteksi-arus-bocor-elcb-rccb-panel-distribusi-sub-feeder sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop penguji fungsi sistem proteksi arus bocor elcb rccb panel distribusi sub feeder kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Penguji Fungsi Sistem Proteksi Arus Bocor ELCB / RCCB Panel Distribusi Sub-Feeder",
