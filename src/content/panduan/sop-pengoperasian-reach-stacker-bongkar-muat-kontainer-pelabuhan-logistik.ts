...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pengoperasian-reach-stacker-bongkar-muat-kontainer-pelabuhan-logistik",
  "title": "SOP Pengoperasian Reach Stacker Bongkar Muat Kontainer Pelabuhan Logistik",
  "metaTitle": "SOP Pengoperasian Reach Stacker Bongkar Muat Kontainer Pelabuhan Logistik | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pengoperasian Reach Stacker Bongkar Muat Kontainer Pelabuhan Logistik di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut, dan tindakan darurat.",
  "answer": "SOP Pengoperasian Reach Stacker Bongkar Muat Kontainer Pelabuhan Logistik adalah instruksi kerja keselamatan baku dalam klaster Pesawat Angkat & Pesawat Angkut (PAA & Rigging) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pengoperasian Reach Stacker Bongkar Muat Kontainer Pelabuhan Logistik",
      "paragraphs": [
        "Penerapan SOP Pengoperasian Reach Stacker Bongkar Muat Kontainer Pelabuhan Logistik bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Angkat & Pesawat Angkut (PAA & Rigging). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya beban gantung jatuh, crane guling akibat kelebihan beban, dan jepitan sling mekanik telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pengoperasian-reach-stacker-bongkar-muat-kontainer-pelabuhan-logistik sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pengoperasian reach stacker bongkar muat kontainer pelabuhan logistik kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pengoperasian Reach Stacker Bongkar Muat Kontainer Pelabuhan Logistik",
