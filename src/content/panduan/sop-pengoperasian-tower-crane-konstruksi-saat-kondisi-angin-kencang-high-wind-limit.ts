...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pengoperasian-tower-crane-konstruksi-saat-kondisi-angin-kencang-high-wind-limit",
  "title": "SOP Pengoperasian Tower Crane Konstruksi Saat Kondisi Angin Kencang (High Wind Limit)",
  "metaTitle": "SOP Pengoperasian Tower Crane Konstruksi Saat Kondisi Angin Kencang (High Wind Limit) | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pengoperasian Tower Crane Konstruksi Saat Kondisi Angin Kencang (High Wind Limit) di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut, dan tindakan darurat.",
  "answer": "SOP Pengoperasian Tower Crane Konstruksi Saat Kondisi Angin Kencang (High Wind Limit) adalah instruksi kerja keselamatan baku dalam klaster Pesawat Angkat & Pesawat Angkut (PAA & Rigging) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 08 Tahun 2020 tentang K3 Pesawat Angkat Angkut guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pengoperasian Tower Crane Konstruksi Saat Kondisi Angin Kencang (High Wind Limit)",
      "paragraphs": [
        "Penerapan SOP Pengoperasian Tower Crane Konstruksi Saat Kondisi Angin Kencang (High Wind Limit) bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Angkat & Pesawat Angkut (PAA & Rigging). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya beban gantung jatuh, crane guling akibat kelebihan beban, dan jepitan sling mekanik telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pengoperasian-tower-crane-konstruksi-saat-kondisi-angin-kencang-high-wind-limit sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pengoperasian tower crane konstruksi saat kondisi angin kencang high wind limit kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pengoperasian Tower Crane Konstruksi Saat Kondisi Angin Kencang (High Wind Limit)",
