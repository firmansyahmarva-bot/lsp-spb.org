...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-penanganan-bahan-peledak-komersial-blasting-area-pertambangan",
  "title": "SOP Penanganan Bahan Peledak Komersial Blasting Area Pertambangan",
  "metaTitle": "SOP Penanganan Bahan Peledak Komersial Blasting Area Pertambangan | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Penanganan Bahan Peledak Komersial Blasting Area Pertambangan di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Kepmenaker No. KEP.187/MEN/1999 tentang Pengendalian Bahan Kimia, dan tindakan darurat.",
  "answer": "SOP Penanganan Bahan Peledak Komersial Blasting Area Pertambangan adalah instruksi kerja keselamatan baku dalam klaster Bahan Kimia Berbahaya & B3 (Chemical Safety) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Kepmenaker No. KEP.187/MEN/1999 tentang Pengendalian Bahan Kimia guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Penanganan Bahan Peledak Komersial Blasting Area Pertambangan",
      "paragraphs": [
        "Penerapan SOP Penanganan Bahan Peledak Komersial Blasting Area Pertambangan bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Bahan Kimia Berbahaya & B3 (Chemical Safety). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya paparan gas toksik beracun, tumpahan asam basa korosif, dan luka bakar kimia telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-penanganan-bahan-peledak-komersial-blasting-area-pertambangan sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop penanganan bahan peledak komersial blasting area pertambangan kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Penanganan Bahan Peledak Komersial Blasting Area Pertambangan",
