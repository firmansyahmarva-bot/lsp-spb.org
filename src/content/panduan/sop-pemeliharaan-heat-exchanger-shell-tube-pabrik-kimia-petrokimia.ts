...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pemeliharaan-heat-exchanger-shell-tube-pabrik-kimia-petrokimia",
  "title": "SOP Pemeliharaan Heat Exchanger Shell & Tube Pabrik Kimia Petrokimia",
  "metaTitle": "SOP Pemeliharaan Heat Exchanger Shell & Tube Pabrik Kimia Petrokimia | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pemeliharaan Heat Exchanger Shell & Tube Pabrik Kimia Petrokimia di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988, dan tindakan darurat.",
  "answer": "SOP Pemeliharaan Heat Exchanger Shell & Tube Pabrik Kimia Petrokimia adalah instruksi kerja keselamatan baku dalam klaster Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pemeliharaan Heat Exchanger Shell & Tube Pabrik Kimia Petrokimia",
      "paragraphs": [
        "Penerapan SOP Pemeliharaan Heat Exchanger Shell & Tube Pabrik Kimia Petrokimia bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya ledakan uap bertekanan tinggi (BLEVE), keretakan dinding bejana, dan scaling kerak telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pemeliharaan-heat-exchanger-shell-tube-pabrik-kimia-petrokimia sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pemeliharaan heat exchanger shell tube pabrik kimia petrokimia kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pemeliharaan Heat Exchanger Shell & Tube Pabrik Kimia Petrokimia",
