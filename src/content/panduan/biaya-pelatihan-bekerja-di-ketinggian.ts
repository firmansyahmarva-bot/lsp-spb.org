...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "biaya-pelatihan-bekerja-di-ketinggian",
  "title": "Panduan Biaya Pelatihan K3 Bekerja di Ketinggian (TKPK & TKBT)",
  "metaTitle": "Panduan Biaya Pelatihan K3 Bekerja di Ketinggian (TKPK & TKBT) | Informasi & Persyaratan Resmi",
  "description": "Estimasi biaya pembinaan Tenaga Kerja Bangunan Tinggi dan Tenaga Kerja Pada Ketinggian rope access berlisensi Kemnaker.",
  "answer": "Panduan Biaya Pelatihan K3 Bekerja di Ketinggian (TKPK & TKBT) memberikan instruksi komprehensif berlandaskan Permenaker No. 09 Tahun 2016 untuk membantu calon peserta, praktisi HSE, dan manajemen perusahaan memenuhi persyaratan regulasi, estimasi biaya, serta kelengkapan administrasi K3 secara tepat.",
  "highlights": [
    "Kategori Panduan: COST",
    "Dasar Regulasi: Permenaker No. 09 Tahun 2016",
    "Penyelenggara: Konsultasi Resmi PT Kreasi Ultimate Berjaya",
    "Verifikasi Berkas: Pre-Screening Gratis Sebelum Pendaftaran"
  ],
  "blocks": [
    {
      "heading": "Kerangka Acuan & Regulasi Panduan Biaya Pelatihan K3 Bekerja di Ketinggian (TKPK & TKBT)",
      "paragraphs": [
        "Penjelasan lengkap mengenai Panduan Biaya Pelatihan K3 Bekerja di Ketinggian (TKPK & TKBT) disusun secara mendalam berdasarkan Permenaker No. 09 Tahun 2016 dan petunjuk teknis Kementerian Ketenagakerjaan RI. Memahami panduan ini sangat penting bagi individu maupun instansi perusahaan untuk memastikan seluruh proses administrasi dan teknis berjalan sesuai standar hukum.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Hubungi tim admisi kami untuk konsultasi langsung mengenai Panduan Biaya Pelatihan K3 Bekerja di Ketinggian (TKPK & TKBT). Kami melayani verifikasi kelayakan ijazah gratis dan penyusunan proposal corporate in-house training."
      ]
    }
  ],
  "faqs": [
    {
      "question": "Apa langkah pertama dalam mengurus Panduan Biaya Pelatihan K3 Bekerja di Ketinggian (TKPK & TKBT)?",
    ...
    {
      "question": "Berapa lama estimasi waktu proses pengurusan Panduan Biaya Pelatihan K3 Bekerja di Ketinggian (TKPK & TKBT)?",
  ...
  "indexable": true,
  "intent": "panduan biaya pelatihan bekerja di ketinggian Estimasi biaya pembinaan Tenaga Kerja Bangunan Tinggi dan Tenaga Kerja Pada Ketinggian rope access berlisensi Kemnaker.",
  "primaryKeyword": "panduan biaya pelatihan bekerja di ketinggian",
  "searchIntent": "Estimasi biaya pembinaan Tenaga Kerja Bangunan Tinggi dan Tenaga Kerja Pada Ketinggian rope access berlisensi Kemnaker.",
