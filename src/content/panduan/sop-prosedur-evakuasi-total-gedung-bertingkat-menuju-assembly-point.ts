...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-prosedur-evakuasi-total-gedung-bertingkat-menuju-assembly-point",
  "title": "SOP Prosedur Evakuasi Total Gedung Bertingkat Menuju Assembly Point",
  "metaTitle": "SOP Prosedur Evakuasi Total Gedung Bertingkat Menuju Assembly Point | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Prosedur Evakuasi Total Gedung Bertingkat Menuju Assembly Point di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Kepmenaker No. KEP.186/MEN/1999 & Permenaker 04/1980, dan tindakan darurat.",
  "answer": "SOP Prosedur Evakuasi Total Gedung Bertingkat Menuju Assembly Point adalah instruksi kerja keselamatan baku dalam klaster Penanggulangan Kebakaran & Proteksi Api (Fire Safety) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Kepmenaker No. KEP.186/MEN/1999 & Permenaker 04/1980 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Prosedur Evakuasi Total Gedung Bertingkat Menuju Assembly Point",
      "paragraphs": [
        "Penerapan SOP Prosedur Evakuasi Total Gedung Bertingkat Menuju Assembly Point bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Penanggulangan Kebakaran & Proteksi Api (Fire Safety). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya penyebaran api cepat, hirupan asap karbon monoksida, dan terjebak di ruangan terkunci telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-prosedur-evakuasi-total-gedung-bertingkat-menuju-assembly-point sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop prosedur evakuasi total gedung bertingkat menuju assembly point kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Prosedur Evakuasi Total Gedung Bertingkat Menuju Assembly Point",
