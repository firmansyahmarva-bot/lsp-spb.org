...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-inspeksi-ketebalan-dinding-bejana-tekan-menggunakan-ultrasonic-thickness-gauge",
  "title": "SOP Inspeksi Ketebalan Dinding Bejana Tekan Menggunakan Ultrasonic Thickness Gauge",
  "metaTitle": "SOP Inspeksi Ketebalan Dinding Bejana Tekan Menggunakan Ultrasonic Thickness Gauge | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Inspeksi Ketebalan Dinding Bejana Tekan Menggunakan Ultrasonic Thickness Gauge di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988, dan tindakan darurat.",
  "answer": "SOP Inspeksi Ketebalan Dinding Bejana Tekan Menggunakan Ultrasonic Thickness Gauge adalah instruksi kerja keselamatan baku dalam klaster Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 37/2016 & Permenaker No. PER.01/MEN/1988 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Inspeksi Ketebalan Dinding Bejana Tekan Menggunakan Ultrasonic Thickness Gauge",
      "paragraphs": [
        "Penerapan SOP Inspeksi Ketebalan Dinding Bejana Tekan Menggunakan Ultrasonic Thickness Gauge bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Pesawat Uap & Bejana Tekan (Boiler & Pressure Vessel). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya ledakan uap bertekanan tinggi (BLEVE), keretakan dinding bejana, dan scaling kerak telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-inspeksi-ketebalan-dinding-bejana-tekan-menggunakan-ultrasonic-thickness-gauge sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop inspeksi ketebalan dinding bejana tekan menggunakan ultrasonic thickness gauge kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Inspeksi Ketebalan Dinding Bejana Tekan Menggunakan Ultrasonic Thickness Gauge",
