...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-closing-izin-kerja-konstruksi-evaluasi-kinerja-k3-kontraktor",
  "title": "SOP Closing Izin Kerja Konstruksi & Evaluasi Kinerja K3 Kontraktor",
  "metaTitle": "SOP Closing Izin Kerja Konstruksi & Evaluasi Kinerja K3 Kontraktor | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Closing Izin Kerja Konstruksi & Evaluasi Kinerja K3 Kontraktor di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permen PUPR No. 10 Tahun 2021 tentang SMKK, dan tindakan darurat.",
  "answer": "SOP Closing Izin Kerja Konstruksi & Evaluasi Kinerja K3 Kontraktor adalah instruksi kerja keselamatan baku dalam klaster Konstruksi & SMKK PUPR (Construction Safety) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permen PUPR No. 10 Tahun 2021 tentang SMKK guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Closing Izin Kerja Konstruksi & Evaluasi Kinerja K3 Kontraktor",
      "paragraphs": [
        "Penerapan SOP Closing Izin Kerja Konstruksi & Evaluasi Kinerja K3 Kontraktor bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Konstruksi & SMKK PUPR (Construction Safety). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya runtuhan penggalian tanah, guling alat berat, dan jatuh dari struktur bekisting telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-closing-izin-kerja-konstruksi-evaluasi-kinerja-k3-kontraktor sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop closing izin kerja konstruksi evaluasi kinerja k3 kontraktor kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Closing Izin Kerja Konstruksi & Evaluasi Kinerja K3 Kontraktor",
