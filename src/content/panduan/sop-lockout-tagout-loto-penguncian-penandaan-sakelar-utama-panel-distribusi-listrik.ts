...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-lockout-tagout-loto-penguncian-penandaan-sakelar-utama-panel-distribusi-listrik",
  "title": "SOP Lockout Tagout (LOTO) Penguncian & Penandaan Sakelar Utama Panel Distribusi Listrik",
  "metaTitle": "SOP Lockout Tagout (LOTO) Penguncian & Penandaan Sakelar Utama Panel Distribusi Listrik | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Lockout Tagout (LOTO) Penguncian & Penandaan Sakelar Utama Panel Distribusi Listrik di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 12 Tahun 2015 & SNI 0225:2020 PUIL 2020, dan tindakan darurat.",
  "answer": "SOP Lockout Tagout (LOTO) Penguncian & Penandaan Sakelar Utama Panel Distribusi Listrik adalah instruksi kerja keselamatan baku dalam klaster Kelistrikan & Isolasi Energi (Electrical LOTO) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 12 Tahun 2015 & SNI 0225:2020 PUIL 2020 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Lockout Tagout (LOTO) Penguncian & Penandaan Sakelar Utama Panel Distribusi Listrik",
      "paragraphs": [
        "Penerapan SOP Lockout Tagout (LOTO) Penguncian & Penandaan Sakelar Utama Panel Distribusi Listrik bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Kelistrikan & Isolasi Energi (Electrical LOTO). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya sengatan listrik tegangan tinggi, busur api Arc Flash, dan hubungan pendek arus listrik telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-lockout-tagout-loto-penguncian-penandaan-sakelar-utama-panel-distribusi-listrik sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop lockout tagout loto penguncian penandaan sakelar utama panel distribusi listrik kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Lockout Tagout (LOTO) Penguncian & Penandaan Sakelar Utama Panel Distribusi Listrik",
