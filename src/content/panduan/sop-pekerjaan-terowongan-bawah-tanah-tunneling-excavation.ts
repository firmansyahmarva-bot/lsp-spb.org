...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-pekerjaan-terowongan-bawah-tanah-tunneling-excavation",
  "title": "SOP Pekerjaan Terowongan & Bawah Tanah (Tunneling Excavation)",
  "metaTitle": "SOP Pekerjaan Terowongan & Bawah Tanah (Tunneling Excavation) | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Pekerjaan Terowongan & Bawah Tanah (Tunneling Excavation) di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permen PUPR No. 10 Tahun 2021 tentang SMKK, dan tindakan darurat.",
  "answer": "SOP Pekerjaan Terowongan & Bawah Tanah (Tunneling Excavation) adalah instruksi kerja keselamatan baku dalam klaster Konstruksi & SMKK PUPR (Construction Safety) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permen PUPR No. 10 Tahun 2021 tentang SMKK guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Pekerjaan Terowongan & Bawah Tanah (Tunneling Excavation)",
      "paragraphs": [
        "Penerapan SOP Pekerjaan Terowongan & Bawah Tanah (Tunneling Excavation) bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Konstruksi & SMKK PUPR (Construction Safety). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya runtuhan penggalian tanah, guling alat berat, dan jatuh dari struktur bekisting telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-pekerjaan-terowongan-bawah-tanah-tunneling-excavation sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop pekerjaan terowongan bawah tanah tunneling excavation kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Pekerjaan Terowongan & Bawah Tanah (Tunneling Excavation)",
