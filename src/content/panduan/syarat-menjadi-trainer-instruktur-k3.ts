...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "syarat-menjadi-trainer-instruktur-k3",
  ...
  "indexable": true,
  "intent": "panduan syarat menjadi trainer instruktur k3 Kualifikasi sertifikat Training of Trainer (TOT) BNSP, kepemilikan lisensi spesialis, dan jam terbang mengajar keselamatan kerja.",
  "primaryKeyword": "panduan syarat menjadi trainer instruktur k3",
  "searchIntent": "Kualifikasi sertifikat Training of Trainer (TOT) BNSP, kepemilikan lisensi spesialis, dan jam terbang mengajar keselamatan kerja.",
