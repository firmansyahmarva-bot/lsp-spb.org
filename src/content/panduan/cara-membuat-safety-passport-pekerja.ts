...
export const record: ContentRecord = {
  ...
  "title": "Panduan Penerbitan & Verifikasi Safety Passport Pekerja Kontraktor",
  "metaTitle": "Panduan Penerbitan & Verifikasi Safety Passport Pekerja Kontraktor | Informasi & Persyaratan Resmi",
  "description": "Format buku paspor keselamatan: rekaman medical checkup, riwayat induksi, lisensi kewenangan, dan catatan pelanggaran safety.",
  "answer": "Panduan Penerbitan & Verifikasi Safety Passport Pekerja Kontraktor memberikan instruksi komprehensif berlandaskan PP No. 50 Tahun 2012 untuk membantu calon peserta, praktisi HSE, dan manajemen perusahaan memenuhi persyaratan regulasi, estimasi biaya, serta kelengkapan administrasi K3 secara tepat.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Kerangka Acuan & Regulasi Panduan Penerbitan & Verifikasi Safety Passport Pekerja Kontraktor",
      "paragraphs": [
        "Penjelasan lengkap mengenai Panduan Penerbitan & Verifikasi Safety Passport Pekerja Kontraktor disusun secara mendalam berdasarkan PP No. 50 Tahun 2012 dan petunjuk teknis Kementerian Ketenagakerjaan RI. Memahami panduan ini sangat penting bagi individu maupun instansi perusahaan untuk memastikan seluruh proses administrasi dan teknis berjalan sesuai standar hukum.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Hubungi tim admisi kami untuk konsultasi langsung mengenai Panduan Penerbitan & Verifikasi Safety Passport Pekerja Kontraktor. Kami melayani verifikasi kelayakan ijazah gratis dan penyusunan proposal corporate in-house training."
      ]
    }
  ],
  "faqs": [
    {
      "question": "Apa langkah pertama dalam mengurus Panduan Penerbitan & Verifikasi Safety Passport Pekerja Kontraktor?",
    ...
    {
      "question": "Berapa lama estimasi waktu proses pengurusan Panduan Penerbitan & Verifikasi Safety Passport Pekerja Kontraktor?",
  ...
  "indexable": true,
  "intent": "panduan cara membuat safety passport pekerja Format buku paspor keselamatan: rekaman medical checkup, riwayat induksi, lisensi kewenangan, dan catatan pelanggaran safety.",
  "primaryKeyword": "panduan cara membuat safety passport pekerja",
  "searchIntent": "Format buku paspor keselamatan: rekaman medical checkup, riwayat induksi, lisensi kewenangan, dan catatan pelanggaran safety.",
