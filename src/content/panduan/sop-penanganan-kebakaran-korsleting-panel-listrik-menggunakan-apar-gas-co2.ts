...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-penanganan-kebakaran-korsleting-panel-listrik-menggunakan-apar-gas-co2",
  "title": "SOP Penanganan Kebakaran Korsleting Panel Listrik Menggunakan APAR Gas CO2",
  "metaTitle": "SOP Penanganan Kebakaran Korsleting Panel Listrik Menggunakan APAR Gas CO2 | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Penanganan Kebakaran Korsleting Panel Listrik Menggunakan APAR Gas CO2 di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permenaker No. 12 Tahun 2015 & SNI 0225:2020 PUIL 2020, dan tindakan darurat.",
  "answer": "SOP Penanganan Kebakaran Korsleting Panel Listrik Menggunakan APAR Gas CO2 adalah instruksi kerja keselamatan baku dalam klaster Kelistrikan & Isolasi Energi (Electrical LOTO) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permenaker No. 12 Tahun 2015 & SNI 0225:2020 PUIL 2020 guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Penanganan Kebakaran Korsleting Panel Listrik Menggunakan APAR Gas CO2",
      "paragraphs": [
        "Penerapan SOP Penanganan Kebakaran Korsleting Panel Listrik Menggunakan APAR Gas CO2 bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Kelistrikan & Isolasi Energi (Electrical LOTO). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya sengatan listrik tegangan tinggi, busur api Arc Flash, dan hubungan pendek arus listrik telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-penanganan-kebakaran-korsleting-panel-listrik-menggunakan-apar-gas-co2 sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop penanganan kebakaran korsleting panel listrik menggunakan apar gas co2 kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Penanganan Kebakaran Korsleting Panel Listrik Menggunakan APAR Gas CO2",
