...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "sop-peledakan-komersial-blasting-pembuatan-jalan-proyek-konstruksi",
  "title": "SOP Peledakan Komersial Blasting Pembuatan Jalan Proyek Konstruksi",
  "metaTitle": "SOP Peledakan Komersial Blasting Pembuatan Jalan Proyek Konstruksi | Prosedur Kerja Aman",
  "description": "Prosedur standar operasional (SOP) keselamatan SOP Peledakan Komersial Blasting Pembuatan Jalan Proyek Konstruksi di industri: tahapan pra-pekerjaan, analisis bahaya JSA, APD wajib, mitigasi risiko Permen PUPR No. 10 Tahun 2021 tentang SMKK, dan tindakan darurat.",
  "answer": "SOP Peledakan Komersial Blasting Pembuatan Jalan Proyek Konstruksi adalah instruksi kerja keselamatan baku dalam klaster Konstruksi & SMKK PUPR (Construction Safety) yang mengatur langkah demi langkah pelaksanaan tugas secara aman berdasarkan Permen PUPR No. 10 Tahun 2021 tentang SMKK guna mencegah kecelakaan fatal, cedera kerja, dan kerusakan aset fasilitas industri.",
  "highlights": [
  ...
  "blocks": [
    {
      "heading": "Tujuan & Ruang Lingkup SOP Peledakan Komersial Blasting Pembuatan Jalan Proyek Konstruksi",
      "paragraphs": [
        "Penerapan SOP Peledakan Komersial Blasting Pembuatan Jalan Proyek Konstruksi bertujuan memberikan panduan operasional terstandar bagi seluruh pekerja, teknisi, dan pengawas yang terlibat dalam aktivitas Konstruksi & SMKK PUPR (Construction Safety). Prosedur ini menjamin bahwa seluruh faktor risiko bahaya runtuhan penggalian tanah, guling alat berat, dan jatuh dari struktur bekisting telah dimitigasi secara terstruktur sebelum pekerjaan dimulai.",
  ...
  "indexable": true,
  "intent": "panduan sop-peledakan-komersial-blasting-pembuatan-jalan-proyek-konstruksi sop prosedur langkah izin keselamatan",
  "primaryKeyword": "sop peledakan komersial blasting pembuatan jalan proyek konstruksi kerja aman",
  "searchIntent": "sop langkah kerja aman, izin kerja, apd, dan mitigasi bahaya SOP Peledakan Komersial Blasting Pembuatan Jalan Proyek Konstruksi",
