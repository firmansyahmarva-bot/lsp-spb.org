...
export const record: ContentRecord = {
  "section": "panduan",
  "slug": "syarat-uji-emisi-cerobong-pabrik-k3",
  ...
  "indexable": true,
  "intent": "panduan syarat uji emisi cerobong pabrik k3 Ketentuan titik sampling isokinetik 8D-2D pada cerobong, lubang pengambilan sampel, dan batas emisi partikulat/gas KLHK.",
  "primaryKeyword": "panduan syarat uji emisi cerobong pabrik k3",
  "searchIntent": "Ketentuan titik sampling isokinetik 8D-2D pada cerobong, lubang pengambilan sampel, dan batas emisi partikulat/gas KLHK.",
