...
export function ProfesiPillarContent({ items }: { items: ContentRecord[] }) {
  return (
    <article className="profesi-pillar-article max-w-5xl mx-auto">
      ...
      <nav className="p-6 my-8 rounded-2xl bg-white border border-slate-200 shadow-sm" aria-label="Daftar Isi Panduan Profesi K3">
        <div className="flex items-center gap-2 mb-4">
          ...
          <strong className="text-xs font-extrabold uppercase tracking-wider text-emerald-800 block">
            Daftar Isi Panduan Profesi K3
          </strong>
        </div>
        <ol className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs sm:text-sm text-slate-700">
          <li>
            <a href="#definisi-profesi-k3" className="flex items-center gap-2.5 p-2.5 rounded-xl border border-slate-100 bg-slate-50/70 hover:bg-emerald-50 hover:border-emerald-200 hover:text-emerald-700 font-semibold transition-all group">
              <span className="w-6 h-6 rounded-lg bg-white border border-slate-200 text-emerald-600 text-xs flex items-center justify-center font-extrabold shrink-0 group-hover:border-emerald-400">01</span>
              <span>1. Apa Itu Profesi K3? Peran Strategis di Dunia Industri</span>
            </a>
          </li>
          <li>
            <a href="#perbedaan-peran-sertifikasi-penunjukan" className="flex items-center gap-2.5 p-2.5 rounded-xl border border-slate-100 bg-slate-50/70 hover:bg-emerald-50 hover:border-emerald-200 hover:text-emerald-700 font-semibold transition-all group">
              <span className="w-6 h-6 rounded-lg bg-white border border-slate-200 text-emerald-600 text-xs flex items-center justify-center font-extrabold shrink-0 group-hover:border-emerald-400">02</span>
              <span>2. Perbedaan Job Title, Penugasan, Sertifikasi, dan SKP Kemnaker</span>
            </a>
          </li>
          <li>
            <a href="#kategori-bidang-spesialisasi" className="flex items-center gap-2.5 p-2.5 rounded-xl border border-slate-100 bg-slate-50/70 hover:bg-emerald-50 hover:border-emerald-200 hover:text-emerald-700 font-semibold transition-all group">
              <span className="w-6 h-6 rounded-lg bg-white border border-slate-200 text-emerald-600 text-xs flex items-center justify-center font-extrabold shrink-0 group-hover:border-emerald-400">03</span>
              <span>3. 9 Kategori Bidang Spesialisasi Profesi K3</span>
            </a>
          </li>
          <li>
            <a href="#panduan-memilih-profesi" className="flex items-center gap-2.5 p-2.5 rounded-xl border border-slate-100 bg-slate-50/70 hover:bg-emerald-50 hover:border-emerald-200 hover:text-emerald-700 font-semibold transition-all group">
              <span className="w-6 h-6 rounded-lg bg-white border border-slate-200 text-emerald-600 text-xs flex items-center justify-center font-extrabold shrink-0 group-hover:border-emerald-400">04</span>
              <span>4. Panduan Memilih Profesi K3 Berdasarkan Profil & Latar Belakang</span>
            </a>
          </li>
          <li>
            <a href="#jenjang-karir-k3" className="flex items-center gap-2.5 p-2.5 rounded-xl border border-slate-100 bg-slate-50/70 hover:bg-emerald-50 hover:border-emerald-200 hover:text-emerald-700 font-semibold transition-all group">
              <span className="w-6 h-6 rounded-lg bg-white border border-slate-200 text-emerald-600 text-xs flex items-center justify-center font-extrabold shrink-0 group-hover:border-emerald-400">05</span>
              <span>5. Peta Jenjang Karir K3: Dari Entry Level hingga Konsultan</span>
            </a>
          </li>
          <li>
            <a href="#tabel-komparasi-profesi-k3" className="flex items-center gap-2.5 p-2.5 rounded-xl border border-slate-100 bg-slate-50/70 hover:bg-emerald-50 hover:border-emerald-200 hover:text-emerald-700 font-semibold transition-all group">
              <span className="w-6 h-6 rounded-lg bg-white border border-slate-200 text-emerald-600 text-xs flex items-center justify-center font-extrabold shrink-0 group-hover:border-emerald-400">06</span>
              <span>6. Tabel Perbandingan Peran Representatif K3</span>
            </a>
          </li>
          <li>
            <a href="#koreksi-miskonsepsi-sertifikasi" className="flex items-center gap-2.5 p-2.5 rounded-xl border border-slate-100 bg-slate-50/70 hover:bg-emerald-50 hover:border-emerald-200 hover:text-emerald-700 font-semibold transition-all group">
              <span className="w-6 h-6 rounded-lg bg-white border border-slate-200 text-emerald-600 text-xs flex items-center justify-center font-extrabold shrink-0 group-hover:border-emerald-400">07</span>
              <span>7. Klarifikasi Regulasi: Pelatihan vs Penunjukan Resmi Menteri</span>
            </a>
          </li>
          <li>
            <a href="#direktori-jabatan-k3" className="flex items-center gap-2.5 p-2.5 rounded-xl border border-slate-100 bg-slate-50/70 hover:bg-emerald-50 hover:border-emerald-200 hover:text-emerald-700 font-semibold transition-all group">
              <span className="w-6 h-6 rounded-lg bg-white border border-slate-200 text-emerald-600 text-xs flex items-center justify-center font-extrabold shrink-0 group-hover:border-emerald-400">08</span>
              <span>8. Direktori Terbuka 200 Jabatan & Spesialisasi Profesi K3</span>
            </a>
          </li>
          <li>
            <a href="#faq-profesi-k3" className="flex items-center gap-2.5 p-2.5 rounded-xl border border-slate-100 bg-slate-50/70 hover:bg-emerald-50 hover:border-emerald-200 hover:text-emerald-700 font-semibold transition-all group">
              <span className="w-6 h-6 rounded-lg bg-white border border-slate-200 text-emerald-600 text-xs flex items-center justify-center font-extrabold shrink-0 group-hover:border-emerald-400">09</span>
              <span>9. Pertanyaan Umum Seputar Profesi & Karir K3 (FAQ)</span>
            </a>
          </li>
          <li>
            <a href="#konsultasi-karir-k3" className="flex items-center gap-2.5 p-2.5 rounded-xl border border-slate-100 bg-slate-50/70 hover:bg-emerald-50 hover:border-emerald-200 hover:text-emerald-700 font-semibold transition-all group">
              <span className="w-6 h-6 rounded-lg bg-white border border-slate-200 text-emerald-600 text-xs flex items-center justify-center font-extrabold shrink-0 group-hover:border-emerald-400">10</span>
              <span>10. Konsultasi Pemilihan Jalur Pembinaan Profesi</span>
            </a>
          </li>
        </ol>
      </nav>
      ...
      <section id="definisi-profesi-k3" className="my-10 scroll-mt-20">
        <h2 className="text-2xl font-extrabold text-slate-900 border-b border-slate-200 pb-3 mb-6 flex items-center gap-2.5">
          <span className="w-2.5 h-6 bg-emerald-500 rounded-full inline-block" />
          <span>1. Apa Itu Profesi K3? Peran Strategis di Dunia Industri</span>
        </h2>

        {/* Executive Takeaway Callout Card */}
        <div className="p-5 mb-6 rounded-2xl bg-emerald-50/80 border border-emerald-200/90 shadow-sm">
          <div className="flex items-center gap-2 text-emerald-800 font-extrabold text-xs uppercase tracking-wider mb-2">
            <ShieldCheck className="w-4 h-4 text-emerald-600" />
            <span>Ringkasan Eksekutif Peran Profesi K3</span>
          </div>
          <p className="text-sm text-slate-800 font-medium leading-relaxed m-0">
            Profesi K3 bukan sekadar pengawas kepatuhan APD di lapangan, melainkan <strong>mitra strategis bisnis</strong> (<em>strategic business partner</em>) yang diwajibkan negara untuk memitigasi skenario bahaya, menekan kerugian aset (<em>loss prevention</em>), dan mengawal tata kelola hukum ketenagakerjaan secara berkelanjutan.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="p-4 rounded-xl border border-slate-200 bg-white shadow-xs flex flex-col justify-between">
            <div>
              <div className="w-9 h-9 rounded-lg bg-emerald-100/70 text-emerald-700 flex items-center justify-center mb-3">
                <Scale className="w-5 h-5" />
              </div>
              <strong className="text-sm font-bold text-slate-900 block mb-1">Mandat Legal Nasional</strong>
              <p className="text-xs text-slate-600 leading-relaxed">
                Diwajibkan mutlak melalui UU No. 1 Tahun 1970 dan UU No. 13 Tahun 2003 bagi seluruh tempat kerja dengan potensi bahaya.
              </p>
            </div>
            <div className="mt-3 pt-3 border-t border-slate-100">
              <Link href="/regulasi-k3/uu-1-1970-keselamatan-kerja" className="text-xs font-bold text-emerald-700 hover:text-emerald-600 inline-flex items-center gap-1">
                <span>Pelajari UU 1/1970</span>
          ...
          <div className="p-4 rounded-xl border border-slate-200 bg-white shadow-xs flex flex-col justify-between">
            <div>
              <div className="w-9 h-9 rounded-lg bg-blue-100/70 text-blue-700 flex items-center justify-center mb-3">
                <Briefcase className="w-5 h-5" />
              </div>
              <strong className="text-sm font-bold text-slate-900 block mb-1">Mitra Strategis Bisnis</strong>
              <p className="text-xs text-slate-600 leading-relaxed">
                Mengintegrasikan pemodelan risiko operasional untuk mencegah downtime, sanksi pidana, dan kerusakan fasilitas pabrik.
              </p>
            </div>
            <div className="mt-3 pt-3 border-t border-slate-100">
              <Link href="/alat/matriks-risiko" className="text-xs font-bold text-emerald-700 hover:text-emerald-600 inline-flex items-center gap-1">
                <span>Gunakan Matriks Risiko</span>
                <ArrowRight className="w-3 h-3" />
              </Link>
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl border border-slate-200 bg-white shadow-xs flex flex-col justify-between">
            <div>
              <div className="w-9 h-9 rounded-lg bg-amber-100/70 text-amber-700 flex items-center justify-center mb-3">
                <Award className="w-5 h-5" />
              </div>
              <strong className="text-sm font-bold text-slate-900 block mb-1">Divisi HSE / EHS Global</strong>
              <p className="text-xs text-slate-600 leading-relaxed">
                Standar pengawasan keselamatan, kesehatan, dan perlindungan lingkungan industri terakreditasi Kemnaker RI & BNSP.
              </p>
            </div>
            <div className="mt-3 pt-3 border-t border-slate-100">
              <Link href="/pelatihan/ahli-k3-umum" className="text-xs font-bold text-emerald-700 hover:text-emerald-600 inline-flex items-center gap-1">
                <span>Sertifikasi Ahli K3</span>
                <ArrowRight className="w-3 h-3" />
              </Link>
            </div>
          </div>
        ...
        <p className="text-slate-700 leading-relaxed mb-4 text-sm sm:text-base">
          Secara yuridis di Indonesia, keberadaan praktisi K3 bukan sekadar inisiatif sukarela manajemen, melainkan mandat legal yang ditegaskan secara tegas dalam <Link href="/regulasi-k3/uu-1-1970-keselamatan-kerja" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">Undang-Undang No. 1 Tahun 1970 tentang Keselamatan Kerja</Link> serta <Link href="/regulasi-k3/uu-13-2003-ketenagakerjaan-k3" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">UU No. 13 Tahun 2003 tentang Ketenagakerjaan</Link>. Negara secara eksplisit mewajibkan setiap tempat kerja yang mempekerjakan personil dan memiliki potensi sumber bahaya untuk menerapkan standar keselamatan kerja serta mempekerjakan tenaga ahli yang memiliki sertifikasi kompetensi dan penunjukan resmi dari pemerintah.
        </p>
        <p className="text-slate-700 leading-relaxed mb-4 text-sm sm:text-base">
          Dalam ekosistem industri modern, peran profesi K3 telah bertransformasi secara fundamental. Praktisi K3 tidak lagi dipandang semata-mata sebagai pengawas lapangan yang memeriksa kelengkapan Alat Pelindung Diri (APD), melainkan sebagai mitra strategis bisnis (<em>strategic business partner</em>). Tanggung jawab intinya mencakup pemodelan skenario bahaya dengan <Link href="/alat/matriks-risiko" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">Matriks Risiko K3</Link>, penyusunan prosedur operasi standar (SOP), minimalisasi downtime akibat kerusakan fasilitas, perlindungan reputasi korporasi dari sanksi pidana ketenagakerjaan, serta mendukung upaya pencegahan insiden dan pengendalian risiko operasional.
        </p>
      </section>
      ...
      <section id="perbedaan-peran-sertifikasi-penunjukan" className="my-10 scroll-mt-20">
        <h2 className="text-2xl font-extrabold text-slate-900 border-b border-slate-200 pb-3 mb-4 flex items-center gap-2.5">
          <span className="w-2.5 h-6 bg-emerald-500 rounded-full inline-block" />
          <span>2. Perbedaan Job Title, Penugasan Internal, Sertifikasi Kompetensi, dan SKP Kemnaker</span>
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
          <div className="p-5 rounded-xl bg-white border border-slate-200 shadow-xs flex flex-col justify-between">
            ...
            <div className="mt-4 pt-3 border-t border-slate-100">
              <span className="text-xs text-slate-500">Penentu: Kebijakan Internal HRD Perusahaan</span>
            </div>
          </div>
          ...
          <div className="p-5 rounded-xl bg-white border border-slate-200 shadow-xs flex flex-col justify-between">
            ...
            <div className="mt-4 pt-3 border-t border-slate-100">
              <span className="text-xs text-slate-500">Penentu: SK Direksi / Penugasan P2K3</span>
            </div>
          </div>
          ...
          <div className="p-5 rounded-xl bg-white border border-slate-200 shadow-xs flex flex-col justify-between">
            ...
            <div className="mt-4 pt-3 border-t border-slate-100">
              <span className="text-xs text-slate-500">Masa Berlaku: 3 Tahun (Melekat pada Individu)</span>
            </div>
          </div>
          ...
          <div className="p-5 rounded-xl bg-white border border-slate-200 shadow-xs flex flex-col justify-between">
            ...
            <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between">
              <span className="text-xs text-slate-500">Masa Berlaku: 3 Tahun (Terikat Perusahaan)</span>
              <Link href="/pelatihan/ahli-k3-umum" className="text-xs font-bold text-emerald-700 hover:text-emerald-600 inline-flex items-center gap-1">
                <span>Daftar Pembinaan</span>
                <ArrowRight className="w-3 h-3" />
              </Link>
            </div>
          </div>
        ...
        <p className="text-xs sm:text-sm text-slate-600 italic">
          Pelajari komparasi mendalam antara kedua sistem sertifikasi pada panduan <Link href="/perbandingan/bnsp-vs-kemnaker" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">Perbandingan Sertifikasi BNSP vs Kemnaker RI</Link>.
        </p>
      </section>
      ...
      <section id="kategori-bidang-spesialisasi" className="my-10 scroll-mt-20">
        <h2 className="text-2xl font-extrabold text-slate-900 border-b border-slate-200 pb-3 mb-4 flex items-center gap-2.5">
          <span className="w-2.5 h-6 bg-emerald-500 rounded-full inline-block" />
          <span>3. 9 Kategori Bidang Spesialisasi Profesi K3 di Indonesia</span>
        </h2>
        <p className="text-slate-700 leading-relaxed mb-6 text-sm sm:text-base">
        ...
        <div className="space-y-4">
          <div className="p-5 rounded-xl border border-slate-200 bg-white shadow-xs">
            <h3 className="text-base font-bold text-slate-900 flex items-center gap-2.5">
              <span className="w-7 h-7 rounded-lg bg-emerald-100 text-emerald-800 text-xs flex items-center justify-center font-extrabold">1</span>
              <span>K3 Umum & Manajemen SMK3 (General Health & Safety)</span>
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 mt-2 leading-relaxed">
              Merupakan fondasi utama sistem keselamatan kerja korporasi, mencakup peran <Link href="/pelatihan/ahli-k3-umum" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">Ahli K3 Umum</Link>, <Link href="/pelatihan/auditor-smk3" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">Auditor SMK3</Link>, dan <Link href="/pelatihan/lead-auditor-smk3" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">Lead Auditor SMK3</Link>. Bertanggung jawab langsung atas perumusan kebijakan K3 perusahaan, pemenuhan 166 kriteria audit SMK3 berdasarkan Peraturan Pemerintah No. 50 Tahun 2012, pengelolaan komite P2K3, serta pengawasan kepatuhan lintas departemen.
            </p>
          </div>

          <div className="p-5 rounded-xl border border-slate-200 bg-white shadow-xs">
            <h3 className="text-base font-bold text-slate-900 flex items-center gap-2.5">
              <span className="w-7 h-7 rounded-lg bg-emerald-100 text-emerald-800 text-xs flex items-center justify-center font-extrabold">2</span>
              <span>K3 Konstruksi & Pekerjaan Sipil</span>
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 mt-2 leading-relaxed">
              Mencakup Ahli K3 Konstruksi (jenjang Muda, Madya, Utama) dan Petugas K3 Konstruksi mengacu pada Permenaker No. 01/Men/1980 dan Permen PUPR No. 10 Tahun 2021. Bertanggung jawab mengendalikan risiko pekerjaan galian dalam, struktur perancah (scaffolding), pengangkatan balok girder jembatan, penataan lalu lintas alat berat di site proyek, serta koordinasi keselamatan mitra subkontraktor. Komparasi lengkap dapat dipelajari pada ulasan <Link href="/perbandingan/ahli-k3-umum-vs-ahli-k3-konstruksi" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">Perbedaan Ahli K3 Umum vs Konstruksi</Link>.
            </p>
          </div>

          <div className="p-5 rounded-xl border border-slate-200 bg-white shadow-xs">
            <h3 className="text-base font-bold text-slate-900 flex items-center gap-2.5">
              <span className="w-7 h-7 rounded-lg bg-emerald-100 text-emerald-800 text-xs flex items-center justify-center font-extrabold">3</span>
              <span>K3 Kelistrikan & Energi Listrik</span>
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 mt-2 leading-relaxed">
              Mencakup Teknisi K3 Listrik dan Ahli K3 Spesialis Listrik yang diatur dalam Permenaker No. 12 Tahun 2015. Bertanggung jawab mengawasi perencanaan, pemasangan, pemeliharaan, serta pengujian berkala instalasi listrik, sistem isolasi energi Lockout-Tagout (LOTO), proteksi terhadap bahaya lonjakan petir, dan mitigasi bahaya busur api listrik (arc flash) sesuai ketentuan Pedoman Umum Instalasi Listrik (PUIL 2020). Pelajari estimasi investasinya pada <Link href="/panduan/biaya-pelatihan-k3-listrik" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">Biaya Pelatihan K3 Listrik</Link>.
            </p>
          </div>

          <div className="p-5 rounded-xl border border-slate-200 bg-white shadow-xs">
            <h3 className="text-base font-bold text-slate-900 flex items-center gap-2.5">
              <span className="w-7 h-7 rounded-lg bg-emerald-100 text-emerald-800 text-xs flex items-center justify-center font-extrabold">4</span>
              <span>K3 Penanggulangan Kebakaran</span>
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 mt-2 leading-relaxed">
              Tersusun dalam empat strata kualifikasi berdasarkan Kepmenaker No. Kep.186/MEN/1999: Petugas Peran Kebakaran (Kelas D), Regu Penanggulangan Kebakaran (Kelas C), Koordinator Unit Kebakaran (Kelas B), dan Ahli K3 Spesialis Kebakaran (Kelas A). Mengelola kesiapan sistem deteksi otomatis, jaringan hidran, sprinkler, APAR, serta simulasi evakuasi darurat. Rincian skema tersedia di panduan <Link href="/panduan/biaya-pelatihan-k3-kebakaran" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">Biaya Pelatihan K3 Kebakaran</Link>.
            </p>
          </div>

          <div className="p-5 rounded-xl border border-slate-200 bg-white shadow-xs">
            <h3 className="text-base font-bold text-slate-900 flex items-center gap-2.5">
              <span className="w-7 h-7 rounded-lg bg-emerald-100 text-emerald-800 text-xs flex items-center justify-center font-extrabold">5</span>
              <span>Kesehatan Kerja, Higiene Perusahaan & Medis</span>
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 mt-2 leading-relaxed">
              Mencakup Dokter Perusahaan bersertifikasi Hiperkes, Paramedis / Perawat Perusahaan bersertifikasi Hiperkes (Permenaker No. 01/1976 & 01/1979), serta Petugas Pertolongan Pertama Pada Kecelakaan (P3K) di Tempat Kerja (Permenaker No. 15/2008). Menjalankan fungsi diagnosis penyakit akibat kerja (PAK), surveilans biologis, pemantauan ergonomi, dan operasional klinik kerja. Simak selengkapnya di <Link href="/panduan/biaya-pelatihan-hiperkes-dokter-paramedis" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">Pelatihan Hiperkes Dokter & Paramedis</Link>.
            </p>
          </div>

          <div className="p-5 rounded-xl border border-slate-200 bg-white shadow-xs">
            <h3 className="text-base font-bold text-slate-900 flex items-center gap-2.5">
              <span className="w-7 h-7 rounded-lg bg-emerald-100 text-emerald-800 text-xs flex items-center justify-center font-extrabold">6</span>
              <span>K3 Lingkungan Kerja & Higiene Industri</span>
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 mt-2 leading-relaxed">
              Mencakup Ahli K3 Lingkungan Kerja (Permenaker No. 5 Tahun 2018) dan Tenaga Higiene Industri berstandar BNSP (HIMU, HIMA, HIU). Melakukan pengukuran instrumentasi laboratorium terhadap faktor fisika (kebisingan, getaran mekanis, pencahayaan, gelombang elektromagnetik), faktor kimia (debu terhirup, uap gas toksik), faktor biologi, dan pengujian beban kerja psikososial. Rincian program pembinaan ada di <Link href="/pelatihan/pelatihan-ahli-k3-lingkungan-kerja-muda-madya-utama-kemnaker-ri" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">Ahli K3 Lingkungan Kerja Kemnaker RI</Link>.
            </p>
          </div>

          <div className="p-5 rounded-xl border border-slate-200 bg-white shadow-xs">
            <h3 className="text-base font-bold text-slate-900 flex items-center gap-2.5">
              <span className="w-7 h-7 rounded-lg bg-emerald-100 text-emerald-800 text-xs flex items-center justify-center font-extrabold">7</span>
              <span>K3 Pesawat Angkat & Pesawat Angkut (PAA)</span>
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 mt-2 leading-relaxed">
              Mencakup Ahli K3 Pesawat Angkat dan Angkut, Operator Forklift, Operator Mobile Crane, Overhead Crane, Tower Crane, serta Rigger / Juru Ikat Beban berdasarkan Permenaker No. 8 Tahun 2020. Fokus utama adalah pengujian kapasitas angkut (load testing), stabilitas alat berat, integritas sling baja, dan pencegahan risiko tertimpa muatan berat saat operasional logistik atau pabrikasi. Pelajari panduan lisensi di <Link href="/panduan/biaya-pelatihan-operator-forklift" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">Lisensi Operator Forklift Kemnaker</Link>.
            </p>
          </div>

          <div className="p-5 rounded-xl border border-slate-200 bg-white shadow-xs">
            <h3 className="text-base font-bold text-slate-900 flex items-center gap-2.5">
              <span className="w-7 h-7 rounded-lg bg-emerald-100 text-emerald-800 text-xs flex items-center justify-center font-extrabold">8</span>
              <span>K3 Bekerja di Ketinggian & Ruang Terbatas</span>
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 mt-2 leading-relaxed">
              Mencakup Tenaga Kerja Bangunan Tinggi (TKBT Tingkat 1 & 2), Tenaga Kerja Pada Ketinggian (TKPK Tingkat 1, 2, 3) mengacu pada Permenaker No. 9 Tahun 2016, serta Petugas Madya & Pengawas Ruang Terbatas (Confined Space) berdasarkan Permenaker No. 11 Tahun 2023. Menguasai teknik pemasangan angkur, tali akses (rope access), prosedur evakuasi vertical rescue, serta pengukuran gas atmosfer. Rincian ada di <Link href="/panduan/biaya-pelatihan-bekerja-di-ketinggian" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">Pelatihan Bekerja di Ketinggian</Link> dan <Link href="/panduan/biaya-pelatihan-petugas-k3-ruang-terbatas" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">K3 Ruang Terbatas</Link>.
            </p>
          </div>

          <div className="p-5 rounded-xl border border-slate-200 bg-white shadow-xs">
            <h3 className="text-base font-bold text-slate-900 flex items-center gap-2.5">
              <span className="w-7 h-7 rounded-lg bg-emerald-100 text-emerald-800 text-xs flex items-center justify-center font-extrabold">9</span>
              <span>K3 Kimia, Bejana Tekan & Proses Manufaktur</span>
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 mt-2 leading-relaxed">
              Mencakup Ahli K3 Kimia dan Petugas K3 Kimia (Kepmenaker No. Kep.187/MEN/1999), Operator Boiler / Bejana Uap, dan Teknisi Bejana Tekan & Tangki Timbun (Permenaker No. 37 Tahun 2016). Bertanggung jawab atas pengelolaan dokumen Lembar Data Keselamatan (LDK/SDS), klasifikasi potensi bahaya besar (Major Hazard Installation), dan integritas pipa bertekanan tinggi. Informasi biaya tersedia di <Link href="/panduan/biaya-pelatihan-ahli-k3-kimia" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">Biaya Pelatihan Ahli K3 Kimia</Link>.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="jenjang-karir-k3" className="my-10 scroll-mt-20">
        <h2 className="text-2xl font-extrabold text-slate-900 border-b border-slate-200 pb-3 mb-4 flex items-center gap-2.5">
          <span className="w-2.5 h-6 bg-emerald-500 rounded-full inline-block" />
          <span>5. Peta Jenjang Karir K3: Dari Entry Level hingga Konsultan Independen</span>
        </h2>
        <p className="text-slate-700 leading-relaxed mb-6 text-sm sm:text-base">
        ...
        <div className="relative border-l-2 border-emerald-500 ml-4 pl-6 space-y-6">
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-600 mt-1 leading-relaxed">
              Tanggung jawab utama berpusat pada kepatuhan operasional harian: memberikan Safety Induction bagi tamu dan pekerja baru, memimpin Toolbox Meeting (TBM) sebelum shift dimulai, memeriksa izin kerja berisiko tinggi (Working Permit), dan menginspeksi kelaikan APD di area kerja. Pahami rincian tugas harian ini pada artikel <Link href="/panduan/tugas-ahli-k3-umum" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">Tugas dan Tanggung Jawab Ahli K3 Umum</Link>.
            </p>
          </div>
      ...
      <section id="tabel-komparasi-profesi-k3" className="my-10 scroll-mt-20">
        <h2 className="text-2xl font-extrabold text-slate-900 border-b border-slate-200 pb-3 mb-4 flex items-center gap-2.5">
          <span className="w-2.5 h-6 bg-emerald-500 rounded-full inline-block" />
          <span>6. Tabel Perbandingan Peran Representatif Profesi K3</span>
        </h2>
        <p className="text-slate-700 leading-relaxed mb-4 text-sm sm:text-base">
          ...
          <table className="w-full text-left text-xs sm:text-sm border-collapse">
            ...
            <tbody className="divide-y divide-slate-100 text-slate-700">
              <tr className="hover:bg-slate-50/70">
                ...
                <td className="p-3.5">
                  <Link href="/pelatihan/ahli-k3-umum" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">Ahli K3 Umum 120 JP</Link> atau BNSP Safety Officer.
                </td>
              </tr>
              <tr className="hover:bg-slate-50/70">
                <td className="p-3.5 font-bold text-slate-900">
              ...
              <tr className="hover:bg-slate-50/70">
                ...
                <td className="p-3.5">
                  <Link href="/pelatihan/auditor-smk3" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">Pelatihan Auditor SMK3</Link> / <Link href="/pelatihan/lead-auditor-smk3" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">Lead Auditor</Link> Kemnaker RI.
                </td>
              </tr>
              <tr className="hover:bg-slate-50/70">
                <td className="p-3.5 font-bold text-slate-900">
                ...
                <td className="p-3.5">
                  Sertifikasi Ahli K3 Konstruksi Kemnaker / BNSP. Bandingkan pada <Link href="/perbandingan/ahli-k3-umum-vs-ahli-k3-konstruksi" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">K3 Umum vs K3 Konstruksi</Link>.
                </td>
              </tr>
              <tr className="hover:bg-slate-50/70">
                <td className="p-3.5 font-bold text-slate-900">
      ...
      <section id="koreksi-miskonsepsi-sertifikasi" className="my-10 scroll-mt-20">
        <h2 className="text-2xl font-extrabold text-slate-900 border-b border-slate-200 pb-3 mb-4 flex items-center gap-2.5">
          <span className="w-2.5 h-6 bg-emerald-500 rounded-full inline-block" />
          <span>7. Klarifikasi Regulasi: Menyelesaikan Pelatihan Tidak Otomatis Mendapatkan Gelar atau Penunjukan Menteri</span>
        </h2>
        <div className="p-5 rounded-2xl bg-amber-50/90 border border-amber-200 text-amber-950 leading-relaxed text-xs sm:text-sm">
          <strong className="block text-sm sm:text-base font-black mb-2 text-amber-950 flex items-center gap-2">
            <AlertTriangle className="w-5 h-5 text-amber-600 shrink-0" />
            <span>Penegasan Yuridis Terkait SKP & Lisensi Kemnaker RI</span>
          </strong>
          ...
          <ol className="list-decimal list-inside space-y-2 mb-3 text-slate-800">
            <li>
        ...
        <div className="space-y-4">
          <div className="p-5 rounded-xl border border-slate-200 bg-white shadow-xs">
            <h3 className="text-sm sm:text-base font-bold text-slate-900 mb-2 flex items-start gap-2">
              ...
              <span>Apakah lulusan non-teknik bisa berkarir di bidang K3?</span>
            </h3>
          ...
          <div className="p-5 rounded-xl border border-slate-200 bg-white shadow-xs">
            <h3 className="text-sm sm:text-base font-bold text-slate-900 mb-2 flex items-start gap-2">
              <HelpCircle className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
              <span>Berapa estimasi rentang gaji profesi K3 di Indonesia?</span>
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed pl-6">
          ...
          <div className="p-5 rounded-xl border border-slate-200 bg-white shadow-xs">
            <h3 className="text-sm sm:text-base font-bold text-slate-900 mb-2 flex items-start gap-2">
              <HelpCircle className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
              <span>Berapa lama masa berlaku Lisensi Kewenangan K3 Kemnaker RI?</span>
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed pl-6">
          ...
          <div className="p-5 rounded-xl border border-slate-200 bg-white shadow-xs">
            <h3 className="text-sm sm:text-base font-bold text-slate-900 mb-2 flex items-start gap-2">
              <HelpCircle className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
              <span>Apa perbedaan mendasar antara Safety Officer dan Ahli K3 Umum?</span>
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed pl-6">
          ...
          <div className="p-5 rounded-xl border border-slate-200 bg-white shadow-xs">
            <h3 className="text-sm sm:text-base font-bold text-slate-900 mb-2 flex items-start gap-2">
              <HelpCircle className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
              <span>Apakah sertifikat BNSP bidang K3 diakui di luar negeri?</span>
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed pl-6">
