...
export function KompetensiHubContent({ items }: { items: ContentRecord[] }) {
  ...
  return (
    <article className="kompetensi-hub-article max-w-5xl mx-auto">
      ...
      <div className="p-5 sm:p-6 my-6 rounded-2xl bg-emerald-50/80 border border-emerald-200/90 text-xs sm:text-sm text-slate-800 leading-relaxed shadow-xs">
        <div className="flex items-center gap-2 text-emerald-800 font-extrabold text-xs uppercase tracking-wider mb-2">
          <ShieldCheck className="w-4 h-4 text-emerald-600" />
          <span>Prinsip Implementasi Standar Keahlian</span>
        </div>
        <strong className="block text-sm sm:text-base font-bold text-slate-900 mb-2">
      ...
      <section className="my-10">
        <h2 className="text-2xl font-extrabold text-slate-900 border-b border-slate-200 pb-3 mb-4 flex items-center gap-2.5">
          ...
          <span>Perbedaan Antara Kompetensi, Pelatihan, Sertifikasi, dan Profesi</span>
        </h2>
          ...
          <table className="w-full text-left text-xs sm:text-sm border-collapse">
            ...
            <tbody className="divide-y divide-slate-100 text-slate-700">
              ...
              <tr className="hover:bg-slate-50/70">
                ...
                <td className="p-3.5">
                  Mengikuti pembinaan melalui <Link href="/pelatihan" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">jalur pelatihan K3</Link> regulasi Kemnaker RI atau bimbingan teknis internal perusahaan.
                </td>
              </tr>
              <tr className="hover:bg-slate-50/70">
                <td className="p-3.5 font-bold text-slate-900">
                ...
                <td className="p-3.5">
                  Menjalani uji kompetensi portofolio dan wawancara; pelajari mekanismenya pada <Link href="/perbandingan/bnsp-vs-kemnaker" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">perbandingan sertifikasi BNSP vs Kemnaker</Link>.
                </td>
              </tr>
              <tr className="hover:bg-slate-50/70">
                <td className="p-3.5 font-bold text-slate-900">
                ...
                <td className="p-3.5">
                  Menjabat sebagai Safety Officer, Koordinator HSE, atau Auditor SMK3; telusuri pilihannya pada direktori <Link href="/profesi" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">profesi atau jabatan K3</Link>.
                </td>
              </tr>
            </tbody>
          </table>
      ...
      <section className="my-10">
        <h2 className="text-2xl font-extrabold text-slate-900 border-b border-slate-200 pb-3 mb-3 flex items-center gap-2.5">
          <span className="w-2.5 h-6 bg-emerald-500 rounded-full inline-block" />
          <span>Kelompok Keahlian Berdasarkan Kebutuhan Kerja</span>
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-5 rounded-xl border border-slate-200 bg-white shadow-xs">
            <h3 className="text-base font-bold text-slate-900 mb-2 flex items-center gap-2.5">
              ...
              <span>Identifikasi Bahaya dan Penilaian Risiko</span>
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
              Keahlian inti dalam mendeteksi sumber bahaya di lingkungan operasional, mengkalkulasi probabilitas insiden menggunakan <Link href="/alat/matriks-risiko" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">Matriks Risiko K3</Link>, serta menyusun dokumen analisis keselamatan seperti <Link href="/kompetensi/identifikasi-bahaya-penilaian-risiko-hiradc" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">penyusunan HIRADC</Link> dan Job Safety Analysis (JSA) sebelum pekerjaan dimulai.
            </p>
          </div>
          ...
          <div className="p-5 rounded-xl border border-slate-200 bg-white shadow-xs">
            <h3 className="text-base font-bold text-slate-900 mb-2 flex items-center gap-2.5">
              ...
              <span>Audit, Inspeksi dan Kepatuhan Regulasi</span>
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
              Keterampilan melakukan inspeksi visual berkala di tempat kerja, menyusun daftar periksa kepatuhan, menilai kesesuaian terhadap peraturan perundangan ketenagakerjaan, serta melaksanakan audit internal sistem manajemen keselamatan mengacu pada 166 kriteria SMK3 PP 50/2012 maupun ISO 45001 melalui <Link href="/pelatihan/auditor-smk3" className="text-emerald-700 font-bold underline decoration-emerald-300 hover:text-emerald-600">Pelatihan Auditor SMK3</Link>.
            </p>
          </div>
          ...
          <div className="p-5 rounded-xl border border-slate-200 bg-white shadow-xs">
            <h3 className="text-base font-bold text-slate-900 mb-2 flex items-center gap-2.5">
              ...
              <span>Tanggap Darurat dan Proteksi Kebakaran</span>
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
          ...
          <div className="p-5 rounded-xl border border-slate-200 bg-white shadow-xs">
            <h3 className="text-base font-bold text-slate-900 mb-2 flex items-center gap-2.5">
              ...
              <span>Kesehatan Kerja, Higiene Industri dan Ergonomi</span>
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
          ...
          <div className="p-5 rounded-xl border border-slate-200 bg-white shadow-xs">
            <h3 className="text-base font-bold text-slate-900 mb-2 flex items-center gap-2.5">
              ...
              <span>Keselamatan Operasional, Alat Berat dan Pabrikasi</span>
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
          ...
          <div className="p-5 rounded-xl border border-slate-200 bg-white shadow-xs">
            <h3 className="text-base font-bold text-slate-900 mb-2 flex items-center gap-2.5">
              ...
              <span>Manajemen K3, Komunikasi dan Pelatihan</span>
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
          ...
          <div className="p-5 rounded-xl border border-slate-200 bg-white shadow-xs">
            <h3 className="text-base font-bold text-slate-900 mb-2 flex items-center gap-2.5">
              ...
              <span>Analisis Risiko Spesialis dan Rekayasa Teknis</span>
            </h3>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
      ...
      <section className="my-10">
        <h2 className="text-2xl font-extrabold text-slate-900 border-b border-slate-200 pb-3 mb-4 flex items-center gap-2.5">
          <span className="w-2.5 h-6 bg-emerald-500 rounded-full inline-block" />
          <span>Panduan Memilih Kompetensi K3 yang Sesuai Kebutuhan</span>
        </h2>
        <p className="text-slate-700 leading-relaxed mb-4 text-sm sm:text-base">
        ...
        <div className="p-5 sm:p-6 rounded-2xl bg-slate-50 border border-slate-200 mb-6 space-y-4">
          ...
          <ul className="space-y-3 text-xs sm:text-sm text-slate-700">
            <li className="flex items-start gap-2.5">
              <span className="font-bold text-emerald-700 min-w-[24px]">1.</span>
              <div>
            ...
            <li className="flex items-start gap-2.5">
              <span className="font-bold text-emerald-700 min-w-[24px]">2.</span>
              <div>
            ...
            <li className="flex items-start gap-2.5">
              <span className="font-bold text-emerald-700 min-w-[24px]">3.</span>
              <div>
            ...
            <li className="flex items-start gap-2.5">
              <span className="font-bold text-emerald-700 min-w-[24px]">4.</span>
              <div>
            ...
            <li className="flex items-start gap-2.5">
              <span className="font-bold text-emerald-700 min-w-[24px]">5.</span>
              <div>
      ...
      <section className="my-10">
        <h2 className="text-2xl font-extrabold text-slate-900 border-b border-slate-200 pb-3 mb-3 flex items-center gap-2.5">
          <span className="w-2.5 h-6 bg-emerald-500 rounded-full inline-block" />
          <span>Tahapan Pengembangan Keahlian (Progresi Belajar)</span>
        </h2>
        <p className="text-slate-700 leading-relaxed mb-4 text-sm sm:text-base">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 my-6">
          <div className="p-4 rounded-xl border border-slate-200 bg-white shadow-xs">
            <span className="text-xs font-bold text-emerald-700 uppercase tracking-wider block mb-1">Tahap 1</span>
            <h3 className="text-sm font-bold text-slate-900 mb-1.5">Pemahaman Dasar</h3>
          ...
          <div className="p-4 rounded-xl border border-slate-200 bg-white shadow-xs">
            <span className="text-xs font-bold text-emerald-700 uppercase tracking-wider block mb-1">Tahap 2</span>
            <h3 className="text-sm font-bold text-slate-900 mb-1.5">Penerapan Lapangan</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
          ...
          <div className="p-4 rounded-xl border border-slate-200 bg-white shadow-xs">
            <span className="text-xs font-bold text-emerald-700 uppercase tracking-wider block mb-1">Tahap 3</span>
            <h3 className="text-sm font-bold text-slate-900 mb-1.5">Analisis & Evaluasi</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
          ...
          <div className="p-4 rounded-xl border border-slate-200 bg-white shadow-xs">
            <span className="text-xs font-bold text-emerald-700 uppercase tracking-wider block mb-1">Tahap 4</span>
            <h3 className="text-sm font-bold text-slate-900 mb-1.5">Koordinasi & Supervisi</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
          ...
          <div className="p-4 rounded-xl border border-slate-200 bg-white shadow-xs">
            <span className="text-xs font-bold text-emerald-700 uppercase tracking-wider block mb-1">Tahap 5</span>
            <h3 className="text-sm font-bold text-slate-900 mb-1.5">Keahlian Spesialis</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
      ...
      {legal && (
        <section className="my-10 p-5 sm:p-6 rounded-2xl bg-emerald-50/70 border border-emerald-200">
      ...
      {faqs.length > 0 && (
        <section className="my-12">
          <h2 className="text-2xl font-extrabold text-slate-900 border-b border-slate-200 pb-3 mb-6 flex items-center gap-2.5">
            <span className="w-2.5 h-6 bg-emerald-500 rounded-full inline-block" />
            <span>Pertanyaan Umum Seputar Kompetensi K3 (FAQ)</span>
          </h2>
