...
const fallbackBySection: Record<Section, string[]> = {
  ...
  industri: ['pelatihan/ahli-k3-umum', 'panduan/tugas-ahli-k3-umum', 'panduan/biaya-pelatihan-k3', 'regulasi-k3/uu-1-1970-keselamatan-kerja'],
  'regulasi-k3': ['regulasi-k3/uu-1-1970-keselamatan-kerja', 'regulasi-k3/pp-50-2012-penerapan-smk3', 'pelatihan/ahli-k3-umum', 'panduan/tugas-ahli-k3-umum'],
  panduan: ['panduan/syarat-ahli-k3-umum', 'panduan/materi-ahli-k3-umum', 'panduan/tugas-ahli-k3-umum', 'panduan/biaya-pelatihan-k3'],
  'kamus-k3': ['pelatihan/ahli-k3-umum', 'panduan/materi-ahli-k3-umum', 'perbandingan/bnsp-vs-kemnaker', 'regulasi-k3/uu-1-1970-keselamatan-kerja'],
